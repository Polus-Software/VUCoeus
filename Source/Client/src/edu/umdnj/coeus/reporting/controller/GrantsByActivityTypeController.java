/**
 * $Header: /home/cvs/cvsroot/coeus/Source/edu/umdnj/coeus/reporting/controller/Attic/GrantsByActivityTypeController.java,v 1.1.2.3 2007/09/06 18:31:21 cvs Exp $
 * $Log: GrantsByActivityTypeController.java,v $
 ...
 * Add NIH support
 *
 * Revision 1.1.2.1  2006/12/28 16:47:04  cvs
 *  Add support for grants by activity type GUI
 *
 *
 */
/*
 * @(#)GrantsByActivityTypeController.java 
 *
...
import edu.umdnj.coeus.reporting.gui.GrantsByActivityTypeForm;
...
public class GrantsByActivityTypeController extends Controller 
                 implements ActionListener
{
    ...
    /** GrantsByActivityTypeForm Form instance whihc form is UI */
    private GrantsByActivityTypeForm grantsByActivityTypeForm = null;

    private static final String REPORTING_MAINTENANCE_SERVLET = "/ReportingMaintenanceServlet";
    private String UnitNumber;
    private String UnitName;

    public GrantsByActivityTypeController() 
    {
        super();
    ...
    /** Creates a new instance of GrantsByActivityTypeController
     * with parameters
    ...
    {
        if(grantsByActivityTypeForm == null) 
        {
            grantsByActivityTypeForm =  new GrantsByActivityTypeForm();   //(Component) parent,modal);
        }
        grantsByActivityTypeForm.descriptionLabel.setText(UnitName);
        grantsByActivityTypeForm.descriptionLabel.setFont(new Font("SansSerif",Font.BOLD,14));
    ...
    public void display() 
    {
        ((GrantsByActivityTypeForm) getControlledUI()).setVisible(true);
    }

    /** method to set Visible the form on close */    
    public void close() 
    {
        ((GrantsByActivityTypeForm) getControlledUI()).setVisible(false);
    }
    ...
    {
        return grantsByActivityTypeForm;
    }

    /** To Register  all the Actionlistner for the Components of UI */
    public void registerComponents() 
    {
        grantsByActivityTypeForm.jbnRunButton.addActionListener(this);
        grantsByActivityTypeForm.jbnCloseButton.addActionListener(this);
    }

  public void actionPerformed(ActionEvent ev)
  {
     Object obj = ev.getSource();
     if (obj == grantsByActivityTypeForm.jbnRunButton)
     {
        RunButtonAction();
     }
     else
     if (obj == grantsByActivityTypeForm.jbnCloseButton)
     {
       close();
     }
  }
  ...
  {
    int fnum = grantsByActivityTypeForm.comboReportFormatsList.getSelectedIndex();
    if (fnum == -1)
    {
       log("Please select a format.");
    }
    
    String strFormat = grantsByActivityTypeForm.comboFormatTypes[fnum];
    String strFiscalYearType = grantsByActivityTypeForm.fiscalYearController.getFiscalYearType();
    String strFiscalYear = grantsByActivityTypeForm.fiscalYearController.getFiscalYear();
  ...
  public Object getFormData() 
  {
    ...
    {
        boolean bNIH = grantsByActivityTypeForm.checkNIH.isSelected();
        ...
        strbuf.append("/GetGrantsByActivityTypeServlet?UnitName=");
