/**
 * $Header: /home/cvs/cvsroot/coeus/Source/edu/umdnj/coeus/reporting/controller/Attic/PendingStatusReportController.java,v 1.1.2.1 2007/08/20 15:05:33 cvs Exp $
 * $Log: PendingStatusReportController.java,v $
 ...
 */
/*
 * @(#)PendingStatusReportController.java 
 *
...
import edu.umdnj.coeus.reporting.gui.PendingStatusReportForm;
...
public class PendingStatusReportController extends Controller 
                 implements ActionListener
{
    ...
    /** PendingStatusReportForm Form instance whihc form is UI */
    private PendingStatusReportForm pendingStatusReportForm = null;

    private static final String REPORTING_MAINTENANCE_SERVLET = "/ReportingMaintenanceServlet";
    private String UnitNumber;
    private String UnitName;

    public PendingStatusReportController() 
    {
        super();
    ...
    /** Creates a new instance of PendingStatusReportController
     * with parameters
    ...
    {
        if(pendingStatusReportForm == null) 
        {
            pendingStatusReportForm =  new PendingStatusReportForm();   //(Component) parent,modal);
        }
        pendingStatusReportForm.descriptionLabel.setText(UnitName);
        pendingStatusReportForm.descriptionLabel.setFont(new Font("SansSerif",Font.BOLD,14));
    ...
    public void display() 
    {
        ((PendingStatusReportForm) getControlledUI()).setVisible(true);
    }

    /** method to set Visible the form on close */    
    public void close() 
    {
        ((PendingStatusReportForm) getControlledUI()).setVisible(false);
    }
    ...
    {
        return pendingStatusReportForm;
    }

    /** To Register  all the Actionlistner for the Components of UI */
    public void registerComponents() 
    {
        pendingStatusReportForm.jbnRunButton.addActionListener(this);
        pendingStatusReportForm.jbnCloseButton.addActionListener(this);
    }

  public void actionPerformed(ActionEvent ev)
  {
     Object obj = ev.getSource();
     if (obj == pendingStatusReportForm.jbnRunButton)
     {
        RunButtonAction();
     }
     else
     if (obj == pendingStatusReportForm.jbnCloseButton)
     {
       close();
     }
  }
  ...
  {
    int fnum = pendingStatusReportForm.comboReportFormatsList.getSelectedIndex();
    if (fnum == -1)
    {
       log("Please select a format.");
    }
    
    String strFormat = pendingStatusReportForm.comboFormatTypes[fnum];

    generateReport(strFormat);
  }
  ...
  public Object getFormData() 
  {
            ...
            String strFormat)
    {
        ...
        strbuf.append("/GetPendingStatusReportServlet?SchoolName=");
