/**
 * $Header: /home/cvs/cvsroot/coeus/Source/edu/umdnj/coeus/reporting/gui/Attic/GrantsBySponsorForm.java,v 1.1.2.8 2007/09/06 18:31:21 cvs Exp $
 * $Log: GrantsBySponsorForm.java,v $
 * Revision 1.1.2.8  2007/09/06 18:31:21  cvs
 * Fiscal Year Delineation: support GUI infrastructure
 *
 * Revision 1.1.2.7  2007/06/20 18:47:23  cvs
 * Add database retrieval for Sponsor Type Description
 *
 * Revision 1.1.2.6  2007/03/08 14:56:16  cvs
 * Change titles into Active for Grants, Expand some dialogs, Select DS in Grants by PI
 *
 * Revision 1.1.2.5  2007/02/27 18:27:57  cvs
 * Increase pixel height of dialogs per Therese instructions
 *
 * Revision 1.1.2.4  2007/01/17 17:20:50  cvs
 * Add NIH support
 *
 * Revision 1.1.2.3  2007/01/17 15:28:53  cvs
 * Add CSV Support
 *
 * Revision 1.1.2.2  2007/01/03 20:00:02  cvs
 * Change description year to fiscal components per Therese
 *
 * Revision 1.1.2.1  2006/12/27 19:15:00  cvs
 *  Add support for grants by sponsor type GUI
 *
 *
 */
/*
 * @(#)GrantsBySponsorForm.java 
 *
...
public class GrantsBySponsorForm extends CoeusDlgWindow

{
 /** Creates a new instance of GrantsBySponsorForm */
 public GrantsBySponsorForm() 
 {
   super(CoeusGuiConstants.getMDIForm(),"",true);
   setFormUI();
 }

 public GrantsBySponsorForm(Component parent, boolean modal)
 {
 ...
 {        
  ...
  {
    setTitle("Active Grants by Sponsor Type");
    ...
    sponsorTypeLabel = new JLabel("Sponsor Type:");
    sponsorTypeLabel.setFont(CoeusFontFactory.getLabelFont());
    gBC = new GridBagConstraints();
    gBC.gridx = 0;
    gBC.gridy = 3;
    gBC.gridwidth = 2;
    ...
    gBC.anchor = GridBagConstraints.WEST;
    gBC.insets = insets();
    pane.add(sponsorTypeLabel, gBC);

    comboSponsorTypeList = new JComboBox();
    gBC = new GridBagConstraints();
    gBC.gridx = 0;
    gBC.gridy = 4;
    gBC.gridwidth = 2;
    ...
    gBC.anchor = GridBagConstraints.WEST;
    gBC.insets = insets();
    pane.add(comboSponsorTypeList, gBC);
