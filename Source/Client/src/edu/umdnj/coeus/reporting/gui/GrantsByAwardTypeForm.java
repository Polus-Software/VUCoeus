/**
 * $Header: /home/cvs/cvsroot/coeus/Source/edu/umdnj/coeus/reporting/gui/Attic/GrantsByAwardTypeForm.java,v 1.1.2.4 2007/09/06 18:31:21 cvs Exp $
 * $Log: GrantsByAwardTypeForm.java,v $
 ...
 *
 * Revision 1.1.2.1  2007/01/23 15:43:20  cvs
 * Add Award Type Grant GUI support
 *
 *
 */
/*
 * @(#)GrantsByAwardTypeForm.java 
 *
...
public class GrantsByAwardTypeForm extends CoeusDlgWindow

{
 /** Creates a new instance of GrantsByAwardTypeForm */
 public GrantsByAwardTypeForm() 
 {
   super(CoeusGuiConstants.getMDIForm(),"",true);
   setFormUI();
 }

 public GrantsByAwardTypeForm(Component parent, boolean modal)
 {
 ...
 {        
  ...
  {
    setTitle("Active Grants by Award Type");
