/**
 * $Header: /home/cvs/cvsroot/coeus/Source/edu/umdnj/coeus/reporting/gui/Attic/GrantsBySchoolForm.java,v 1.1.2.8 2007/09/06 18:31:21 cvs Exp $
 * $Log: GrantsBySchoolForm.java,v $
 * Revision 1.1.2.8  2007/09/06 18:31:21  cvs
 * Fiscal Year Delineation: support GUI infrastructure
 *
 * Revision 1.1.2.7  2007/03/08 14:56:16  cvs
 * Change titles into Active for Grants, Expand some dialogs, Select DS in Grants by PI
 *
 * Revision 1.1.2.6  2007/02/27 18:27:57  cvs
 * Increase pixel height of dialogs per Therese instructions
 *
 * Revision 1.1.2.5  2007/01/17 15:28:53  cvs
 * Add CSV Support
 *
 * Revision 1.1.2.4  2007/01/03 20:00:02  cvs
 * Change description year to fiscal components per Therese
 *
 * Revision 1.1.2.3  2006/12/27 15:35:37  cvs
 * Extend support for NIH-specific grants GUI
 *
 * Revision 1.1.2.2  2006/12/05 18:46:50  cvs
 * Add fiscal year filtering for PDF-based SOM model
 *
 * Revision 1.1.2.1  2006/11/30 16:42:31  cvs
 * Add support for Grants By School form dialog
 *
 *
 */
/*
 * @(#)GrantsBySchoolForm.java 
 *
...
public class GrantsBySchoolForm extends CoeusDlgWindow

{
 /** Creates a new instance of GrantsBySchoolForm */
 public GrantsBySchoolForm() 
 {
   super(CoeusGuiConstants.getMDIForm(),"",true);
   setFormUI();
 }

 public GrantsBySchoolForm(Component parent, boolean modal)
 {
 ...
 {        
  ...
  {
    setTitle("Active Grants by Unit");
  ...
  public ComboBoxModel listModel;
