/**
 * $Header: /home/cvs/cvsroot/coeus/Source/edu/umdnj/coeus/reporting/gui/Attic/GrantsByActivityTypeForm.java,v 1.1.2.7 2007/09/06 18:31:21 cvs Exp $
 * $Log: GrantsByActivityTypeForm.java,v $
 * Revision 1.1.2.7  2007/09/06 18:31:21  cvs
 ...
 *
 * Revision 1.1.2.1  2006/12/28 16:46:36  cvs
 *  Add support for grants by activity type GUI
 *
 *
 */
/*
 * @(#)GrantsByActivityTypeForm.java 
 *
...
public class GrantsByActivityTypeForm extends CoeusDlgWindow

{
 /** Creates a new instance of GrantsByActivityTypeForm */
 public GrantsByActivityTypeForm() 
 {
   super(CoeusGuiConstants.getMDIForm(),"",true);
   setFormUI();
 }

 public GrantsByActivityTypeForm(Component parent, boolean modal)
 {
 ...
 {        
  ...
  {
    setTitle("Active Grants by Activity Type");
