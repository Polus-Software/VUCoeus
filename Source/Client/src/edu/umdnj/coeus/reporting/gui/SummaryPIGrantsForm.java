/**
 * $Header: /home/cvs/cvsroot/coeus/Source/edu/umdnj/coeus/reporting/gui/Attic/SummaryPIGrantsForm.java,v 1.1.2.7 2007/10/10 15:45:32 cvs Exp $
 * $Log: SummaryPIGrantsForm.java,v $
 * Revision 1.1.2.7  2007/10/10 15:45:32  cvs
 * Add fiscal year choices up to 2011
 *
 * Revision 1.1.2.6  2007/03/21 15:24:28  cvs
 * Test for comments
 *
...
public class SummaryPIGrantsForm extends CoeusDlgWindow

{
 /** Creates a new instance of SummaryPIGrantsForm */
 public SummaryPIGrantsForm() 
 {
   super(CoeusGuiConstants.getMDIForm(),"",true);
   setFormUI();
 }

 public SummaryPIGrantsForm(Component parent, boolean modal)
 {
 ...
 {        
  ...
  {
    setTitle("Summary of Active Grants by Primary Investigator");
