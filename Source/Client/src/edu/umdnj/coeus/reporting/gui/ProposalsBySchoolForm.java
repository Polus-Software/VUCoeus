/**
 * $Header: /home/cvs/cvsroot/coeus/Source/edu/umdnj/coeus/reporting/gui/Attic/ProposalsBySchoolForm.java,v 1.1.2.4 2007/10/10 15:45:32 cvs Exp $
 * $Log: ProposalsBySchoolForm.java,v $
 * Revision 1.1.2.4  2007/10/10 15:45:32  cvs
 ...
 * Add CSV Support
 *
 * Revision 1.1.2.1  2006/12/22 17:16:57  cvs
 * Add support for Submitted Proposals by School form
 *
 *
 */
/*
 * @(#)ProposalsBySchoolForm.java 
 *
...
public class ProposalsBySchoolForm extends CoeusDlgWindow

{
 /** Creates a new instance of ProposalsBySchoolForm */
 public ProposalsBySchoolForm() 
 {
   super(CoeusGuiConstants.getMDIForm(),"",true);
   setFormUI();
 }

 public ProposalsBySchoolForm(Component parent, boolean modal)
 {
 ...
 {        
  ...
  {
    setTitle("Submitted Proposals by Unit");
