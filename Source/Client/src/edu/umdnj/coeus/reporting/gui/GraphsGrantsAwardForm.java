/**
 * $Header: /home/cvs/cvsroot/coeus/Source/edu/umdnj/coeus/reporting/gui/Attic/GraphsGrantsAwardForm.java,v 1.1.2.3 2007/03/08 14:56:16 cvs Exp $
 * $Log: GraphsGrantsAwardForm.java,v $
 ...
 *
 * Revision 1.1.2.1  2007/01/24 16:32:53  cvs
 * Add GUI support for Graph Award Types
 *
 *
 */
/*
 * @(#)GraphsGrantsAwardForm.java 
 *
...
public class GraphsGrantsAwardForm extends CoeusDlgWindow

{
 /** Creates a new instance of GraphsGrantsAwardForm */
 public GraphsGrantsAwardForm() 
 {
   super(CoeusGuiConstants.getMDIForm(),"",true);
   setFormUI();
 }

 public GraphsGrantsAwardForm(Component parent, boolean modal)
 {
 ...
 {        
  ...
  {
    setTitle("Graph of Active Grants by Award Type");
