/**
 * $Header: /home/cvs/cvsroot/coeus/Source/edu/umdnj/coeus/reporting/gui/Attic/SpecReviewProposalsForm.java,v 1.1.2.3 2007/10/10 15:45:32 cvs Exp $
 * $Log: SpecReviewProposalsForm.java,v $
 * Revision 1.1.2.3  2007/10/10 15:45:32  cvs
 * Add fiscal year choices up to 2011
 *
 * Revision 1.1.2.2  2007/03/08 14:56:16  cvs
...
public class SpecReviewProposalsForm extends CoeusDlgWindow

{
 /** Creates a new instance of SpecReviewProposalsForm */
 public SpecReviewProposalsForm() 
 {
   super(CoeusGuiConstants.getMDIForm(),"",true);
   setFormUI();
 }

 public SpecReviewProposalsForm(Component parent, boolean modal)
 {
 ...
 {        
  ...
  {
    setTitle("Proposals for Pending Special Reviews by Unit");
