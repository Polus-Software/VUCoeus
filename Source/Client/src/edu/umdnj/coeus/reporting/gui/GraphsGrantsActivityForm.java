/**
 * $Header: /home/cvs/cvsroot/coeus/Source/edu/umdnj/coeus/reporting/gui/Attic/GraphsGrantsActivityForm.java,v 1.1.2.3 2007/03/08 14:56:16 cvs Exp $
 * $Log: GraphsGrantsActivityForm.java,v $
 ...
 *
 * Revision 1.1.2.1  2007/01/23 20:47:42  cvs
 * Add GUI support for Graph Activity Types
 *
 *
 */
/*
 * @(#)GraphsGrantsActivityForm.java 
 *
...
public class GraphsGrantsActivityForm extends CoeusDlgWindow

{
 /** Creates a new instance of GraphsGrantsActivityForm */
 public GraphsGrantsActivityForm() 
 {
   super(CoeusGuiConstants.getMDIForm(),"",true);
   setFormUI();
 }

 public GraphsGrantsActivityForm(Component parent, boolean modal)
 {
 ...
 {        
  ...
  {
    setTitle("Graph of Active Grants by Activity Type");
