/*
 * AmountInfoCommentsForm.java
 *
 * Created on September 14, 2006, 3:45 PM
 */
 ...
 * @author  tarique
 */
public class AmountInfoCommentsForm extends javax.swing.JComponent {
    public CoeusDlgWindow dlgWindow;
    /** Creates new form AmountInfoCommentsForm */
    public AmountInfoCommentsForm(String title) {
        initComponents();
//        dlgWindow = new CoeusDlgWindow(CoeusGuiConstants.getMDIForm(), "Amount Info Comments", true);
