...
public class CoeusMultiCampusLogin extends javax.swing.JApplet 
        implements ActionListener, AuthResponseListener {
...
//    public static int POLLING_INTERVAL;
    ...
    private String secondaryLoginMode;
    private AuthXMLNodeBean authNodeBean;
    /** Creates new form CoeusApplet */
    public CoeusMultiCampusLogin() {
        super();
        initComponents();
    }
    
    public CoeusMultiCampusLogin(java.awt.Frame parent) {
        super();
        initComponents();
        parentFrame = parent ;
    }
    ...
    public void init() {
        ...
        try {
            ...
            codeBase = "http://localhost:8084/build/";
        }
...
//        CoeusGuiConstants.POLLING_INTERVAL = POLLING_INTERVAL;
        ...
        try{
            if(loginMode.equals(USERID) || loginMode.equals(LDAP)){
                userIdMode = true;
                ...
                // starts
                java.awt.Component[] components = {txtUserName,password,cmbCampus,ok, reset};
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 1, 3, 0);
        ...
        pnlMain.add(lblCampus, gridBagConstraints);
        ...
        pnlMain.add(cmbCampus, gridBagConstraints);
    ...
    public javax.swing.JLabel lblCampus;
...
//            CoeusGuiConstants.POLLING_INTERVAL = Integer.parseInt(hashProps.get(CoeusPropertyKeys.POLLING_INTERVAL).toString());
    ...
    public void respond(Object res) throws CoeusException {
        if(res instanceof ResponderBean){
            //           response = (ResponderBean)res;
            setMDIFormAttr((ResponderBean)res);
        }
    }
