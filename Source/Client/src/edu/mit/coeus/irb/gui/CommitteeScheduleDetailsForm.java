...
//      tblSchedule = new JTable();
    ...
    throws Exception{
        ...
        if(functionType == TypeConstants.ADD_MODE || getCommitteeTypeCode() == CoeusConstants.IRB_COMMITTEE_TYPE_CODE){
        ...
        }else if(getCommitteeTypeCode() == CoeusConstants.IACUC_COMMITTEE_TYPE_CODE){
            edu.mit.coeus.iacuc.gui.ScheduleDetailsForm scheduleDetailsForm =
                    new edu.mit.coeus.iacuc.gui.ScheduleDetailsForm(fType,scheduleId,mdiForm);
            scheduleDetailsForm.setScheduleStatus(statusCodes);
            scheduleDetailsForm.setCommitteeScheduleDetailsForm(this);
            try{
                scheduleDetailsForm.showScheduleDetailForm();
 ...
 */
    ...
    //Added for IACUC Changes - Start
    /*
     * Method to get committee type code
    ...
    /*
     * Method to set committee type code
