 ...
 */
public class ProtocolKeyStudyPersonnelForm extends javax.swing.JComponent {
    ...
    public ProtocolKeyStudyPersonnelForm(char functionType,
        java.util.Vector keyStudyPersonnelData, java.util.Vector vecAffiliation) {
    ...
    public void setFormData(){
        ...
        if((protocolKeyStudyPersonnelData != null) &&
            ...
            for(int inCtrdata=0;inCtrdata < keyPersonnelSize;inCtrdata++){
                ...
                String role = protocolDataBean.getPersonRole();
            ...
            for(int newLocIndex = 0; newLocIndex < dataSize;newLocIndex++){
                ...
                if(!found){
                    ...
                    if(protocolOldDataBean != null){
                        ...
                        protocolOldDataBean.setPersonRole(
                                        protocolNewDataBean.getPersonRole());
...
//            });
    ...
    private void setTableEditors(){
        ...
        if ( functionType != CoeusGuiConstants.DISPLAY_MODE ) {
            ...
            /*comboBox = new CoeusComboBox(vecAffiliation,false);
            //comboBox.setModel(new CoeusComboBox(vecAffiliation,false).getModel()); 
            column.setCellEditor(new DefaultCellEditor(comboBox){
                public Object getCellEditorValue(){
                    return (ComboBoxBean)((JComboBox)getComponent()).getSelectedItem();
                }
            });
            comboBox.addItemListener(new ItemListener(){
   ...
   /** This method is called from within the showProtocolKeyStudyPersonnelForm 
    ...
    private void initComponents() {
        ...
        setPreferredSize( new java.awt.Dimension(622, 415 ));
        ...
        btnAdd.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae){
                if (tblKeyStPer.getModel() instanceof DefaultTableModel) {
                    ...
                    //modified for internal issue#112 : Affiliate added by default for Study Persons(IRB)
                ...
                if (totalRows > 0) {
                    ...
                    if (selectedRow != -1) {
                        int selectedOption = CoeusOptionPane.
                                            showQuestionDialog(
                                            coeusMessageResources.parseMessageKey(
                                            "protoKeyStPsnlFrm_delConfirmCode.1141"),
...
//        scrPnPane1.setPreferredSize(new java.awt.Dimension(450, 200));
        ...
        scrPnPane1.setMinimumSize(new java.awt.Dimension(500, 410));
        scrPnPane1.setPreferredSize(new java.awt.Dimension(500, 410));
        scrPnPane1.setViewportView(tblKeyStPer);
