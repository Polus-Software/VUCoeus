...
//        private byte[] fileBytes;        
        ...
        private static final int LAST_UPDATED_COLUMN_WIDTH = 100;
        private static final int UPDATED_BY_COLUMN_WIDTH = 60;
        //COEUSDEV-328 : End
        //Added for COEUSDEV-86 : Questionnaire for a Submission
        private final String PROTOCOL_SUBMISSION_SERVLET = "/protocolSubSrvlt";
        ...
        private static final String NOTIFICATION_TYPE_CHANGE_WITH_ANS_QNR = "protoSubmission_notifyChange_exceptionCode.1002";
        private static final String NOTIFY_SUBMISSION_WITHOUT_COMMITTEE = "notifySubmissionWithoutCommittee_exceptionCode.1004";
        private static final String SELECT_NOTIFICATION_TYPE = "protoSubmissionNotifyType_exceptionCode.1005";
        private static final String SELECT_REVIEW_TYPE = "protoSubmissionReviewType_exceptionCode.1006";
        private static final String SELECT_COMMITTEE = "protoSubmissionCommittee_exceptionCode.1007";
        private static final String QUESTIONNAIRE_SAVE_CONFIRMATION = "questions_exceptionCode.1005";
        private static final String NEW_QUESTIONNAIRE_VERSION = "protoSubquestionnaire_exceptionCode.1010";
        private static final String INCOMPLETE_QUESTIONNAIRE ="protoSubQuestionnaire_exceptionCode.1009";
        private static final String MANDATORY_QUESTIONNAIRE = "protoSubQuestionnaire_exceptionCode.1008";
        ...
        private static final int REQUEST_FOR_WITHDRAW_ACTION = 303;
...
//                                                if(actionBean.getActionTypeCode()==116){
                                                ...
                                                if(actionCode==NOTIFY_IRB){//COEUSDEV-86 : END
...
//                                                            CoeusOptionPane.showErrorDialog("Please select a committee.");
                                                ...
                                                //details will be updated in OSP$PROTOCOL_SUBMISSION and OSP$PROTOCOL_ACTIONS table
                                                else if(actionCode ==  REQUEST_TO_CLOSE_ACTION ||
...
//		"dd-MMM-yyyy");
	...
	public void showForm(){
		...
		//
		//       // added on 3-Sep-03 to close the form on click of close ( X ) button for window.
		...
		//       //thisWindow.setSize(450, 275);
		//       thisWindow.setSize(500, 275);
		...
		//       thisWindow.show() ;
                ...
                //Modified for performing Protocol Actions - start
		setSize(650, 520);
                //Modified for performing Protocol Actions - end
...
//                if(actionBean.getActionTypeCode()==116){
                  int actionCode = actionBean.getActionTypeCode();
                  if(actionCode == NOTIFY_IRB){//COEUSDEV-328 : End
                      //pnlAttachment.setVisible(true);
                      ...
                      if( typeQualifiers != null ){
                        /* add a blank row in Submission Type Qualifier combo box so that
                          ...
                          //cmbNotificationType.addItem(new ComboBoxBean("",""));
                      ...
                      if(submissionMode == DENIED){
                          ...
                          //Added for COEUSDEV-387 : Attachment portion of window cut off in Notify IRB Submission window in Premium - Start
                          scrpnAttachments.setMinimumSize(new Dimension(400,200));
                          scrpnAttachments.setMaximumSize(new Dimension(400,200));
                          scrpnAttachments.setPreferredSize(new Dimension(400,200));
                          setSize(600, 520);
                          //COEUSDEV-387 : END
                      }
                  ...
                  //Multiple attachment can be uploaded for the request to close,
                  //request for suspension, request to close enrollment, request for data analysis only and 
                  // request for re-open enrollment
                  }else if(actionCode ==  REQUEST_TO_CLOSE_ACTION ||
                          actionCode == REQUEST_FOR_SUSPENSION_ACTION  ||
                          actionCode == REQUEST_TO_CLOSE_ENROLLMENT_ACTION  ||
                          actionCode == REQUEST_FOR_DATA_ANALYSIS_ONLY_ACTION  ||
                          actionCode == REQUEST_FOR_RE_OPEN_ENROLLMENT_ACTION){
                      //Added for COEUSDEV-86 : Questionnaire for a Submission - Start
                      // Sets the attachments scroll pane size to avoid scrinking of the panel
                      scrpnAttachments.setMinimumSize(new Dimension(450,200));
                      scrpnAttachments.setMaximumSize(new Dimension(450,200));
                      scrpnAttachments.setPreferredSize(new Dimension(450,200));
                      setSize(600, 520);
                      ...
                      //COEUSDEV-86 : End
                      setUIForAttachemnts(true);
//                      btnAdd.setPreferredSize(new Dimension(140, 23));
                      enableDocumentButtons(false);
                  ...
                  //COEUSDEV-327 : End
                      ...
                      //COEUSDEV-86 : End
                      //COEUSQA-3183 IRB - Review Comments should not be available when performing a withdraw - Start
                      if(actionCode == REQUEST_FOR_WITHDRAW_ACTION){
...
//        map.put("FILE_NAME", fileName);
    ...
    public void getDefaultSubmissionMode() throws Exception{
        ...
        RequesterBean request = new RequesterBean();
        request.setDataObject("IRB_COMM_SELECTION_DURING_SUBMISSION") ;
    ...
    private void setUIForAttachemnts(boolean isVisible){
        //Modified for COEUSDEV-328 :  Notify IRB FYI submission only permits the Aggregator to upload one document - Start
        //Attachment table and buttons are visible only for request to close,
        //request for suspension, request to close enrollment, request for data analysis only and 
        // request for re-open enrollment and Notify IRB actions
//        lblAttachment.setVisible(isVisible);
//        txtAttachment.setVisible(isVisible);
...
//        btnBrowse.setVisible(isVisible);
    ...
    public void addTempSubmissionActionDetails() throws Exception{
        ...
        if(actionBean.getActionTypeCode() == NOTIFY_IRB){
    ...
    private Vector validateQuestionnaireCompleted() {
        ...
        proposalData.add(1, new Integer(PROTOCOL_MODULE));
    ...
    private boolean isAnyQuestionAnswered(){
        ...
        cvModuleData.add(new Integer(PROTOCOL_MODULE));
    ...
    /*
     * Method to make the review comments visible/ invisible
     * @param isVisible - boolean
     */
    public void setReviewCommentsButtonVisibility(boolean isVisible){
        btnReviewComments.setVisible(isVisible);
