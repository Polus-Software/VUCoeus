...
//    private boolean showScheduleWarning = true;
    ...
    // Commented to diable the Review Complete and Recommended ACtions Column - Start
//    private Vector recommendeActiontypes;
    // Commented to diable the Review Complete and Recommended ACtions Column - end
...
//    private static final String SUBMISSION_SERVLET = "/iacucProtocolSubSrvlt";
    ...
    ProtocolInfoBean protocolInfo) throws Exception{
        ...
        //        String choice =   CoeusOptionPane.showInputDialog(this,"Submission Mode","Enter the submission Mode","O") ;
        //        if (choice.equals("O"))
        //        {
...
//                Date date  = null;
    ...
    private ProtocolSubmissionInfoBean getSubmissionData() throws Exception {
        ...
        //Added for case 2785 - Routing enhancement - start
        if(isMapsFound()){
            submissionBean.setSubmissionStatusCode(ROUTING_IN_PROGRESS);
        }else{
...
//                    }
    ...
    private void saveSubmissionDetails() throws Exception{
        ...
        if(isSaveRequired()){
            ...
            //Commented for case 4326:Protocol Submission in Coeus Premium create two routing entries - Start
                //Added for case 2785 - Routing enhancement - start
...
//                            " has been successfully submitted for routing") ;
                //Modified for Case:#4227 - Create new roles - Primary Reviewer, Secondary Reviewer and Faculty Adviser 
//                      routingForm = new RoutingForm(protocolInfo, 7, protocolId,
//                              protocolInfo.getSequenceNumber(), leadUnitNumber, false);                
                //Case:#4227 - End
...
//                }
                //Added for case 2785 - Routing enhancement - end
                //Commented for case 4326:Protocol Submission in Coeus Premium create two routing entries - End
                //COEUSQA-2554_Parent key not found error while submitting protocol for Routing_Start
                /*Included this if condition for COEUSQA-2554
                 if the selected Approver is an Invalid user, then the submission should not be completed
                 When mapsFound is false, protocol submission step is skipped after displaying the error message*/
//                    if(mapsFound){
...
//                    /****** begin: updated on 13-02-03 for fixing the bug sent by
//                     * geo with refID: 203  */                
//                     /* for inserting new row in
//                        protocol detail table, submission table and reviewers table
//                        whenever there is any change in submission details */
//
//                    /* if(functionType == ADD_MODE){
...
//                    }*/
//                    //modified by ravi for setting the protocol status to SUBMIT_TO_IRB
//                    //whenever user submits the protocol - 9/10/03
//                    //                if(functionType == ADD_MODE){
//                    //                    // updating protocol status to Submitted to IRB
//                    //                    protocolInfo.setProtocolStatusCode(SUBMIT_TO_IRB);
//                    //                }
...
////                    protocolInfo.setProtocolStatusCode(SUBMIT_TO_IRB);                
//                    if(submissionInfoBean.getSubmissionStatusCode() == ROUTING_IN_PROGRESS){
...
//                    // modified by ravi on 9/10/03 end
//                    protocolInfo.setAcType(UPDATE_RECORD);
//                    protocolInfo.setVulnerableSubjectLists(null);
//                    protocolInfo.setLocationLists(null);
//                    protocolInfo.setInvestigators(null);
...
//                        //Added for Case:#4227 - Create new roles - Primary Reviewer, Secondary Reviewer and Faculty Adviser
//    //                    mapsFound = doSubmitApproveAction();
//                        //Case:#4227 - End
//                        //Modified for case 4326:Protocol Submission in Coeus Premium create two routing entries - Start
//                        this.dispose();
//                        if(mapsFound){
//
//                            CoeusOptionPane.showInfoDialog("The Protocol " + protocolId +
//                                    " has been successfully submitted for routing") ;
//                            //Added for COEUSQA-2249  : Routing history is lost after an amendment is routed and approved
//                            //Included a parameter to check for routing form is called during submission
//    //                        RoutingForm routingForm = new RoutingForm(protocolInfo, ModuleConstants.PROTOCOL_MODULE_CODE, protocolId,
//    //                                protocolInfo.getSequenceNumber(), leadUnitNumber, false);
//                            RoutingForm routingForm = new RoutingForm(protocolInfo, ModuleConstants.PROTOCOL_MODULE_CODE, protocolId,
...
//    //                        this.dispose();                        
//    //                        //Modified for Case:#4227 - Create new roles - Primary Reviewer, Secondary Reviewer and Faculty Adviser
//    //                        // To load the Routing form after Review Submitted
//    //                        routingForm = new RoutingForm(protocolInfo, 7, protocolId,
//    //                                protocolInfo.getSequenceNumber(), leadUnitNumber, false);
//    //                        //Case:#4227 - End
//    //                        routingForm.display();
//    //                        setSubmissionStatusCode(routingForm.getSubmissionStatusCode());
//    //                    }
//                         //Modified for case 4326:Protocol Submission in Coeus Premium create two routing entries - End
...
//        protocolInfo.setProtocolStatusCode(SUBMIT_TO_IRB);
        ...
        if (!response.isSuccessfulResponse()) {
            ...
            if(mapsFound){
                ...
                serverDataObjects.add(new Integer(ROUTING_IN_PROGRESS));
