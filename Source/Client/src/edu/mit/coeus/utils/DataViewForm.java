 ...
 * @author  ravikanth
 */
public class DataViewForm extends javax.swing.JComponent {
    ...
    public void setData(edu.mit.coeus.irb.bean.ProtocolActionsBean protocolActionsBean) {
...
//        lblUpdTimestampValue.setText(simpleDateFormat.format(protocolActionsBean.getUpdateTimestamp()));
    ...
    public void setProtoSubmissionBean(ProtocolSubmissionInfoBean protoSubmInfoBean){
     ...
     public void setProtoSubmissionBean(edu.mit.coeus.iacuc.bean.ProtocolSubmissionInfoBean protoSubmInfoBean){
     //   this.protoSubmInfoBean = protoSubmInfoBean;
    }
