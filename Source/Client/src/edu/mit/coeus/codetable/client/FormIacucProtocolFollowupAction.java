...
public class FormIacucProtocolFollowupAction extends CoeusDlgWindow
{
...
//    private TableSorter sorter ;
    ...
    public FormIacucProtocolFollowupAction(Frame parent, String title, boolean modal,boolean userRights, AllCodeTablesBean allCodeTablesBean)
    {
   ...
   private Vector getModifiedRows()
   {
     ...
     {                
        ...
        {    
            ...
            if (tempTableStructBean.getActualName().equalsIgnoreCase("OSP$AC_PROTO_FOLLOWUP_ACTIONS"))
            {
...
//                    hmRow.get("DESCRIPTION").toString()));
          String protocolActionTypeCode = hmRow.get("PROTOCOL_ACTION_TYPE_CODE").toString();
            String actionDescription = hmRow.get("DESCRIPTION").toString();
            int actionTypeCode = Integer.parseInt(protocolActionTypeCode);
            if(IacucProtocolActionsConstants.REVISIONS_REQUIRED != actionTypeCode &&
                    IacucProtocolActionsConstants.FULL_COMMITTEE_REVIEW_REQUIRED != actionTypeCode){
                System.out.println(protocolActionTypeCode);
                cmbProtocolAction.addItem(new ComboBoxBean
                        (protocolActionTypeCode ,actionDescription));
            }
...
//                            hmRow.get("DESCRIPTION").toString()));
    ...
    private void getDataForTheTable()
    {
      ...
      param.add("OSP$AC_PROTO_FOLLOWUP_ACTIONS");
