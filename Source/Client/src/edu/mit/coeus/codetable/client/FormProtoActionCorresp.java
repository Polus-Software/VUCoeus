...
public class FormProtoActionCorresp extends CoeusDlgWindow {
...
//    private TableSorter sorter ;
    ...
    public FormProtoActionCorresp(Frame parent, String title, boolean modal,boolean userRights, AllCodeTablesBean allCodeTablesBean) {
...
//            tblProtoActionCorresp.setRowSelectionInterval(selectedRow,selectedRow);
    ...
    public void initialiseData() {
        ...
        for (int tableCount =0 ; tableCount < hashAllCodeTableStructure.size() ; tableCount++) {
            ...
            if (tempTableStructBean.getActualName().equalsIgnoreCase("osp$valid_proto_action_coresp")) {
...
//        //end temp out sorter
    ...
    private void getDataForTheTable() {
       ...
       */
        ...
        param.add("osp$valid_proto_action_coresp");
