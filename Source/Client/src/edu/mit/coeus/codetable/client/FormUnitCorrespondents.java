...
public class FormUnitCorrespondents extends CoeusDlgWindow 
{
...
//    CoeusComboBox cmbNotice = new CoeusComboBox() ;
   ...
   private Frame parent;
    ...
    public FormUnitCorrespondents(Frame parent, String title, boolean modal,boolean userRights, AllCodeTablesBean allCodeTablesBean)
    {
    ...
    public void initialiseData()
     {
        ...
        for (int tableCount =0 ; tableCount < hashAllCodeTableStructure.size() ; tableCount++)
        {
            ...
            if (tempTableStructBean.getActualName().equalsIgnoreCase("OSP$UNIT_CORRESPONDENTS"))
            {
