...
public class FormIacucProtoCorrespDefRecip extends CoeusDlgWindow
{
...
//   private static final String SPONSOR_SEARCH = "sponsorSearch";
   ...
   private Frame parent;
    ...
    public FormIacucProtoCorrespDefRecip(Frame parent, String title, boolean modal,boolean userRights, AllCodeTablesBean allCodeTablesBean)
    {
    ...
    public void btnCloseActionPerformed()
    {
     ...
     public void initialiseData()
     {
        ...
        for (int tableCount =0 ; tableCount < hashAllCodeTableStructure.size() ; tableCount++)
        {
            ...
            if (tempTableStructBean.getActualName().equalsIgnoreCase("OSP$AC_PROTO_CORRESP_DEF_RECIP"))
            {
