 /*
 * @(#)FormMembershipRoleUsage.java 1.0 04 August 2010, 17:20 PM
 *
...
public class FormIacucOrgCorrespondents extends CoeusDlgWindow {
    ...
    public FormIacucOrgCorrespondents(Frame parent, String title, boolean modal,boolean userRights, AllCodeTablesBean allCodeTablesBean) {
    ...
    public void initialiseData() {
        ...
        for (int tableCount =0 ; tableCount < hashAllCodeTableStructure.size() ; tableCount++) {
            ...
            if (tempTableStructBean.getActualName().equalsIgnoreCase("OSP$AC_ORG_CORRESPONDENT")) {
