 ...
 * @author  ajaygm
 */
public class SponsorContactDetailsForm extends javax.swing.JComponent {
    AwardContactDetailsBean awardContactDetailsBean;
    
    String EMPTY_STRING = "";
    
    public SponsorContactDetailsForm(){
        initComponents();
    }
    ...
    awardContactDetailsBean) {
        ...
        if(awardContactDetailsBean.getRolodexId() == -1 || awardContactDetailsBean.getRolodexId() == 0){
            txtPersonID.setText(EMPTY_STRING);
        }else {
            txtPersonID.setText(EMPTY_STRING + awardContactDetailsBean.getRolodexId());
        }
    ...
    public void setTemplateData(AwardTemplateContactsBean awardTemplateContactsBean) {
        ...
        if(awardTemplateContactsBean.getRolodexId() == -1 || awardTemplateContactsBean.getRolodexId() == 0){
            ...
            txtPersonID.setText(EMPTY_STRING + awardTemplateContactsBean.getRolodexId());
        }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        txtPersonID = new edu.mit.coeus.utils.CoeusTextField();
        ...
        lblPersonID.setFont(CoeusFontFactory.getLabelFont());
        ...
        add(lblPersonID, gridBagConstraints);
        ...
        txtPersonID.setDragEnabled(true);
        txtPersonID.setMinimumSize(new java.awt.Dimension(132, 20));
        txtPersonID.setPreferredSize(new java.awt.Dimension(132, 20));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 5;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new java.awt.Insets(4, 0, 0, 3);
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        add(txtPersonID, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 10;
        gridBagConstraints.gridwidth = 5;
        gridBagConstraints.insets = new java.awt.Insets(3, 0, 5, 3);
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
    ...
    public javax.swing.JLabel lblPersonID;
    ...
    public edu.mit.coeus.utils.CoeusTextField txtPersonID;
