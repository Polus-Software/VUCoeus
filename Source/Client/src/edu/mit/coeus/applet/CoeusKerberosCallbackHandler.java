/*
 * @(#)DialogCallbackHandler.java	1.8 03/01/23
 *
 */
 ...
 */
public class CoeusKerberosCallbackHandler implements CallbackHandler {
     ...
     */
    public CoeusKerberosCallbackHandler() { }
     ...
     */
    public CoeusKerberosCallbackHandler(Component parentComponent) {
	this.parentComponent = parentComponent;
    }

    /**
     * @return the cancelClicked
     */
    ...
    /**
     * @param cancelClicked the cancelClicked to set
     */
...
System.out.println(nc.getDefaultName());
...
System.out.println(System.getProperty("user.name"));
		...
		okActions.add(new Action() {
			...
			nc.setName(name.getText());
                        userId = name.getText().trim();
                        System.out.println("UserId set as "+userId);
		    }
		});
	...
	}else if(result == JOptionPane.CLOSED_OPTION || result == JOptionPane.CANCEL_OPTION){//Clicked Cancel
