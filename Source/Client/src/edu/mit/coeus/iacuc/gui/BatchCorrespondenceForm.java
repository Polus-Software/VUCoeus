/*
 * @(#)BatchCorrespondenceForm.java 1.0 Created on March 2, 2004, 4:23 PM
 *
...
public class BatchCorrespondenceForm extends edu.mit.coeus.gui.CoeusDlgWindow 
   ...
   private  StatusWindow statusWindow;
    ...
    private String finalActionTypeDesc;
   ...
   /*
    * This method is used to display the batch correspondence form   
    */
    ...
    */
        ...
        if (batchData != null)
        {
            ...
            if (vecBatchDetail != null)
            {
                ...
                { // populate the data
                    ...
                    //Added for COEUSQA-2675 Remaining IACUC Protocol Actions Batch Correspondence-start
                    this.finalActionTypeDesc = batchCorrespondenceBean.getFinalActionTypeDesc();
                    //Added for COEUSQA-2675 Remaining IACUC Protocol Actions Batch Correspondence-start
                    ...
                    String batchCorrespendenceFormTitle = "";
                    if(batchTypeCode == 1){
                        batchCorrespendenceFormTitle = "IACUC Protocol Renewal Reminders";
                    }else{
                        batchCorrespendenceFormTitle = "Reminder to IACUC Notifications";
                    }
                    this.setTitle(batchCorrespendenceFormTitle) ;
                }    
             }    
    ...
    /*
     * This method is used to get the batch correspondence detail value.
     * @param Vector batchData       
     */
   ...
   /*
    * This method is used to validate the batch correspondence data.
    ...
    */
        ...
        return false ;
            ...
            if((txtCurrStartDate.getText() != null)
                ...
                if (convertedDate==null){
                    oldDate = dtUtils.restoreDate(txtCurrStartDate.getText(),DATE_SEPERATOR);
            ...
            if((txtCurrEndDate.getText() != null)
                ...
                convertedDate = dtUtils.formatDate(txtCurrEndDate.getText(),
                        DATE_SEPERATOR , DATE_FORMAT);
                if (convertedDate==null){
                    oldDate = dtUtils.restoreDate(txtCurrEndDate.getText(),DATE_SEPERATOR);
    ...
    /*
    * This method is used to control the button status
   ...
   /*
    * This method is used to set the batch correspondence value and generate the batch correspondence     
    */
    private void runBatchGeneration() throws Exception
    {
        ...
        batchCorrespondenceBean.setTimeWindowStart( new java.sql.Date(dtFormat.parse(
                            dtUtils.restoreDate(txtCurrStartDate.getText(),DATE_SEPERATOR)).getTime())) ;
        batchCorrespondenceBean.setTimeWindowEnd(new java.sql.Date(dtFormat.parse(
                            dtUtils.restoreDate(txtCurrEndDate.getText(),DATE_SEPERATOR)).getTime())) ;     
        ...
        batchCorrespondenceBean.setFinalActionTypeDesc(this.finalActionTypeDesc) ; 
        batchCorrespondenceBean.setDescription(this.titleDescription);
        request.setDataObject(batchCorrespondenceBean) ; 
   ...
   /*
    * This method is used show the end date of batch correspondence    
    */
     public void showEndDate() throws java.text.ParseException
    {
            Date apprDate = null;
            String startDate = txtCurrStartDate.getText();
            ...
            txtCurrEndDate.setText(dtUtils.formatDate( expDate, "/", DATE_FORMAT));
            }
      }   
