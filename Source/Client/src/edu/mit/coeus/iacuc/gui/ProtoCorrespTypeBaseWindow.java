...
implements ActionListener{
     ...
     */
    final String connectTo = CoeusGuiConstants.CONNECTION_URL + "/iacucCorrespondenceServlet";
    ...
    public ProtoCorrespTypeBaseWindow(CoeusAppletMDIForm mdiForm) throws Exception{
        super(CoeusGuiConstants.IACUC_CORRESP_TYPE_BASE_FRAME_TITLE, mdiForm,OTHER_MODE);
        this.mdiForm = mdiForm;
        initComponents();
        mdiForm.putFrame(CoeusGuiConstants.IACUC_CORRESP_TYPE_BASE_FRAME_TITLE,this);
    ...
    private void initComponents() throws Exception{
        ...
        this.setFrame(CoeusGuiConstants.IACUC_CORRESP_TYPE_BASE_FRAME_TITLE);
...
//                        request.setDataObject(correspBean);
                        ...
                        map.put(DocumentConstants.READER_CLASS, "edu.mit.coeus.iacuc.CorrespondenceTemplateReader");
