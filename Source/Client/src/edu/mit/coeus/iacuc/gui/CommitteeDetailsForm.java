...
implements ActionListener{
    ...
    private CoeusMenuItem  batchIACUCNotification ;
    ...
    //COEUSQA-2802 - Allow user to remove values for areas of research in IACUC 
    ...
    CoeusAppletMDIForm mdiForm){
        ...
        super("IACUC Committee Details" + ( (committeeId != null &&
    ...
    private CoeusMenu committeeDetailsEditMenu() {
        ...
        //Modified for COEUSQA-2675 Remaining IACUC Protocol Actions Batch Correspondence-start
        batchProtocolRenewal = new CoeusMenuItem("IACUC Renewal Reminder",null,true,true);
        //Modified for COEUSQA-2675 Remaining IACUC Protocol Actions Batch Correspondence-end
        batchProtocolRenewal.setMnemonic('R');
        batchProtocolRenewal.addActionListener(this);                 
        //Modified for COEUSQA-2675 Remaining IACUC Protocol Actions Batch Correspondence-start                
        batchIACUCNotification = new CoeusMenuItem("IACUC Notification Reminder",null,true,true);      
        batchIACUCNotification.setMnemonic('I');
        batchIACUCNotification.addActionListener(this);                
        //Modified for COEUSQA-2675 Remaining IACUC Protocol Actions Batch Correspondence-end
        ...
        //Modified for COEUSQA-2675 Remaining IACUC Protocol Actions Batch Correspondence-start
        batchChildren.add(batchIACUCNotification) ;
        //Modified for COEUSQA-2675 Remaining IACUC Protocol Actions Batch Correspondence-end
        ...
        if (functionType != 'M')
        {
            ...
            //Modified for COEUSQA-2675 Remaining IACUC Protocol Actions Batch Correspondence-start
            batchIACUCNotification.setEnabled(false) ;
            //Modified for COEUSQA-2675 Remaining IACUC Protocol Actions Batch Correspondence-end
   ...
   */
    ...
    public Vector getLookupDetails() throws Exception{
        ...
        // Modified COEUSQA-2685_IACUC - comm member areas of research should point to IACUC areas of research_start
    ...
    protected void setCommitteeInfo() throws Exception{
        if(functionType == 'D'){
            ...
            //COEUSQA-2802 - Allow user to remove values for areas of research in IACUC 
                ...
                vecData.add(1,CoeusConstants.IACUC_COMMITTEE_TYPE_CODE);
    ...
    public void actionPerformed(ActionEvent ae){
        try {
            ...
            else if (actSource.equals(batchIACUCNotification))
            {
                //type 2
                Vector vecParam = new Vector() ;
                vecParam.add(0, committeeDetails.getCommitteeId()) ;
