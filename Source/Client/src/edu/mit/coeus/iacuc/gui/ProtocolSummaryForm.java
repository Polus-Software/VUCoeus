...
//    private HashMap hmProtocolDetails = new HashMap();
    ...
    private void setFormData() {
        if( protocolInfoBean != null ) {
            ...
            lblProjectTypeValue.setText( protocolInfoBean.getProjectTypeDesc());
    ...
    private void setKeyStudyData( Vector keyStudyData ){
        ...
        if( (keyStudyData != null) && (keyStudyData.size()>0) ){
            ...
            for(int inCtrdata=0;inCtrdata < keyPersonnelSize;inCtrdata++){
                ...
                vcData.addElement(keyBean.getPersonRoleDesc());
...
//        Object source = listSelectionEvent.getSource();
    ...
    private void initComponents() {
        ...
        lblProjectTypeValue = new javax.swing.JLabel();

        pnlMain.setLayout(new java.awt.GridBagLayout());

        pnlMain.setMinimumSize(new java.awt.Dimension(630, 503));
        pnlMain.setPreferredSize(new java.awt.Dimension(630, 525));
        ...
        lblProjectType.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        ...
        pnlMain.add(lblProjectType, gridBagConstraints);

        lblProjectTypeValue.setFont(CoeusFontFactory.getNormalFont());
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.gridwidth = 3;
        ...
        pnlMain.add(lblProjectTypeValue, gridBagConstraints);
    ...
    public javax.swing.JLabel lblProjectType;
    public javax.swing.JLabel lblProjectTypeValue;
