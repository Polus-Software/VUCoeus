...
import edu.mit.coeus.iacuc.bean.MinuteEntryBean;
/**
...
public class MinuteEntryForm extends javax.swing.JComponent
   ...
   // private static final String OTHER_BUSINESS = "Other Business";
    ...
    private static final char GET_PARAMETER_MINUTE_ENTRY_CODE = 'c';
    ...
    public MinuteEntryForm(char functionType, MinuteEntryInfoBean minuteEntryInfoBean,
        ...
        //COEUSQA-2290 : End
        protocolNoList = (Vector)getProtocolsForScheduleMinutes();//Bug fix #933
...
//            }
    ...
    private MinuteEntryBean getEntryType(int entryTypeCode){
        if (minuteEntryTypes!=null){
            edu.mit.coeus.iacuc.bean.MinuteEntryBean minuteEntryBean;
            int maxSize = minuteEntryTypes.size();
            Vector localMinEntryTypes = minuteEntryTypes;
            for ( int rowIndex = 0; rowIndex < maxSize; rowIndex++) {
                minuteEntryBean = (edu.mit.coeus.iacuc.bean.MinuteEntryBean) localMinEntryTypes.elementAt(rowIndex);
...
//                otherActionInfoBean = (OtherActionInfoBean) localOtherActionList.
    ...
    private Vector getEntryTypes(){
        ...
        // Modified for COEUSQA-2686 IACUC - Changes to schedule maintenance for 4.4.3 release_start
        requester.setDataObject("GET_IACUC_MINUTE_ENTRY_TYPES");
        // Modified for COEUSQA-2686 IACUC - Changes to schedule maintenance for 4.4.3 release_end
    ...
    //start 12 aug 2004
    /**
     * This Method to return the Protocols list from the database .
     * @return Vector .
     * The vector returned is used for populating the Protocols list box.
     */
    private Vector getProtocolsForScheduleMinutes() {
        RequesterBean requester = new RequesterBean();
        Vector nonDefProtocols = new Vector();
        requester.setDataObject(minuteEntryInfoBean.getScheduleId());
        requester.setFunctionType(GET_IACUC_PROTOCOLS_FOR_SCHEDULE_MINUTES);       
...
//    }
    ...
    private String validateContingencyCode(String contingencyCode){
        ...
        request.setDataObject("GET_IACUC_CONTINGENCY_DESC");
...
//        minuteEntryInfoBean.setEntryNumber(getMaxEntryNumber());
    ...
    //Added for COEUSQA-2290 : New Minute entry type for Review Comments - Start
     /**
     * Method to get the minuteEntryTypeCode from the 'IACUC_MINUTE_TYPE_REVIEWER_COMMENT' parameter
