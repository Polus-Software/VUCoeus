...
//    private static final int HEIGHT = 260;
    ...
    //Added for Coeus 4.3 enhancement
    private final String PROTOCOL_MAINTENANCE_SERVLET = "/IacucProtocolServlet";
    ...
    private static final String NO_TEMPLATE_TO_REGENERATE = "iacucProtoCorrespRegen_exceptionCode.1000";
...
//        dialog.setSize(WIDTH, HEIGHT);
    ...
    public void setMailSettings(){
       //Updated for COEUSQA-1724-Email Notifications For All Actions in IACUC - start
...
//                ex.printStackTrace();
//            }
         //Updated for COEUSQA-1724-Email Notifications For All Actions in IACUC - end
        }
    }
    ...
    public void loadFormData(ProtocolActionsBean protocolActionsBean) {
        ...
        //Added for COEUSQA-1724: Email Notifications For All Actions In IACUC - start
        setMailSettings();
        //Added for COEUSQA-1724: Email Notifications For All Actions In IACUC -- end
    }
...
//                try {
                    url = actionValidityChecking.fetchAttachment(protoBean.getProtocolNumber(), 
                        protoBean.getActionId(), protoBean.getProtoCorrespTypeCode(),ModuleConstants.IACUC_MODULE_CODE);
                }
                actionValidityChecking.setUrl(url);
                //COEUSQA-1724:Email Notificatsions For All Actions In IACUC 
                //Send button in correspondences list window should be enabled always
                actionValidityChecking.sendMail(ModuleConstants.IACUC_MODULE_CODE,actionBean.getActionTypeCode(),
...
//                }
        ...
        private void regenerateLetterWithTags() {
            ...
            if (response.isSuccessfulResponse()) {
                ...
                setCursor( new Cursor( Cursor.DEFAULT_CURSOR ) );
                CoeusOptionPane.showInfoDialog(coeusMessageResources.parseMessageKey(NO_TEMPLATE_TO_REGENERATE)) ;
            }
        }
