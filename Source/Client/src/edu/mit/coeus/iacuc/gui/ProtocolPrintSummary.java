...
public class ProtocolPrintSummary extends javax.swing.JPanel implements ActionListener{
    ...
    // Modified COEUSQA-2630_Allow the ability to print attachments with protocol summary/Schema changes start
    private static final String connectTo = CoeusGuiConstants.CONNECTION_URL;
    // Modified COEUSQA-2630_Allow the ability to print attachments with protocol summary/Schema changes end
...
//    private static final char SIGNATURE_REQUIRED_REQUEST = 'r' ;
    ...
    private int subModuleItemCode = 0;
    // Added COEUSQA-2630_Allow the ability to print attachments with protocol summary/Schema changes start
    ...
    private static final String IACUC_PROTOCOL_SERVLET = "/IacucProtocolServlet";
    ...
    public ProtocolPrintSummary(ProtocolInfoBean protocolInfoBean) {
        ...
        setAmendRenewCheckBoxTitle(protocolInfoBean);
    }
    ...
    private void setFocusTraversal(){
        ...
        chkInvestigator,chkRoles,chkStudyPersonnel,chkSpecialReview,chkReferences,chkCorrespondents,chkAreaOfResearch,chkNotes,
        chkScientificJustification,chkProcedures,chkSpeciesGroup,chkAlternativeSearch};
        // Modified COEUSQA-2630_Allow the ability to print attachments with protocol summary/Schema changes end
    ...
    */
    private void enableComponents() {
        ...
        chkScientificJustification.setSelected(true);
        chkProcedures.setSelected(true);
        chkSpeciesGroup.setSelected(true);
        chkAlternativeSearch.setSelected(true);
...
//            dlgPrintSummary.setSize(650, 385);
    ...
    private boolean getPDFUrl() {
        ...
        requesterBean.setId("IacucProtocol/ProtocolSummary");
    ...
    private Hashtable getSelectedItems() {
        ...
        // Added for COEUSQA-2630_Allow the ability to print attachments with protocol summary/Schema changes start
        htSelectedItems.put(CoeusConstants.SCIENTIFIC_JUSTIFICATION, new Boolean(chkScientificJustification.isSelected()));
        htSelectedItems.put(CoeusConstants.PROCEDURES, new Boolean(chkProcedures.isSelected()));
        htSelectedItems.put(CoeusConstants.SPECIES_GROUP, new Boolean(chkSpeciesGroup.isSelected()));
        htSelectedItems.put(CoeusConstants.ALTERNATIVE_SEARCH, new Boolean(chkAlternativeSearch.isSelected()));
        // Added for COEUSQA-2630_Allow the ability to print attachments with protocol summary/Schema changesend
        ...
        // Added for COEUSQA-2630_Allow the ability to print attachments with protocol summary/Schema changesstart
    ...
    public void actionPerformed(java.awt.event.ActionEvent ae) {
        ...
        try {
            ...
            if (source.equals(btnClose)) {
                ...
                // Added for COEUSQA-2630_Allow the ability to print attachments with protocol summary/Schema changes start
                chkScientificJustification.setSelected(false);
                chkProcedures.setSelected(false);
                chkSpeciesGroup.setSelected(false);
                chkAlternativeSearch.setSelected(false);
                //  Added for COEUSQA-2630_Allow the ability to print attachments with protocol summary/Schema changesend
                if(vcQuestionnaireChk != null && vcQuestionnaireChk.size() > 0){
                    for(int index = 0;index < vcQuestionnaireChk.size();index++){
                        javax.swing.JCheckBox chkQuestionnarie = (javax.swing.JCheckBox)vcQuestionnaireChk.get(index);
...
//            pnlInclude.setPreferredSize(size);
        ...
        pnlProtocolAttachments.setLayout(flowLayout);
    ...
    // Added for COEUSQA-2630_Allow the ability to print attachments with protocol summary/Schema changesv start
    /**
             ...
             for(Object docData: attachmentsData){
                 ...
                 if(attachBean != null){                     
                     String fileExtension = attachBean.getFileName().toLowerCase();
                       if(fileExtension.endsWith(".pdf") && attachBean.getStatusCode()!= 3){                          
    ...
    private void initComponents() {
        ...
        chkSpeciesGroup = new javax.swing.JCheckBox();
        chkProcedures = new javax.swing.JCheckBox();
        ...
        pnlProtocolAttachments.setPreferredSize(new java.awt.Dimension(0, 0));
        ...
        chkSpeciesGroup.setText("Species / Groups");
        chkSpeciesGroup.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        chkSpeciesGroup.setMargin(new java.awt.Insets(0, 0, 0, 0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        ...
        pnlInclude.add(chkSpeciesGroup, gridBagConstraints);

        chkProcedures.setText("Procedures");
        chkProcedures.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        chkProcedures.setMargin(new java.awt.Insets(0, 0, 0, 0));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.ipady = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 44, 0, 0);
        pnlInclude.add(chkProcedures, gridBagConstraints);

        chkAlternativeSearch.setText("Alternative Search");
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 44, 0, 0);
        pnlInclude.add(chkAlternativeSearch, gridBagConstraints);

        chkScientificJustification.setText("Scientific Justification");
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 44, 0, 0);
        pnlInclude.add(chkScientificJustification, gridBagConstraints);
    ...
    private void setModuleDetailsForQuestionnaire() {
        if(questionnaire != null && questionnaire.size() > 0){
            for(int index=0;index<questionnaire.size();index++){
                ...
                questionAnsHeaderBean.setModuleItemCode(ModuleConstants.IACUC_MODULE_CODE);
                questionAnsHeaderBean.setModuleItemKey(protocolInfoBean.getProtocolNumber());
                //Added for COEUSDEV-86 : Questionnaire for a Submission - Start                
                subModuleItemCode = setSubModuleItemCode();
                //COEUSDEV-86 : END
    ...
    //COEUSQA-1724 - Implemented for new Amendment/Renewals type - Start
    /*This method is used to set the Sub module item code for Amendment/Renewals
     *@return int submoduleCode
     */
    private int setSubModuleItemCode() {
        int subModuleItemCode = 0;
        if(protocolInfoBean.getProtocolNumber().indexOf("A") > -1 
        || protocolInfoBean.getProtocolNumber().indexOf("R") > -1 
        || protocolInfoBean.getProtocolNumber().indexOf("E") > -1 
        || protocolInfoBean.getProtocolNumber().indexOf("C") > -1 
        || protocolInfoBean.getProtocolNumber().indexOf("O") > -1){
            subModuleItemCode = 1; // Amendment/Renewal
        }
        return subModuleItemCode;
    }
    
    /*Method Created to set the Amendment/renewal check box title in Print Summary form
     *@param protocolInfoBean is use to get the protocol number for checking Amendment type
     */
    private void setAmendRenewCheckBoxTitle(final ProtocolInfoBean protocolInfoBean) {
        // If protocol is Amendment or Renewal check box label is set to Amendment/Renewal Summary
    ...
    //COEUSQA-1724 - Implemented for new Amendment/Renewals type - End
    ...
    public javax.swing.JCheckBox chkAlternativeSearch;
    ...
    public javax.swing.JCheckBox chkProcedures;
    ...
    public javax.swing.JCheckBox chkScientificJustification;
    public javax.swing.JCheckBox chkSpecialReview;
    public javax.swing.JCheckBox chkSpeciesGroup;
