...
import edu.mit.coeus.iacuc.bean.SubmissionDetailsBean ;
...
public class ProtocolActionsForm extends javax.swing.JComponent{
...
//                return btnDocument;
    ...
    class ProtocolActionCellEditor extends DefaultCellEditor implements ActionListener{
        ...
        private IacucDataViewForm commentsViewForm;
        ...
        ProtocolActionCellEditor() {
            ...
            commentsViewForm = new IacucDataViewForm();
