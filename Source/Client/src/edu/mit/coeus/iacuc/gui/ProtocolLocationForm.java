...
public class ProtocolLocationForm extends javax.swing.JComponent {
    ...
    private javax.swing.JLabel lblAnimalWelfare;
    private javax.swing.JLabel lblAnimalWelfareData;
...
//        if(tblLocation.getRowCount() > 0  && functionType != 'D'){
    ...
    private void initComponents() {
        ...
        lblAnimalWelfare = new javax.swing.JLabel();
        lblAnimalWelfare.setText("Animal Welfare Assurance #: ");
        lblAnimalWelfare.setFont(CoeusFontFactory.getLabelFont());
        lblAnimalWelfare.setHorizontalAlignment(SwingConstants.RIGHT);
        lblAnimalWelfare.setHorizontalTextPosition(SwingConstants.RIGHT);
        lblAnimalWelfareData = new javax.swing.JLabel();
        lblAnimalWelfareData.setOpaque(false);
...
//        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        scrPnLocation.setPreferredSize(new java.awt.Dimension(310, 70));
        scrPnLocation.setMinimumSize(new java.awt.Dimension(310, 70));
...
//                if( columnIndex == 1 && functionType != 'D' ) {                
        ...
        gridBagConstraints.insets = new java.awt.Insets(5, 0, 5, 0); //(5,10,5,10)
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        scrPnAddress.setBorder(new TitledBorder(new EtchedBorder(), "Address",
                ...
                CoeusFontFactory.getLabelFont()));
        scrPnAddress.setPreferredSize(new Dimension(310, 70));
        scrPnAddress.setMinimumSize(new Dimension(310, 70));
        ...
        gridBagConstraints.insets = new java.awt.Insets(5, 0, 5, 0); //(5,5,5,5)
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        add(scrPnAddress, gridBagConstraints);
        
        //COEUSQA-1724:Protocol Organisation - Animal Welfare Assurance # not displayed -  start     
        //Animal Welfare Assurance Label
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        //gridBagConstraints.ipadx = 50;
        //gridBagConstraints.insets = new java.awt.Insets(0, 0, 5, 5); 
        gridBagConstraints.insets = new java.awt.Insets(0, 9, 5, 0); //(5,5,5,5)
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        add(lblAnimalWelfare, gridBagConstraints);

        //Animal Welfare Assurance Data        
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        //gridBagConstraints.ipadx = 50;
        //gridBagConstraints.insets = new java.awt.Insets(0, 0, 5, 5); 
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 5, 0); //(5,5,5,5)
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        add(lblAnimalWelfareData, gridBagConstraints);
        //COEUSQA-1724:Protocol Organisation - Animal Welfare Assurance # not displayed - end
                ...
                if(orgId != null && orgId.trim().length()>0){
                    ...
                    if(option == JOptionPane.YES_OPTION){
                        ...
                        if(newRowCount >0){
                            ...
                            txtArAddress.setText("");    
                            //Added For COEUSQA-1724:Animal Welfare Assurance # in Premium
                            lblAnimalWelfareData.setText("");
                            //tblLocation.setRowSelectionInterval(0,0);
                            btnDeleteLocation.setEnabled(false);            
                            btnAddAddress.setEnabled( false );
                            btnClearAddress.setEnabled( false );
    ...
    private void btnAddLocationActionPerformed(ActionEvent evt) {
        ...
        try{
            ...
            if (orgSelected != null && !orgSelected.isEmpty() ) {
                ...
                //COEUSQA-1724:Protocol Organisation - Animal Welfare Assurance # not displayed
                animalWelfare = Utils.convertNull(orgSelected.get(
            ...
            if(orgId != null && orgId.trim().length() > 0 ) {
                ...
                if(!duplicate){
                    ...
                    //COEUSQA-1724:Protocol Organisation - Animal Welfare Assurance # not displayed
                    locBean.setAnimalWelfareAssurance(animalWelfare);
                    locationAddress.put(orgId,locBean);
                  ...
                  txtArAddress.setText(address);
                  //COEUSQA-1724:Protocol Organisation - Animal Welfare Assurance # not displayed
                  lblAnimalWelfareData.setText(animalWelfare);
                  btnClearAddress.setEnabled( true );
                }else{
                  txtArAddress.setText(txtArAddress.getText());
                  //COEUSQA-1724:Protocol Organisation - Animal Welfare Assurance # not displayed
                  lblAnimalWelfareData.setText(lblAnimalWelfareData.getText());
                }
                //txtArAddress.setText(address);
                btnDeleteLocation.setEnabled(true);  
                btnAddAddress.setEnabled( true );
...
//                    if(functionType != 'D'){                    
                ...
                //COEUSQA-1724: Protocol Organisation - Animal Welfare Assurance # not displayed
                lblAnimalWelfareData.setText(locBean.getAnimalWelfareAssurance());
    ...
    public void checkDefOrgIsMultiCampus() {
        ...
        vecParameter.add("DEFAULT_IACUC_ORGANIZATION_ID");
    ...
    public void setDefaultOrgAddress()
    {
        ...
        String contactAddressID="";
        String address="";
        String animalWelfareAssurance = "";
       // boolean duplicate = false;
        String connectTo = CoeusGuiConstants.CONNECTION_URL + "/coeusFunctionsServlet";
        RequesterBean request = new RequesterBean();
        request.setDataObject("GET_IACUC_DEFAULT_LOCATION");
        //request.setId(contactAddressID);
        AppletServletCommunicator comm = new AppletServletCommunicator(connectTo, request);
        comm.send();
        ResponderBean response = comm.getResponse();
...
//                                            formatAddress(rolodexDetailsBean));
//                //COEUSQA-1724:Protocol Organisation - Animal Welfare Assurance # not displayed 
//                animalWelfareAssurance = Utils.convertNull(organizationAddress.getAnimalWelfareAssurance()) ;
//                try
//                {
//                    if(orgId != null && orgId.trim().length() > 0 ) {
//                    // Add your handling code here:
...
//                        locBean.setAddress(address);
//                        //COEUSQA-1724:Protocol Organisation - Animal Welfare Assurance # not displayed 
//                        locBean.setAnimalWelfareAssurance(animalWelfareAssurance);
//                        locationAddress.put(orgId,locBean);
//
//                        Vector tableRow = new Vector();
//                        tableRow.addElement("");
...
//                      txtArAddress.setText(address);
//                      //COEUSQA-1724:Protocol Organisation - Animal Welfare Assurance # not displayed 
//                      lblAnimalWelfareData.setText(animalWelfareAssurance);
//                      btnClearAddress.setEnabled( true );
//                      btnDeleteLocation.setEnabled(true);  
//                      btnAddAddress.setEnabled( true );
//                      
