        ...
        for (int i = 0 ; i< dataObject.size() ; i++)
        {
           ...
           if (batchCorrespondenceDetailsBean.getProtocolApprovalDate() != null)
           {
            vecDataRow.add(dtUtils.formatDate(
                      batchCorrespondenceDetailsBean.getProtocolApprovalDate().toString(), DATE_FORMAT)) ;
           }
           else
           {
                vecDataRow.add("") ;
           ...
           {    
             vecDataRow.add(dtUtils.formatDate(
                      batchCorrespondenceDetailsBean.getProtocolExpirationDate().toString(), DATE_FORMAT)) ;
           }
           else
           {
                vecDataRow.add("") ;
...
//        request.setDataObject(vecDocParam);
        ...
        map.put(DocumentConstants.READER_CLASS, "edu.mit.coeus.iacuc.BatchCorrespondenceReader");
