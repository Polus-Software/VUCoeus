...
public class ProtocolMaintenanceForm extends JComponent {
    ...
    private CoeusComboBox cmbType,cmbProjectType;
    private JPanel pnlLocations;
    private JLabel lblType,lblProjectType;   
    private CoeusTextField txtApprDate;
    private CoeusComboBox cmbStatus;
    private JTextArea  txtTitle, txtLayStmt1, txtLayStmt2; //CoeusTextField txtTitle;
    private JLabel lblStatus;
    private CoeusTextField txtFDAApplNo;
    private JLabel lblTitle, lblLayStmt1, lblLayStmt2;
...
//    private ProtocolLocationForm locationForm = null;
    ...
    private Vector availProjectType = null;
...
//        boolean enabled = functionType != 'D' ? true : false ;
        ...
        txtLayStmt1.setOpaque(enabled);
        txtLayStmt2.setOpaque(enabled);
...
//          txtLastApprovalDate.setEditable( false );
        ...
        txtLayStmt1.setEditable(enabled);
        txtLayStmt2.setEditable(enabled);
        txtArDescription.setEditable( enabled );
        cmbType.setEnabled(enabled);
        cmbProjectType.setEnabled(enabled);
    ...
    public void setAvailProjectType(Vector availProjectType){
        this.availProjectType = availProjectType;
    }
    ...
    public void log(String mesg) throws CoeusUIException {
        ...
        coeusUIException.setTabIndex(CoeusGuiConstants.IACUC_DETAIL_EXCEP_TAB_INDEX);
    ...
    public boolean validateData() throws Exception, CoeusUIException{
        ...
        if((functionType == CoeusGuiConstants.DISPLAY_MODE 
                || functionType == CoeusGuiConstants.AMEND_MODE) 
                && (locationFunctionType == CoeusGuiConstants.DISPLAY_MODE 
                || locationFunctionType == CoeusGuiConstants.AMEND_MODE)){
            return true;
        }
        ...
        if((txtTitle.getText()== null)
          ...
          /*  
            ...
            if (convertedDate==null){
                oldDate = dtUtils.restoreDate(txtApplnDate.getText(),DATE_SEPERATOR);
            ...
            if((txtApprDate.getText() != null)
                ...
                convertedDate = dtUtils.formatDate(txtApprDate.getText(),
                        DATE_SEPERATOR , DATE_FORMAT);
                if (convertedDate==null){
                    oldDate = dtUtils.restoreDate(txtApprDate.getText(),DATE_SEPERATOR);
            ...
            if((txtExpDate.getText() != null)
                ...
                convertedDate = dtUtils.formatDate(txtExpDate.getText(),
                        DATE_SEPERATOR , DATE_FORMAT);
                if (convertedDate==null){
                    oldDate = dtUtils.restoreDate(txtExpDate.getText(),DATE_SEPERATOR);
...
//            }
    ...
    public ProtocolInfoBean getFormData() throws Exception{
        ...
        protocolInfoBean.setLayStmt1(txtLayStmt1.getText());
        protocolInfoBean.setLayStmt2(txtLayStmt2.getText());
        /**
         * Ref ID : 107 Feb' 14/`8 2003. FDA Application Number
         * Not Mandatory.
         * UPdated for Save Confirmation Bug. Feb' 19 2003.
...
//            protocolInfoBean.setApplicationDate(
//                                new java.sql.Date(dtFormat.parse(
//                            dtUtils.restoreDate(txtApplnDate.getText(),DATE_SEPERATOR)).getTime()));
            String convertedDate = dtUtils.formatDate(txtApplnDate.getText(),DATE_SEPERATOR,"MM/dd/yyyy");
            if(convertedDate == null) {
...
//        }                    
        ...
        ComboBoxBean projectTypeBean = 
                (ComboBoxBean)cmbProjectType.getSelectedItem();
       //Added for internal issue 1673 start 
        if(projectTypeBean.getCode() != null && !CoeusGuiConstants.EMPTY_STRING.equals(projectTypeBean.getCode())){
            protocolInfoBean.setProjectTypeCode(Integer.parseInt(
                    projectTypeBean.getCode()));
            protocolInfoBean.setProjectTypeDesc(projectTypeBean.getDescription());
        }
         //Added for internal issue 1673 end 
...
//            if(functionType == 'M' ){
    ...
    private void setFormData(){
        ...
        if( ( availProjectType != null ) && ( availProjectType.size() > 0 )
                && ( cmbProjectType.getItemCount() == 0 ) ) {
            for(int index = 0 ; index < availProjectType.size(); index++){
                cmbProjectType.addItem((ComboBoxBean)availProjectType.elementAt(index));
            }
        }
       ...
       /* if( parameters != null && parameters.size() > 0 ) {
        ...
        if( protocolInfoBean != null ){
            ...
            txtLayStmt1.setText(protocolInfoBean.getLayStmt1());
            txtLayStmt2.setText(protocolInfoBean.getLayStmt2());
            ...
            if ( protocolInfoBean.getApplicationDate() != null ){
               ...
               protocolInfoBean.getApplicationDate().toString(),DATE_FORMAT));
            }
            ...
            ComboBoxBean projectTypeComboBean = new ComboBoxBean();
            projectTypeComboBean.setCode(new Integer(
                    protocolInfoBean.getProjectTypeCode()).toString());
            projectTypeComboBean.setDescription(protocolInfoBean.getProjectTypeDesc());
...
//            }
            ...
            boolean isProjectTypPresent = false;
            for(int typeRow = 0; typeRow < cmbProjectType.getItemCount(); typeRow++){
                if(((ComboBoxBean)cmbProjectType.getItemAt(typeRow)).getCode().equals(projectTypeComboBean.getCode())){
                    cmbProjectType.setSelectedIndex(typeRow);
                    isProjectTypPresent = true;
                    break;
                }
            }
            if(!isProjectTypPresent && !projectTypeComboBean.getCode().equals("0")){
                cmbProjectType.addItem(projectTypeComboBean);
                cmbProjectType.setSelectedItem(projectTypeComboBean);
            }
...
//            }
            ...
            if(protocolLocations != null && protocolLocations.size() > 0 ) {
                ...
                for(int locIndex = 0 ; locIndex < locCount; locIndex++ ) {
                    ...
                    listBean.setAnimalWelfareAssurance(tempBean.getAnimalWelfareAssurance());
    ...
    private void initComponents() {
        ...
        lblTitle = new JLabel();
        lblLayStmt1 = new JLabel();
        lblLayStmt2 = new JLabel();
        ...
        txtLayStmt1.setWrapStyleWord(true);
        txtLayStmt1.setLineWrap(true);
        txtLayStmt1.setDocument(new LimitedPlainDocument( 2000 ));
        txtLayStmt1.setFont(CoeusFontFactory.getNormalFont());
        txtLayStmt1.setRows(2000) ;

        txtLayStmt2.setWrapStyleWord(true);
        txtLayStmt2.setLineWrap(true);
        txtLayStmt2.setDocument(new LimitedPlainDocument( 2000 ));
        txtLayStmt2.setFont(CoeusFontFactory.getNormalFont());
        txtLayStmt2.setRows(2000) ;
        ...
        gridBagConstraints.insets = new Insets(3, 340, 3, 5);
        ...
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new Insets(0, 5, 3, 350);
        gridBagConstraints.anchor = GridBagConstraints.EAST;
        pnlDetails.add(lblType, gridBagConstraints);


        lblProjectType.setText("Project Type :");
        lblProjectType.setFont(CoeusFontFactory.getLabelFont());
        lblProjectType.setHorizontalAlignment(SwingConstants.RIGHT);
        lblProjectType.setHorizontalTextPosition(SwingConstants.RIGHT);
        gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new Insets(0, 5, 3, 130);
        gridBagConstraints.anchor = GridBagConstraints.EAST;
        pnlDetails.add(lblProjectType, gridBagConstraints);
        ...
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.insets = new Insets(0, 5, 3, 30);
        gridBagConstraints.anchor = GridBagConstraints.EAST;
        ...
        gridBagConstraints.insets = new Insets(0, 0, 3, 5); //(0,5,5,5)
        ...
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 6; //2
        gridBagConstraints.insets = new Insets(3, 125, 3, 5);
        gridBagConstraints.anchor = GridBagConstraints.NORTHWEST;
...
//        gridBagConstraints.gridx = 1;
//        gridBagConstraints.gridy = 9; //3
//        gridBagConstraints.insets = new Insets(3, 335, 3, 0);
//        gridBagConstraints.anchor = GridBagConstraints.NORTHWEST;
//        pnlDetails.add(lblFDAApplNo, gridBagConstraints);
        ...
        //gridBagConstraints.insets = new Insets(0, 5, 5, 5);
         gridBagConstraints.insets = new Insets(0, 245, 0, 5);
        gridBagConstraints.anchor = GridBagConstraints.NORTHWEST;
        gridBagConstraints.anchor = GridBagConstraints.NORTHWEST;
...
//        if(functionType != 'D'){        
        ...
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 6; //3
        gridBagConstraints.insets = new Insets(0, 460, 0, 0);
        gridBagConstraints.anchor = GridBagConstraints.NORTHWEST;
        ...
        txtFldRef1.setPreferredSize(new java.awt.Dimension(225, 20));
        gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 11; 
        ...
        scrPnCommentsContainer.setPreferredSize(new java.awt.Dimension(120, 45));
...
//  
        ...
        scrPnDescContainer.setPreferredSize(new java.awt.Dimension(120, 45));
        ...
        lblLayStmt1.setText("Lay Statement 1 :");
        lblLayStmt1.setFont(CoeusFontFactory.getLabelFont());
        lblLayStmt1.setHorizontalAlignment(SwingConstants.RIGHT);
        lblLayStmt1.setHorizontalTextPosition(SwingConstants.RIGHT);
        gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 0; 
        gridBagConstraints.gridy = 4;  
        gridBagConstraints.insets = new Insets(0, 0, 3, 5);  
        gridBagConstraints.anchor = GridBagConstraints.NORTHEAST;
        pnlDetails.add(lblLayStmt1, gridBagConstraints);
        
        txtLayStmt1.setPreferredSize(new Dimension(120, 90)); 
        gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 1; 
        gridBagConstraints.gridy = 4; 
        ...
        javax.swing.JScrollPane scrPnLayStmt1 = new javax.swing.JScrollPane();
        scrPnLayStmt1.setHorizontalScrollBarPolicy(javax.swing.JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
        scrPnLayStmt1.setPreferredSize(new java.awt.Dimension(120, 45));
        scrPnLayStmt1.setMinimumSize(new java.awt.Dimension(120, 50));
        scrPnLayStmt1.setMaximumSize(new java.awt.Dimension(120, 50));
        scrPnLayStmt1.setViewportView(txtLayStmt1);
        pnlDetails.add(scrPnLayStmt1, gridBagConstraints);
        
        lblLayStmt2.setText("Lay Statement 2 :");
        lblLayStmt2.setFont(CoeusFontFactory.getLabelFont());
        lblLayStmt2.setHorizontalAlignment(SwingConstants.RIGHT);
        lblLayStmt2.setHorizontalTextPosition(SwingConstants.RIGHT);
        gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 0;  
        gridBagConstraints.gridy = 5;  
        gridBagConstraints.insets = new Insets(0, 0, 3, 5);  
        gridBagConstraints.anchor = GridBagConstraints.NORTHEAST;
        pnlDetails.add(lblLayStmt2, gridBagConstraints); 
        
        txtLayStmt2.setPreferredSize(new Dimension(120, 90));
        gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 1; 
        gridBagConstraints.gridy = 5; 
        gridBagConstraints.insets = new Insets(0, 0, 5, 5);
        ...
        javax.swing.JScrollPane scrPnLayStmt2 = new javax.swing.JScrollPane();
        scrPnLayStmt2.setHorizontalScrollBarPolicy(javax.swing.JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
        scrPnLayStmt2.setPreferredSize(new java.awt.Dimension(120, 45));
        scrPnLayStmt2.setMinimumSize(new java.awt.Dimension(120, 50));
        scrPnLayStmt2.setMaximumSize(new java.awt.Dimension(120, 50));
        scrPnLayStmt2.setViewportView(txtLayStmt2);
        pnlDetails.add(scrPnLayStmt2, gridBagConstraints);
...
//        pnlDetails.add(txtFDAApplNo, gridBagConstraints);
       //Commented for  COEUSQA-2799 Remove FDA Application from IACUC Protocol General Information end
        ...
        txtFldRef2.setPreferredSize(new java.awt.Dimension(225, 20));
        gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 11; 
        gridBagConstraints.insets = new Insets(0, 355, 0, 0);
        gridBagConstraints.anchor = GridBagConstraints.NORTHWEST;
        //gridBagConstraints.gridwidth = 1;
        //gridBagConstraints.fill = GridBagConstraints.HORIZONTAL;
        ...
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new Insets(0, 0, 3, 225);
        gridBagConstraints.anchor = GridBagConstraints.EAST;
        pnlDetails.add(cmbType, gridBagConstraints);
        
        cmbProjectType.setPreferredSize(new Dimension(120, 20));
        gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new Insets(0, 0, 3, 5);
        gridBagConstraints.anchor = GridBagConstraints.EAST;
        pnlDetails.add(cmbProjectType, gridBagConstraints);
        ...
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.insets = new Insets(10, 0, 3, 10);
        gridBagConstraints.anchor = GridBagConstraints.WEST;
...
//        locationForm = new ProtocolLocationForm(functionType,null,orgTypes,mdiForm);
        ...
        pnlLocations.setPreferredSize(new Dimension(686,155));
        ...
        java.awt.Component[] components = {cmbType,cmbProjectType,chkBillable,txtTitle,txtArDescription, txtLayStmt1, txtLayStmt2,
        txtApplnDate,//txtApprDate,txtExpDate,  //Commented by Vyjayanthi - 02/08/2004 for IRB Enhancement
        //txtFDAApplNo,
        txtFldRef1,txtFldRef2,locationFormComponent};
...
//    }
    ...
    public void setTraversalInAdminCorrection() {
        ...
        txtApplnDate,txtApprDate,txtExpDate,
        //txtFDAApplNo,
        txtFldRef1,txtFldRef2};
        ScreenFocusTraversalPolicy  traversePolicy = new ScreenFocusTraversalPolicy( components );
        pnlMain.setFocusTraversalPolicy(traversePolicy);
        pnlMain.setFocusCycleRoot(true);
    }
   ...
   // 2562 -Last Approval Date field  editable in Administrative Correction Mode
    ...
    //COEUSQA-1724-Added to check the function type - Start
    /*This method is used to check the function type
     *@return boolean value
     */
    private boolean isActionTypeTrueFalse(){
    ...
    //COEUSQA-1724-Added to check the function type - end
}