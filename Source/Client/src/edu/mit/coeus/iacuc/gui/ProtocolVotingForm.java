...
import edu.mit.coeus.iacuc.bean.ProtocolVoteAbsFormBean;
import edu.mit.coeus.iacuc.bean.AttendanceInfoBean;
import edu.mit.coeus.iacuc.bean.ProtocolSubmissionVoteFormBean;
...
//        protocolSubmissionVoteFormBean.setSubmissionNumber(getMaxSubmissionNumber(protocolId)) ;
    ...
    private ProtocolSubmissionVoteFormBean getAbstaineesList(){
        ...
        if(protocolSubmissionVoteFormBean == null){
            protocolSubmissionVoteFormBean = new ProtocolSubmissionVoteFormBean();
        }
        return protocolSubmissionVoteFormBean;
    }
