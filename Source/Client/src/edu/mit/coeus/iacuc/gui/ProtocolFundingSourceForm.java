...
public class ProtocolFundingSourceForm extends javax.swing.JComponent {
    ...
    private String strSponsorCode = CoeusGuiConstants.EMPTY_STRING;
...
//        if(functionType == CoeusGuiConstants.DISPLAY_MODE){
    ...
    private void initComponents() {
        ...
        btnMedusa.setMaximumSize(new java.awt.Dimension(90, 27));
        btnMedusa.setMinimumSize(new java.awt.Dimension(90, 27));
        btnMedusa.setPreferredSize(new java.awt.Dimension(90, 27));
...
//                if((functionType == 'D' || col == 0 || col == 3)  ){
        ...
        java.awt.Component[] components = {tblFundSoForm,btnAdd,btnDelete,btnFind,btnMedusa};
    ...
    public static void errorMessage(String mesg) throws CoeusUIException {
        ...
        coeusUIException.setTabIndex(CoeusGuiConstants.IACUC_FUNDING_SOURCE_EXCEP_TAB_INDEX);
    ...
    //Added for COEUSQA-3119  - Need to implement IACUC link to Award, IP, Prop Dev, and IRB - start
    /**
     * Getter for property vecMailFundingData.
     * @return Value of property vecMailFundingData.
     */
    public Vector getVecMailFundingData() {
        return vecMailFundingData;
    }
     ...
     * @return Value of property vecMailFundingData.
     */
    public void setVecMailFundingData(Vector vecMailFundingData) {
        this.vecMailFundingData = vecMailFundingData;
    }
    //Added for COEUSQA-3119  - Need to implement IACUC link to Award, IP, Prop Dev, and IRB - end
