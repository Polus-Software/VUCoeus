...
public class DocumentListController {
    ...
    private static final String connectTo = CoeusGuiConstants.CONNECTION_URL + "/IacucProtocolServlet";
    private static final char DOCUMENT_LIST = 'd';
    private static final char DOCUMENT_URL = 'e';
    
    private boolean hasRight = false;//PERFORM_IACUC_ACTIONS_ON_PROTO
