...
/*
 * AwardAddRecipientsController.java
 * @author  ajaygm
 * Created on June 10, 2004, 3:04 PM
 */

public class AwardAddRecipientsController extends AwardController 
implements ActionListener,ListSelectionListener{
    ...
    // Renamed the Variable SELECT_ROW to SELECT_CONTACT and changed the Message
//    private static final String SELECT_ROW = "search_exceptionCode.1119";
    ...
    /**
     * Creates a new instance of AwardAddRecipients
     */
    public AwardAddRecipientsController(AwardBaseBean awardBaseBean , char funType) {
        super(awardBaseBean);
     ...
     public AwardAddRecipientsController(AwardBaseBean awardBaseBean , char funType, String queryKey) {
...
//            queryKey,AwardDetailsBean.class, CoeusVector.FILTER_ACTIVE_BEANS);
            ...
            queryKey,AwardContactDetailsBean.class, CoeusVector.FILTER_ACTIVE_BEANS);
...
//        awardHeaderForm.setFormData (awardDetailsBean);
        ...
        awardAddRecipientsTableModel.setData(cvAwardContactBean);
         ...
         if( cvAwardContactBean != null && cvAwardContactBean.size() > 0){
            ...
            awardContactDetailsBean = (AwardContactDetailsBean)cvAwardContactBean.get(0);
            awardAddRecipientsForm.awardContactDetailsForm.setFormData(awardContactDetailsBean);
    ...
    public void valueChanged(ListSelectionEvent listSelectionEvent) {
        if( !listSelectionEvent.getValueIsAdjusting() ){
            ...
            if (selectedRow != -1) {
                ...
                (AwardContactDetailsBean)cvAwardContactBean.get(selectedRow);
                awardAddRecipientsForm.awardContactDetailsForm.setFormData(awardContactDetailsBean);
            }
        }
    }
    ...
    public class AwardAddRecipientsTableModel extends AbstractTableModel{
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            AwardContactDetailsBean contactDetailsBean = (AwardContactDetailsBean)cvAwardContactBean.get(rowIndex);
            switch(columnIndex) {
                case HAND_ICON_COLUMN:
                    return EMPTY;
                case CONTACT_TYPE_COLUMN:
        ...
        public void setValueAt(Object value, int row, int column){
            AwardContactDetailsBean awardContactDetailsBean = (AwardContactDetailsBean)cvAwardContactBean.get(row);
            if(column == CONTACT_TYPE_COLUMN) {
                ...
                if( contactCode != awardContactDetailsBean.getContactTypeCode() ){
                    ...
                    } else if( awardContactDetailsBean.getFirstName().trim().equals(EMPTY)) {
   ...
   public class IconRenderer  extends DefaultTableCellRenderer {
    ...
    public boolean getSelectedPersons(){
        ...
        for(int index = 0; index< selRows.length ; index++){
            AwardContactDetailsBean contactDetailsBean = new AwardContactDetailsBean();
	    contactDetailsBean  = (AwardContactDetailsBean)cvAwardContactBean.elementAt (selRows[index]);
    ...
    public void cleanUp() {
        ...
        awardAddRecipientsTableModel.cleanUp();
