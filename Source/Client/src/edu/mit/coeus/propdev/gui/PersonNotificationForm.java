 ...
 *
 * Created on Dec 24, 2010, 11:21:27 AM
 */
 ...
 * @author jaishab
 */
public class PersonNotificationForm extends javax.swing.JPanel {
    ...
    public PersonNotificationForm() {

     
    }


     public PersonNotificationForm(String  ProposalNum) {
       proposalNumber=ProposalNum;
       // proposalNumber="00000171";
       initComponents();
       postInitComponents();
       setFormData();
       setTableEditors();
...
//            switch(column) {
//                case ID :
//                    return personNotificationBean.getCheck()+"";
//                case TYPE :
//                    if(personNotificationBean.getMapType().equals("I")) {
//                        return "Indirect";
//                    }
//                    if(personNotificationBean.getMapType().equals("D")) {
//                        return "Direct";
//                    }
//
//                case DESCRIPTION :
//                    return personNotificationBean.getDescription();
//            }
            return null;
        }
...
//            switch(column) {
//                case ID :
//                    personNotificationBean.setMapId(Integer.parseInt(value.toString()));
//                    break;
//                case TYPE :
//                    personNotificationBean.setMapType(value.toString());
//                    break;
//                case DESCRIPTION :
//                    personNotificationBean.setDescription(value.toString());
//                    break;
//            }
...
//        int colSize[] = {30, 75,250};
//
//        for(int col = 0; col < colSize.length; col++) {
//            tableColumn = jTable1.getColumnModel().getColumn(col);
...
private void sendPersonNotification(){
   ...
   if(sendNotificationFlag)
   {
    ...
    if(personIdToSendNotification.size()>0){
         ...
         requesterBean.setFunctionType(PROPOSAL_PERSON_SEND);
          ...
          try{
              ...
              dlgNotificationForm.dispose();
                  ...
                  CoeusOptionPane.showErrorDialog(" Unable to send the notification.  ");
              }
          }catch(Exception e) {
            e.printStackTrace();
        }
...
private void selectAllPerson()
{
    ...
    public void retrievePersonsToSendNotificationDetails(){
          ...
          requestParameter.add(proposalNumber);
          RequesterBean requesterBean  = new RequesterBean();
          requesterBean.setFunctionType(GET_NOTIFY_MAPS);
          // requesterBean.setDataObject(requestParameter);
          requesterBean.setDataObject(proposalNumber);
          String connectTo = CoeusGuiConstants.CONNECTION_URL + conURL;
          AppletServletCommunicator comm = new AppletServletCommunicator(connectTo, requesterBean);
