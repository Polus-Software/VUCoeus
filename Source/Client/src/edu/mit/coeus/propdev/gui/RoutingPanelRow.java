...
public class RoutingPanelRow extends javax.swing.JPanel {
    ...
    private Dimension userIDDimension = new Dimension(110, 20);
    ...
    public void showStatus(boolean show){
     ...
     /** Getter for property proposalApprovalBean.
     * @return Value of property proposalApprovalBean.
     *
     */
    public ProposalApprovalBean getProposalApprovalBean() {
        return proposalApprovalBean;
    }    
    
    /** Setter for property proposalApprovalBean.
     * @param proposalApprovalBean New value of property proposalApprovalBean.
     *
     */
    public void setProposalApprovalBean(ProposalApprovalBean proposalApprovalBean) {
        this.proposalApprovalBean = proposalApprovalBean;
    }    
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblUserID.setIcon(new javax.swing.ImageIcon(""));
