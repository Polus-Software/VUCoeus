/**
 * AwardCentersForm.java
 * 
 * GUI for award centers tab
 *
...
public class AwardCentersForm extends javax.swing.JPanel {
    ...
    public AwardCentersForm() {
    	//constructor
    }	
	
    /** Creates new form AwardCenters */
	public AwardCentersForm(CoeusVector cvCenters) {
	...
	private void initComponents() {
        ...
        scrPnCenterList.setBorder(BorderFactory.createTitledBorder(null, "Award Center Numbers", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 1, 11)));
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		AwardCentersBean bean = (AwardCentersBean) cvCenters.get(rowIndex);
        switch(columnIndex){
        case CENTER_NUMBER:
    ...
    public static void main(String s[]){
        JFrame frame = new JFrame("Award Centers");
        AwardCentersForm awardCentersForm = new AwardCentersForm();
        frame.getContentPane().add(awardCentersForm);
