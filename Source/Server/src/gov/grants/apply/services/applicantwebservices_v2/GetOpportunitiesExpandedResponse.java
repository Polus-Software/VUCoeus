...
@XmlRootElement(name = "GetOpportunitiesExpandedResponse")
public class GetOpportunitiesExpandedResponse {

    @XmlElement(name = "OpportunityInfo")
    protected List<GetOpportunitiesExpandedResponse.OpportunityInfo> opportunityInfo;
     ...
     * {@link GetOpportunitiesExpandedResponse.OpportunityInfo }
     * 
     * 
     */
    public List<GetOpportunitiesExpandedResponse.OpportunityInfo> getOpportunityInfo() {
        if (opportunityInfo == null) {
            opportunityInfo = new ArrayList<GetOpportunitiesExpandedResponse.OpportunityInfo>();
        }
