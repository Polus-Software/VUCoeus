...
@XmlRootElement(name = "GetOpportunitiesPlusCompTitleResponse")
public class GetOpportunitiesPlusCompTitleResponse {

    @XmlElement(name = "OpportunityInfo")
    protected List<GetOpportunitiesPlusCompTitleResponse.OpportunityInfo> opportunityInfo;
     ...
     * {@link GetOpportunitiesPlusCompTitleResponse.OpportunityInfo }
     * 
     * 
     */
    public List<GetOpportunitiesPlusCompTitleResponse.OpportunityInfo> getOpportunityInfo() {
        if (opportunityInfo == null) {
            opportunityInfo = new ArrayList<GetOpportunitiesPlusCompTitleResponse.OpportunityInfo>();
        }
