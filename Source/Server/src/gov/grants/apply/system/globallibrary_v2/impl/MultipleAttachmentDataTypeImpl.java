...
public class MultipleAttachmentDataTypeImpl implements gov.grants.apply.system.globallibrary_v2.MultipleAttachmentDataType, com.sun.xml.bind.JAXBObject, gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallableObject, gov.grants.apply.forms.attachments_v1.impl.runtime.XMLSerializable, gov.grants.apply.forms.attachments_v1.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _AttachedFile;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (gov.grants.apply.system.globallibrary_v2.MultipleAttachmentDataType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getAttachedFile() {
        if (_AttachedFile == null) {
            _AttachedFile = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _AttachedFile;
    }

    public java.util.List getAttachedFile() {
        return _getAttachedFile();
    }

    public gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallingEventHandler createUnmarshaller(gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallingContext context) {
        return new gov.grants.apply.system.globallibrary_v2.impl.MultipleAttachmentDataTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_AttachedFile == null)? 0 :_AttachedFile.size());
        while (idx1 != len1) {
            context.startElement("http://apply.grants.gov/system/GlobalLibrary-V2.0", "AttachedFile");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _AttachedFile.get(idx_0 ++)), "AttachedFile");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _AttachedFile.get(idx_1 ++)), "AttachedFile");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _AttachedFile.get(idx1 ++)), "AttachedFile");
            context.endElement();
        }
    }
...
+".grants.apply.system.globallibrary_v2.AttachedFileDataTypet\u0000"
...
+"-instanceq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\fAttachedFilet\u00001http://apply.grants.go"
+"v/system/GlobalLibrary-V2.0sr\u0000\"com.sun.msv.grammar.Expressio"
...
+"\u0000~\u0000\u0005x"));
        ...
        extends gov.grants.apply.forms.attachments_v1.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return gov.grants.apply.system.globallibrary_v2.impl.MultipleAttachmentDataTypeImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("FileName" == ___local)&&("http://apply.grants.gov/system/GlobalLibrary-V2.0" == ___uri)) {
                            _getAttachedFile().add(((gov.grants.apply.system.globallibrary_v2.impl.AttachedFileDataTypeImpl) spawnChildFromEnterElement((gov.grants.apply.system.globallibrary_v2.impl.AttachedFileDataTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
