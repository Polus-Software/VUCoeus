...
public class RRPerformanceSiteTypeImpl implements gov.grants.apply.forms.rr_performancesite_v1.RRPerformanceSiteType, com.sun.xml.bind.JAXBObject, gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallableObject, gov.grants.apply.forms.attachments_v1.impl.runtime.XMLSerializable, gov.grants.apply.forms.attachments_v1.impl.runtime.ValidatableObject
{

    protected gov.grants.apply.forms.rr_performancesite_v1.SiteLocationDataType _PrimarySite;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (gov.grants.apply.forms.rr_performancesite_v1.RRPerformanceSiteType.class);
    }

    public gov.grants.apply.forms.rr_performancesite_v1.SiteLocationDataType getPrimarySite() {
        return _PrimarySite;
    }

    public void setPrimarySite(gov.grants.apply.forms.rr_performancesite_v1.SiteLocationDataType value) {
        _PrimarySite = value;
    }
    ...
    public gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallingEventHandler createUnmarshaller(gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallingContext context) {
        return new gov.grants.apply.forms.rr_performancesite_v1.impl.RRPerformanceSiteTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.startElement("http://apply.grants.gov/forms/RR_PerformanceSite-V1.0", "PrimarySite");
        ...
        context.endElement();
        while (idx4 != len4) {
            context.startElement("http://apply.grants.gov/forms/RR_PerformanceSite-V1.0", "OtherSite");
            int idx_2 = idx4;
        ...
        if (_AttachedFile!= null) {
            context.startElement("http://apply.grants.gov/forms/RR_PerformanceSite-V1.0", "AttachedFile");
        ...
        throws org.xml.sax.SAXException
    {
        int idx4 = 0;
        final int len4 = ((_OtherSite == null)? 0 :_OtherSite.size());
        context.startAttribute("http://apply.grants.gov/forms/RR_PerformanceSite-V1.0", "FormVersion");
        try {
        ...
        throws org.xml.sax.SAXException
    {
        int idx4 = 0;
        final int len4 = ((_OtherSite == null)? 0 :_OtherSite.size());
        context.getNamespaceContext().declareNamespace("http://apply.grants.gov/forms/RR_PerformanceSite-V1.0", null, true);
        while (idx4 != len4) {
            idx4 += 1;
        }
    }
...
+"\u0000~\u0000 xq\u0000~\u0000\u001bt\u0000Agov.grants.apply.forms.rr_performancesite_v1.Si"
+"teLocationDataTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-elem"
...
+"3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u000bPrimarySitet\u00005htt"
+"p://apply.grants.gov/forms/RR_PerformanceSite-V1.0sq\u0000~\u0000\u000eppsq"
+"\u0000~\u0000\u0000q\u0000~\u0000\u0014psq\u0000~\u0000\bq\u0000~\u0000\u0014p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0010q\u0000~\u0000\u0014p"
...
+"\u0000~\u00009q\u0000~\u0000\u001eq\u0000~\u0000Jsq\u0000~\u0000\u000eppsq\u0000~\u0000\u0000q\u0000~\u0000\u0014psq\u0000~\u0000\bq\u0000~\u0000\u0014p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000"
...
+"q\u0000~\u0000)q\u0000~\u00009q\u0000~\u0000\u001eq\u0000~\u0000Jsq\u0000~\u0000\u000eppsq\u0000~\u0000\u0000q\u0000~\u0000\u0014psq\u0000~\u0000\bq\u0000~\u0000\u0014p\u0000sq\u0000~\u0000\u0000p"
+"psq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0010q\u0000~\u0000\u0014psq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000"
+"~\u0000\u001fq\u0000~\u0000\"q\u0000~\u0000#sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00009q\u0000~\u0000\u001eq\u0000~\u0000Jsq\u0000~\u0000\u000ep"
+"psq\u0000~\u0000\u0000q\u0000~\u0000\u0014psq\u0000~\u0000\bq\u0000~\u0000\u0014p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0010q\u0000~"
...
+"\u0000-t\u00001http://apply.grants.gov/system/GlobalLibrary-V1.0t\u0000\u0013For"
...
+"\u0000\tmaxLength\u0000\u0000\u0000\u001esq\u0000~\u00007q\u0000~\u0000\u00a5q\u0000~\u0000\u00a4t\u0000\u00031.0sq\u0000~\u0000\u001ft\u0000\u000bFormVersionq\u0000~"
...
+"nPool;xp\u0000\u0000\u00005\u0001pq\u0000~\u0000\fq\u0000~\u0000Bq\u0000~\u0000Oq\u0000~\u0000Zq\u0000~\u0000eq\u0000~\u0000pq\u0000~\u0000{q\u0000~\u0000\u0085q\u0000~\u0000Lq"
+"\u0000~\u0000\u008fq\u0000~\u0000\u0005q\u0000~\u0000nq\u0000~\u0000cq\u0000~\u0000Mq\u0000~\u0000\u0083q\u0000~\u0000\u008dq\u0000~\u0000xq\u0000~\u0000\u0007q\u0000~\u0000\u000fq\u0000~\u0000Dq\u0000~\u0000Qq"
+"\u0000~\u0000\\q\u0000~\u0000$q\u0000~\u0000Hq\u0000~\u0000Uq\u0000~\u0000`q\u0000~\u0000gq\u0000~\u0000kq\u0000~\u0000rq\u0000~\u0000vq\u0000~\u0000}q\u0000~\u0000\u0081q\u0000~\u0000\u0087q"
+"\u0000~\u0000\u008bq\u0000~\u0000yq\u0000~\u0000\u0091q\u0000~\u0000\u0096q\u0000~\u0000Xq\u0000~\u0000Wq\u0000~\u0000mq\u0000~\u0000\u0012q\u0000~\u0000Eq\u0000~\u0000Rq\u0000~\u0000]q\u0000~\u0000hq"
+"\u0000~\u0000sq\u0000~\u0000~q\u0000~\u0000\u0088q\u0000~\u0000bq\u0000~\u0000@q\u0000~\u0000\u0092q\u0000~\u0000?q\u0000~\u0000\u0006x"));
        }
        ...
        extends gov.grants.apply.forms.attachments_v1.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return gov.grants.apply.forms.rr_performancesite_v1.impl.RRPerformanceSiteTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  9 :
                        ...
                        return ;
                    case  3 :
                        if (("PrimarySite" == ___local)&&("http://apply.grants.gov/forms/RR_PerformanceSite-V1.0" == ___uri)) {
                    ...
                    case  10 :
                        if (("OrganizationName" == ___local)&&("http://apply.grants.gov/forms/RR_PerformanceSite-V1.0" == ___uri)) {
                            _getOtherSite().add(((gov.grants.apply.forms.rr_performancesite_v1.impl.SiteLocationDataTypeImpl) spawnChildFromEnterElement((gov.grants.apply.forms.rr_performancesite_v1.impl.SiteLocationDataTypeImpl.class), 11, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                    ...
                    case  4 :
                        if (("OrganizationName" == ___local)&&("http://apply.grants.gov/forms/RR_PerformanceSite-V1.0" == ___uri)) {
                            _PrimarySite = ((gov.grants.apply.forms.rr_performancesite_v1.impl.SiteLocationDataTypeImpl) spawnChildFromEnterElement((gov.grants.apply.forms.rr_performancesite_v1.impl.SiteLocationDataTypeImpl.class), 5, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("Address" == ___local)&&("http://apply.grants.gov/forms/RR_PerformanceSite-V1.0" == ___uri)) {
                            _PrimarySite = ((gov.grants.apply.forms.rr_performancesite_v1.impl.SiteLocationDataTypeImpl) spawnChildFromEnterElement((gov.grants.apply.forms.rr_performancesite_v1.impl.SiteLocationDataTypeImpl.class), 5, ___uri, ___local, ___qname, __atts));
                    ...
                    case  7 :
                        ...
                        break;
                    case  6 :
                        if (("OtherSite" == ___local)&&("http://apply.grants.gov/forms/RR_PerformanceSite-V1.0" == ___uri)) {
                            context.pushAttributes(__atts, false);
                            state = 10;
                            return ;
                        }
                        if (("AttachedFile" == ___local)&&("http://apply.grants.gov/forms/RR_PerformanceSite-V1.0" == ___uri)) {
                            context.pushAttributes(__atts, false);
                            state = 7;
                            return ;
                        }
