...
public class RRPerformanceSiteTypeVerifier implements de.fzi.dbs.verification.ObjectVerifier
{
    ...
    public void check(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_performancesite_v1_1.RRPerformanceSiteType master) {
    ...
    public void checkPrimarySite(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_performancesite_v1_1.RRPerformanceSiteType master, gov.grants.apply.forms.rr_performancesite_v1_1.SiteLocationDataType value) {
        if (value instanceof gov.grants.apply.forms.rr_performancesite_v1_1.SiteLocationDataType) {
            gov.grants.apply.forms.rr_performancesite_v1_1.SiteLocationDataType realValue = ((gov.grants.apply.forms.rr_performancesite_v1_1.SiteLocationDataType) value);
            {
                // Check complex value
                gov.grants.apply.forms.rr_performancesite_v1_1.verification.SiteLocationDataTypeVerifier verifier = new gov.grants.apply.forms.rr_performancesite_v1_1.verification.SiteLocationDataTypeVerifier();
    ...
    public void checkFormVersion(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_performancesite_v1_1.RRPerformanceSiteType master, java.lang.String value) {
    ...
    public void checkAttachedFile(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_performancesite_v1_1.RRPerformanceSiteType master, gov.grants.apply.system.attachments_v1.AttachedFileDataType value) {
    ...
    public void checkOtherSite(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_performancesite_v1_1.RRPerformanceSiteType master, java.util.List values) {
    ...
    public void checkOtherSite(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_performancesite_v1_1.RRPerformanceSiteType master, int index, java.lang.Object value) {
        if (value instanceof gov.grants.apply.forms.rr_performancesite_v1_1.SiteLocationDataType) {
            gov.grants.apply.forms.rr_performancesite_v1_1.SiteLocationDataType realValue = ((gov.grants.apply.forms.rr_performancesite_v1_1.SiteLocationDataType) value);
            {
                // Check complex value
    ...
    public void check(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, java.lang.Object object) {
        check(parentLocator, handler, ((gov.grants.apply.forms.rr_performancesite_v1_1.RRPerformanceSiteType) object));
    }

    public void check(javax.xml.bind.ValidationEventHandler handler, java.lang.Object object) {
        check(null, handler, ((gov.grants.apply.forms.rr_performancesite_v1_1.RRPerformanceSiteType) object));
    }
