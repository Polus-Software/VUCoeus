...
public class OrganizationContactPersonDataTypeImpl implements gov.grants.apply.forms.rr_sf424_1_2_v1_2.OrganizationContactPersonDataType, com.sun.xml.bind.JAXBObject, gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallableObject, gov.grants.apply.forms.attachments_v1.impl.runtime.XMLSerializable, gov.grants.apply.forms.attachments_v1.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (gov.grants.apply.forms.rr_sf424_1_2_v1_2.OrganizationContactPersonDataType.class);
    }
    ...
    public gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallingEventHandler createUnmarshaller(gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallingContext context) {
        return new gov.grants.apply.forms.rr_sf424_1_2_v1_2.impl.OrganizationContactPersonDataTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.endElement();
        if (_Title!= null) {
            context.startElement("http://apply.grants.gov/forms/RR_SF424_1_2-V1-2", "Title");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
        ...
        context.startElement("http://apply.grants.gov/forms/RR_SF424_1_2-V1-2", "Address");
        ...
        context.endElement();
        context.startElement("http://apply.grants.gov/forms/RR_SF424_1_2-V1-2", "OrganizationName");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
        ...
        if (_DepartmentName!= null) {
            context.startElement("http://apply.grants.gov/forms/RR_SF424_1_2-V1-2", "DepartmentName");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
        ...
        if (_DivisionName!= null) {
            context.startElement("http://apply.grants.gov/forms/RR_SF424_1_2-V1-2", "DivisionName");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
...
+"4_1_2-V1-2sq\u0000~\u0000\u0013ppsq\u0000~\u0000\rq\u0000~\u0000\u0019p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000+ppsr\u0000\'com.sun.m"
...
+"~\u0000.q\u0000~\u0000>q\u0000~\u0000#sq\u0000~\u0000$t\u0000\u0003Faxq\u0000~\u0000Cq\u0000~\u0000#sq\u0000~\u0000\rpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000+pp"
+"sq\u0000~\u0000Hq\u0000~\u0000Nt\u0000\rEmailDataTypeq\u0000~\u0000Q\u0000\u0001sq\u0000~\u0000Rq\u0000~\u0000Nq\u0000~\u0000\u0080q\u0000~\u0000Q\u0000\u0000q\u0000~"
+"\u0000Uq\u0000~\u0000Uq\u0000~\u0000W\u0000\u0000\u0000\u0001q\u0000~\u0000Uq\u0000~\u0000X\u0000\u0000\u0000<q\u0000~\u0000;sq\u0000~\u0000<q\u0000~\u0000\u0080q\u0000~\u0000Nsq\u0000~\u0000\u0013pps"
+"q\u0000~\u0000\u001aq\u0000~\u0000\u0019pq\u0000~\u0000.q\u0000~\u0000>q\u0000~\u0000#sq\u0000~\u0000$t\u0000\u0005Emailq\u0000~\u0000Csq\u0000~\u0000\rpp\u0000sq\u0000~\u0000\u0000"
+"ppsq\u0000~\u0000+ppsq\u0000~\u0000Hq\u0000~\u0000Nt\u0000\u0018OrganizationNameDataTypeq\u0000~\u0000Q\u0000\u0001sq\u0000~\u0000"
+"Rq\u0000~\u0000Nq\u0000~\u0000\u008bq\u0000~\u0000Q\u0000\u0000q\u0000~\u0000Uq\u0000~\u0000Uq\u0000~\u0000W\u0000\u0000\u0000\u0001q\u0000~\u0000Uq\u0000~\u0000X\u0000\u0000\u0000<q\u0000~\u0000;sq\u0000~"
+"\u0000<q\u0000~\u0000\u008bq\u0000~\u0000Nsq\u0000~\u0000\u0013ppsq\u0000~\u0000\u001aq\u0000~\u0000\u0019pq\u0000~\u0000.q\u0000~\u0000>q\u0000~\u0000#sq\u0000~\u0000$t\u0000\u0010Orga"
+"nizationNameq\u0000~\u0000Csq\u0000~\u0000\u0013ppsq\u0000~\u0000\rq\u0000~\u0000\u0019p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000+ppsq\u0000~\u0000H"
+"q\u0000~\u0000Nt\u0000\u0016DepartmentNameDataTypeq\u0000~\u0000Q\u0000\u0001sq\u0000~\u0000Rq\u0000~\u0000Nq\u0000~\u0000\u0097q\u0000~\u0000Q\u0000\u0000"
+"q\u0000~\u0000Uq\u0000~\u0000Uq\u0000~\u0000W\u0000\u0000\u0000\u0001q\u0000~\u0000Uq\u0000~\u0000X\u0000\u0000\u0000\u001eq\u0000~\u0000;sq\u0000~\u0000<q\u0000~\u0000\u0097q\u0000~\u0000Nsq\u0000~\u0000\u0013"
+"ppsq\u0000~\u0000\u001aq\u0000~\u0000\u0019pq\u0000~\u0000.q\u0000~\u0000>q\u0000~\u0000#sq\u0000~\u0000$t\u0000\u000eDepartmentNameq\u0000~\u0000Cq\u0000~"
+"\u0000#sq\u0000~\u0000\u0013ppsq\u0000~\u0000\rq\u0000~\u0000\u0019p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000+ppsq\u0000~\u0000Hq\u0000~\u0000Nt\u0000\u0014Divisio"
+"nNameDataTypeq\u0000~\u0000Q\u0000\u0001sq\u0000~\u0000Rq\u0000~\u0000Nq\u0000~\u0000\u00a3q\u0000~\u0000Q\u0000\u0000q\u0000~\u0000Uq\u0000~\u0000Uq\u0000~\u0000W\u0000\u0000"
+"\u0000\u0001q\u0000~\u0000Uq\u0000~\u0000X\u0000\u0000\u0000\u001eq\u0000~\u0000;sq\u0000~\u0000<q\u0000~\u0000\u00a3q\u0000~\u0000Nsq\u0000~\u0000\u0013ppsq\u0000~\u0000\u001aq\u0000~\u0000\u0019pq\u0000~"
+"\u0000.q\u0000~\u0000>q\u0000~\u0000#sq\u0000~\u0000$t\u0000\fDivisionNameq\u0000~\u0000Cq\u0000~\u0000#sr\u0000\"com.sun.msv.g"
...
+"q\u0000~\u0000\u009eq\u0000~\u0000\tq\u0000~\u0000\u0006q\u0000~\u0000Fq\u0000~\u0000\u0005q\u0000~\u0000)q\u0000~\u0000Zq\u0000~\u0000fq\u0000~\u0000qq\u0000~\u0000xq\u0000~\u0000\u0083q\u0000~\u0000\u008e"
+"q\u0000~\u0000\u009aq\u0000~\u0000\u0092q\u0000~\u0000\u00a6q\u0000~\u0000\nq\u0000~\u0000Dq\u0000~\u0000kq\u0000~\u0000wq\u0000~\u0000\fq\u0000~\u0000\u0011q\u0000~\u0000_q\u0000~\u0000}q\u0000~\u0000\u0014"
+"q\u0000~\u0000aq\u0000~\u0000\u000bq\u0000~\u0000\u0088q\u0000~\u0000\u0017q\u0000~\u0000bq\u0000~\u0000\bq\u0000~\u0000\u0007q\u0000~\u0000\u00a0q\u0000~\u0000\u0094x"));
        }
        ...
        extends gov.grants.apply.forms.attachments_v1.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return gov.grants.apply.forms.rr_sf424_1_2_v1_2.impl.OrganizationContactPersonDataTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  9 :
                        ...
                        break;
                    case  6 :
                        if (("Address" == ___local)&&("http://apply.grants.gov/forms/RR_SF424_1_2-V1-2" == ___uri)) {
                    ...
                    case  1 :
                        ...
                        break;
                    case  21 :
                        if (("DepartmentName" == ___local)&&("http://apply.grants.gov/forms/RR_SF424_1_2-V1-2" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 22;
                            return ;
                        }
                        ...
                        continue outer;
                    case  3 :
                        if (("Title" == ___local)&&("http://apply.grants.gov/forms/RR_SF424_1_2-V1-2" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 4;
                            return ;
                        }
                    ...
                    case  7 :
                        ...
                        break;
                    case  18 :
                        if (("OrganizationName" == ___local)&&("http://apply.grants.gov/forms/RR_SF424_1_2-V1-2" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 19;
                            return ;
                        }
                        break;
                    case  24 :
                        if (("DivisionName" == ___local)&&("http://apply.grants.gov/forms/RR_SF424_1_2-V1-2" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 25;
                            return ;
                        }
