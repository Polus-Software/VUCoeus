...
public class BudgetYear1DataTypeVerifier
    extends gov.grants.apply.forms.rr_fednonfedbudget_v1_1.verification.BudgetYearDataTypeVerifier
{


    public void check(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_fednonfedbudget_v1_1.BudgetYear1DataType master) {
    ...
    public void checkBudgetJustificationAttachment(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_fednonfedbudget_v1_1.BudgetYear1DataType master, gov.grants.apply.system.attachments_v1.AttachedFileDataType value) {
    ...
    public void check(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, java.lang.Object object) {
        check(parentLocator, handler, ((gov.grants.apply.forms.rr_fednonfedbudget_v1_1.BudgetYear1DataType) object));
    }

    public void check(javax.xml.bind.ValidationEventHandler handler, java.lang.Object object) {
        check(null, handler, ((gov.grants.apply.forms.rr_fednonfedbudget_v1_1.BudgetYear1DataType) object));
    }
