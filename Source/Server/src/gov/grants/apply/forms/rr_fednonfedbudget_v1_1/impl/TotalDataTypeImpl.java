...
public class TotalDataTypeImpl implements gov.grants.apply.forms.rr_fednonfedbudget_v1_1.TotalDataType, com.sun.xml.bind.JAXBObject, gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallableObject, gov.grants.apply.forms.attachments_v1.impl.runtime.XMLSerializable, gov.grants.apply.forms.attachments_v1.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (gov.grants.apply.forms.rr_fednonfedbudget_v1_1.TotalDataType.class);
    }
    ...
    public gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallingEventHandler createUnmarshaller(gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallingContext context) {
        return new gov.grants.apply.forms.rr_fednonfedbudget_v1_1.impl.TotalDataTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(gov.grants.apply.forms.attachments_v1.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://apply.grants.gov/forms/RR_FedNonFedBudget-V1-1", "Federal");
        ...
        context.endElement();
        context.startElement("http://apply.grants.gov/forms/RR_FedNonFedBudget-V1-1", "NonFederal");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
        ...
        context.endElement();
        context.startElement("http://apply.grants.gov/forms/RR_FedNonFedBudget-V1-1", "TotalFedNonFed");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
...
+"~\u0000Lt\u0000\u0007Federalt\u00005http://apply.grants.gov/forms/RR_FedNonFedBu"
+"dget-V1-1sq\u0000~\u0000\u0007pp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u000fsq\u0000~\u0000Appsq\u0000~\u0000Cq\u0000~\u0000Fpq\u0000~\u0000Gq\u0000~\u0000"
+"Nq\u0000~\u0000Rsq\u0000~\u0000Lt\u0000\nNonFederalq\u0000~\u0000Vsq\u0000~\u0000\u0007pp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\fppsq\u0000~\u0000"
+"\u0010q\u0000~\u0000\u001bt\u0000\u0019BudgetTotalAmountDataTypeq\u0000~\u0000\u001f\u0000\u0001sq\u0000~\u0000 q\u0000~\u0000\u001bq\u0000~\u0000aq\u0000~"
+"\u0000\u001f\u0000\u0000sq\u0000~\u0000\"q\u0000~\u0000\u001bq\u0000~\u0000aq\u0000~\u0000\u001f\u0000\u0000sq\u0000~\u0000%q\u0000~\u0000\u001bq\u0000~\u0000aq\u0000~\u0000\u001f\u0000\u0000q\u0000~\u0000*q\u0000~\u0000*"
+"q\u0000~\u0000-\u0000\u0000\u0000\u000fq\u0000~\u0000*q\u0000~\u0000.\u0000\u0000\u0000\u0002q\u0000~\u0000*q\u0000~\u0000/sq\u0000~\u00000\u0000\u0000\u0000\u0000sq\u0000~\u00004\u00ff\u00ff\u00ff\u00ff\u00ff\u00ff\u00ff\u00ff\u00ff\u00ff\u00ff"
+"\u00fe\u00ff\u00ff\u00ff\u00fe\u0000\u0000\u0000\u0000uq\u0000~\u00007\u0000\u0000\u0000\u0000xxq\u0000~\u0000*q\u0000~\u00009sq\u0000~\u00000\u0000\u0000\u0000\u0002sq\u0000~\u00004\u00ff\u00ff\u00ff\u00ff\u00ff\u00ff\u00ff\u00ff\u00ff\u00ff\u00ff\u00fe\u00ff"
+"\u00ff\u00ff\u00fe\u0000\u0000\u0000\u0001uq\u0000~\u00007\u0000\u0000\u0000\u0007\u0003\u008d~\u00a4\u00c6\u007f\u00ffxxq\u0000~\u0000>sq\u0000~\u0000?q\u0000~\u0000aq\u0000~\u0000\u001bsq\u0000~\u0000Appsq\u0000~\u0000"
+"Cq\u0000~\u0000Fpq\u0000~\u0000Gq\u0000~\u0000Nq\u0000~\u0000Rsq\u0000~\u0000Lt\u0000\u000eTotalFedNonFedq\u0000~\u0000Vsr\u0000\"com.su"
...
+"\u0001pq\u0000~\u0000\u000bq\u0000~\u0000Xq\u0000~\u0000\u0006q\u0000~\u0000\u0005q\u0000~\u0000Bq\u0000~\u0000Yq\u0000~\u0000lq\u0000~\u0000^x"));
        ...
        extends gov.grants.apply.forms.attachments_v1.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return gov.grants.apply.forms.rr_fednonfedbudget_v1_1.impl.TotalDataTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  9 :
                        ...
                        return ;
                    case  3 :
                        if (("NonFederal" == ___local)&&("http://apply.grants.gov/forms/RR_FedNonFedBudget-V1-1" == ___uri)) {
                        ...
                        break;
                    case  6 :
                        if (("TotalFedNonFed" == ___local)&&("http://apply.grants.gov/forms/RR_FedNonFedBudget-V1-1" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 7;
                            return ;
                        }
