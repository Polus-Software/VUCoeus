...
public class KeyPersonCompensationDataTypeVerifier
    extends gov.grants.apply.forms.rr_budget_v1.verification.SectACompensationDataTypeVerifier
{


    public void check(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_budget_v1.KeyPersonCompensationDataType master) {
    ...
    public void checkBaseSalary(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_budget_v1.KeyPersonCompensationDataType master, java.math.BigDecimal value) {
    ...
    public void check(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, java.lang.Object object) {
        check(parentLocator, handler, ((gov.grants.apply.forms.rr_budget_v1.KeyPersonCompensationDataType) object));
    }

    public void check(javax.xml.bind.ValidationEventHandler handler, java.lang.Object object) {
        check(null, handler, ((gov.grants.apply.forms.rr_budget_v1.KeyPersonCompensationDataType) object));
    }
