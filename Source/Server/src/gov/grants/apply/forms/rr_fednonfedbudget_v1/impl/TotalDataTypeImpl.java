...
public class TotalDataTypeImpl implements gov.grants.apply.forms.rr_fednonfedbudget_v1.TotalDataType, com.sun.xml.bind.JAXBObject, gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallableObject, gov.grants.apply.forms.attachments_v1.impl.runtime.XMLSerializable, gov.grants.apply.forms.attachments_v1.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (gov.grants.apply.forms.rr_fednonfedbudget_v1.TotalDataType.class);
    }
    ...
    public gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallingEventHandler createUnmarshaller(gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallingContext context) {
        return new gov.grants.apply.forms.rr_fednonfedbudget_v1.impl.TotalDataTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(gov.grants.apply.forms.attachments_v1.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://apply.grants.gov/forms/RR_FedNonFedBudget-V1.0", "Federal");
        ...
        context.endElement();
        context.startElement("http://apply.grants.gov/forms/RR_FedNonFedBudget-V1.0", "NonFederal");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
        ...
        context.endElement();
        context.startElement("http://apply.grants.gov/forms/RR_FedNonFedBudget-V1.0", "TotalFedNonFed");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
...
+"\u0002\u0000\u0000xq\u0000~\u0000\u0003sq\u0000~\u00000\u0001q\u0000~\u0000=sq\u0000~\u00007t\u0000\u0007Federalt\u00005http://apply.grants."
+"gov/forms/RR_FedNonFedBudget-V1.0sq\u0000~\u0000\u0007pp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u000fsq\u0000~\u0000"
+",ppsq\u0000~\u0000.q\u0000~\u00001pq\u0000~\u00002q\u0000~\u00009q\u0000~\u0000=sq\u0000~\u00007t\u0000\nNonFederalq\u0000~\u0000Asq\u0000~\u0000\u0007"
+"pp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\fppsq\u0000~\u0000\u0010q\u0000~\u0000\u0019t\u0000\u0019BudgetTotalAmountDataTypeq\u0000"
+"~\u0000\u001d\u0000\u0000sq\u0000~\u0000\u001eq\u0000~\u0000\u0019q\u0000~\u0000Lq\u0000~\u0000\u001d\u0000\u0000q\u0000~\u0000#q\u0000~\u0000#q\u0000~\u0000&\u0000\u0000\u0000\u000fq\u0000~\u0000#q\u0000~\u0000\'\u0000\u0000\u0000"
+"\u0002q\u0000~\u0000)sq\u0000~\u0000*q\u0000~\u0000Lq\u0000~\u0000\u0019sq\u0000~\u0000,ppsq\u0000~\u0000.q\u0000~\u00001pq\u0000~\u00002q\u0000~\u00009q\u0000~\u0000=sq\u0000"
+"~\u00007t\u0000\u000eTotalFedNonFedq\u0000~\u0000Asr\u0000\"com.sun.msv.grammar.ExpressionP"
...
+"n/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\b\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\u0006q\u0000~\u0000Iq\u0000~\u0000-q\u0000~"
+"\u0000Dq\u0000~\u0000Oq\u0000~\u0000\u000bq\u0000~\u0000Cx"));
        }
        ...
        extends gov.grants.apply.forms.attachments_v1.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return gov.grants.apply.forms.rr_fednonfedbudget_v1.impl.TotalDataTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  9 :
                        ...
                        return ;
                    case  3 :
                        if (("NonFederal" == ___local)&&("http://apply.grants.gov/forms/RR_FedNonFedBudget-V1.0" == ___uri)) {
                        ...
                        break;
                    case  6 :
                        if (("TotalFedNonFed" == ___local)&&("http://apply.grants.gov/forms/RR_FedNonFedBudget-V1.0" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 7;
                            return ;
                        }
