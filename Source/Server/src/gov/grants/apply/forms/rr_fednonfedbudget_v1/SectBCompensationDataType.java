 ...
 * <p>The following schema fragment specifies the expected content contained within this java content object. (defined at http://apply.grants.gov/forms/schemas/RR_FedNonFedBudget-V1.0.xsd line 139)
 * <p>
 * <pre>
 ...
 *       &lt;sequence>
 *         &lt;element name="CalendarMonths" type="{http://apply.grants.gov/forms/RR_FedNonFedBudget-V1.0}Month3whole2fracDataType" minOccurs="0"/>
 *         &lt;element name="AcademicMonths" type="{http://apply.grants.gov/forms/RR_FedNonFedBudget-V1.0}Month3whole2fracDataType" minOccurs="0"/>
 *         &lt;element name="SummerMonths" type="{http://apply.grants.gov/forms/RR_FedNonFedBudget-V1.0}Month3whole2fracDataType" minOccurs="0"/>
 ...
 *         &lt;element name="OtherTotal" type="{http://apply.grants.gov/forms/RR_FedNonFedBudget-V1.0}TotalDataType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public interface SectBCompensationDataType {
     ...
     */
    gov.grants.apply.forms.rr_fednonfedbudget_v1.TotalDataType getOtherTotal();
     ...
     *     {@link gov.grants.apply.forms.rr_fednonfedbudget_v1.TotalDataType}
     */
    void setOtherTotal(gov.grants.apply.forms.rr_fednonfedbudget_v1.TotalDataType value);
