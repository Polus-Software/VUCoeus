 ...
 * generated in the gov.grants.apply.forms.planned_report_v1_0 package. 
    ...
    extends gov.grants.apply.forms.attachments_v1.impl.runtime.DefaultJAXBContextImpl
{
    ...
    public final static gov.grants.apply.forms.attachments_v1.impl.runtime.GrammarInfo grammarInfo = new gov.grants.apply.forms.attachments_v1.impl.runtime.GrammarInfoImpl(rootTagMap, defaultImplementations, (gov.grants.apply.forms.planned_report_v1_0.ObjectFactory.class));
    ...
    static {
        ...
        defaultImplementations.put((gov.grants.apply.forms.planned_report_v1_0.PlannedReportType.StudyType.class), "gov.grants.apply.forms.planned_report_v1_0.impl.PlannedReportTypeImpl.StudyTypeImpl");
        ...
        defaultImplementations.put((gov.grants.apply.forms.planned_report_v1_0.PlannedReportRacialCategoryDataType.class), "gov.grants.apply.forms.planned_report_v1_0.impl.PlannedReportRacialCategoryDataTypeImpl");
        defaultImplementations.put((gov.grants.apply.forms.planned_report_v1_0.PlannedReportEthnicCategoryDataType.class), "gov.grants.apply.forms.planned_report_v1_0.impl.PlannedReportEthnicCategoryDataTypeImpl");
        defaultImplementations.put((gov.grants.apply.forms.planned_report_v1_0.PlannedReportType.class), "gov.grants.apply.forms.planned_report_v1_0.impl.PlannedReportTypeImpl");
        ...
        defaultImplementations.put((gov.grants.apply.forms.planned_report_v1_0.PlannedReport.class), "gov.grants.apply.forms.planned_report_v1_0.impl.PlannedReportImpl");
        defaultImplementations.put((gov.grants.apply.forms.planned_report_v1_0.PlannedReportTotalsDataType.class), "gov.grants.apply.forms.planned_report_v1_0.impl.PlannedReportTotalsDataTypeImpl");
        rootTagMap.put(new javax.xml.namespace.QName("http://apply.grants.gov/forms/PlannedReport-V1.0", "PlannedReport"), (gov.grants.apply.forms.planned_report_v1_0.PlannedReport.class));
    }

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: gov.grants.apply.forms.planned_report_v1_0
     * 
     */
    ...
    /**
     * Create an instance of PlannedReportTypeStudyType
     * 
     * @throws JAXBException
     *     if an error occurs
     */
    public gov.grants.apply.forms.planned_report_v1_0.PlannedReportType.StudyType createPlannedReportTypeStudyType()
        throws javax.xml.bind.JAXBException
    {
        return new gov.grants.apply.forms.planned_report_v1_0.impl.PlannedReportTypeImpl.StudyTypeImpl();
    }
    ...
    /**
     * Create an instance of PlannedReportRacialCategoryDataType
     * 
     * @throws JAXBException
     *     if an error occurs
     */
    public gov.grants.apply.forms.planned_report_v1_0.PlannedReportRacialCategoryDataType createPlannedReportRacialCategoryDataType()
        throws javax.xml.bind.JAXBException
    {
        return new gov.grants.apply.forms.planned_report_v1_0.impl.PlannedReportRacialCategoryDataTypeImpl();
    }

    /**
     * Create an instance of PlannedReportEthnicCategoryDataType
     * 
     * @throws JAXBException
     *     if an error occurs
     */
    public gov.grants.apply.forms.planned_report_v1_0.PlannedReportEthnicCategoryDataType createPlannedReportEthnicCategoryDataType()
        throws javax.xml.bind.JAXBException
    {
        return new gov.grants.apply.forms.planned_report_v1_0.impl.PlannedReportEthnicCategoryDataTypeImpl();
    }

    /**
     * Create an instance of PlannedReportType
     * 
     * @throws JAXBException
     *     if an error occurs
     */
    public gov.grants.apply.forms.planned_report_v1_0.PlannedReportType createPlannedReportType()
        throws javax.xml.bind.JAXBException
    {
        return new gov.grants.apply.forms.planned_report_v1_0.impl.PlannedReportTypeImpl();
    }
    ...
    /**
     * Create an instance of PlannedReport
     * 
     * @throws JAXBException
     *     if an error occurs
     */
    public gov.grants.apply.forms.planned_report_v1_0.PlannedReport createPlannedReport()
        throws javax.xml.bind.JAXBException
    {
        return new gov.grants.apply.forms.planned_report_v1_0.impl.PlannedReportImpl();
    }

    /**
     * Create an instance of PlannedReportTotalsDataType
     * 
     * @throws JAXBException
     *     if an error occurs
     */
    public gov.grants.apply.forms.planned_report_v1_0.PlannedReportTotalsDataType createPlannedReportTotalsDataType()
        throws javax.xml.bind.JAXBException
    {
        return new gov.grants.apply.forms.planned_report_v1_0.impl.PlannedReportTotalsDataTypeImpl();
    }
