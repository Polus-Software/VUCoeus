...
public class RRPersonalData12TypeVerifier implements de.fzi.dbs.verification.ObjectVerifier
{


    public void check(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_personaldata_1_2_v1_2.RRPersonalData12Type master) {
    ...
    public void checkProjectDirector(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_personaldata_1_2_v1_2.RRPersonalData12Type master, gov.grants.apply.forms.rr_personaldata_1_2_v1_2.DirectorType value) {
        if (value instanceof gov.grants.apply.forms.rr_personaldata_1_2_v1_2.DirectorType) {
            gov.grants.apply.forms.rr_personaldata_1_2_v1_2.DirectorType realValue = ((gov.grants.apply.forms.rr_personaldata_1_2_v1_2.DirectorType) value);
            {
                // Check complex value
                gov.grants.apply.forms.rr_personaldata_1_2_v1_2.verification.DirectorTypeVerifier verifier = new gov.grants.apply.forms.rr_personaldata_1_2_v1_2.verification.DirectorTypeVerifier();
    ...
    public void checkFormVersion(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_personaldata_1_2_v1_2.RRPersonalData12Type master, java.lang.String value) {
    ...
    public void checkCoProjectDirector(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_personaldata_1_2_v1_2.RRPersonalData12Type master, java.util.List values) {
    ...
    public void checkCoProjectDirector(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_personaldata_1_2_v1_2.RRPersonalData12Type master, int index, java.lang.Object value) {
        if (value instanceof gov.grants.apply.forms.rr_personaldata_1_2_v1_2.DirectorType) {
            gov.grants.apply.forms.rr_personaldata_1_2_v1_2.DirectorType realValue = ((gov.grants.apply.forms.rr_personaldata_1_2_v1_2.DirectorType) value);
            {
                // Check complex value
    ...
    public void check(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, java.lang.Object object) {
        check(parentLocator, handler, ((gov.grants.apply.forms.rr_personaldata_1_2_v1_2.RRPersonalData12Type) object));
    }

    public void check(javax.xml.bind.ValidationEventHandler handler, java.lang.Object object) {
        check(null, handler, ((gov.grants.apply.forms.rr_personaldata_1_2_v1_2.RRPersonalData12Type) object));
    }
