...
public class KeyPersonDataTypeVerifier implements de.fzi.dbs.verification.ObjectVerifier
{
    ...
    public void check(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_budget_v1_1.KeyPersonDataType master) {
    ...
    public void checkCompensation(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_budget_v1_1.KeyPersonDataType master, gov.grants.apply.forms.rr_budget_v1_1.KeyPersonCompensationDataType value) {
        if (value instanceof gov.grants.apply.forms.rr_budget_v1_1.KeyPersonCompensationDataType) {
            gov.grants.apply.forms.rr_budget_v1_1.KeyPersonCompensationDataType realValue = ((gov.grants.apply.forms.rr_budget_v1_1.KeyPersonCompensationDataType) value);
            {
                // Check complex value
                gov.grants.apply.forms.rr_budget_v1_1.verification.KeyPersonCompensationDataTypeVerifier verifier = new gov.grants.apply.forms.rr_budget_v1_1.verification.KeyPersonCompensationDataTypeVerifier();
    ...
    public void checkProjectRole(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_budget_v1_1.KeyPersonDataType master, java.lang.String value) {
    ...
    public void checkName(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, gov.grants.apply.forms.rr_budget_v1_1.KeyPersonDataType master, gov.grants.apply.system.globallibrary_v2.HumanNameDataType value) {
    ...
    public void check(de.fzi.dbs.verification.event.AbstractVerificationEventLocator parentLocator, javax.xml.bind.ValidationEventHandler handler, java.lang.Object object) {
        check(parentLocator, handler, ((gov.grants.apply.forms.rr_budget_v1_1.KeyPersonDataType) object));
    }

    public void check(javax.xml.bind.ValidationEventHandler handler, java.lang.Object object) {
        check(null, handler, ((gov.grants.apply.forms.rr_budget_v1_1.KeyPersonDataType) object));
    }
