    ...
    implements gov.grants.apply.forms.project_v1.ProjectNarrativeAttachments, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallableObject, gov.grants.apply.forms.attachments_v1.impl.runtime.XMLSerializable, gov.grants.apply.forms.attachments_v1.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (gov.grants.apply.forms.project_v1.ProjectNarrativeAttachments.class);
    }

    public java.lang.String ____jaxb_ri____getNamespaceURI() {
        return "http://apply.grants.gov/forms/Project-V1.0";
    }
    ...
    public gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallingEventHandler createUnmarshaller(gov.grants.apply.forms.attachments_v1.impl.runtime.UnmarshallingContext context) {
        return new gov.grants.apply.forms.project_v1.impl.ProjectNarrativeAttachmentsImpl.Unmarshaller(context);
    }

    public void serializeBody(gov.grants.apply.forms.attachments_v1.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://apply.grants.gov/forms/Project-V1.0", "ProjectNarrativeAttachments");
...
+"tst\u0000*http://apply.grants.gov/forms/Project-V1.0sq\u0000~\u0000\u0015ppsr\u0000\u001cc"
...
+"rants.gov/system/GlobalLibrary-V1.0t\u0000\u0013FormVersionDataTypesr\u0000"
...
+"\u00007q\u0000~\u0000Jq\u0000~\u0000It\u0000\u00031.0sq\u0000~\u0000\u001ft\u0000\u000bFormVersionq\u0000~\u0000>sq\u0000~\u0000\u000eppsq\u0000~\u0000\u0015q\u0000~"
...
+"ol;xp\u0000\u0000\u0000\u0007\u0001pq\u0000~\u0000\tq\u0000~\u0000\nq\u0000~\u0000$q\u0000~\u0000Xq\u0000~\u0000\fq\u0000~\u0000\u000fq\u0000~\u0000\u0012x"));
        ...
        extends gov.grants.apply.forms.attachments_v1.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return gov.grants.apply.forms.project_v1.impl.ProjectNarrativeAttachmentsImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("ProjectNarrativeAttachments" == ___local)&&("http://apply.grants.gov/forms/Project-V1.0" == ___uri)) {
                ...
                switch (state) {
                    case  1 :
                        if (("FormVersion" == ___local)&&("http://apply.grants.gov/forms/Project-V1.0" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((gov.grants.apply.forms.project_v1.impl.ProjectNarrativeAttachmentsTypeImpl)gov.grants.apply.forms.project_v1.impl.ProjectNarrativeAttachmentsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
                        break;
                    case  3 :
