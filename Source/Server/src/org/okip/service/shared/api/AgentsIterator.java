...
/*
 * $Source: /cvs/oki/tech/src/org/okip/service/shared/api/AgentsIterator.java,v $
 */
...
*/
public interface AgentsIterator
extends java.io.Serializable {

  /**
   * Returns true if the iteration has more Agents.
   *
   * @return true if there are more Agents
   *
   *
   ...
   *
   */
  org.okip.service.shared.api.Agent next()
  throws org.okip.service.shared.api.Exception;
}
