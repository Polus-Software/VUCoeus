...
/*
 * $Source: /cvs/oki/tech/src/org/okip/service/authorization/api/Qualifier.java,v $
 */

/**
 * Qualifier is the context for an Authorization consisting of a description and a QualifierType.
 * <p>
...
extends java.io.Serializable {
  ...
  /**
   * Adds a parent to this qualifier
   ...
   *
   */
  void addParent(Qualifier parent)
  throws AuthorizationException;
   ...
   * in the Authorizations DB.
   *
   * If this is the last parent the delete will fail
   * and an AuthorizationException will be thrown.
   * For a non-Root Qualifier there must always be a
   * parent.
   *
   * @throws AuthorizationException
   *
   */
  void removeParent(Qualifier parent)
  throws AuthorizationException;

  /**
   * Changes the parent of this Qualifier by adding
   * a new parent and removing the old parent.
   *
   *
   * @param oldParent
   * @param newParent
   ...
   *
   */
  void changeParent(Qualifier oldParent, Qualifier newParent)
  throws AuthorizationException;

  /*
   * Method isChildOf
   *
   * Determines if this Qualifier is the child a
   * given parent
   *
   * @param Qualifier
   *
   ...
   *
   */
  boolean isChildOf( Qualifier parent )
  throws AuthorizationException ;
    ...
    *
    */
  QualifiersIterator getChildren()
  throws AuthorizationException ;
