...
/*
 * $Source: /cvs/oki/tech/src/org/okip/service/authorization/api/Agent.java,v $
 */

/**
 * Person represents who is granted an Authorization to do a Function in a Qualifier context.
 * <p>
 * Licensed under the {@link org.okip.service.ApiLicense MIT OKI&#153; API Definition License}.
 * <p>
 * @see Factory
 * @version $Name:  $ / $Revision:   1.0  $ / $Date:   Jan 14 2003 15:29:00  $
 */
public abstract class Agent
extends org.okip.service.shared.api.Agent {

  /**
   * Method getKey
   *
   * Returns the key with which an agent can be found in the Authorizations DB.
   *
   ...
   *
   * Determines if this Agent has a matching Person in the Authorizations DB.
   *
   * @return boolean
   *
   * @throws AuthorizationException
   *
   */
  public abstract boolean isFoundInAuthorization()
  throws AuthorizationException;
