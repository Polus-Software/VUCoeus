...
/*
 * $Source: /cvs/oki/tech/src/org/okip/service/authorization/api/AuthorizationsIterator.java,v $
 */
 ...
 */
public interface AuthorizationsIterator
extends java.io.Serializable {
   ...
   *
   * Depending on the technique used to get Authorizations
   * some Authorizations may be explicitly stored in
   * the Authorization DB and others may be implied.
   * The default behavior of this API is to show
   * all authorizations explicit or implied. Use this method
   * to hide implied authorizations
   *
   * @throws AuthorizationException
   *
   */
  void hideImpliedAuthorizations()
  throws AuthorizationException;
   ...
   * The default behavior of this API is to show
   * all authorizations explicit or implied. Use this method
   * to explicitly show implied authorizations
   *
   * @throws AuthorizationException
   *
   */
  void showImpliedAuthorizations()
  throws AuthorizationException;
}
