 ...
 * @author Lijo Joy
 */
public class CoiPersonProjectDetailsForm extends ActionForm {
    ...
    private Integer coiDiscDetails;
    ...
    private String coiProjectStartDate;
    private String coiProjectEndDate;
    private double coiProjectFundingAmount;
    private String coiProjectRole;
    private String awardTitle;
    private String mitAwardNo;
    ...
    /**
     * @return the coiDiscDetails
     */
    public Integer getCoiDiscDetails() {
        return coiDiscDetails;
    }

    /**
     * @param coiDiscDetails the coiDiscDetails to set
     */
    public void setCoiDiscDetails(Integer coiDiscDetails) {
    ...
    /**
     * @param coiStatusCode the coiStatusCode to set
     */
    ...
    /**
     * @param coiProjectSponser the coiProjectSponser to set
     */
     ...
     */
    public String getCoiProjectStartDate() {
     ...
     */
    public void setCoiProjectStartDate(String coiProjectStartDate) {
     ...
     */
    public String getCoiProjectEndDate() {
     ...
     */
    public void setCoiProjectEndDate(String coiProjectEndDate) {
    ...
    /**
     * @return the mitAwardNo
     */
    public String getMitAwardNo() {
        return mitAwardNo;
    }

    /**
     * @param mitAwardNo the mitAwardNo to set
     */
    public void setMitAwardNo(String mitAwardNo) {
        this.mitAwardNo = mitAwardNo;
    }
