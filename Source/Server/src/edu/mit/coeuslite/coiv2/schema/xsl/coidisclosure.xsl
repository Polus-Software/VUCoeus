...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:altova="http://www.altova.com" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="clitype fn iso4217 ix java link xbrldi xbrli xlink xs xsi altova">
	...
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-171453312-even" margin-left="0.60in" margin-right="0.60in" page-height="11in" page-width="8.50in">
				<fo:region-body margin-top="1.80in" margin-bottom="0.79in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header" overflow="hidden" extent="1.50in"/>
				<fo:region-after region-name="even-page-footer" overflow="hidden" extent="0.49in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-171453312-odd" margin-left="0.60in" margin-right="0.60in" page-height="11in" page-width="8.50in">
				<fo:region-body margin-top="1.80in" margin-bottom="0.79in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="odd-page-header" overflow="hidden" extent="1.50in"/>
			...
			<fo:page-sequence-master master-name="page-master-171453312">
				<fo:repeatable-page-master-alternatives>
					<fo:conditional-page-master-reference master-reference="page-master-171453312-even" odd-or-even="even"/>
					<fo:conditional-page-master-reference master-reference="page-master-171453312-odd" odd-or-even="odd"/>
				</fo:repeatable-page-master-alternatives>
	...
	<xsl:template match="/">
		<fo:root>
			...
			<fo:page-sequence force-page-count="no-force" master-reference="page-master-171453312" initial-page-number="auto" format="1">
							...
							<xsl:for-each select="$XML">
								<xsl:for-each select="coiDisclosure">
									...
									<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
										...
										<fo:table-column column-width="proportional-column-width(1)"/>
										<xsl:variable name="altova:CurrContextGrid_0A2561A0" select="."/>
													...
													<fo:table-cell padding="2pt" display-align="center">
														<fo:block text-align="left">
															<xsl:for-each select="disclosureNumber">
																...
																<xsl:choose>
																	<xsl:when test="contains(string($value-of-template_07A01798),'&#x200B;')">
																		<fo:block>
													...
													<fo:table-cell padding="2pt" display-align="center">
														<fo:block text-align="left">
															<xsl:for-each select="sequenceNumber">
																...
																<xsl:choose>
																	<xsl:when test="contains(string($value-of-template_07A01878),'&#x200B;')">
																		<fo:block>
														...
														<fo:block text-align="left">
															<xsl:for-each select="person">
																<xsl:for-each select="fullName">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_07A01958),'&#x200B;')">
																			<fo:block>
													...
													<fo:table-cell padding="2pt" display-align="center">
														<fo:block text-align="left">
															<xsl:for-each select="expirationDate">
																...
																<xsl:choose>
																	<xsl:when test="contains(string($value-of-template_07A01A38),'&#x200B;')">
																		<fo:block>
					...
					<fo:block-container height="0.490000in" overflow="hidden" display-align="after">
						<fo:block>
							...
							<fo:table width="100%" table-layout="fixed" border-spacing="2pt">
								...
								<xsl:variable name="altova:CurrContextGrid_0A256980" select="."/>
								<fo:table-body start-indent="0pt">
									<xsl:variable name="altova:tablerows">
										<fo:table-row>
						...
						<xsl:for-each select="$XML">
							...
							<xsl:for-each select="coiDisclosure">
								...
								<fo:table table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="-1pt">
									...
									<xsl:variable name="altova:CurrContextGrid_0A3892F0" select="."/>
									<fo:table-body start-indent="0pt">
										<xsl:variable name="altova:tablerows">
											<fo:table-row>
													...
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
														<fo:block text-align="left">
															<xsl:for-each select="fullName">
																...
																<xsl:choose>
																	<xsl:when test="contains(string($value-of-template_07A01B18),'&#x200B;')">
																		<fo:block>
													...
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
														<fo:block text-align="left">
															<xsl:for-each select="address1">
																...
																<xsl:choose>
																	<xsl:when test="contains(string($value-of-template_07A01BF8),'&#x200B;')">
																		<fo:block>
													...
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
														<fo:block text-align="left">
															<xsl:for-each select="dirDept">
																...
																<xsl:choose>
																	<xsl:when test="contains(string($value-of-template_07A01CD8),'&#x200B;')">
																		<fo:block>
													...
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
														<fo:block text-align="left">
															<xsl:for-each select="school">
																...
																<xsl:choose>
																	<xsl:when test="contains(string($value-of-template_07A01DB8),'&#x200B;')">
																		<fo:block>
													...
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
														<fo:block text-align="left">
															<xsl:for-each select="offPhone">
																...
																<xsl:choose>
																	<xsl:when test="contains(string($value-of-template_07A01E98),'&#x200B;')">
																		<fo:block>
													...
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
														<fo:block text-align="left">
															<xsl:for-each select="email">
																...
																<xsl:choose>
																	<xsl:when test="contains(string($value-of-template_07A01F78),'&#x200B;')">
																		<fo:block>
								...
								<xsl:if test="certificationQuestion">
									<fo:table table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="-1pt">
										...
										<xsl:variable name="altova:CurrContextGrid_0A389B30" select="."/>
														...
														<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
															<fo:block text-align="left">
																<xsl:for-each select="questionID">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_07A02058),'&#x200B;')">
																			<fo:block>
														...
														<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
															<fo:block text-align="left">
																<xsl:for-each select="question">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_07A02138),'&#x200B;')">
																			<fo:block>
														...
														<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
															<fo:block text-align="left">
																<xsl:for-each select="answer">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_07A02218),'&#x200B;')">
																			<fo:block>
										...
										<fo:leader leader-pattern="space"/>
                                                                ...
                                                                <xsl:if test="moduleCode = '8'">
                                                                    <fo:inline font-weight="bold">
									<xsl:text>Travel Details</xsl:text>
								</fo:inline>
									...
									<fo:table table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="-1pt">
										<fo:table-column column-width="2.090in"/>
										<fo:table-column column-width="5.360in"/>
										<xsl:variable name="altova:CurrContextGrid_0AAC0EC8" select="."/>
										<fo:table-body start-indent="0pt">
											<xsl:variable name="altova:tablerows">
												<fo:table-row>
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
													...
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
														<fo:block text-align="left">
															<xsl:for-each select="eventName">
																<xsl:variable name="value-of-template_0A399530">
																	<xsl:apply-templates/>
																</xsl:variable>
																<xsl:choose>
																	<xsl:when test="contains(string($value-of-template_0A399530),'&#x200B;')">
																		<fo:block>
													...
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
														<fo:block text-align="left">
															<xsl:for-each select="destination">
																...
																<xsl:choose>
																	<xsl:when test="contains(string($value-of-template_0A399610),'&#x200B;')">
																		<fo:block>
												...
												<fo:table-row>
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
														<fo:block text-align="left">
															<fo:inline>
																<xsl:text>Purpose of Travel</xsl:text>
															</fo:inline>
														</fo:block>
													</fo:table-cell>
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
												...
												<fo:table-row>
													...
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
														<fo:block text-align="left">
															<xsl:for-each select="projectFundingAmount">
																<xsl:variable name="value-of-template_0A399610">
																	<xsl:apply-templates/>
																</xsl:variable>
																<xsl:choose>
												...
												<fo:table-row>
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
														<fo:block text-align="left">
															<fo:inline>
																<xsl:text>Travel Sponser</xsl:text>
															</fo:inline>
														</fo:block>
													</fo:table-cell>
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
														<fo:block text-align="left">
															<xsl:for-each select="coiProjectSponsor">
																<xsl:variable name="value-of-template_0A399610">
																	<xsl:apply-templates/>
																</xsl:variable>
																<xsl:choose>
												...
												<fo:table-row>
													...
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
														<fo:block text-align="left">
															<xsl:for-each select="sDate">
																<xsl:variable name="value-of-template_0A3996F0">
																	<xsl:apply-templates/>
																</xsl:variable>
																<xsl:choose>
																	<xsl:when test="contains(string($value-of-template_0A3996F0),'&#x200B;')">
																		<fo:block>
												...
												<fo:table-row>
													...
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
														<fo:block text-align="left">
															<xsl:for-each select="eDate">
																<xsl:variable name="value-of-template_0A3997D0">
																	<xsl:apply-templates/>
																</xsl:variable>
																<xsl:choose>
																	<xsl:when test="contains(string($value-of-template_0A3997D0),'&#x200B;')">
																		<fo:block>
								...
								<xsl:for-each select="disclosureProjects">
									...
									<xsl:if test="coiDisclosureDetails">
										<fo:table table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="-1pt">
											<fo:table-column column-width="2.090in"/>
											<fo:table-column column-width="5.360in"/>
											<xsl:variable name="altova:CurrContextGrid_0A3AD090" select="."/>
											<fo:table-header start-indent="0pt">
												<fo:table-row>
													<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
														<fo:block text-align="left">
															...
															<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
																<fo:block text-align="left">
																	<xsl:for-each select="EntityName">
																		...
																		<xsl:choose>
																			<xsl:when test="contains(string($value-of-template_0A3998B0),'&#x200B;')">
																				<fo:block>
															...
															<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
																<fo:block text-align="left">
																	<xsl:for-each select="ConflictStatus">
																		...
																		<xsl:choose>
																			<xsl:when test="contains(string($value-of-template_0A399990),'&#x200B;')">
																				<fo:block>
								...
								<xsl:if test="disclosureNotes">
									<fo:table table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="-1pt">
										...
										<xsl:variable name="altova:CurrContextGrid_0A390C50" select="."/>
										<fo:table-header start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
													<fo:block text-align="left">
														...
														<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
															<fo:block text-align="left">
																<xsl:for-each select="comments">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_07A02838),'&#x200B;')">
																			<fo:block>
														...
														<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
															<fo:block text-align="left">
																<xsl:for-each select="title">
																	<xsl:variable name="value-of-template_07A02918">
																		<xsl:apply-templates/>
																	</xsl:variable>
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_07A02918),'&#x200B;')">
																			<fo:block>
																				<xsl:copy-of select="$value-of-template_07A02918"/>
																			</fo:block>
																		</xsl:when>
																		<xsl:otherwise>
																			<fo:inline>
														...
														<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
															<fo:block text-align="left">
																<xsl:for-each select="noteEntry">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_07A029F8),'&#x200B;')">
																			<fo:block>
														...
														<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
															<fo:block text-align="left">
																<xsl:for-each select="updateTimestamp">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_07A02AD8),'&#x200B;')">
																			<fo:block>
														...
														<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
															<fo:block text-align="left">
																<xsl:for-each select="updateUser">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_07A02BB8),'&#x200B;')">
																			<fo:block>
								...
								<xsl:if test="disclosureDocuments">
									<fo:table table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="-1pt">
										...
										<fo:table-column column-width="proportional-column-width(1)"/>
										<fo:table-column column-width="1in"/>
										<xsl:variable name="altova:CurrContextGrid_0A3974D0" select="."/>
										<fo:table-header start-indent="0pt">
											<fo:table-row>
												<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
													<fo:block text-align="left">
														...
														<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
															<fo:block text-align="left">
																<xsl:for-each select="documentType">
																	<xsl:variable name="value-of-template_07A02C98">
																		<xsl:apply-templates/>
																	</xsl:variable>
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_07A02C98),'&#x200B;')">
																			<fo:block>
																				<xsl:copy-of select="$value-of-template_07A02C98"/>
																			</fo:block>
																		</xsl:when>
																		<xsl:otherwise>
																			<fo:inline>
														...
														<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
															<fo:block text-align="left">
																<xsl:for-each select="description">
																	<xsl:variable name="value-of-template_07A02D78">
																		<xsl:apply-templates/>
																	</xsl:variable>
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_07A02D78),'&#x200B;')">
																			<fo:block>
																				<xsl:copy-of select="$value-of-template_07A02D78"/>
																			</fo:block>
																		</xsl:when>
																		<xsl:otherwise>
																			<fo:inline>
														...
														<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
															<fo:block text-align="left">
																<xsl:for-each select="UPDATE_TIMESTAMP">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_07A02E58),'&#x200B;')">
																			<fo:block>
														...
														<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
															<fo:block text-align="left">
																<xsl:for-each select="UPDATE_USER">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-of-template_07A02F38),'&#x200B;')">
																			<fo:block>
								...
								<fo:table table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="-1pt">
									<fo:table-column column-width="2.090in"/>
									<fo:table-column column-width="5.360in"/>
									<xsl:variable name="altova:CurrContextGrid_0A397B90" select="."/>
									<fo:table-body start-indent="0pt">
										<xsl:variable name="altova:tablerows">
											<fo:table-row>
												<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
												...
												<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="certifiedBy">
															...
															<xsl:choose>
																<xsl:when test="contains(string($value-of-template_07A03018),'&#x200B;')">
																	<fo:block>
												...
												<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="certificationText">
															...
															<xsl:choose>
																<xsl:when test="contains(string($value-of-template_0A399290),'&#x200B;')">
																	<fo:block>
												...
												<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
													<fo:block text-align="left">
														<xsl:for-each select="certificationTimestamp">
															...
															<xsl:choose>
																<xsl:when test="contains(string($value-of-template_0A399370),'&#x200B;')">
																	<fo:block>
