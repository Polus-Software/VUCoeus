...
//    private WebTxnBean webTxnBean ;
    ...
    private static final String GET_REFERENCE_ACTION = "/getReferenceAction";
    ...
    HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        mapMenuList.put("menuCode",CoeusliteMenuItems.PROTOCOL_REFERENCE_MENU); 
    ...
    private void addUpdateProtocolReference(DynaValidatorForm protoReferenceForm, HttpServletRequest request) throws Exception{        
        ...
        //date validation for Application and Approval Date - end
        ...
        webTxnBean.getResults(request,"updateProtoReference",protoReferenceForm);
        if(acType.equals(INSERT)){
            boolean isAllDeleted = false;
            updateIndicators(isAllDeleted, request);            
        }
    ...
    private int getReferenceNumber(String protocolNumber, String sequenceNumber, HttpServletRequest request) throws Exception{
        ...
        Hashtable  htReferenceNumber = (Hashtable)webTxnBean.getResults(request, "protocolReferenceNumber", hmReferenceNumber);
        HashMap hmTemp = (HashMap)htReferenceNumber.get("protocolReferenceNumber");
