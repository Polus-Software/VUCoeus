...
//    private ActionMessages actionMessages ;
    private static final String GET_PROTOCOL_SUBMISSION_DATA="/getSubmitForReview";
    private static final String GET_SCHEDULES_DETAILS = "/getScheduleDetails";
    private static final String GET_REVIEWER_DETAILS ="/getReviewerDetails";
    private static final String GET_COMMITTEE_DETAILS = "/getCommitteeDetails";
    private static final String GET_ALL_COMM_LIST = "/getAllCommitteeList";
    private static final String GET_CHECK_LIST = "/getCheckList";
    private static final String SAVE_PROTOCOL_SUBMISSION = "/protocolSubmission";
    // Added for case# 3063 Notice Page to the PI that a Protocol Submission to the IRB is successful
    private static final String GET_SUBMISSION_CONFIRMATION = "/getSubmissionConfirmation";
    private static final String SUCCESS = "success";
    private static final String EMPTY_STRING ="";
    private static final String PROTOCOL_NUMBER = "protocolNumber";
    private static final String SEQUENCE_NUMBER ="sequenceNumber";
    private static final String IRB_COMM_SEL_DURING_SUBMM="IRB_COMM_SELECTION_DURING_SUBMISSION";
    private static final String GET_PROTOCOL_SUBMISSION_MODE = "getProtocolSubmissionMode";
    private static final String PARAMETER_NAME = "parameterName";
    private static final String GET_PARAMETER_VALUE = "getParameterValue";
    private static final String GET_SUBMIT_FOR_REVIEW_DETAILS = "getSubmitForReviewDetails";
    private static final String GET_SUBMISSION_TYPES = "getSubmissionTypes";
    private static final String GET_SUBMISSION_TYPE_QUALIFIERS = "getSubmissionTypeQualifiers";
    private static final String GET_PROTOCOL_REVIEW_TYPES = "getProtocolReviewTypes";
    ...
    private static final String GET_PROTO_SUBMISSION_COMMITTEE = "getProtoSubmissionCommittee";
    private static final String GET_MATCHING_COMM_FOR_PROTO = "getMatchingCommForProto";
    private static final String GET_VALID_PROTO_SUB_REVIEW_TYPES = "getValidProtoSubReviewTypes";
    private static final String GET_PROTOCOL_REVIEWER_LIST = "getProtocolReviewerList";
    private static final String SUBMIT_FOR_REVIEW_FORM = "submitForReviewForm";
    ...
    private static final String GET_COMM_COMMITTEE_REVIEWERS = "getCommCommitteeReviewers";
    ...
    private static final String GET_COMMITTEE_REVIEWERS = "getCommitteeReviewers";
    private static final String GET_PROTO_SUBMISSION_COUNT = "getProtoSubmissionCount";
    private static final String MAX_PROTOCOLS_EXCEEDED = "MaxProtocolsExceeded";
    private static final String GET_COMMITTEE_LIST = "getCommitteeList";
    ...
    private static final String GET_SUBMISSION_DETAILS = "getSubmissionDetails";
    private static final String GET_PROTOCOL_INFO = "getProtocolInformation";
    ...
    private static final String CHECK_IS_PROTOCOL_COMPLETE = "checkIsProtocolComplete";
    ...
    private static final String UPD_PROTOCOL = "updProtocol";
    private static final String UPD_PROTOCOL_SUBMISSION = "updProtocolSubmission";
    private static final String UPD_PROTOCOL_REVIEWER = "updProtocolReviewer";
    private static final String UPD_PROTOCOL_EXPIDITED_CHKLST  = "updProtocolExpiditedCheckList";
    private static final String UPD_PROTOCOL_EXEMPT_CHKLST = "updProtocolExemptCheckList";
    private static final String SAVE_SUBMISSION_DETAILS = "saveSubmissionDetails";
    ...
    private static final String GET_PROTO_AM_MODULES = "getProtoAmendRenewModules";
    //Added for protocol custom elements validation - end - 1
    
    
    //Added for Case#3053 - Submission Details Type Qualifier Filter - Start
    private static final String GET_VALID_PROTO_SUB_TYPE_QUALS= "getValidProtoSubTypeQuals";
    ...
    private static final String MANDATORY_QUESTIONNAIRE_FILE_NAME = "IRBMessages";
    ...
    private final String PROTOCOL_MAP           = "PROTOCOL_RULES_MAP";
    private final String VALIDATE_CHECK_FORM = "protocolValidationCheck";
    ...
    private static final String ROUTING_IN_PROGRESS_STATUS = "107";
...
//        userInfoBean = (UserInfoBean)session.getAttribute(USER);
        ...
        ActionForward actionForward = getProtocolSubmissionData(protocolSubmissionDynaBeanList,actionForm, request, response, actionMapping);
     ...
     */
    private ActionForward getProtocolSubmissionData(ProtocolSubmissionDynaBeanList protocolSubmissionDynaBeanList,ActionForm actionForm,
    ...
    private String getSubmitForReveiwDetails(ProtocolSubmissionDynaBeanList protocolSubmissionDynaBeanList, HttpServletRequest request)throws Exception{
        ...
        hmProtocolData.put(PARAMETER_NAME, IRB_COMM_SEL_DURING_SUBMM);
...
//        Vector vecUnfilledQnr = questionnaireTxnBean.fetchQuestionnaireCompletedForModule(protocolNumber, 7, "0", Integer.parseInt(sequenceNumber));
        ...
        Vector vecUnfilledQnr = questionnaireTxnBean.fetchQuestionnaireCompletedForModule(protocolNumber, 7, String.valueOf(subModuleCode), Integer.parseInt(sequenceNumber));
        ...
        if(vecUnfilledQnr != null && vecUnfilledQnr.size() > 0){
            ...
            if(mandatoryQnrPresent){
                ...
                //String validationMessage = "Fill 11 the following mandatory forms before submitting the protocol to IRB";
                //Added for COEUSQA-2444 -Change wording on mandatory questionnaire message in IRB 
                MessageResources messages = MessageResources.getMessageResources(MANDATORY_QUESTIONNAIRE_FILE_NAME);
            ...
            if(incompleteQnrPresent){
                ...
                String validationMessage = "Complete the following forms before submitting the protocol to IRB";
            ...
            if(newVersionQnrPresent){
                String validationMessage = "Fill the latest version of the following forms before submitting the protocol to IRB" ;
        ...
        if(isProtocolComplete!=null &&  !isProtocolComplete.equals(EMPTY_STRING) && isProtocolComplete.equalsIgnoreCase("0") && canSubmit
            ...
            hmProtocolData.put("matchingCommitteeTypeCode", new Integer(CoeusConstants.IRB_COMMITTEE_TYPE_CODE));
...
//                session.setAttribute(GET_VALID_PROTO_SUB_REVIEW_TYPES, vecValidProtoSubReviewTypes);
            ...
            //Added for the case# COEUSQA-1403 Implement validation based on rules in protocols - start            
            //            navigator = SUCCESS; Commented for COEUSQA-1403
            ...
            if(vecResponseObject != null && vecResponseObject.size()>0  ){
                ...
                if( onlyWarning != null &&"Y".equals(onlyWarning) ){
                    navigator = SUCCESS;
                }else{
                    navigator =  "protocolValidationType";                    
                }
            }else{
                if( onlyWarning != null &&"Y".equals(onlyWarning) ){
                    navigator = SUCCESS;
    ...
    private String saveProtocolSubmission(ProtocolSubmissionDynaBeanList protocolSubmissionDynaBeanList,
        ...
        if(!isLockExists && lockBean.getSessionId().equals(lockData.getSessionId())) {
            ...
            if(isValidateSuccess){
                ...
                Integer seqNo = (Integer) dynaUploadActionForm.get(SEQUENCE_NUMBER);
                ...
                if(vecMaps != null && vecMaps.size() > 0 && !vecMaps.get(0).equals(new Integer(0))){
                    if(hmSaveProtocolSubmission.get(UPD_PROTOCOL_SUBMISSION) != null){
                        ...
                        protcolSubmissiondynaForm.set("submissionStatusCode",new Integer(213));
                        int protoSubmissionNumber = ((Integer)protcolSubmissiondynaForm.get(SUBMISSION_NUMBER)).intValue();
                        protocolSubmissionUpdateTxnBean.updateProtoSubmissionStatus(protocolNumber,seqNo,protoSubmissionNumber,213);
                    }
                    ...
                    if(hmSaveProtocolSubmission.get(UPD_PROTOCOL) != null){
                        ...
                        protcolSubmissiondynaForm.set("protocolStatusCode",new Integer(protocolStatusCode));
...
//                String url = "/mailAction.do";       
         ...
         //     session.setAttribute("ACTION_CODE", "501"); // Action Code for Protocol Submission
...
//                 setMenuForAmendRenew(protocolNumber, request);
    ...
    private Vector prepareProtocolInfo(Vector vecProtocolInfo)throws Exception{
        ...
        if(vecProtocolInfo !=null && vecProtocolInfo.size()>0){
            ...
            dynaActionForm.set(PROTOCOL_STATUS_CODE, new Integer(101));
    ...
    private Vector prepareProtocolSubmission(ProtocolSubmissionDynaBeanList protocolSubmissionDynaBeanList,
        ...
        if(committeParamId == null || committeParamId.equals(EMPTY_STRING)){ //|| scheduleId == null || scheduleId.equals(EMPTY_STRING)){
            protcolSubmissiondynaForm.set(SUBMISSION_STATUS_CODE,new Integer(102));
        }else{
...
//        }
        ...
        protcolSubmissiondynaForm.set(SEQUENCE_NUMBER,dynaActionForm.get(SEQUENCE_NUMBER));
...
//        protcolSubmissiondynaForm.set(STR_SUBMISSION_TYPE_QUAL_CODE, typeQualifier);
        ...
        if((lstReviewerInfo !=null && lstReviewerInfo.size()>0) && (vecGetReviewers !=null && vecGetReviewers.size()>0)){
            for(int vecIndex =0; vecIndex < vecGetReviewers.size(); vecIndex++ ){
                ...
                if(key <= lstReviewerInfo.size()){
                    ...
                    dynaReviewerActionForm.set(SEQUENCE_NUMBER,dynaActionForm.get(SEQUENCE_NUMBER));
    ...
    private Vector getProtocolCheckList(ProtocolSubmissionDynaBeanList protocolSubmissionDynaBeanList,
        ...
        //COEUSQA-3127 - Not always forcing user to select checklist item for exempt or expedited in Lite - Start
        HttpSession session = request.getSession();
        String submitProtocolNumber = (String)session.getAttribute(CoeusLiteConstants.PROTOCOL_NUMBER+session.getId());
        //COEUSQA-3127 - Not always forcing user to select checklist item for exempt or expedited in Lite - End
        if(lstCheckListInfo !=null && lstCheckListInfo.size()>0){
            for(int index=0; index < lstCheckListInfo.size(); index++){
                ...
                //COEUSQA-3127 - Not always forcing user to select checklist item for exempt or expedited in Lite - Start
                String protocolNumber =(String) dynaForm.get(PROTOCOL_NUMBER);
                if((selectCheckList ==null || selectCheckList.equals(EMPTY_STRING)) && (!protocolNumber.equals(submitProtocolNumber))){
                ...
                //}
                //To check whether the protocol number in the list is matching with the protocol submitted
                if(protocolNumber !=null && ((EMPTY_STRING).equals(protocolNumber) ||  protocolNumber.equals(submitProtocolNumber))){
                    if(selectCheckList !=null && !selectCheckList.equals(EMPTY_STRING) && selectCheckList.equals(ON)){
                        vecCheckLstInfo.addElement(new Integer(index));
                    }
                }
...
//                (Hashtable)webTxnBean.getResults(request,GET_COMMITTEE_LIST ,null);
        ...
        if(htCommitteeDetail !=null && htCommitteeDetail.size()>0){
            ...
            Vector vecIrbCommittee = new Vector();
...
//                // If committee type code is equal to 1 , then it takes only irb committee
//                if(matchingCommitteeTypeCode.equals(1)){
//                    vecIrbCommittee.add(dynaForm);
//                }
//            }
    ...
    public void setSubmitForReviewMenu(HttpServletRequest request)throws Exception {
        ...
        String protocolStatusCode = (String) session.getAttribute("protocolStatusCode");
    ...
    private boolean checkSubmitProtocolRights(HttpServletRequest request)throws Exception{
        ...
        String SUBMIT_PROTOCOL = "SUBMIT_PROTOCOL";
        String SUBMIT_ANY_PROTOCOL = "SUBMIT_ANY_PROTOCOL";
        String protocolNumber = (String)session.getAttribute(CoeusLiteConstants.PROTOCOL_NUMBER+session.getId());
        ...
        boolean canSubmit =  txnData.getUserHasProtocolRight(loggedinUser, SUBMIT_PROTOCOL, protocolNumber);
        //If no rights check at Unit level right
        if(unitNumber !=null && !canSubmit){
            canSubmit = txnData.getUserHasRight(loggedinUser, SUBMIT_ANY_PROTOCOL, unitNumber);
        }
        return canSubmit;
    }
    ...
    private String getConfirmationMessage(HttpServletRequest request) throws Exception {
        HttpSession session = request.getSession();
        String protocolNumber = (String)session.getAttribute(CoeusLiteConstants.PROTOCOL_NUMBER+session.getId());
        String sequenceNo=(String)session.getAttribute(CoeusLiteConstants.SEQUENCE_NUMBER+session.getId());
        ...
        && Integer.parseInt(mapsFound) > 0){
            actionMessages.add("confirmationMessage3",
                    new ActionMessage("protocolSubmission.submissionConfirmationMessage3",protocolNumber));
            saveMessages(request, actionMessages);
        } else {
            actionMessages.add("confirmationMessage1",
                    new ActionMessage("protocolSubmission.submissionConfirmationMessage1",protocolNumber));
            actionMessages.add("confirmationMessage2",
                    new ActionMessage("protocolSubmission.submissionConfirmationMessage2",protocolNumber));
            saveMessages(request, actionMessages);
        }
         //Code modified for Case#2785 - Protocol Routing - ends
        setMenuForAmendRenew(protocolNumber, ""+sequenceNo, request);
    ...
    //Added for the case# COEUSQA-1403 Implement validation based on rules in protocols - start
    /*
     * To check and get all the Protocol Validations
     * @throws Exception
     * @return HashMap. Containing Validations 
     */
    ...
    public Vector checkValidationProtocol(String protocolNumber, int sequenceNumber,
        ...
        return getBusinessRulesData(routingTxnBean.validateForRouting(ModuleConstants.PROTOCOL_MODULE_CODE,0, protocolNumber,sequenceNumber, 1, headerBean.getUnitNumber(), userId), dynaForm);
    }
    /**
     ...
     * @return Vector. Conatins the objects from DynaValidatorForm
     */
    private Vector getBusinessRulesData(Vector vecValidationProposal, DynaActionForm  dynaForm) throws Exception{
