...
public class VulnerableAction extends ProtocolBaseAction{
    ...
    private static final String GET_PROTOCOL_VULNERABLE_SUB_LIST="getProtocolVulnerableSubList";
    private static final String AC_TYPE="acType";
    private static final String UPD_PROTO_VULNERABLES="updProtoVulnerables";
    private static final String UPDATE_PROTOCOL_INDICATOR ="updateProtocolIndicator";
    private static final String VULNERABLE_SUBJECTS ="vulnerableSubjects";
