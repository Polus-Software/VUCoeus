...
import edu.mit.coeus.irb.bean.ProtoCorrespRecipientsBean;
...
import edu.mit.coeuslite.irb.form.ProtocolActionForm;
...
public class ProtocolRequestAction extends ProtocolBaseAction{    
    ...
    private static final String SAVE_PROTOCOL_ACTION = "/saveProtocolActions";
    private static final String GET_LEAD_UNIT_NUMBER = "getLeadUnitNumber";
    private static final String CAN_PERFORM_PROTOCOL_ACTION = "canPerformProtocolAction";    
    private static final String GET_MAX_SEQ_NUMBER = "getMaxSequenceNumber";
   ...
   // private static final String COMMENTS = "comments";
    ...
    private static final String REQUEST_TO_CLOSE = "Request to Close";
    private static final String REQUEST_FOR_SUSPENSION = "Request for Suspension";
    private static final String REQUEST_TO_CLOSE_ENROLLMENT = "Request to Close Enrollment";
    ...
    private static final String GET_REQUEST_TO_DATA = "/getRequestForDataAnalysis";
    private static final String GET_NOTIFY_IRB = "/getNotifyIRB";    
    ...
    private static final String EXCEPTION_CODE = "protocolAction_exceptionCode.2200";
    private static final String NOTIFY_IRB = "Notify IRB";
    ...
    private static final String ACTION_RIGHT = "PERFORM_IRB_ACTIONS_ON_PROTO";
    private static final String APPROVAL_ACTION_ERROR_FLAG = "approvalActionErrorFlag";
    private static final String SUBMISSION_DETAILS = "SUBMISSION_DETAILS";
    private static final String APPROVAL_DATE = "approvalDate";
    private static final String EXPIRATION_DATE = "expirationDate";
    private static final String ERROR_2200 = "2200";
    private static final String DATE_SEPARATERS = ":/.,|-";
    private static final String SIMPLE_DATE_FORMAT = "MM/dd/yyyy";    
    private static final String GET_PROTOCOL_DETAILS = "getProtocolInfo";
    private static final String PROTOCOL_STATUS_CODE = "protocolStatusCode";
    private static final String GET_ORG_APPROVAL_DATE = "getOriginalApprovalDate";
    ...
    private static final String NOTIFY_IRB_CODE = "116";
    ...
    private static final String GET_WITHDRAW_SUBMISSION =  "/getWithdrawSubmission";
    private static final String WITHDRAW_SUBMISSION_CODE = "303";
    ...
    private static final String PERFORM_ABANDON_PROTOCOL =  "/getAbandonProtocol";
    private static final String ABANDON_ACTION_CODE = "119";
    ...
    private static final String GET_QUALIFIER_TYPE = "getQualifierTypeForSubtype";
    private static final String QUALIFIER_TYPE = "QUALIFIER_TYPE";
    ...
    private static final String ADD_PROTOCOL_ACTION_ATTACHMENT= "/addProtocolActionAttachment"; 
    private static final String MODIFY_PROTOCOL_ACTION_ATTACHMENT = "/modifyProtocolActionAttachment";
    private static final String VIEW_PROTOCOL_ACTION_ATTACHMENT = "/viewProtocolActionAttachment";
    ...
    private static final String SAVE_TEMP_PROTOCOL_ACTION = "/saveTempProtocolActions";
    private static final String COMPLETE_PROTOCOL_SUBMISSION = "/completeProtocolSubmission";
    private static final String CANCEL_PROTOCOL_SUBMISSION = "/cancelProtocolSubmission";
...
//    HttpServletRequest request) throws Exception{ 
    ...
    HttpServletRequest request, HttpServletResponse response) throws Exception{        
        ...
        session.removeAttribute("IRB_COMM_SELECTION_DURING_SUBMISSION");
        ...
        if(actionMapping.getPath().equals(GET_REQUEST_TO_CLOSE)){            
            ...
            if(actionCode == null){
                actionCode = (String)session.getAttribute(ACTION_CODE);
            }
            session.setAttribute(ACTION_CODE, actionCode);
            ...
            mapReqActionMenuList.put("menuCode", CoeusliteMenuItems.PROTO_REQUEST_ACTION_SUBMISSION_DETAILS_MENU);
        ...
        // COEUSDEV-86: Questionnaire for a Submission - Start
            ...
            Map mapReqActionMenuList = new HashMap();
            mapReqActionMenuList.put("menuItems",PROTOCOL_REQUEST_ACTION_MENU_ITEMS);
            mapReqActionMenuList.put("menuCode", CoeusliteMenuItems.PROTO_REQUEST_ACTION_COMPLETE_MENU);
            setSelectedMenuList(request, mapReqActionMenuList);
            ...
            session.removeAttribute("tempSubmissionSaved");
          ...
          //  session.removeAttribute("tempSubmissionActionForm");
            ...
            if(!isLockExists && lockBean.getSessionId().equals(lockData.getSessionId())) {
                ...
                if(actionCode != null && actionCode.equals(NOTIFY_IRB_CODE)) {
                    ...
                    hmQualifiers.put("jobCode", "IRB_COMM_SELECTION_DURING_SUBMISSION");
                    ...
                    session.setAttribute("IRB_COMM_SELECTION_DURING_SUBMISSION", value);
                    ...
                    if(protocolActionForm.getNotificationType() == null
                        ...
                        session.setAttribute("successFlag", EMPTY_STRING);
                        session.setAttribute("IRB_COMM_SELECTION_DURING_SUBMISSION", value);
                        canSave = false;
                    }
                    ...
                    if(CoeusLiteConstants.YES.equalsIgnoreCase(tempSubmissionCompleted)){
                        ...
                        && !"".equals(savedNotificationType)){
                            ...
                            questionnaireUpdateTxnBean.deleteQuestionnaireAnswers(7,2, protocolNumber+"T", String.valueOf(Integer.parseInt(submissionNumber) +1));
                ...
                if(canSave){
                    ...
                    if(menuItemsVector != null && !menuItemsVector.isEmpty()){
                        ...
                        for(int index =0; index < size; index++){
                            ...
                            if(menuBean != null && CoeusliteMenuItems.PROTO_REQUEST_ACTION_SUBMISSION_DETAILS_MENU.equalsIgnoreCase(menuBean.getMenuId())){
                ...
                if(questionnaireRefreshed){
                    ...
                    if(CoeusLiteConstants.YES.equalsIgnoreCase(newSubmission)){
                        resetQuestionnaireMenuData(request, "PROTOCOL_SUBMISSION", protocolNumber+"T",String.valueOf(Integer.parseInt(submissionNumber) +1));
                    } else {
...
//            if(canSave){
            ...
            if(NOTIFY_IRB_CODE.equals(actionCode)
            || REQUEST_TO_CLOSE_CODE.equals(actionCode)
            || REQUEST_FOR_SUSPENSION_CODE.equals(actionCode)
            || REQUEST_TO_CLOSE_ENROLLMENT_CODE.equals(actionCode)
            || REQUEST_FOR_DATA_ANALYSIS_ONLY_CODE.equals(actionCode)
            || REQUEST_FOR_RE_OPEN_ENROLLMENT_CODE.equals(actionCode)
            ){
...
//            session.removeAttribute("tempSubmissionActionForm");
        ...
        //Added for including new actions - start    
            ...
            protocolSubmissionUpdateTxnBean.cleanTemporarySubmissionDetails(protocolNumber);
            session.removeAttribute("tempSubmissionSaved");
            session.removeAttribute("protocolActionMenuItems");
       //     session.removeAttribute("tempSubmissionActionForm");
            resetFormField(protocolActionForm);
            ...
            resetFormField(protocolActionForm);
        }else if(actionMapping.getPath().equals(GET_REQUEST_TO_DATA)){            
            ...
            if(!ableToLockProtocol){
                ...
                navigator = performRequestToDataOperation(request);
            }
            // COEUSDEV-86: Questionnaire for a Submission - Start
            String tempSubmissionSaved = (String) session.getAttribute("tempSubmissionSaved");
            if(CoeusLiteConstants.YES.equalsIgnoreCase(tempSubmissionSaved)){
            ...
            resetFormField(protocolActionForm);
        }else if(actionMapping.getPath().equals(GET_NOTIFY_IRB)){            
            //Code commented and modified for Case#3554 - Notify IRB enhancement
//            navigator = performNotifyIRBOperation(request);
            // COEUSDEV-327 / COEUSDEV-328: Notify IRB FYI submission only permits the Aggregator to upload one document 
            String actionCode = request.getParameter(ACTION_CODE);
            if(actionCode == null){
                actionCode = (String)session.getAttribute(ACTION_CODE);
            ...
            if(!ableToLockProtocol){
                ...
                navigator = performNotifyIRBOperation(request, protocolActionForm);
            }
          //  }
//            resetFormField(protocolActionForm);  
        //Added for including new actions - end
        ...
        // COEUSDEV-327 / COEUSDEV-328: Notify IRB FYI submission only permits the Aggregator to upload one document - End   
        mapMenuList.put("menuCode",CoeusliteMenuItems.PROTOCOL_ACTION_MENU);
    ...
    private String isAuthorizedToPerformAction(HttpServletRequest request) throws Exception{
        ...
        if (txnData.getUserHasProtocolRight(loggedinUser, SUBMIT_PROTOCOL, protocolNumber) 
        || txnData.getUserHasRight(loggedinUser, MODIFY_ANY_PROTOCOL, leadUnitNumber)){            
            responseCode = canPerformProtocolAction(request, protocolNumber);            
        }    
        else{
            responseCode = ERROR_2200;             
        }
     ...
     */     
     private String canPerformProtocolAction(HttpServletRequest request, String protocolNumber) throws Exception{
        ...
        hmSubmissionData = (HashMap)session.getAttribute(SUBMISSION_DETAILS);
    ...
    private void throwMessage(HttpServletRequest request, String responseCode){        
        ...
        if(responseCode.equals(ERROR_2200)){            
           if(actionCode.equals("105")){
                actionMessages.add(EXCEPTION_CODE, new ActionMessage(EXCEPTION_CODE, REQUEST_TO_CLOSE));
           }else if(actionCode.equals("106")){
                actionMessages.add(EXCEPTION_CODE, new ActionMessage(EXCEPTION_CODE, REQUEST_FOR_SUSPENSION));
           }else if(actionCode.equals("108")){
                actionMessages.add(EXCEPTION_CODE, new ActionMessage(EXCEPTION_CODE, REQUEST_TO_CLOSE_ENROLLMENT));
           //Added for including new actions - start    
           }else if(actionCode.equals("114")){
               actionMessages.add(EXCEPTION_CODE, new ActionMessage(EXCEPTION_CODE, REQUEST_TO_DATA_ANALYSIS));
           }else if(actionCode.equals("115")){
               actionMessages.add(EXCEPTION_CODE, new ActionMessage(EXCEPTION_CODE, REQUEST_TO_REOPEN_ENROLLMENT));
           }else if(actionCode.equals(NOTIFY_IRB_CODE)){
               actionMessages.add(EXCEPTION_CODE, new ActionMessage(EXCEPTION_CODE, NOTIFY_IRB));
           // Added for case #2250 - Expire Protocol - start 
           ...
           //Added for including new actions - end    
           //Added for case#3214 - Withdraw Submission - Start  
           }else if(actionCode.equals(WITHDRAW_SUBMISSION_CODE)){
               actionMessages.add(EXCEPTION_CODE, new ActionMessage(EXCEPTION_CODE, WITHDRAW_SUBMISSION));
           }else if(actionCode.equals(ABANDON_ACTION_CODE)){ 
           ...
           saveMessages(request, actionMessages);           
           error = true;
        }else if(responseCode.equals("2007")){
           actionMessages.add("protocolAction_exceptionCode.2007",new ActionMessage("protocolAction_exceptionCode.2007"));
           saveMessages(request, actionMessages);  
           error = true;
        ...
        // Added for case #2250 - Expire Protocol - End
        //Added for case#3214 - Withdraw Submission - Start
        else if(responseCode.equals("2000")){
            actionMessages.add("protocolAction_exceptionCode.2000",new ActionMessage("protocolAction_exceptionCode.2000"));
            saveMessages(request, actionMessages);   
            error = true;            
            ...
            error = true;  
        // Added for COEUSQA-2692_Allow an investigator to abandon an IRB protocol that has never been approved_start
        }else if(responseCode.equals("2059")){
            actionMessages.add("protocolAction_exceptionCode.2059",new ActionMessage("protocolAction_exceptionCode.2059"));
            saveMessages(request, actionMessages);   
            error = true;  
        }
        // Added for COEUSQA-2692_Allow an investigator to abandon an IRB protocol that has never been approved_end
    ...
    private boolean saveProtocolActions(HttpServletRequest request, ActionForm actionForm, 
        ...
        // Modified for COEUSQA-2692_Allow an investigator to abandon an IRB protocol that has never been approved_start
        if(WITHDRAW_SUBMISSION_CODE.equals(actionCode) || ABANDON_ACTION_CODE.equals(actionCode)){
        ...
        if(actionCode != null && actionCode.equals(NOTIFY_IRB_CODE)){
            ...
            actionBean.setReviwerTypeCode("7");
            actionBean.setCommitteeId(committeeId);
        }
        //Code added for Case#3554 - Notify IRB enhancement - ends
        ...
        if(saveSuccess){
            ...
            if(actionCode.equals(EXPEDITED_APPROVAL_ACTION_CODE) || actionCode.equals(RESPONSE_APPROVAL_ACTION_CODE) || actionCode.equals(EXPIRE_PROTOCOL_CODE)){//Modified for Case#2250 - Expire Protocol
                if(protocolNumber != null && protocolNumber.length() > 10){
                    ...
                    session.removeAttribute(CoeusLiteConstants.PROTOCOL_NUMBER);
                ...
                session.removeAttribute(CoeusLiteConstants.SEQUENCE_NUMBER);
                session.setAttribute(CoeusLiteConstants.SEQUENCE_NUMBER+session.getId(), hmProtocolDetails.get(SEQUENCE_NUMBER).toString()); 
            }                
            //Added for case#3046 - Notify IRB attachments - start
            // COEUSDEV-327 / COEUSDEV-328: Notify IRB FYI submission only permits the Aggregator to upload one document -Start
...
//                    templateFileBytes = protoCorrespTypeTxnBean.getCorrespTemplate(correpTypeFormBean.getProtoCorrespTypeCode(), null,null);
                    templateFileBytes = protoCorrespTypeTxnBean.getCorrespTemplate(
                            correpTypeFormBean.getProtoCorrespTypeCode(), actionBean.getScheduleId(),actionBean.getCommitteeId());
...
//        hmCommittees = (Hashtable)webTxnBean.getResults(request, GET_ALL_COMMITTEES, null);
        ...
        hmCommitteeType.put("matchingCommitteeTypeCode", new Integer(CoeusConstants.IRB_COMMITTEE_TYPE_CODE));
    ...
    /**
     * This method sets ERROR, ACTION_CODE, SUBMISSION_DETAILS and APPROVAL_ACTION_ERROR_FLAG
    ...
    private void initActions(HttpServletRequest request) throws Exception{
        ...
        hmSubmissionDetails = getNonNotifyIRBCommitteeForProtocol(request, protocolNumber);        
        session.removeAttribute(SUBMISSION_DETAILS);
        session.setAttribute(SUBMISSION_DETAILS, hmSubmissionDetails);
        ...
        session.removeAttribute(ERROR); 
        session.setAttribute(ERROR, NO);
        //Initial, ACTION_CODE is set to A
        session.removeAttribute(ACTION_CODE);
        session.setAttribute(ACTION_CODE, request.getParameter(ACTION_CODE));        
    }
     ...
     * @throws Exception
     */
    private String performRequestToDataOperation(HttpServletRequest request) throws Exception{        
        String navigator = SUCCESS;        
        String responseCode = isAuthorizedToPerformAction(request);
        throwMessage(request, responseCode);
        return navigator;          
     ...
     * @return navigator     
     */
    private String performNotifyIRBOperation(HttpServletRequest request,
            ProtocolActionForm protocolActionForm) throws Exception{  
...
//        session.setAttribute(ACTION_CODE, actionCode);
    ...
    private String isAuthorizedToPerformApprovalAction(HttpServletRequest request) throws Exception{
        ...
        String protocolNumber = (String)session.getAttribute(CoeusLiteConstants.PROTOCOL_NUMBER+session.getId());   
        HashMap hmSubmissionDetails = new HashMap();
        hmSubmissionDetails = (HashMap)session.getAttribute(SUBMISSION_DETAILS);        
        String committeeId = (String)hmSubmissionDetails.get(COMMITTEE_ID);
    ...
    private String getCommitteeHomeUnitForSchedule(HttpServletRequest request, String scheduleId)  throws Exception{
        ...
        Vector vecOutputData =(Vector)webTxnBean.getResults(request, "getScheduleInfo", hmData);
        if(vecOutputData != null && vecOutputData.size() > 0){
            //Commented/Added for case#3046 - Notify IRB attachments - start
            //DynaActionForm dynaForm = (DynaActionForm)vecOutputData.get(0);
            //unitNumber = (String)dynaForm.get("HOME_UNIT_NUMBER");
     ...
     * @throws Exception
     */
    private HashMap getNonNotifyIRBCommitteeForProtocol(HttpServletRequest request, String protocolNumber) throws Exception {        
        ...
        session.setAttribute("irbSubmissionStatusCode",""+submissionStatusCode);   
        return hmSubDetails;         
    }
...
//            generateCorrespondence(request, actionBean);
        ...
        if(saveSuccess){
            session.setAttribute("tempSubmissionSaved", CoeusLiteConstants.YES);
    ...
    private void setUnfilledQuestionnaireData(Vector vecUnfilledQnr, HttpServletRequest request) {
        ...
        String actionName;
        if(NOTIFY_IRB_CODE.equals(actionCode)){
           actionName = NOTIFY_IRB; 
        } else if ( REQUEST_TO_CLOSE_CODE.equals(actionCode)){
           actionName = REQUEST_TO_CLOSE; 
        } else  if(REQUEST_FOR_SUSPENSION_CODE.equals(actionCode)){
            actionName = REQUEST_FOR_SUSPENSION;
        }else if(REQUEST_TO_CLOSE_ENROLLMENT_CODE.equals(actionCode)) {
            actionName = REQUEST_TO_CLOSE_ENROLLMENT;
        }else if(REQUEST_FOR_DATA_ANALYSIS_ONLY_CODE.equals(actionCode)){
            actionName = REQUEST_TO_DATA_ANALYSIS ;
        }else if(REQUEST_FOR_RE_OPEN_ENROLLMENT_CODE.equals(actionCode)){
            actionName = REQUEST_TO_REOPEN_ENROLLMENT;
        } else {
    ...
    private boolean checkSubmissionQuestionnaireCompleted(HttpServletRequest request) throws DBException, CoeusException {
        ...
        if(CoeusLiteConstants.YES.equalsIgnoreCase(tempSubmissionCompleted)){
            ...
            Vector vecUnfilledQnr = questionnaireTxnBean.fetchQuestionnaireCompletedForModule(protocolNumber+"T", 7, "2", Integer.parseInt(submissionNumber) +1);
