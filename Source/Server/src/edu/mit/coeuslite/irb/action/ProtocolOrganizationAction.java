...
public class ProtocolOrganizationAction extends ProtocolBaseAction{
    ...
    private static final String GET_ORGANIZATION = "/getProtocolOrganization";
    private static final String SAVE_ORGANIZATION = "/saveProtocolOrganization";
    private static final String UPDATE_ORGANIZATION = "/updateProtocolOrganization";
    private static final String DELETE_ORGANIZATION = "/deleteProtocolOrganization";
    private static final String PROTOCOL_NUMBER = "protocolNumber";
    private static final String SEQUENCE_NUMBER = "sequenceNumber";
    private static final String GET_PROTOCOL_ORGANIZATION = "getProtocolLocationData";
    private static final String GET_PROTOCOL_ORG_TYPES = "getProtocolOrgTypes";
    private static final String UPDATE_PROTOCOL_ORGANIZATION = "updProtoOrganizations";
...
//    private UserInfoBean userInfoBean;
    ...
    HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if(actionMapping.getPath().equals(GET_ORGANIZATION)){
            ...
            mapMenuList.put("menuCode",CoeusliteMenuItems.PROTOCOL_ORGANIZATION_MENU);
...
//            }
        ...
        //set it to session
        session.setAttribute("protocolOrganizationList", coeusDynaBeansList);   
        ...
        //set it to session
        session.setAttribute("protocolFreqUsedOrgNames", vecFrequentlyUsedOrg);
   ...
   private String performSaveAction(CoeusDynaBeansList coeusDynaBeansList, HttpServletRequest request) throws Exception{
        ...
        if(addOrganizationList != null && addOrganizationList.size() > 0){
           ...
           Vector vecFrequentlyUsedOrg = (Vector)session.getAttribute("protocolFreqUsedOrgNames");
...
//    }
    ...
    private void setOrganizationDatas(DynaActionForm dynaForm, 
        ...
        Vector vecFreqUsedOrgNames =(Vector) request.getSession().getAttribute("protocolFreqUsedOrgNames");
        ...
        if(!isPresent){
            ...
            request.getSession().setAttribute("protocolFreqUsedOrgNames", vecFreqUsedOrgNames);
        }
    }
