...
//    private static final String PENDING_PI_ACTION_EXPIRE_PROTO_SEARCH = "PENDING_PI_ACTION_EXPIRE_PROTO_SEARCH";
    private static final String PENDING_PI_ACTION_SMR_RQD_IACUC_PROTO_SEARCH = "PENDING_PI_ACTION_SMR_RQD_IACUC_PROTO_SEARCH";
    private static final String PENDING_PI_ACTION_SR_RQD_IACUC_PROTO_SEARCH = "PENDING_PI_ACTION_SR_RQD_IACUC_PROTO_SEARCH";
    private static final String PENDING_PI_ACTION_EXPIRE_IACUC_PROTO_SEARCH = "PENDING_PI_ACTION_EXPIRE_IACUC_PROTO_SEARCH";
    //COEUSQA:3050 - End
...
//        secondLevelHeaderPath(subHeaderId,req);
            ...
            session.removeAttribute(PENDING_PI_ACTION_SMR_RQD_IACUC_PROTO_SEARCH);
            session.removeAttribute(PENDING_PI_ACTION_SR_RQD_IACUC_PROTO_SEARCH);
            session.removeAttribute(PENDING_PI_ACTION_EXPIRE_IACUC_PROTO_SEARCH);
            protoType = PENDING_PI_ACTION_SMR_RQD_IACUC_PROTO_SEARCH ;
            getResult(vecColData,hmProtoName,protoType,personId,req);
            protoType = PENDING_PI_ACTION_SR_RQD_IACUC_PROTO_SEARCH ;
            getResult(vecColData,hmProtoName,protoType,personId,req);
            protoType = PENDING_PI_ACTION_EXPIRE_IACUC_PROTO_SEARCH ;
            getResult(vecColData,hmProtoName,protoType,personId,req);
            secondLevelHeaderPath(subHeaderId,req);
...
//            CriteriaBean criteria = new CriteriaBean("OSP$PROTOCOL_INVESTIGATORS.PERSON_ID",null,"string",null,null,null, null);
        if(searchName !=null && (!searchName.equals("ACTIVEIACUCSEARCH") && !searchName.equals("ALL_IACUC_SEARCH") && !searchName.equals("PENDINGIACUCSEARCH")
        && !searchName.equals("ACTIVE_SUBMISSION_IACUC_SEARCH")  && !searchName.equals("AMENDS_RENEWALS_IACUC_SEARCH") && !searchName.equals("PENDING_PI_ACTION_SMR_RQD_IACUC_PROTO_SEARCH")
        && !searchName.equals("PENDING_PI_ACTION_SR_RQD_IACUC_PROTO_SEARCH") && !searchName.equals("PENDING_PI_ACTION_EXPIRE_IACUC_PROTO_SEARCH"))){
...
//            ColumnBean column = new ColumnBean("OSP$PROTOCOL_INVESTIGATORS.PERSON_ID");
        ...
        if(searchName !=null && (searchName.equals("ACTIVEIACUCSEARCH") || searchName.equals("ALL_IACUC_SEARCH") ||
        searchName.equals("PENDINGIACUCSEARCH") || searchName.equals("ACTIVE_SUBMISSION_IACUC_SEARCH") || searchName.equals("AMENDS_RENEWALS_IACUC_SEARCH")
        //COEUSQA:3050 - IACUC - add Pending PI Action - Start
...
//        || searchName.equals("PENDING_PI_ACTION_EXPIRE_PROTO_SEARCH") )){
        || searchName.equals("PENDING_PI_ACTION_SMR_RQD_IACUC_PROTO_SEARCH")
        || searchName.equals("PENDING_PI_ACTION_SR_RQD_IACUC_PROTO_SEARCH")
        || searchName.equals("PENDING_PI_ACTION_EXPIRE_IACUC_PROTO_SEARCH") )){
            //COEUSQA:3050 - End
