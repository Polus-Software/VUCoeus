...
/* PMD check performed, and commented unused imports and variables on 07-APR-2011
 * by Bharati
 */
...
public class ProtocolAction extends ProtocolBaseAction{
    ...
    public ActionForward performExecute(ActionMapping actionMapping, ActionForm actionForm,
        ...
        mapMenuList.put(MENU_CODE,CoeusliteMenuItems.IACUC_PROTOCOL_VIEW_HISTORY_MENU);
        ...
        //Commented and added for COEUSQA-3461 : IACUC CoeusLite View FYI Attachments - start
        //Added for case#3046 - Notify IRB attachments - start
        //if(actionMapping.getPath().equals("/viewProtoSubAtt")){
        if(actionMapping.getPath().equals("/viewIacucSubAtt")){
        ...
        //Commented and added for COEUSQA-3461 : IACUC CoeusLite View FYI Attachments - end
...
//                            hmProtocolMap.put(IACUC_SEQUENCE_NUMBER, (Integer) protocolForm.get(IACUC_SEQUENCE_NUMBER));
...
//                }
                ...
                int protocolActionCode = Integer.parseInt(protocolForm.get("protocolActionCode").toString());
                hmProtocolMapDet.put("ProtocolActionCode", new Integer(protocolActionCode));       
                //Uncommented for the COEUSQA-3120 : IACUC - Major and Minor Revisions required letters do not appear under View History/Protocol Action Details in Lite - start
...
//                        //Modified for case#3214 - end
               ...
               //Uncommented for the COEUSQA-3120 : IACUC - Major and Minor Revisions required letters do not appear under View History/Protocol Action Details in Lite - end
...
//    }
    ...
    private String viewSubmissionDocumnet(String protocolNumber, String sequenceNumber,
        ...
        String templateURL = null;
        //COEUSQA-3866:Notify IACUC other attachments opening as zip - Start
        ...
        /*
         * Commented for COEUSQA-3866:Notify IACUC other attachments opening as zip
    ...
    private Vector getSubmissionDocs(HttpServletRequest request, String protocolNumber, 
        ...
        WebTxnBean webTxnBean = new WebTxnBean();
        Hashtable htSubmissionDocs = (Hashtable)webTxnBean.getResults(request, "getIacucSubmissionDocs", hmSubmissionDocs);
        Vector vecSubmissionDocs = (Vector)htSubmissionDocs.get("getIacucSubmissionDocs");
