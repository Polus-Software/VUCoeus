...
public class ProtocolNotesAction extends ProtocolBaseAction{
    private static final String GET_PROTOCOL_NOTE = "/getIacucNotes";
    private static final String SAVE_IACUC_PROTOCOL_NOTE = "/saveIacucNotes";
...
//    private WebTxnBean webTxnBean ;
    ...
    private final String ADD_IACUC_PROTOCOL_NOTES = "ADD_IACUC_PROTOCOL_NOTES";
    private final String ADD_ANY_IACUC_PROTOCOL_NOTES = "ADD_ANY_IACUC_PROTOCOL_NOTES";
    private final String MODIFY_PROTOCOL = "MODIFY_PROTOCOL";
    private final String GET_PROTOCOL_NOTES = "getIacucNotes";
    private final String PROTOCOL_NOTES_DATA = "protocolNotesData";
    private final String GET_PROTO_NOT_RESTRICTED_NOTES = "getIacucNotRestrictedNotes";
    private final String PROTO_NOT_RESTRICTED_NOTES_DATA = "protoNotRestrictedNotesData";
    private final String GET_MAX_ENTRY_NUMBER = "getIacucMaxEntryNumber";
    private final String MAX_ENTRY_NUMBER = "maxEntryNumber";
    private final String UPDATE_PROTOCOL_NOTES = "updateIacucNotes";
    ...
    HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        mapMenuList.put("menuCode",CoeusliteMenuItems.IACUC_PROTOCOL_NOTES_MENU);
    ...
    private ActionForward performProtocolNotesAction(ActionForm actionForm, HttpServletRequest request, 
        ...
        if(actionMapping.getPath().equals(SAVE_IACUC_PROTOCOL_NOTE)){
...
//        hasViewRestrictedNotes = userMaintDataTxnBean.getUserHasRight(userId, VIEW_RESTRICTED_PROTOCOL_NOTES,unitNumber);
    ...
    private boolean isAuthorized(HttpServletRequest request) throws Exception{
        ...
        isAuthorised = txnData.getUserHasIACUCProtocolRight(loggedinUser, ADD_IACUC_PROTOCOL_NOTES, protocolNumber);
        ...
        if(!isAuthorised){
            ...
            //If not authorised check ADD_ANY_IACUC_PROTOCOL_NOTES at unit level
            if(!isAuthorised){
                isAuthorised = txnData.getUserHasRight(loggedinUser, ADD_ANY_IACUC_PROTOCOL_NOTES, unitNumber);
            }
        }
        return isAuthorised;
    }
