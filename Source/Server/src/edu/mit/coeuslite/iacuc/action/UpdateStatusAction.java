...
public class UpdateStatusAction extends ProtocolBaseAction {
    ...
    public org.apache.struts.action.ActionForward performExecute(ActionMapping mapping, 
        ...
        //start--4
        hmProtocol.put(CoeusLiteConstants.IACUC_PROTOCOL_NUMBER, (String)session.getAttribute(CoeusLiteConstants.IACUC_PROTOCOL_NUMBER)+session.getId());
        //end--5
        hmProtocol.put("StatusCode", protocolStatusCode);
        webTxnBean.getResults(req, "updateIacucStatus", hmProtocol );
