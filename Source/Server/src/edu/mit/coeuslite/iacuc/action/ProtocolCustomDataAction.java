...
public class ProtocolCustomDataAction extends ProtocolBaseAction{
    ...
    private static final String GET_IACUC_GROUPS = "/getIacucGroups";
    private static final String SAVE_GROUPS = "/saveIacucCustomData";
    private static final String PARAMETER_NAME = "COEUS_MODULE_IACUC";
    ...
    private static final String IS_CUSTOM_DATA_PRESENT = "isIacucCustomDataPresent";
    private static final String IS_CUSTOM_ELEMENT_PRESENT = "hasCustomDataModule";
    private static final String GET_PROTOCOL_CUSTOM_DATA = "getIacucCustomData";
    private static final String MODULE_ID = "moduleId";
    private static final String MISCELLANEOUS = "Miscellaneous";
    private static final String GET_CUST_COLS_FOR_IACUC_MODULE = "getCustColsForIacucModule";
    private static final String UPDATE_PROTOCOL_CUSTOM_DATA = "updateIacucCustomData";
    ...
    public ActionForward performExecute(ActionMapping actionMapping, ActionForm actionForm,
        ...
        if(actionMapping.getPath().equals(GET_IACUC_GROUPS)){
        ...
        mapMenuList.put("menuCode", CoeusliteMenuItems.IACUC_PROTOCOL_OTHERS_MENU);
    ...
    private Vector getCustomElementsForModule(String moduleId, HttpServletRequest request)throws Exception{
        ...
        inputData.put(MODULE_ID, moduleId);
        WebTxnBean webTxnBean = new WebTxnBean();
        Hashtable htCustomData = (Hashtable) webTxnBean.getResults(request, GET_CUST_COLS_FOR_IACUC_MODULE, inputData);
        Vector vecCustomDetails = (Vector)htCustomData.get(GET_CUST_COLS_FOR_IACUC_MODULE);
    ...
    private String getTabbedData(HttpServletRequest request, CoeusDynaBeansList  coeusDynaBeansList) throws Exception{
        ...
        moduleId = getParameterValue(request);
        inputData.put(MODULE_ID, moduleId);
        Hashtable htGroupData = (Hashtable) webTxnBean.getResults(request, GET_CUST_COLS_FOR_IACUC_MODULE, inputData);
        Vector vecGroupData = (Vector)htGroupData.get(GET_CUST_COLS_FOR_IACUC_MODULE);
    ...
    private void saveProtocolCustomData(CoeusDynaBeansList coeusDynaBeanList,
        ...
        String newSequenceNumber = (String)session.getAttribute(CoeusLiteConstants.IACUC_SEQUENCE_NUMBER+session.getId());
