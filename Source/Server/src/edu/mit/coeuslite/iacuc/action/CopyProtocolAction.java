...
public class CopyProtocolAction extends ProtocolBaseAction{
    ...
    private static final String COPY_PROTOCOL = "copyIacuc";    
    ...
    HttpServletRequest request , HttpServletResponse response) throws Exception {
        ...
        if("1".equals(copyQnr) || "1".equals(copyAttachments) || "1".equals(copyOtherAttach)) {
            ...
            mapMenuList.put("menuCode",CoeusliteMenuItems.IACUC_PROTOCOL_COPY_PROTOCOL_MENU);
            ...
            boolean isQnrPresent = questionnaireTxnBean.checkAnyQuestionIsAnsweredInModule(ModuleConstants.IACUC_MODULE_CODE, protocolNumber, 0, seq);
            if("1".equals(copyQnr)) {
            ...
            boolean canCopyQnr = questionnaireTxnBean.checkCanCopyQuestionnaireFromModule(ModuleConstants.IACUC_MODULE_CODE, 0, protocolNumber, seq);
