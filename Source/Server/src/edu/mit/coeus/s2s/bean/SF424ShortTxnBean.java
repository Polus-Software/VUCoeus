...
public class SF424ShortTxnBean {
    private DBEngineImpl dbEngine;
    /** Creates a new instance of SF424ShortTxnBean */
    public SF424ShortTxnBean() {
        dbEngine = new DBEngineImpl();
    }
    
     public HashMap getEpsInfo (String propNumber)
        ...
        if(dbEngine !=null){
           ...
           result = dbEngine.executeRequest("Coeus",
               "call s2sSF424ShortPkg.get_eps_infos( <<PROPOSAL_NUMBER>> , "
      ...
      public HashMap getS2sOpportunity (String propNumber)
        ...
        if(dbEngine !=null){
           result = new Vector(3,2);
           result = dbEngine.executeRequest("Coeus",
               "call s2sSF424ShortPkg.getS2sOpportunity( <<PROPOSAL_NUMBER>> , "
                                + " <<OUT RESULTSET rset>> )", "Coeus", param);
        }else{
                throw new CoeusException("db_exceptionCode.1000");
        }
       ...
       public HashMap getStateName (String stateCode)
        ...
        if(dbEngine !=null){
           result = new Vector(3,2);
           result = dbEngine.executeRequest("Coeus",
               "call s2sSF424ShortPkg.getStateName( <<STATE_CODE>> , "
                                + " <<OUT RESULTSET rset>> )", "Coeus", param);
        }else{
                throw new CoeusException("db_exceptionCode.1000");
        }
       ...
       public HashMap getCountryName (String countryCode)
        ...
        if(dbEngine !=null){
           result = new Vector(3,2);
           result = dbEngine.executeRequest("Coeus",
               "call s2sSF424ShortPkg.getCountryName( <<COUNTRY_CODE>> , "
                                + " <<OUT RESULTSET rset>> )", "Coeus", param);
        }else{
                throw new CoeusException("db_exceptionCode.1000");
        }
    ...
    public HashMap getApplicantType(int orgCode)
        throws CoeusException, DBException {
        ...
        if(dbEngine !=null){
           result = new Vector(3,2);
           result = dbEngine.executeRequest("Coeus",
               "call s2sSF424ShortPkg.getApplicantType( <<ORGANIZATION_CODE>> , "
                                + " <<OUT RESULTSET rset>> )", "Coeus", param);
        }else{
                throw new CoeusException("db_exceptionCode.1000");
        }
     ...
     public HashMap getContactPersonInfo (String propNumber)
        ...
        if(dbEngine !=null){
           result = new Vector(3,2);
           result = dbEngine.executeRequest("Coeus",
               "call s2sSF424ShortPkg.get_contact_person_info( <<PROPOSAL_NUMBER>> , "
                                + " <<OUT RESULTSET rset>> )", "Coeus", param);
        }else{
                throw new CoeusException("db_exceptionCode.1000");
        }
     ...
     public HashMap getProjectDirectorInfo (String propNumber)
        throws CoeusException, DBException {
        ...
        if(dbEngine !=null){
           result = new Vector(3,2);
           result = dbEngine.executeRequest("Coeus",
               "call s2sSF424ShortPkg.get_project_director( <<PROPOSAL_NUMBER>> , "
                                + " <<OUT RESULTSET rset>> )", "Coeus", param);
        }else{
                throw new CoeusException("db_exceptionCode.1000");
        }
    ...
    public HashMap getProjectDescription (String propNumber)
        throws CoeusException, DBException {
        ...
        if(dbEngine !=null){
           result = new Vector(3,2);
           result = dbEngine.executeRequest("Coeus",
               "call s2sSF424ShortPkg.getProjectSummary( <<PROPOSAL_NUMBER>> , "
                                + " <<OUT RESULTSET rset>> )", "Coeus", param);
        }else{
                throw new CoeusException("db_exceptionCode.1000");
        }
