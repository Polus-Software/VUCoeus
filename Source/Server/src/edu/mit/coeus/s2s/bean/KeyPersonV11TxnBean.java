 ...
 * @author  ele
 */
public class KeyPersonV11TxnBean {
    ...
    /** Creates a new instance of KeyPersonV11TxnBean */
    public KeyPersonV11TxnBean() {
     ...
     public HashMap getStateName (String stateCode)
        ...
        if(dbEngine !=null){
           ...
           result = dbEngine.executeRequest("Coeus",
               "call s2sKeyPerson_V11Pkg.getStateName( <<STATE_CODE>> , "
     ...
     public HashMap getCountryName (String countryCode)
        ...
        if(dbEngine !=null){
           result = new Vector(3,2);
           result = dbEngine.executeRequest("Coeus",
               "call s2sKeyPerson_V11Pkg.getCountryName( <<COUNTRY_CODE>> , "
                                + " <<OUT RESULTSET rset>> )", "Coeus", param);
        }else{
                throw new CoeusException("db_exceptionCode.1000");
        }
