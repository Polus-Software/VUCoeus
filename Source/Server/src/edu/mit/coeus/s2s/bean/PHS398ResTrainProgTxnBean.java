 ...
 * @author ele
 */
public class PHS398ResTrainProgTxnBean {
    ...
    String propNumber;
      ...
      /** Creates a new instance of PHS398ResTrainProgTxnBean */
    public PHS398ResTrainProgTxnBean() {
     ...
     public HashMap getApplicationType (String propNumber)
        ...
        if(dbEngine !=null){
           ...
           result = dbEngine.executeRequest("Coeus",
               "call s2sPhsResTrainProgPkg.getApplicationType( <<PROPOSAL_NUMBER>> , "
