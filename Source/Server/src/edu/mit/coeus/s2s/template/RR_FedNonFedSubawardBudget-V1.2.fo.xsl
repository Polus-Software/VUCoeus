...
<!-- $Revision:   1.4  $ -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:att="http://apply.grants.gov/system/Attachments-V1.0" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:footer="http://apply.grants.gov/system/Footer-V1.0" xmlns:glob="http://apply.grants.gov/system/Global-V1.0" xmlns:RR_FedNonFed_SubawardBudget="http://apply.grants.gov/forms/RR_FedNonFed_SubawardBudget-V1.2" xmlns:RR_FedNonFedBudget="http://apply.grants.gov/forms/RR_FedNonFedBudget-V1.1" xmlns:globLib="http://apply.grants.gov/system/GlobalLibrary-V2.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<!--    -->
	...
	<xsl:template match="RR_FedNonFed_SubawardBudget:RR_FedNonFed_SubawardBudget">
		<fo:root>
			<!-- -->
					...
					<fo:table width="100%">
						...
						<fo:table-body>
							<!-- <fo:table-row>
                                                         <fo:table-cell>
                                                         	<fo:block>-->
							<xsl:if test="RR_FedNonFed_SubawardBudget:ATT1!=''">
								<xsl:call-template name="attach_block">
									...
									<xsl:with-param name="filename">
										<xsl:value-of select="RR_FedNonFed_SubawardBudget:ATT1"/>
									</xsl:with-param>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="RR_FedNonFed_SubawardBudget:ATT2!=''">
								<xsl:call-template name="attach_block">
									<xsl:with-param name="block_num"/>
									<xsl:with-param name="block_title">2) Please attach Attachment 2</xsl:with-param>
									<xsl:with-param name="filename">
										<xsl:value-of select="RR_FedNonFed_SubawardBudget:ATT2"/>
									</xsl:with-param>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="RR_FedNonFed_SubawardBudget:ATT3!=''">
								<xsl:call-template name="attach_block">
									<xsl:with-param name="block_num"/>
									<xsl:with-param name="block_title">3) Please attach Attachment 3</xsl:with-param>
									<xsl:with-param name="filename">
										<xsl:value-of select="RR_FedNonFed_SubawardBudget:ATT3"/>
									</xsl:with-param>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="RR_FedNonFed_SubawardBudget:ATT4!=''">
								<xsl:call-template name="attach_block">
									<xsl:with-param name="block_num"/>
									<xsl:with-param name="block_title">4) Please attach Attachment 4</xsl:with-param>
									<xsl:with-param name="filename">
										<xsl:value-of select="RR_FedNonFed_SubawardBudget:ATT4"/>
									</xsl:with-param>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="RR_FedNonFed_SubawardBudget:ATT5!=''">
								<xsl:call-template name="attach_block">
									<xsl:with-param name="block_num"/>
									<xsl:with-param name="block_title">5) Please attach Attachment 5</xsl:with-param>
									<xsl:with-param name="filename">
										<xsl:value-of select="RR_FedNonFed_SubawardBudget:ATT5"/>
									</xsl:with-param>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="RR_FedNonFed_SubawardBudget:ATT6!=''">
								<xsl:call-template name="attach_block">
									<xsl:with-param name="block_num"/>
									<xsl:with-param name="block_title">6) Please attach Attachment 6</xsl:with-param>
									<xsl:with-param name="filename">
										<xsl:value-of select="RR_FedNonFed_SubawardBudget:ATT6"/>
									</xsl:with-param>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="RR_FedNonFed_SubawardBudget:ATT7!=''">
								<xsl:call-template name="attach_block">
									<xsl:with-param name="block_num"/>
									<xsl:with-param name="block_title">7) Please attach Attachment 7</xsl:with-param>
									<xsl:with-param name="filename">
										<xsl:value-of select="RR_FedNonFed_SubawardBudget:ATT7"/>
									</xsl:with-param>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="RR_FedNonFed_SubawardBudget:ATT8!=''">
								<xsl:call-template name="attach_block">
									<xsl:with-param name="block_num"/>
									<xsl:with-param name="block_title">8) Please attach Attachment 8</xsl:with-param>
									<xsl:with-param name="filename">
										<xsl:value-of select="RR_FedNonFed_SubawardBudget:ATT8"/>
									</xsl:with-param>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="RR_FedNonFed_SubawardBudget:ATT9!=''">
								<xsl:call-template name="attach_block">
									<xsl:with-param name="block_num"/>
									<xsl:with-param name="block_title">9) Please attach Attachment 9</xsl:with-param>
									<xsl:with-param name="filename">
										<xsl:value-of select="RR_FedNonFed_SubawardBudget:ATT9"/>
									</xsl:with-param>
								</xsl:call-template>
							</xsl:if>
							<xsl:if test="RR_FedNonFed_SubawardBudget:ATT10!=''">
								<xsl:call-template name="attach_block">
									<xsl:with-param name="block_num"/>
									<xsl:with-param name="block_title">10) Please attach Attachment 10</xsl:with-param>
									<xsl:with-param name="filename">
										<xsl:value-of select="RR_FedNonFed_SubawardBudget:ATT10"/>
									</xsl:with-param>
								</xsl:call-template>
							</xsl:if>
							<!--</fo:block>
			...
			<xsl:for-each select="RR_FedNonFed_SubawardBudget:BudgetAttachments/RR_FedNonFedBudget:RR_FedNonFedBudget">
	...
	<xsl:template name="SingleYearPart1">
		...
		<fo:block>
			...
			<fo:block font-size="8pt">
				...
				<fo:inline>
					<xsl:value-of select="../RR_FedNonFedBudget:DUNSID"/>
				</fo:inline>
			</fo:block>
	...
	<xsl:template name="SingleYearPart2">
		...
		<fo:block>
						...
						<fo:table-cell hyphenate="true" language="en" border-style="solid" border-color="black" padding-start="1pt" padding-end="1pt" padding-before="1pt" padding-after="1pt" display-align="before" text-align="start">
							<fo:block>
								...
								<fo:table width="100%" space-before.optimum="1pt" space-after.optimum="2pt">
									...
									<fo:table-body>
										<xsl:if test="string-length(RR_FedNonFedBudget:Equipment)=0">
											<fo:table-row>
												<fo:table-cell >
													<fo:block/>
												</fo:table-cell>
			...
			<fo:table border-style="solid" border-color="black" width="100%" space-before.optimum="1pt" space-after.optimum="2pt">
				...
				<fo:table-body>
					<xsl:if test="RR_FedNonFedBudget:IndirectCosts=''">
						<fo:table-row>
							<fo:table-cell >
								<fo:block/>
							</fo:table-cell>
