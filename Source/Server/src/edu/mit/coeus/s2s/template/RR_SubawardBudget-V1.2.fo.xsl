...
<!-- $Revision:   1.4  $ -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:att="http://apply.grants.gov/system/Attachments-V1.0" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:footer="http://apply.grants.gov/system/Footer-V1.0" xmlns:glob="http://apply.grants.gov/system/Global-V1.0" xmlns:RR_SubawardBudget="http://apply.grants.gov/forms/RR_SubawardBudget-V1.2" xmlns:RR_Budget="http://apply.grants.gov/forms/RR_Budget-V1.1" xmlns:globLib="http://apply.grants.gov/system/GlobalLibrary-V2.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
							...
							<fo:table-row>
								...
								<fo:table-cell width="7.5in">
									...
									<fo:block font-size="8pt" hyphenate="true" language="en">
										...
										<!-- COEUSDEV-765 -->
                                     On this form, you will attach the R&amp;R Subaward Budget files for your grant application. Complete the subawardee budget(s) in
	...
	<xsl:template name="SingleYearPart1">
		...
		<fo:block>
			...
			<fo:block font-size="8pt">
				...
				<fo:inline>
					<xsl:value-of select="../RR_Budget:DUNSID"/>
				</fo:inline>
			</fo:block>
