...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:footer="http://apply.grants.gov/system/Footer-V1.0" xmlns:SFLLL="http://apply.grants.gov/forms/SFLLL-V1.1" xmlns:glob="http://apply.grants.gov/system/Global-V1.0" xmlns:codes="http://apply.grants.gov/system/UniversalCodes-V2.0" xmlns:globLib="http://apply.grants.gov/system/GlobalLibrary-V2.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
										...
										<fo:block>
											<fo:table width="100%" space-before.optimum="1pt" space-after.optimum="2pt">
												...
												<fo:table-body>
													...
													<fo:table-row>
														<fo:table-cell hyphenate="true" language="en" border-after-color="white" border-before-color="white" font-size="8px" display-align="before" text-align="left" width="172.75pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" border-style="solid" border-width="1pt" border-color="black">
															<fo:block>
											...
											<fo:table width="100%" space-before.optimum="1pt" space-after.optimum="2pt">
												...
												<fo:table-body>
													<fo:table-row>
														<fo:table-cell border-after-color="white" display-align="before" number-columns-spanned="2" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" text-align="start" border-style="solid" border-width="1pt" border-color="black">
															<fo:block>
													...
													<fo:table-row>
														<fo:table-cell border-after-color="white" border-before-color="white" border-end-color="black" border-start-color="black" font-size="8px" display-align="before" number-columns-spanned="2" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" text-align="start" border-style="solid" border-width="1pt" border-color="black">
															<fo:block>
													...
													<fo:table-row>
														<fo:table-cell border-before-color="white" font-size="8px" display-align="before" number-columns-spanned="2" width="30pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" text-align="start" border-style="solid" border-width="1pt" border-color="black">
															<fo:block>
																<xsl:for-each select="SFLLL:ReportEntity">
																	<xsl:for-each select="SFLLL:Prime">
																		<fo:table width="100%" space-before.optimum="1pt" space-after.optimum="2pt">
																			...
																			<fo:table-body>
																				<fo:table-row>
																					<fo:table-cell language="en" hyphenate="true" keep-together="always" border-after-color="white" border-before-color="white" border-end-color="white" border-start-color="white" font-size="8px" display-align="before" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" text-align="start" border-style="solid" border-width="1pt" border-color="black">
																						<fo:block>
																							...
																							<xsl:for-each select="SFLLL:OrganizationName">
																								<fo:inline font-size="8px" font-style="normal">
																									<xsl:apply-templates/>
																								</fo:inline>
																							</xsl:for-each>
																				...
																				<fo:table-row>
																					<fo:table-cell language="en" hyphenate="true" keep-together="always" font-size="8px" display-align="before" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" text-align="start" border-style="solid" border-width="1pt" border-color="white">
																						<fo:block keep-together="always">
																							<fo:inline font-size="8px" font-style="normal">* Address: </fo:inline>
																							<xsl:for-each select="SFLLL:Address">
																								<xsl:for-each select="SFLLL:Street1">
																									<fo:block keep-together="always">
																										<fo:inline font-size="8px" font-style="normal">
																											<xsl:value-of select="."/>
																										</fo:inline>
																								...
																								<fo:inline font-size="8px" font-style="normal">&#160;</fo:inline>
																								<xsl:for-each select="SFLLL:Street2">
																									<fo:block keep-together="always">
																										<fo:inline font-size="8px" font-style="normal">
																											<xsl:value-of select="."/>
																										</fo:inline>
																								...
																								<fo:inline font-size="8px" font-style="normal">&#160;</fo:inline>
																								<xsl:for-each select="SFLLL:City">
																									<fo:block keep-together="always">
																										<fo:inline font-size="8px" font-style="normal" keep-together="always">
																											<xsl:value-of select="."/>
																										</fo:inline>
																									</fo:block>
																								</xsl:for-each>
																								...
																								<fo:inline font-size="8px" font-style="normal">&#160;</fo:inline>
																								<xsl:for-each select="SFLLL:State">
																									<fo:block keep-together="always">
																										<fo:inline font-size="8px" font-style="normal">
																											<xsl:value-of select="."/>
																										</fo:inline>
																								...
																								<fo:inline font-size="8px" font-style="normal">&#160;</fo:inline>
																								<xsl:for-each select="SFLLL:ZipPostalCode">
																									<fo:block keep-together="always">
																										<fo:inline font-size="8px" font-style="normal">
																											<xsl:value-of select="."/>
																										</fo:inline>
																				...
																				<fo:table-row>
																					<fo:table-cell language="en" hyphenate="true" font-size="8px" display-align="before" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" text-align="start" border-style="solid" border-width="1pt" border-color="white">
																						<fo:block>
																							...
																							<xsl:for-each select="SFLLL:CongressionalDistrict">
																								<fo:block keep-together="always">
																									<fo:inline font-size="8px" font-style="normal">
																										<xsl:apply-templates/>
																									</fo:inline>
													...
													<fo:table-row>
														<fo:table-cell border-after-color="white" number-columns-spanned="2" border-end-color="black" display-align="before" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" text-align="start" border-style="solid" border-width="1pt" border-color="black">
															<fo:block>
													...
													<fo:table-row>
												<!--fo:table-cell border-after-color="white" number-columns-spanned="2" border-end-color="black" padding-end="3pt" border-style="solid" border-width="1pt" border-color="black" height="75pt" 
												font-family="Arial" line-height="13pt" padding="2pt" text-align="center" display-align="after" -->
														<fo:table-cell border-before-color="white" height="75pt"  number-columns-spanned="2" border-end-color="black" border-style="solid" border-width="1pt">
														...
														<fo:table-cell language="en" hyphenate="true" font-size="8px" display-align="before" height="9pt" width="30pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" text-align="start" border-style="solid" border-width="1pt" border-color="black">
															<fo:block>
																...
																<xsl:for-each select="SFLLL:FederalProgramName">
																	...
																	<xsl:for-each select="SFLLL:CFDANumber">
																		<fo:inline font-size="8px" font-style="normal">
																			<xsl:apply-templates/>
																		</fo:inline>
																	</xsl:for-each>
													...
													<fo:table-row>
														<fo:table-cell font-size="8px" display-align="before" number-columns-spanned="2" text-align="left" width="30pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" border-style="solid" border-width="1pt" border-color="black">
															<fo:block>
														...
														<fo:table-row>
														<fo:table-cell font-size="8px" display-align="before" text-align="left" width="30pt" number-columns-spanned="2" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" border-style="solid" border-width="1pt" border-color="black">
															<fo:block>
																						...
																						<xsl:for-each select="SFLLL:Individual">
																							<xsl:for-each select="SFLLL:Name">
																								<fo:table width="100%" space-before.optimum="1pt" space-after.optimum="2pt">
																									...
																									<fo:table-body>
																										<fo:table-row>
																											<fo:table-cell language="en" hyphenate="true" font-size="8px" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="white">
																												<fo:block>* Name: <xsl:for-each select="globLib:PrefixName">
																													...
																													</xsl:for-each>&#160;<xsl:for-each select="globLib:LastName">&#160;<fo:block keep-together="always">
																															<xsl:apply-templates/>
																														</fo:block>
																													</xsl:for-each>&#160;<xsl:for-each select="globLib:SuffixName">
																														<fo:block keep-together="always">
																							...
																							<xsl:for-each select="SFLLL:Address">
																								<fo:table width="100%" space-before.optimum="1pt" space-after.optimum="2pt">
																									...
																									<fo:table-body>
																										<fo:table-row>
																											<fo:table-cell language="en" hyphenate="true" font-size="8px" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="white">
																												<fo:block>* Address: <xsl:for-each select="SFLLL:Street1">
																														<fo:block keep-together="always">
																															<xsl:apply-templates/>
																														</fo:block>
																													</xsl:for-each>&#160;<xsl:for-each select="SFLLL:Street2">
																														<fo:block keep-together="always">
																															<xsl:apply-templates/>
																														</fo:block>
																													</xsl:for-each>
																										...
																										<fo:table-row>
																											<fo:table-cell language="en" hyphenate="true" font-size="8px" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="white">
																												<fo:block>
																													...
																													</xsl:for-each>&#160;<xsl:for-each select="SFLLL:State">
																														<fo:block keep-together="always">
																															<xsl:apply-templates/>
																														</fo:block>
																													</xsl:for-each>&#160;<xsl:for-each select="SFLLL:ZipPostalCode">
																														<fo:block keep-together="always">
																															<xsl:apply-templates/>
																														</fo:block>
													...
													<fo:table-row>
														<fo:table-cell language="en" hyphenate="true" font-size="8px" display-align="before" height="10pt" number-columns-spanned="2" text-align="left" width="30pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" border-style="solid" border-width="1pt" border-color="black">
															<fo:block>
														...
														<fo:table-row>
														<fo:table-cell font-size="8px" display-align="before" height="10pt" text-align="left" width="30pt" number-columns-spanned="2" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" border-style="solid" border-width="1pt" border-color="black">
															<fo:block>
																<fo:table width="100%" space-before.optimum="1pt" space-after.optimum="2pt">
																	<fo:table-column/>
																	<fo:table-body>
													...
													<fo:table-row>
														<fo:table-cell background-color="silver" font-size="7pt" height="9pt" text-align="left" width="30pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" border-style="solid" border-width="1pt" border-color="black">
