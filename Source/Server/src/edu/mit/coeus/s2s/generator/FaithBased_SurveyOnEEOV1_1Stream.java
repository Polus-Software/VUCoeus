/*
 * FaithBased_SurveyOnEEOV1_1Stream.java
 *
...
import gov.grants.apply.forms.faithbased_surveyoneeo_v1_1.*;

public class FaithBased_SurveyOnEEOV1_1Stream extends S2SBaseStream{ 
     private gov.grants.apply.forms.faithbased_surveyoneeo_v1_1.ObjectFactory objFactory;
     private CoeusXMLGenrator xmlGenerator;
     private String propNumber;
     
     
    /** Creates a new instance of FaithBased_SurveyOnEEOV1_1Stream */
    public FaithBased_SurveyOnEEOV1_1Stream() {
        objFactory = new gov.grants.apply.forms.faithbased_surveyoneeo_v1_1.ObjectFactory();
    ...
    private SurveyOnEEOType    getFaithBased_SurveyOnEEOV() throws CoeusXMLException,CoeusException,DBException,JAXBException{
        ...
        surveyOnEEO.setFormVersion("1.1");
