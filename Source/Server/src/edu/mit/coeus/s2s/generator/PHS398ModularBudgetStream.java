/*
 * @(#)PHS398ModularBudgetStream.java December 23, 2005, 10:12 AM
 *
...
import gov.grants.apply.forms.phs398_modularbudget_v1.*;
 ...
 * @Created on December 23, 2005, 10:12 AM
 * Class for generating the object stream for grants.gov PHS398_ModularBudget. It uses jaxb classes
 ...
 */
 ...
 public class PHS398ModularBudgetStream extends S2SBaseStream{ 
    private gov.grants.apply.forms.phs398_modularbudget_v1.ObjectFactory objFactory;
    ...
    /** Creates a new instance of PHS398ModularBudgetStream */
    public PHS398ModularBudgetStream(){
        objFactory = new gov.grants.apply.forms.phs398_modularbudget_v1.ObjectFactory();
    ...
    private PHS398ModularBudgetType getPHS398ModBudget() throws CoeusXMLException,CoeusException,DBException{
        ...
        try{
           ...
           modBudgetType.setCummulativeBudgetInfo(getCumBudget());
            ...
            utilFactory.log(jaxbEx.getMessage(),jaxbEx,"PHS398ModularBudgetStream","getPHS398ModBudget()");
