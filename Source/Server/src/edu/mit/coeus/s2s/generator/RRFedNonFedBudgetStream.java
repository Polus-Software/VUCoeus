...
import gov.grants.apply.forms.rr_fednonfedbudget_v1.*;
 ...
 **/
 ...
 public class RRFedNonFedBudgetStream extends S2SBaseStream{ 
    private gov.grants.apply.forms.rr_fednonfedbudget_v1.ObjectFactory objFactory;
    ...
    /** Creates a new instance of RRFedNonFedBudgetStream */
    public RRFedNonFedBudgetStream(){
        objFactory = new gov.grants.apply.forms.rr_fednonfedbudget_v1.ObjectFactory();
...
//           orgMaintFormBean = getOrgData(propDevFormBean.getOrganizationId());
           ...
           */
            ...
            * FormVersion
            */
           rrFedNonFedBudget.setFormVersion("1.0");  
