/*
 * @(#)NSFDeviationAuthorizationStream.java 
 *
...
import gov.grants.apply.forms.nsf_deviationauthorization_v1.*;
 ...
 */
 ...
 public class NSFDeviationAuthorizationStream extends S2SBaseStream{ 
     
    private gov.grants.apply.forms.nsf_deviationauthorization_v1.ObjectFactory objFactory;
    ...
    /** Creates a new instance of NSFDeviationAuthorizationStream */
    public NSFDeviationAuthorizationStream(){
        System.out.println("&&&&  Inside NSFDeviationAuthorizationStream constructor &&&&");
        objFactory = 
            new gov.grants.apply.forms.nsf_deviationauthorization_v1.ObjectFactory();
    ...
    private NSFDeviationAuthorizationType getNSFDeviationAuthorization() 
        ...
        try{
            ...
            nsfDeviationAuthorization.setFormVersion("1.0");
            
        }catch (JAXBException jaxbEx){
            utilFactory.log(jaxbEx.getMessage(),jaxbEx,
                "NSFDeviationAuthorizationStream", "getNSFDeviationAuthorization()");
