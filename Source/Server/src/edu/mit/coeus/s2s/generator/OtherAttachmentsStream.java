...
import gov.grants.apply.forms.other_v1.*;
 ...
 * Class for generating the object stream for grants.gov other_v1. It uses jaxb classes
 * which have been created under gov.grants.apply package. 
 */

 public class OtherAttachmentsStream extends S2SBaseStream  { 
    private gov.grants.apply.forms.other_v1.ObjectFactory objFactory;
   ...
   gov.grants.apply.system.attachments_v1.AttachedFileDataType attachedFileType;
    ...
    public OtherAttachmentsStream(){
        objFactory = new gov.grants.apply.forms.other_v1.ObjectFactory();
    ...
    private OtherNarrativeAttachmentsType getOtherAttachments()
        ...
        try{
          /**
            *FormVersion
          */ 
          otherNarrativeAttachmentsType.setFormVersion("1.0");
...
private gov.grants.apply.system.attachments_v1.AttachedFileDataType getAttachedFileType(Attachment attachment) 
    ...
    try{
        ...
        ex.printStackTrace();
        UtilFactory.log(ex.getMessage(),ex, "OtherAttachmentsStream", "getAttachedFile");
