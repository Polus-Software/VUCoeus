/*
 * @(#)RRKeyPersonexpandedStreamV1_1.java
 *
...
import gov.grants.apply.forms.rr_keypersonexpanded_v1_1.*;
 ...
 * @Created on Aug 9, 2006, 10:12 AM
 * Class for generating the object stream for grants.gov RRKeyPersonexpandedStreamV1_1. It uses jaxb classes
 ...
 * RRKeyPersonexpandedStreamV1_1 schema.
 */

 public class RRKeyPersonExpandedStreamV1_1 extends S2SBaseStream{

    private gov.grants.apply.forms.rr_keypersonexpanded_v1_1.ObjectFactory objFactory;
...
//    private gov.grants.apply.system.global_v1.ObjectFactory globalObjectFactory;
 ...
 //start case 2406
    ...
    /** Creates a new instance of RR_KeyPersonExpandedStreamv1_1 */
    public RRKeyPersonExpandedStreamV1_1(){
        System.out.println("****** inside RRKeyPersonexpandedStreamV1_1 constructor *******");
        objFactory = new gov.grants.apply.forms.rr_keypersonexpanded_v1_1.ObjectFactory();
    ...
    private RRKeyPersonExpandedType getRRKeyPerson() throws CoeusXMLException,
                                                CoeusException,DBException{

        RRKeyPersonExpandedType rrKeyPerson = null;
...
//           orgMaintFormBean = getOrgData(propDevFormBean.getOrganizationId());
           ...
           rrKeyPerson = objFactory.createRRKeyPersonExpanded();
           ...
           if(otherBioSketchs != null){
               gov.grants.apply.forms.rr_keypersonexpanded_v1_1.RRKeyPersonExpandedType.BioSketchsAttachedType
                            otherBioSketchsAttached =
                            objFactory.createRRKeyPersonExpandedTypeBioSketchsAttachedType();
           ...
           if(otherCurrentPending != null){
               gov.grants.apply.forms.rr_keypersonexpanded_v1_1.RRKeyPersonExpandedType.SupportsAttachedType
                            otherSupportsAttached =
                            objFactory.createRRKeyPersonExpandedTypeSupportsAttachedType();
               gov.grants.apply.system.attachments_v1.AttachedFileDataType
           ...
           if(additionalProfile != null){
               gov.grants.apply.forms.rr_keypersonexpanded_v1_1.RRKeyPersonExpandedType.AdditionalProfilesAttachedType
                    additionalProfilesAttached =
                    objFactory.createRRKeyPersonExpandedTypeAdditionalProfilesAttachedType();
               gov.grants.apply.system.attachments_v1.AttachedFileDataType
           ...
           rrKeyPerson.setFormVersion("1.1");
            ...
            UtilFactory.log(jaxbEx.getMessage(),jaxbEx,"RRKeyPersonExpandedStream",
                                                            "getRRKeyPerson()");
...
//                                        CURRENTPENDING_TYPE,CURRENTPENDING);
                ...
                UtilFactory.log(ex.getMessage(),ex, "RRKeyPersonExpandedStreamV1_1", "genExKeyPersonAttachment");
        ...
        if (extraKeyPersons != null){
           ...
           List extraPersonList = extraPersonProfileList.getExtraKeyPerson();
            ...
            for (int i=0; i<extraKeyPersons.size();i++){
                ...
                //personProfile is type  gov.grants.apply.forms.rr_keypersonexpanded_v1_1.PersonProfileDataType
                ...
                gov.grants.apply.forms.rr_keypersonexpanded_v1_1.PersonProfileDataType.ProfileType.OtherProjectRoleCategoryType otherRole;
...
//        hashValueType = globalObjectFactory.createHashValueType();
        ...
        try{
            ...
            ex.printStackTrace();
            UtilFactory.log(ex.getMessage(),ex, "RRKeyPersonExpandedStream", "getAttachedFile");
