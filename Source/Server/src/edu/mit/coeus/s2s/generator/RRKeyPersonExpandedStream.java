/*
 * @(#)RRKeyPersonexpandedStream.java
 *
...
import gov.grants.apply.forms.rr_keypersonexpanded_v1.*;
 ...
 * @Created on June 8, 2005, 10:12 AM
 * Class for generating the object stream for grants.gov RR_KeyPersonExpanded. It uses jaxb classes
 ...
 * RR_KeyPersonExpanded schema.
 */

 public class RRKeyPersonExpandedStream extends S2SBaseStream{

    private gov.grants.apply.forms.rr_keypersonexpanded_v1.ObjectFactory objFactory;
 ...
 //start case 2406
    ...
    /** Creates a new instance of RR_KeyyPersonExpandedStream */
    public RRKeyPersonExpandedStream(){
        System.out.println("****** inside RRKeyPersonExpandedStream constructor *******");
        objFactory = new gov.grants.apply.forms.rr_keypersonexpanded_v1.ObjectFactory();
...
//           orgMaintFormBean = getOrgData(propDevFormBean.getOrganizationId());
           ...
           if(otherBioSketchs != null){
               gov.grants.apply.forms.rr_keypersonexpanded_v1.RRKeyPersonExpandedType.BioSketchsAttachedType
           ...
           if(otherCurrentPending != null){
               gov.grants.apply.forms.rr_keypersonexpanded_v1.RRKeyPersonExpandedType.SupportsAttachedType
           ...
           if(additionalProfile != null){
               gov.grants.apply.forms.rr_keypersonexpanded_v1.RRKeyPersonExpandedType.AdditionalProfilesAttachedType
...
//                                        CURRENTPENDING_TYPE,CURRENTPENDING);
                ...
                UtilFactory.log(ex.getMessage(),ex, "RRKeyPersonExpandedStream", "genExKeyPersonAttachment");
        ...
        if (extraKeyPersons != null){
           ...
           List extraPersonList = extraPersonProfileList.getExtraKeyPerson();
            ...
            for (int i=0; i<extraKeyPersons.size();i++){
                ...
                //personProfile is type  gov.grants.apply.forms.rr_keypersonexpanded_v1.PersonProfileDataType
                ...
                gov.grants.apply.forms.rr_keypersonexpanded_v1.PersonProfileDataType.ProfileType.OtherProjectRoleCategoryType otherRole;
