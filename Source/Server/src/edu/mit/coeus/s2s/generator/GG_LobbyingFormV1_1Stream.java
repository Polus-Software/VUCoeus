/*
 * GG_LobbyingFormV1_1Stream.java
 *
...
import gov.grants.apply.forms.gg_lobbyingform_v1_1.*;
 ...
 * @author  jenlu
 */
public class GG_LobbyingFormV1_1Stream extends S2SBaseStream{ 
    private gov.grants.apply.forms.gg_lobbyingform_v1_1.ObjectFactory objFactory;
...
//    private DepartmentPersonFormBean aorBean;
    ...
    /** Creates a new instance of GG_LobbyingFormV1_1Stream */
    public GG_LobbyingFormV1_1Stream() {
        objFactory = new gov.grants.apply.forms.gg_lobbyingform_v1_1.ObjectFactory();
...
//        attachmentsObjFactory = new gov.grants.apply.system.attachments_v1.ObjectFactory();
    ...
    private  LobbyingFormType  getGG_LobbyingForm()
       ...
       try{
            ...
            * FormVersion
            */
           lobbyingForm.setFormVersion("1.1");  
           ...
           if (hmInfo != null && hmInfo.get("ORGANIZATION_NAME") != null){              
               if (hmInfo.get("ORGANIZATION_NAME").toString().length() > 60)
                   lobbyingForm.setApplicantName(hmInfo.get("ORGANIZATION_NAME").toString().substring(0,60));
               else    
           ...
           lobbyingForm.setSubmittedDate(getTodayDate());
            ...
            utilFactory.log(jaxbEx.getMessage(),jaxbEx,"GG_LobbyingFormV1_1Stream", "getGG_LobbyingForm()");
