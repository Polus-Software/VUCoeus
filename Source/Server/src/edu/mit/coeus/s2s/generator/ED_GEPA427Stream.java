...
import gov.grants.apply.forms.ed_gepa427_v1.*;
import java.util.*;
import javax.xml.bind.JAXBException;

public class ED_GEPA427Stream extends S2SBaseStream{ 
    private gov.grants.apply.forms.ed_gepa427_v1.ObjectFactory objFactory;
    ...
    /** Creates a new instance of ED_GEPA427Stream */
    public ED_GEPA427Stream() {
        objFactory = new gov.grants.apply.forms.ed_gepa427_v1.ObjectFactory();
    ...
    private  GEPA427AttachmentsType  getED_GEPA427()
       ...
       try{
           ...
           String description;
            ...
            utilFactory.log(jaxbEx.getMessage(),jaxbEx,"ED_GEPA427Stream", "getED_GEPA427()");
