/*
 * @(#)PerformanceSiteStream_V1_3.java
 *
...
import gov.grants.apply.forms.performancesite_1_3_v1_3.*;
 ...
 */
 ...
 public class PerformanceSiteStream_V1_3 extends S2SBaseStream{
    private gov.grants.apply.forms.performancesite_1_3_v1_3.ObjectFactory objFactory;
    ...
    gov.grants.apply.system.attachments_v1.AttachedFileDataType attachedFileType;
       ...
       public PerformanceSiteStream_V1_3(){
        objFactory = new gov.grants.apply.forms.performancesite_1_3_v1_3.ObjectFactory();
    ...
    private PerformanceSite13Type getPerformanceSite()
                            throws CoeusXMLException,CoeusException,DBException{
        PerformanceSite13Type performanceSite = null;
        
        try{
            performanceSite = objFactory.createPerformanceSite13();
            //version
            performanceSite.setFormVersion("1.3");
        ...
        //attachment
          ...
          if (attachedFileType.getFileName() != null)
            ...
            UtilFactory.log(jaxbEx.getMessage(),jaxbEx," PerformanceSiteStream_V1_3",
                                                    "get PerformanceSite()");
   ...
   //getOrgData - returns organizationBean with performing org data
    private OrganizationMaintenanceFormBean getOrgData()
     ...
     private RolodexDetailsBean getRolodexData(int rolodexId)
      ...
      private gov.grants.apply.forms.performancesite_1_3_v1_3.SiteLocationDataType getOtherSiteLocationDataType
             (HashMap hmSite) 
       ...
       if (!siteType.equals("4")) {
         ...
         if (rolodexDetailsBean != null) {
           siteLocationDataType.setOrganizationName(rolodexDetailsBean.getOrganization()); //JM 5-25-2011 want the name from rolodex instead of manually keyed location per 4.4.2
      ...
      private gov.grants.apply.forms.performancesite_1_3_v1_3.SiteLocationDataType getPrimarySiteLocationDataType
        ...
        try{
          ...
          HashMap hmNarrative = new HashMap();
           ...
           for (int row=0; row < size;row++) {
            ...
            utilFactory.log(jaxbEx.getMessage(),jaxbEx,"RRPerformanceSiteStream_V1_3","getAttachedSite()");
            throw new CoeusXMLException(jaxbEx.getMessage());
         }
        }
    ...
    try{
       attachedFileType.setHashValue(S2SHashValue.getValue(attachment.getContent()));
        ...
        ex.printStackTrace();
        UtilFactory.log(ex.getMessage(),ex, "RRPerformanceSiteStream_V1_3", "getAttachedFile");
