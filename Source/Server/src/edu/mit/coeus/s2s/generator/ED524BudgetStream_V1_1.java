...
import gov.grants.apply.forms.ed_524_budget_v1_1.*;
 ...
 * @author  ele
 */
public class ED524BudgetStream_V1_1 extends S2SBaseStream{ 
    private gov.grants.apply.forms.ed_524_budget_v1_1.ObjectFactory objFactory;
    ...
    /** Creates a new instance of ED524BudgetStream_V1_1 */
    public ED524BudgetStream_V1_1() {
        objFactory = new gov.grants.apply.forms.ed_524_budget_v1_1.ObjectFactory();
       ...
       //case 3210         totalCostSharingAllYrs = totalCostSharingAllYrs.add(totalCategoryCS);
        ...
        //case 3210        totalCostSharingAllYrs = totalCostSharingAllYrs.add(totalCategoryCS);
           ...
           if (fromDate.equals("NONE")){
               agency.setIsIndirectCostRateAgreementApproved("N: No");
              
           } else {
               fromDateType.setValue(convertDateStringToCalendar(fromDate));
               fromDateType.setIsIndirectCostRateAgreementApproved("Y: Yes");
               indirectCostType.setIndirectCostRateAgreementFromDate(fromDateType);
               agency.setIsIndirectCostRateAgreementApproved("Y: Yes");
                if (agencyName.equals("ED")){
                    ...
                    indirectCostType.setIsIndirectCostRateAgreementApproved("Y: Yes");
