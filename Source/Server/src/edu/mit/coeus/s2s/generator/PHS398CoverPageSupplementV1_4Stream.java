/*
 * PHS398CoverPageSupplementV1_4Stream.java
 *
...
import gov.grants.apply.forms.phs398_coverpagesupplement_1_4_v1_4.*;
 ...
 * @author  jenlu
 */
public class PHS398CoverPageSupplementV1_4Stream extends S2SBaseStream{
    private gov.grants.apply.forms.phs398_coverpagesupplement_1_4_v1_4.ObjectFactory objFactory;
    ...
    /** Creates a new instance of PHS398CoverPageSupplementV1_4Stream */
    public PHS398CoverPageSupplementV1_4Stream() {
        objFactory = new gov.grants.apply.forms.phs398_coverpagesupplement_1_4_v1_4.ObjectFactory();
        globallibObjFactory = new gov.grants.apply.system.globallibrary_v2.ObjectFactory();
        xmlGenerator = new CoeusXMLGenrator();   
    }
    
    private PHS398CoverPageSupplement14Type getPHS398CoverPageSupplement()
                throws CoeusXMLException,CoeusException,DBException,JAXBException{
        PHS398CoverPageSupplement14Type phs398CoverPageSupplement14Type = objFactory.createPHS398CoverPageSupplement14();
        ...
        try{
          ...
          */ 
            ...
            phs398CoverPageSupplement14Type.setFormVersion("1.4");
            phs398CoverPageSupplement14Type.setPDPI(getPDPIType());
            phs398CoverPageSupplement14Type.setClinicalTrial(getClinicalTrialType());
            phs398CoverPageSupplement14Type.setContactPersonInfo(getContactPersonInfoType());
            PHS398CoverPageSupplement14Type.StemCellsType stemCells = getStemCellsType();
            if (stemCells != null)
                phs398CoverPageSupplement14Type.setStemCells(stemCells);
             return phs398CoverPageSupplement14Type;
            
        }catch (JAXBException jaxbEx){
            utilFactory.log(jaxbEx.getMessage(),jaxbEx,"PHS398CoverPageSupplementV1_4Stream","getPHS398CoverPageSupplement()");
            throw new CoeusXMLException(jaxbEx.getMessage());
        }           
    }   
    
    private PHS398CoverPageSupplement14Type.PDPIType getPDPIType() throws JAXBException,DBException,CoeusException{
        
        PHS398CoverPageSupplement14Type.PDPIType pdpiType = objFactory.createPHS398CoverPageSupplement14TypePDPIType();
...
//        }
     ...
     private PHS398CoverPageSupplement14Type.ClinicalTrialType getClinicalTrialType() throws JAXBException,DBException,CoeusException{
        PHS398CoverPageSupplement14Type.ClinicalTrialType clinicalTrialType = objFactory.createPHS398CoverPageSupplement14TypeClinicalTrialType();
        //JIRA COEUSQA-3660 - START
     ...
     private PHS398CoverPageSupplement14Type.ContactPersonInfoType getContactPersonInfoType() throws JAXBException,DBException,CoeusException{
        PHS398CoverPageSupplement14Type.ContactPersonInfoType contactPersonInfoType = objFactory.createPHS398CoverPageSupplement14TypeContactPersonInfoType();
...
//                if (hmName != null)
      ...
      private PHS398CoverPageSupplement14Type.StemCellsType getStemCellsType() throws JAXBException,DBException,CoeusException{
        PHS398CoverPageSupplement14Type.StemCellsType stemCellsType = null;
        //JIRA COEUSQA-3660 - START
        ProposalYNQBean propYNQBean = getQuestionnaireAnswer("5", vctAnswerList);//Stem Cells
          if (propYNQBean != null) {
               stemCellsType = objFactory.createPHS398CoverPageSupplement14TypeStemCellsType();
              String answer = propYNQBean.getAnswer();
              if (answer.equals("Y")) {
