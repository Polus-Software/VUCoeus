...
import gov.grants.apply.forms.phs_coverletter_v1_2.*;
 ...
 */
 ...
 public class PHSCoverLetterV1_2Stream extends S2SBaseStream  {
    private gov.grants.apply.forms.phs_coverletter_v1_2.ObjectFactory objFactory;
...
//    private Calendar calendar;
    ...
    public PHSCoverLetterV1_2Stream(){
        objFactory = new gov.grants.apply.forms.phs_coverletter_v1_2.ObjectFactory();
    ...
    private PHSCoverLetter12Type getPHSCoverLetter()
        throws CoeusXMLException,CoeusException,DBException,JAXBException{
        PHSCoverLetter12Type phs398CoverLetterType = objFactory.createPHSCoverLetter12();
        PHSCoverLetter12Type.CoverLetterFileType coverLetterFile = objFactory.createPHSCoverLetter12TypeCoverLetterFileType();
...
//        String contentType;
        ...
        try{
          /**
            *FormVersion
          */ 
          phs398CoverLetterType.setFormVersion("1.2");
          ...
          Vector vctNarrative = proposalNarrativeTxnBean.getPropNarrativePDFForProposal(propNumber);
           ...
           for (int row=0; row < size;row++) {
            ...
            utilFactory.log(jaxbEx.getMessage(),jaxbEx,"PHSCoverLetterV1_2Stream","getPHSCoverLetter()");
