...
import gov.grants.apply.forms.phs398_researchplan_1_2_v1_2.*;
 ...
 */
 ...
 public class PHS398ResearchPlanV1_2Stream extends S2SBaseStream  { 
    private gov.grants.apply.forms.phs398_researchplan_1_2_v1_2.ObjectFactory objFactory;
    ...
    public PHS398ResearchPlanV1_2Stream(){
        objFactory = new gov.grants.apply.forms.phs398_researchplan_1_2_v1_2.ObjectFactory();
    ...
    private PHS398ResearchPlan12Type getPHS398ResearchPlanV1_2()
                throws CoeusXMLException,CoeusException,DBException,JAXBException{
                    
        PHS398ResearchPlan12Type phs398ResearchPlan12Type = objFactory.createPHS398ResearchPlan12();  
        PHS398ResearchPlan12Type.ResearchPlanAttachmentsType researchPlanAttachments = objFactory.createPHS398ResearchPlan12TypeResearchPlanAttachmentsType();
        ...
        PHS398ResearchPlan12Type.ApplicationTypeType applicationType = objFactory.createPHS398ResearchPlan12TypeApplicationTypeType();
        ...
        try{
          /**
            *FormVersion
          */ 
          phs398ResearchPlan12Type.setFormVersion("1.2");
          ...
          if (hmInfo.get("APPLICATIONTYPE") != null){
            ...
            phs398ResearchPlan12Type.setApplicationType(applicationType);
          }
...
//                        narrativeAttachment.setFileName(AttachedFileDataTypeStream.addExtension(fileNameForOtherType));
                        ...
                        PHS398ResearchPlan12Type.ResearchPlanAttachmentsType.IntroductionToApplicationType
                            introductionToApplication = objFactory.createPHS398ResearchPlan12TypeResearchPlanAttachmentsTypeIntroductionToApplicationType();
...
//                        narrativeAttachment.setFileName(AttachedFileDataTypeStream.addExtension(fileNameForOtherType));
                        ...
                        PHS398ResearchPlan12Type.ResearchPlanAttachmentsType.SpecificAimsType
                            specificAims = objFactory.createPHS398ResearchPlan12TypeResearchPlanAttachmentsTypeSpecificAimsType();
...
//                        narrativeAttachment.setFileName(AttachedFileDataTypeStream.addExtension(fileNameForOtherType));
                        ...
                        PHS398ResearchPlan12Type.ResearchPlanAttachmentsType.BackgroundSignificanceType
                            backgroundSignificance = objFactory.createPHS398ResearchPlan12TypeResearchPlanAttachmentsTypeBackgroundSignificanceType();
...
//                        narrativeAttachment.setFileName(AttachedFileDataTypeStream.addExtension(fileNameForOtherType));
                        ...
                        attachedFileType = getAttachedFileType(narrativeAttachment,attachmentsObjFactory);
                        PHS398ResearchPlan12Type.ResearchPlanAttachmentsType.ProgressReportType
                            progressReport = objFactory.createPHS398ResearchPlan12TypeResearchPlanAttachmentsTypeProgressReportType();
...
//                        narrativeAttachment.setFileName(AttachedFileDataTypeStream.addExtension(fileNameForOtherType));
                        ...
                        attachedFileType = getAttachedFileType(narrativeAttachment,attachmentsObjFactory);
                        PHS398ResearchPlan12Type.ResearchPlanAttachmentsType.ResearchDesignMethodsType
                            researchDesignMethods = objFactory.createPHS398ResearchPlan12TypeResearchPlanAttachmentsTypeResearchDesignMethodsType();
               ...
               if (narrativeType == 43) {//InclusionEnrollmentReport
                  if (attachment == null) {
                    proposalNarrativePDFSourceBean = proposalNarrativeTxnBean.getNarrativePDF(proposalNarrativePDFSourceBean);
                     ...
                     if (narrativeAttachment.getContent() != null){
                        attachedFileType = getAttachedFileType(narrativeAttachment,attachmentsObjFactory);
                        PHS398ResearchPlan12Type.ResearchPlanAttachmentsType.InclusionEnrollmentReportType
                            inclusionEnrollmentReport = objFactory.createPHS398ResearchPlan12TypeResearchPlanAttachmentsTypeInclusionEnrollmentReportType();
               ...
               if (narrativeType == 44) {//ProgressReportPublicationList
                  if (attachment == null) {
                    proposalNarrativePDFSourceBean = proposalNarrativeTxnBean.getNarrativePDF(proposalNarrativePDFSourceBean);
                     ...
                     if (narrativeAttachment.getContent() != null){
                        attachedFileType = getAttachedFileType(narrativeAttachment,attachmentsObjFactory);
                        PHS398ResearchPlan12Type.ResearchPlanAttachmentsType.ProgressReportPublicationListType  progressReportPublicationList 
                            = objFactory.createPHS398ResearchPlan12TypeResearchPlanAttachmentsTypeProgressReportPublicationListType();
               ...
               if (narrativeType == 46) {//MultiplePILeadershipPlan
                  if (attachment == null) {
                    proposalNarrativePDFSourceBean = proposalNarrativeTxnBean.getNarrativePDF(proposalNarrativePDFSourceBean);
                     ...
                     if (narrativeAttachment.getContent() != null){
                        attachedFileType = getAttachedFileType(narrativeAttachment,attachmentsObjFactory);
                        OtherResearchPlanSectionsType.MultiplePDPILeadershipPlanType multiplePILeadershipPlan =
                                objFactory.createOtherResearchPlanSectionsTypeMultiplePDPILeadershipPlanType();
...
//                        researchPlanAttachments.getAppendix().getAttachedFile().add(attachedFileType);
           ...
           if (attachmentGroup != null)
            ...
            phs398ResearchPlan12Type.setResearchPlanAttachments(researchPlanAttachments);
            return phs398ResearchPlan12Type;
           
         }catch (JAXBException jaxbEx){
            utilFactory.log(jaxbEx.getMessage(),jaxbEx,"PHS398ResearchPlanV1_2Stream","getPHS398ResearchPlanV1_2()");
    ...
    public Object getStream(HashMap ht) throws JAXBException, CoeusException, DBException{
        ...
        return getPHS398ResearchPlanV1_2();
    }     
