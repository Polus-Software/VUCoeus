...
import gov.grants.apply.forms.sflll_v1.*;
import gov.grants.apply.system.globallibrary_v1.*;

public class SFLLLStream extends S2SBaseStream{ 
     private gov.grants.apply.forms.sflll_v1.ObjectFactory objFactory;
    ...
    /** Creates a new instance of SFLLLStream */
    public SFLLLStream() {
         objFactory = new gov.grants.apply.forms.sflll_v1.ObjectFactory();
           ...
           if (hmInfo  !=  null){
                 if (hmInfo.get("REPORT_ENTITY_TYPE") != null ){
                     ...
                     if (reportEntity.getReportEntityType().equals("Prime")) 
                         reportEntity.setReportEntityIsPrime("Yes");
                     else 
                         reportEntity.setReportEntityIsPrime("No");
                 }
...
//                            AwardeeDataType.AddressType addressType = objFactory.createAwardeeDataTypeAddressType();
                            ...
                            if (orgContactRolodexDetailsBean.getPostalCode() != null)
                                    addressType.setZipCode(UtilFactory.convertNull(orgContactRolodexDetailsBean.getPostalCode()));
