...
import gov.grants.apply.forms.project_v1_1.*;
import java.util.*;
import javax.xml.bind.JAXBException;


public class ProjectV1_1Stream extends S2SBaseStream{ 
    private gov.grants.apply.forms.project_v1_1.ObjectFactory objFactory;
    ...
    /** Creates a new instance of ProjectV1_1Stream */
    public ProjectV1_1Stream() {
        objFactory = new gov.grants.apply.forms.project_v1_1.ObjectFactory();
