/*
 * PHS398ChecklistV1_1Stream.java
 *
...
import gov.grants.apply.forms.phs398_checklist_v1_1.*;
 ...
 */
 ...
 public class PHS398ChecklistV1_1Stream extends S2SBaseStream{ 
    private gov.grants.apply.forms.phs398_checklist_v1_1.ObjectFactory objFactory;
...
//    Attachment attachment = null;
  ...
  /** Creates a new instance of PHS398ChecklistV1_1Stream */
    public PHS398ChecklistV1_1Stream() {
        objFactory = new gov.grants.apply.forms.phs398_checklist_v1_1.ObjectFactory();
...
///////////////////////////////////////////////////////////////////////////////////////////////////
             ...
             checklistType.setFormVersion("1.1");             
             if (hmAppType != null)
           ...
           if (certAttachment.getCertifications() != null)              
            ...
            utilFactory.log(jaxbEx.getMessage(),jaxbEx,"PHS398ChecklistV1_1Stream","getPHS398Checklist()");
