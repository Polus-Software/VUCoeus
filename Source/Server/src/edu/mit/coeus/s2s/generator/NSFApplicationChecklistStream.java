/*
 * @(#)NSFApplicationChecklistStream.java October 19, 2004, 10:12 AM
 *
...
import gov.grants.apply.forms.nsf_applicationchecklist_v1.*;
 ...
 */
 ...
 public class NSFApplicationChecklistStream extends S2SBaseStream{ 
    private gov.grants.apply.forms.nsf_applicationchecklist_v1.ObjectFactory objFactory;
    ...
    /** Creates a new instance of NSFApplicationChecklistStream */
    public NSFApplicationChecklistStream(){
        objFactory = new gov.grants.apply.forms.nsf_applicationchecklist_v1.ObjectFactory();
    ...
    private NSFApplicationChecklistType getNSFApplicationChecklist() 
        ...
        try{
           ...
           */
           ...
           NSFApplicationChecklist.setFormVersion("1.0");
             
           return NSFApplicationChecklist;
           
        }catch (JAXBException jaxbEx){
            utilFactory.log(jaxbEx.getMessage(),jaxbEx,"NSFApplicationChecklistStream",
