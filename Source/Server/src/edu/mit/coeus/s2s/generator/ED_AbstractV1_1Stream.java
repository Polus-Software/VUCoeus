...
import gov.grants.apply.forms.ed_abstract_v1_1.*;
import java.util.*;
import javax.xml.bind.JAXBException;

public class ED_AbstractV1_1Stream extends S2SBaseStream{ 
    private gov.grants.apply.forms.ed_abstract_v1_1.ObjectFactory objFactory;
    ...
    /** Creates a new instance of ED_AbstractV1_1Stream */
    public ED_AbstractV1_1Stream() {
        objFactory = new gov.grants.apply.forms.ed_abstract_v1_1.ObjectFactory();
    ...
    private  AbstractAttachmentsType  getED_Abstract()
       ...
       try{
            ...
            * FormVersion
            */
           ED_abstract.setFormVersion("1.1");  
           ...
           String description;
            ...
            utilFactory.log(jaxbEx.getMessage(),jaxbEx,"ED_AbstractV1_1Stream", "getED_Abstract()");
