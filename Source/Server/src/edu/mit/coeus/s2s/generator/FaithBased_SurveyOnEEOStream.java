/*
 * FaithBased_SurveyOnEEOStream.java
 *
...
import gov.grants.apply.forms.faithbased_surveyoneeo_v1.*;

public class FaithBased_SurveyOnEEOStream extends S2SBaseStream{ 
     private gov.grants.apply.forms.faithbased_surveyoneeo_v1.ObjectFactory objFactory;
     private CoeusXMLGenrator xmlGenerator;
     private String propNumber;
     
     
    /** Creates a new instance of FaithBased_SurveyOnEEOStream */
    public FaithBased_SurveyOnEEOStream() {
        objFactory = new gov.grants.apply.forms.faithbased_surveyoneeo_v1.ObjectFactory();
    ...
    private SurveyOnEEOType getFaithBased_SurveyOnEEOV() throws CoeusXMLException,CoeusException,DBException,JAXBException{
        ...
        surveyOnEEO.setFormVersion("1.0");
