/*
 * @(#)RRPersonalDataStream_V1_1.java October 19, 2004, 10:12 AM
 *
...
import gov.grants.apply.forms.rr_personaldata_v1_1.*;
 ...
 */
 ...
 public class RRPersonalDataStream_V1_1 extends S2SBaseStream{ 
    private gov.grants.apply.forms.rr_personaldata_v1_1.ObjectFactory objFactory;
  ...
  private static final String PDPI = "PD/PI";
   gov.grants.apply.system.attachments_v1.AttachedFileDataType attachedFileType;
    ...
    public RRPersonalDataStream_V1_1(){
        objFactory = new gov.grants.apply.forms.rr_personaldata_v1_1.ObjectFactory();
    ...
    private RRPersonalDataType getRRPersonalData() 
        ...
        RRPersonalDataType RRPersonalData = objFactory.createRRPersonalData();
         try{ 
            ...
            RRPersonalData.setFormVersion("1.1");
        
           
        }catch (JAXBException jaxbEx){
            utilFactory.log(jaxbEx.getMessage(),jaxbEx,"RRPersonalDataStream_V1_1",
                                                        "getRRPersonalData()");
