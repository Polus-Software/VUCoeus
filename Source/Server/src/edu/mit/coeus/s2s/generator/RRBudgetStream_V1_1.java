 ...
 * @Created on Sept 11, 2006
 ...
 public class RRBudgetStream_V1_1 extends S2SBaseStream{ 
...
//    private ArrayList attachmentList;
    ...
    /** Creates a new instance of RR_BudgetStreamV1_1 */
    public RRBudgetStream_V1_1(){
...
//           orgMaintFormBean = getOrgData(propDevFormBean.getOrganizationId());
           ...
           */
           ...
           rrBudget.setFormVersion("1.1");  
            ...
            utilFactory.log(jaxbEx.getMessage(),jaxbEx,"RRBudgetStreaV1_1","getRRBudget()");
...
//    }
   ...
   private  gov.grants.apply.forms.rr_budget_v1_1.RRBudgetType.BudgetSummaryType getBudgetSummary()
        throws JAXBException, CoeusException {
        BudgetSummaryStream_V1_1 budgetSummaryStream = new BudgetSummaryStream_V1_1();
   ...
   private BudgetYear1DataType getBudgetYear1( CoeusVector cvPeriod)
        ...
        BudgetYearDataTypeStream_V1_1 budgetYearDataStream = new BudgetYearDataTypeStream_V1_1();
        attachmentMap = getAttachmentMap();
