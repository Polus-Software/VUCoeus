...
import gov.grants.apply.forms.rr_keyperson_v1_1.*;
 ...
 * Class for generating the object stream for grants.gov RR_KeyPersonV1.1. It uses jaxb classes
 ...
 * RR_KeyPersonV1.1 schema.
 */

 public class RRKeyPersonStreamV1_1 extends S2SBaseStream{

    private gov.grants.apply.forms.rr_keyperson_v1_1.ObjectFactory objFactory;
    private gov.grants.apply.system.globallibrary_v2.ObjectFactory globalObjFactoryV2;
    ...
    /** Creates a new instance of RRKeyPersonStreamV1_1 */
    public RRKeyPersonStreamV1_1(){
        System.out.println("****** inside RRKeyPersonStreamV1_1 constructor *******");
        objFactory = new gov.grants.apply.forms.rr_keyperson_v1_1.ObjectFactory();
        globalObjFactoryV2 = new gov.grants.apply.system.globallibrary_v2.ObjectFactory();
...
//           orgMaintFormBean = getOrgData(propDevFormBean.getOrganizationId());
           ...
           if(otherBioSketchs != null){
               gov.grants.apply.forms.rr_keyperson_v1_1.RRKeyPersonType.BioSketchsAttachedType
           ...
           if(otherCurrentPending != null){
               gov.grants.apply.forms.rr_keyperson_v1_1.RRKeyPersonType.SupportsAttachedType
           ...
           if(additionalProfile != null){
               gov.grants.apply.forms.rr_keyperson_v1_1.RRKeyPersonType.AdditionalProfilesAttachedType
           ...
           rrKeyPerson.setFormVersion("1.1");
            ...
            UtilFactory.log(jaxbEx.getMessage(),jaxbEx,"RRKeyPersonStreamV11",
                                                            "getRRKeyPerson()");
...
//                                        CURRENTPENDING_TYPE,CURRENTPENDING);
    ...
    private void genExKeyPersonAttachments() throws CoeusException,DBException{
        if (extraKeyPersons != null){
           ...
           gov.grants.apply.forms.rr_keyperson_v1_1.PersonProfileDataType.ProfileType.OtherProjectRoleCategoryType otherRole;
           ...
           List extraPersonList = extraPersonProfileList.getExtraKeyPerson();
            ...
            for (int i=0; i<extraKeyPersons.size();i++){
                ...
                //personProfile is type  gov.grants.apply.forms.rr_keyperson_v1_1.PersonProfileDataType
...
//              nameType.setFirstName(UtilFactory.setNullToUnknown(keyPersonBean.getFirstName()));
...
//                if (globalAddress.getStreet2() != null) addressType.setStreet2(globalAddress.getStreet2());
                ...
                KeyPersonV11TxnBean keyPersonV11TxnBean = new KeyPersonV11TxnBean();
                HashMap hmCountry;
                
                if (globalAddress.getCountry() != null) {   
                   hmCountry = keyPersonV11TxnBean.getCountryName(globalAddress.getCountry());
            ...
            if (globalAddress.getState() != null) {        
              hmState = keyPersonV11TxnBean.getStateName(globalAddress.getState());
...
//        int moduleNumber = s2sTxnBean.insertAutoGenNarrativeDetails(propNarrBean, propNarrPDFBean,false);
...
//      2nd vector is the remaining people - all are sorted by sort_id (done in stored procedure)
    ...
    private PersonProfileDataType getKeyPerson(KeyPersonBean keyPersonBean,boolean extraKeyPersonFlag)
        ...
        HumanNameDataType humanNameDataType =
                        globalObjFactoryV2.createHumanNameDataType();
        ...
        AddressDataType address = globalObjFactoryV2.createAddressDataType();
...
//             address.setStreet2(proposalPersonForm.getAddress2());
        ...
        String stateProvince = null;
        HashMap hmState= null;
        HashMap hmCountry= null;
         
        if (proposalPersonForm.getState() != null) {        
            hmState = keyPersonV11TxnBean.getStateName(proposalPersonForm.getState());
            if (hmState.get("STATE_NAME") != null )
                  stateProvince = hmState.get("STATE_NAME").toString();
         }
        
        if (proposalPersonForm.getCountryCode() != null) {   
            hmCountry = keyPersonV11TxnBean.getCountryName(proposalPersonForm.getCountryCode());
            if (hmCountry.get("COUNTRY_NAME") != null ){
        ...
        if (keyPersonBean.getRole().equals(PDPI))
             ...
             if ( s2sTxnBean.getIsNIHSponsor(propNumber) == 1){
                   ...
                   otherProjectRole = true;//Added for COEUSQA-4077
