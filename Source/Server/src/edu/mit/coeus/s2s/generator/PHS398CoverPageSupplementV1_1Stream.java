/*
 * PHS398CoverPageSupplementV1_1Stream.java
 *
...
import gov.grants.apply.forms.phs398_coverpagesupplement_v1_1.*;
 ...
 * @author  jenlu
 */
public class PHS398CoverPageSupplementV1_1Stream extends S2SBaseStream{ 
    private gov.grants.apply.forms.phs398_coverpagesupplement_v1_1.ObjectFactory objFactory;
    ...
    public PHS398CoverPageSupplementV1_1Stream() {
        objFactory = new gov.grants.apply.forms.phs398_coverpagesupplement_v1_1.ObjectFactory();
    ...
    private PHS398CoverPageSupplementType getPHS398CoverPageSupplement()
        ...
        try{
          ...
          */
            ...
            phs398CoverPageSupplementType.setFormVersion("1.1");
