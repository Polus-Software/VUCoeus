...
import edu.mit.coeus.irb.bean.MemberRolesBean;
...
public class MembershipTxnBean {
    ...
    public Vector getMemberRoles() throws CoeusException, DBException{
        ...
        if(dbEngine!=null){
            result = dbEngine.executeRequest("Coeus",
            "call get_membership_roles( <<OUT RESULTSET rset>> )", 
            "Coeus", param);
        }else{
            throw new CoeusException("db_exceptionCode.1000");
        }
     ...
     * <li>To fetch the data, it uses get_comm_member_expertise procedure.
     *
    ...
    throws CoeusException, DBException{
        ...
        if(dbEngine!=null){
            result = dbEngine.executeRequest("Coeus",
            "call get_comm_member_expertise( <<MEMBERSHIP_ID>>,"
