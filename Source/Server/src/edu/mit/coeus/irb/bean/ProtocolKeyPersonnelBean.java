...
public class ProtocolKeyPersonnelBean implements java.io.Serializable, IBaseDataBean {
    
    private static final String PROP_PERSON_ID = "PersonId";
    private static final String PROP_FACULTY_FLAG = "FacultyFlag";
    private static final String PROP_PERSON_ROLE = "PersonRole";
    ...
    /**
     * Method used to get the personRole
     * @return personRole String
     */
    ...
    public void setPersonRole(String newPersonRole) {
        ...
        propertySupport.firePropertyChange(PROP_PERSON_ROLE, oldPersonRole, 
                personRole);
     ...
     */
     public String toString(){
        ...
        strBffr.append("personRole  =>"+personRole );
