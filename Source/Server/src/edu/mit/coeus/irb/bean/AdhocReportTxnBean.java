...
//        // code below is valid code (do not delete)
        ...
        if(dbEngine!=null){
            ...
            "call get_adhoc_report_for_module( <<AW_MODULE>>, <<OUT RESULTSET rset>> )",
            "Coeus", param);
        }else{
    ...
    */
                                                                                                   ...
                                                                                                   edu.mit.coeus.exception.CoeusException, DBException
    {
        ...
        byte[] templateFileFromDb = pdfTxnBean.getIRBCorrespondenceTemplate(committeeId, Integer.parseInt(adhocDetailsBean.getFormId())) ;
