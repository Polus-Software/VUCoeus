...
public class OtherGroupTypeImpl implements edu.mit.coeus.xml.instprop.OtherGroupType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.xml.instprop.impl.runtime.UnmarshallableObject, edu.mit.coeus.xml.instprop.impl.runtime.XMLSerializable, edu.mit.coeus.xml.instprop.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.xml.instprop.OtherGroupType.class);
    }
    ...
    public edu.mit.coeus.xml.instprop.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.xml.instprop.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.xml.instprop.impl.OtherGroupTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            ...
            int idx_4 = idx2;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _OtherGroupDetails.get(idx_4 ++)), "OtherGroupDetails");
            context.endNamespaceDecls();
            int idx_5 = idx2;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _OtherGroupDetails.get(idx_5 ++)), "OtherGroupDetails");
            context.endAttributes();
...
+"\r\u0001q\u0000~\u00004sq\u0000~\u0000.t\u0000\tgroupNamet\u0000\u0000q\u0000~\u00004sq\u0000~\u0000\u0007ppsq\u0000~\u0000\tq\u0000~\u0000\u000ep\u0000sq\u0000~\u0000\u0000"
+"ppq\u0000~\u0000\u0013sq\u0000~\u0000\u0007ppsq\u0000~\u0000%q\u0000~\u0000\u000epq\u0000~\u0000\'q\u0000~\u00000q\u0000~\u00004sq\u0000~\u0000.t\u0000\tgroupDesc"
+"q\u0000~\u00008q\u0000~\u00004sq\u0000~\u0000\u0007ppsr\u0000 com.sun.msv.grammar.OneOrMoreExp\u0000\u0000\u0000\u0000\u0000\u0000"
+"\u0000\u0001\u0002\u0000\u0000xr\u0000\u001ccom.sun.msv.grammar.UnaryExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\u0003expq\u0000~\u0000\u0002x"
+"q\u0000~\u0000\u0003q\u0000~\u0000\u000epsq\u0000~\u0000\tq\u0000~\u0000\u000ep\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000Aq\u0000~\u0000\u000e"
+"psq\u0000~\u0000%q\u0000~\u0000\u000epsr\u00002com.sun.msv.grammar.Expression$AnyStringExp"
+"ression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003q\u0000~\u00005q\u0000~\u0000Ksr\u0000 com.sun.msv.grammar.An"
+"yNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000/q\u0000~\u00004sq\u0000~\u0000.t\u00000edu.mit.coeus.xml.i"
+"nstprop.OtherGroupDetailsTypet\u0000+http://java.sun.com/jaxb/xjc"
+"/dummy-elementssq\u0000~\u0000\u0007ppsq\u0000~\u0000%q\u0000~\u0000\u000epq\u0000~\u0000\'q\u0000~\u00000q\u0000~\u00004sq\u0000~\u0000.t\u0000\u0011O"
+"therGroupDetailsq\u0000~\u00008q\u0000~\u00004sr\u0000\"com.sun.msv.grammar.Expression"
...
+"un/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u000e\u0001pq\u0000~\u0000Eq\u0000~\u0000\u0005q\u0000~\u0000\bq\u0000~\u00009q\u0000"
+"~\u0000\u000fq\u0000~\u0000;q\u0000~\u0000$q\u0000~\u0000<q\u0000~\u0000Qq\u0000~\u0000\u0006q\u0000~\u0000Cq\u0000~\u0000Hq\u0000~\u0000Gq\u0000~\u0000@x"));
        }
        ...
        extends edu.mit.coeus.xml.instprop.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.xml.instprop.impl.OtherGroupTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  7 :
                        if (("ColumnName" == ___local)&&("" == ___uri)) {
                            _getOtherGroupDetails().add(((edu.mit.coeus.xml.instprop.impl.OtherGroupDetailsTypeImpl) spawnChildFromEnterElement((edu.mit.coeus.xml.instprop.impl.OtherGroupDetailsTypeImpl.class), 8, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        continue outer;
                    case  7 :
                        _getOtherGroupDetails().add(((edu.mit.coeus.xml.instprop.impl.OtherGroupDetailsTypeImpl) spawnChildFromLeaveElement((edu.mit.coeus.xml.instprop.impl.OtherGroupDetailsTypeImpl.class), 8, ___uri, ___local, ___qname)));
                        return ;
                    case  0 :
                        state = 3;
                        continue outer;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        continue outer;
                    case  7 :
                        _getOtherGroupDetails().add(((edu.mit.coeus.xml.instprop.impl.OtherGroupDetailsTypeImpl) spawnChildFromEnterAttribute((edu.mit.coeus.xml.instprop.impl.OtherGroupDetailsTypeImpl.class), 8, ___uri, ___local, ___qname)));
                        return ;
                    case  0 :
                        state = 3;
                        continue outer;
            ...
            while (true) {
                switch (state) {
                    ...
                    case  3 :
                        ...
                        continue outer;
                    case  7 :
                        _getOtherGroupDetails().add(((edu.mit.coeus.xml.instprop.impl.OtherGroupDetailsTypeImpl) spawnChildFromLeaveAttribute((edu.mit.coeus.xml.instprop.impl.OtherGroupDetailsTypeImpl.class), 8, ___uri, ___local, ___qname)));
                        return ;
                    case  0 :
                        state = 3;
                        continue outer;
                ...
                try {
                    switch (state) {
                        ...
                        case  1 :
                            ...
                            return ;
                        case  7 :
                            _getOtherGroupDetails().add(((edu.mit.coeus.xml.instprop.impl.OtherGroupDetailsTypeImpl) spawnChildFromText((edu.mit.coeus.xml.instprop.impl.OtherGroupDetailsTypeImpl.class), 8, value)));
                            return ;
                        case  0 :
                            state = 3;
                            continue outer;
