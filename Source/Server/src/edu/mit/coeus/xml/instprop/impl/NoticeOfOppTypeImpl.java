...
public class NoticeOfOppTypeImpl implements edu.mit.coeus.xml.instprop.NoticeOfOppType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.xml.instprop.impl.runtime.UnmarshallableObject, edu.mit.coeus.xml.instprop.impl.runtime.XMLSerializable, edu.mit.coeus.xml.instprop.impl.runtime.ValidatableObject
{

    protected java.lang.String _NoticeOfOppcode;
    protected java.lang.String _NoticeOfOppDesc;
    public final static java.lang.Class version = (edu.mit.coeus.xml.instprop.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.xml.instprop.NoticeOfOppType.class);
    }

    public java.lang.String getNoticeOfOppcode() {
        return _NoticeOfOppcode;
    }

    public void setNoticeOfOppcode(java.lang.String value) {
        _NoticeOfOppcode = value;
    }

    public java.lang.String getNoticeOfOppDesc() {
        return _NoticeOfOppDesc;
    }

    public void setNoticeOfOppDesc(java.lang.String value) {
        _NoticeOfOppDesc = value;
    }
    ...
    public edu.mit.coeus.xml.instprop.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.xml.instprop.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.xml.instprop.impl.NoticeOfOppTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.mit.coeus.xml.instprop.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        if (_NoticeOfOppcode!= null) {
            context.startElement("", "NoticeOfOppcode");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(((java.lang.String) _NoticeOfOppcode), "NoticeOfOppcode");
            } catch (java.lang.Exception e) {
                edu.mit.coeus.xml.instprop.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
        }
        if (_NoticeOfOppDesc!= null) {
            context.startElement("", "NoticeOfOppDesc");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(((java.lang.String) _NoticeOfOppDesc), "NoticeOfOppDesc");
            } catch (java.lang.Exception e) {
                edu.mit.coeus.xml.instprop.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
...
+"q\u0000~\u0000-t\u0000\u000fNoticeOfOppcodet\u0000\u0000q\u0000~\u00003sq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\rp\u0000sq\u0000~\u0000\u0000pp"
+"q\u0000~\u0000\u0012sq\u0000~\u0000\u0006ppsq\u0000~\u0000$q\u0000~\u0000\rpq\u0000~\u0000&q\u0000~\u0000/q\u0000~\u00003sq\u0000~\u0000-t\u0000\u000fNoticeOfOpp"
+"Descq\u0000~\u00007q\u0000~\u00003sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001"
...
+"ar/ExpressionPool;xp\u0000\u0000\u0000\u0007\u0001pq\u0000~\u0000\u0007q\u0000~\u00008q\u0000~\u0000\u000eq\u0000~\u0000:q\u0000~\u0000#q\u0000~\u0000;q\u0000~\u0000"
+"\u0005x"));
        }
        ...
        extends edu.mit.coeus.xml.instprop.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.xml.instprop.impl.NoticeOfOppTypeImpl.this;
        }
