...
<!-- Document generated with XSLfast v1.3 Visit www.XSLfast.com for 
    ...
    <xsl:template match="/">
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            <fo:layout-master-set>
                <fo:simple-page-master master-name="BudgetSummaryWithoutHeader" page-height="21cm" page-width="29.7cm">
                    <fo:region-body  margin-left=".79in" margin-top="auto" margin-bottom=".79in" margin-right=".79in">
                    </fo:region-body>
                ...
                <!--				<fo:simple-page-master master-name="CalculationMethodologyWithoutHeader" page-height="21cm" page-width="29.7cm">
    ...
    <xsl:template name="BudgetSummaryWithoutHeader">
        <fo:page-sequence master-name="BudgetSummaryWithoutHeader" master-reference="BudgetSummaryWithoutHeader">
            ...
            <fo:flow flow-name="xsl-region-body">
                        ...
                        <fo:table-header>
                            <fo:table-row>
                                ...
                                <fo:table-cell text-align="center" display-align="center">
                                    <fo:block white-space-collapse="true" text-align="start" color="#000000"  font-size="8.0pt" font-weight="bold">
                                        <xsl:if test="count(ReportPage/BudgetSummary/SalarySummaryFromEDI/Group/Details) != 0">EB Rate</xsl:if>
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell text-align="center" display-align="center">
                                    <fo:block white-space-collapse="true" text-align="start" color="#000000"  font-size="8.0pt" font-weight="bold">
                                        <xsl:if test="count(ReportPage/BudgetSummary/SalarySummaryFromEDI/Group/Details) != 0">Vac Rate</xsl:if>
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell text-align="center" display-align="center">
                                    <fo:block white-space-collapse="true" text-align="start" color="#000000"  font-size="8.0pt" font-weight="bold">
                                ...
                                <fo:table-cell text-align="center" display-align="center">
                                    <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt" font-weight="bold">
                                        <xsl:if test="count(ReportPage/BudgetSummary/SalarySummaryFromEDI/Group/Details) != 0">Fringe Benefits</xsl:if>
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell text-align="center" display-align="center">
                                    <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt" font-weight="bold">
                    ...
                    <fo:table table-layout="fixed">
                        ...
                        <fo:table-body>
                            <fo:table-row>
                                ...
                                <xsl:variable name="totNonPerCost">
                                    <xsl:value-of select="sum(ReportPage/BudgetSummary/BudgetSummaryNonPersonnel/Group/Details/CalculatedCost)"/>
                                </xsl:variable>
                                
                                <xsl:variable name="totSalCostShare">
                                    <xsl:value-of select="sum(ReportPage/BudgetSummary/SalarySummaryFromEDI/Group/Details/CostSharingAmount)"/>
                                </xsl:variable>
                                <xsl:variable name="totFringeCostShare">
                                    <xsl:value-of select="sum(ReportPage/BudgetSummary/SalarySummaryFromEDI/Group/Details/CalculatedCost)"/>
                                </xsl:variable>
                                <xsl:variable name="totNonPerCostShare">
                                    <xsl:value-of select="sum(ReportPage/BudgetSummary/BudgetSummaryNonPersonnel/Group/Details/CostSharingAmount)"/>
                                </xsl:variable>
                                ...
                                <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                                    <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                                        ...
                                        $<xsl:value-of select="format-number(($totSal+$totFringe+$totNonPerCost), '#,###,###,###,###,##0.00')"/>
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                                    <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                                        
                                        $<xsl:value-of select="format-number(($totSalCostShare+$totFringeCostShare+$totNonPerCostShare), '#,###,###,###,###,##0.00')"/>
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                                    <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                                        
                                        $<xsl:value-of select="format-number(($totSal+$totFringe+$totNonPerCost+$totSalCostShare+$totFringeCostShare+$totNonPerCostShare), '#,###,###,###,###,##0.00')"/>
                                    </fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                        </fo:table-body>
                ...
                <fo:block span="none">
                    <fo:table table-layout="fixed">
                        <fo:table-column column-width="570pt"/>
                        <fo:table-body>
                             <fo:table-row><fo:table-cell><fo:block/></fo:table-cell></fo:table-row>
...
-->                                                                
                                <fo:table-row>
                                    ...
                                    <xsl:variable name="totSal">
                                        <xsl:value-of select="sum(SalarySummaryFromEDI/Group/Details/SalaryRequested)"/>
                                    </xsl:variable>
                                    <xsl:variable name="totFringe">
                                        <xsl:value-of select="sum(SalarySummaryFromEDI/Group/Details/Fringe)"/>
                                    </xsl:variable>
                                    <xsl:variable name="totNonPerCost">
                                        <xsl:value-of select="sum(BudgetSummaryNonPersonnel/Group/Details/CalculatedCost)"/>
                                    </xsl:variable>
                                    <xsl:variable name="totIndirectCost">
                                        <xsl:value-of select="sum(BudgetIndirectCostsForReport/Group/Details/CalculatedCost)"/>
                                    </xsl:variable>
                                    
                                    <xsl:variable name="totSalCostShare">
                                        <xsl:value-of select="sum(SalarySummaryFromEDI/Group/Details/CostSharingAmount)"/>
                                    </xsl:variable>
                                    <xsl:variable name="totFringeCostShare">
                                        <xsl:value-of select="sum(SalarySummaryFromEDI/Group/Details/CalculatedCost)"/>
                                    </xsl:variable>
                                    <xsl:variable name="totNonPerCostShare">
                                        <xsl:value-of select="sum(BudgetSummaryNonPersonnel/Group/Details/CostSharingAmount)"/>
                                    </xsl:variable>
                                    <xsl:variable name="totIndirectCostShare">
                                        <xsl:value-of select="sum(BudgetIndirectCostsForReport/Group/Details/CostSharingAmount)"/>
                                    </xsl:variable>
                                    
                                    <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                                            
                                            $<xsl:value-of select="format-number(($totSal+$totFringe+$totNonPerCost+$totIndirectCost),'#,###,###,###,###,##0.00')"/>
                                        </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                                            
                                            $<xsl:value-of select="format-number(($totSalCostShare+$totFringeCostShare+$totNonPerCostShare+$totIndirectCostShare),'#,###,###,###,###,##0.00')"/>
                                        </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                                            
                                            $<xsl:value-of select="format-number(($totSal+$totFringe+$totNonPerCost+$totIndirectCost+$totSalCostShare+$totFringeCostShare+$totNonPerCostShare+$totIndirectCostShare),'#,###,###,###,###,##0.00')"/>
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                            </xsl:for-each>
        ...
        <fo:table table-layout="fixed">
            ...
            <fo:table-footer>
                <fo:table-row>
                    ...
                    <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" border-top-style="solid" border-top-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                            $<xsl:value-of select="format-number(sum(Details/CostSharingAmount), '##,###,###,###,###,###,##0.00')"/>
                        </fo:block>
                    </fo:table-cell>
                    <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" border-top-style="solid" border-top-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                            
                            $<xsl:value-of select="format-number((sum(Details/CalculatedCost)+sum(Details/CostSharingAmount)), 
            ...
            <fo:table-body>
                ...
                <xsl:for-each select="Details">
                    <fo:table-row>
                        ...
                        <fo:table-cell padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                            <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                                <xsl:if test="CostSharingAmount != 0">
                                    <xsl:text>$</xsl:text>
                                    <xsl:value-of disable-output-escaping="no" select="format-number(CostSharingAmount, '##,###,###,###,###,##0.00')"/>
                                </xsl:if>
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                            <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                                <xsl:text>$</xsl:text>
                                <xsl:value-of disable-output-escaping="no" select="format-number((CalculatedCost+CostSharingAmount), '##,###,###,###,###,##0.00')"/>
                            </fo:block>
                        </fo:table-cell>
                    </fo:table-row>
                </xsl:for-each>
                ...
                <fo:table-row>
                    ...
                    <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" border-top-style="solid" border-top-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                            ...
                            $<xsl:value-of select="format-number(sum(Details/Fringe), 
                            '##,###,###,###,###,###,##0.00')"/>
                        </fo:block>
                    </fo:table-cell>
                    <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" border-top-style="solid" border-top-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                            ...
                            $<xsl:value-of select="format-number(sum(Details/SalaryRequested), 
                    ...
                    <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" border-top-style="solid" border-top-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                            ...
                            $<xsl:value-of select="format-number(sum(Details/CostSharingAmount), 
                            '##,###,###,###,###,###,##0.00')"/>
                        </fo:block>
                    </fo:table-cell>
                    <xsl:variable name="salCostShare">
                        <xsl:value-of select="sum(Details/CostSharingAmount)"/>
                    </xsl:variable>
                    <xsl:variable name="costToSponsor">
                        <xsl:value-of select="sum(Details/SalaryRequested)"/>
                    </xsl:variable>
                    <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" border-top-style="solid" border-top-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                            $<xsl:value-of select="format-number(($salCostShare+$costToSponsor),'##,###,###,###,###,###,##0.00')"/>
                        </fo:block>
                    </fo:table-cell>
                </fo:table-row>
            </fo:table-footer>
            <fo:table-body border="1">
                ...
                <xsl:for-each select="Details">
                    <fo:table-row>
                        ...
                        <fo:table-cell padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                            <fo:block white-space-collapse="true" text-align="start" color="#000000"  font-size="8.0pt">
                                <xsl:value-of disable-output-escaping="no" select="EmployeeBenefitRate"/>
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                            <fo:block white-space-collapse="true" text-align="start" color="#000000"  font-size="8.0pt">
                                <xsl:value-of disable-output-escaping="no" select="VacationRate"/>
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                            <fo:block white-space-collapse="true" text-align="start" color="#000000"  font-size="8.0pt">
                        ...
                        <fo:table-cell padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                            <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                                <xsl:text>$</xsl:text>
                                <xsl:value-of disable-output-escaping="no" select="format-number(Fringe, '##,###,###,###,###,###,##0.00')"/>
                            </fo:block>
                        </fo:table-cell>
                        ...
                        <fo:table-cell text-align="end" display-align="center">
                            <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                                <xsl:text>$</xsl:text>
                                <xsl:value-of disable-output-escaping="no" select="format-number((CostSharingAmount+SalaryRequested), '##,###,###,###,###,###,##0.00')"/>
                            </fo:block>
                        </fo:table-cell>
                    </fo:table-row>
                </xsl:for-each>
    ...
    <xsl:template name="SalarySummaryForEDITotals">
        ...
        <fo:table table-layout="fixed">
            ...
            <fo:table-body>
                ...
                <xsl:variable name="totSalary">
                    <xsl:value-of select="sum(ReportPage/BudgetSummary/SalarySummaryFromEDI/Group/Details/SalaryRequested)"/>
                </xsl:variable>
                <xsl:variable name="totSalaryCostShare">
                    <xsl:value-of select="sum(ReportPage/BudgetSummary/SalarySummaryFromEDI/Group/Details/CostSharingAmount)"/>
                </xsl:variable>
                <fo:table-row>
                    ...
                    <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                            ...
                            $<xsl:value-of select="format-number($totFringe,'#,###,###,###,###,###,##0.00')"/>
                        </fo:block>
                    </fo:table-cell>
                    <fo:table-cell  border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                            
                            $<xsl:value-of select="format-number($totFringeCostShare,'#,###,###,###,###,###,##0.00')"/>
                        </fo:block>
                    </fo:table-cell>
                    <fo:table-cell  border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                            
                            $<xsl:value-of select="format-number(($totFringe+$totFringeCostShare),'#,###,###,###,###,###,##0.00')"/>
                        </fo:block>
                    </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                    ...
                    <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                            ...
                            $<xsl:value-of select="format-number(($totFringe+$totSalary),'#,###,###,###,###,###,##0.00')"/>
                        </fo:block>
                    </fo:table-cell>
                    <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                            
                            $<xsl:value-of select="format-number(($totSalaryCostShare+$totFringeCostShare),'#,###,###,###,###,###,##0.00')"/>
                        </fo:block>
                    </fo:table-cell>
                    <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                            
                            $<xsl:value-of select="format-number(($totFringe+$totSalary+$totSalaryCostShare+$totFringeCostShare),'#,###,###,###,###,###,##0.00')"/>
                        </fo:block>
                    </fo:table-cell>
                </fo:table-row>
            </fo:table-body>
    ...
    <xsl:template name="IndirectCosts">
        ...
        <fo:table table-layout="fixed">
            ...
            <fo:table-footer>
                <fo:table-row>
                    <fo:table-cell padding-left="15.0pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt"  font-weight="bold">
                    ...
                    <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" border-top-style="solid" border-top-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                            ...
                            $<xsl:value-of select="format-number((sum(Details/CostSharingAmount)+sum(Details/CalculatedCost)),'###,###,###,###,###,##0.00')"/>
                        </fo:block>
                    </fo:table-cell>
                </fo:table-row>
            </fo:table-footer>
				...
				<fo:table font-family="Arial" font-size="9pt" table-layout="fixed" width="100%" border-spacing="2pt">
						...
						<fo:table-body start-indent="0pt">
								...
								<fo:table-cell padding="0" padding-bottom="0" padding-top="10pt" number-columns-spanned="4" height="10" text-align="left" display-align="center">
									<fo:block>
										<fo:inline font-family="Arial" font-size="15pt" font-weight="bold">
											<xsl:text>Coeus Proposal Development - Cost Sharing Summary</xsl:text>
										</fo:inline>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								...
								<fo:table-cell padding="2pt" font-family="Arial" font-size="9pt" display-align="center">
									<fo:block>
										<xsl:value-of select="ReportHeader/BudgetVersion"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
					...
					<xsl:if test="ReportHeader/PrintBudgetComment = &apos;Yes&apos;">
						<fo:inline-container>
							<fo:block>
								<xsl:text>&#x2029;</xsl:text>
							</fo:block>
									...
									<fo:block>
										<fo:inline font-weight="bold">
											<xsl:text>Period: </xsl:text>
                                                                                 ...
                                                                                 <xsl:value-of select="ReportHeader/Period"/>
									</fo:block>
								</fo:table-cell>
								<fo:table-cell padding="2pt" font-family="Arial" font-size="9pt" display-align="center">
									<fo:block>
