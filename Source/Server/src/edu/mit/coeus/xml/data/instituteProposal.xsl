				...
				<fo:flow flow-name="xsl-region-body">
					<fo:block>
						<xsl:for-each select="$XML">
							<xsl:if test="count(   InstituteProposal/DisclosureItem  ) &gt; 0">
								<xsl:for-each select="InstituteProposal">
									<xsl:for-each select="SchoolInfo">
										...
										<fo:block font-family="Times New Roman" font-size="9pt" text-align="center" margin="0pt">
											<fo:block>
										...
										<fo:block font-family="Times New Roman" font-size="9pt" text-align="center" margin="0pt">
											<fo:block>
												<fo:inline font-size="14pt" font-weight="bold">
													<xsl:text>Proposal Summary - Disclosure Status</xsl:text>
												</fo:inline>
											</fo:block>
										</fo:block>
									</xsl:for-each>
											...
											<fo:table-cell padding="0" display-align="center">
												<fo:block>
													...
													<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
														...
														<fo:table-body start-indent="0pt">
															<fo:table-row>
																<fo:table-cell padding-left="0" padding-right="0" padding="2pt" display-align="center">
																	<fo:block>
																		<xsl:for-each select="InstituteProposal">
																...
																<fo:table-cell padding-right="0" padding="2pt" text-align="right" display-align="center">
																	<fo:block>
																		<fo:inline font-family="Times New Roman" font-size="9pt" font-weight="bold">
														...
														<fo:table-body start-indent="0pt">
															<fo:table-row>
																...
																<fo:table-cell padding-right="0" padding="2pt" text-align="right" display-align="center">
																	<fo:block>
																		<fo:inline font-family="Times New Roman" font-size="9pt" font-weight="bold">
																			<xsl:text>Sponsor Proposal Number:</xsl:text>
																		</fo:inline>
																	</fo:block>
																</fo:table-cell>
																<fo:table-cell padding="2pt" display-align="center">
										...
										<fo:table-row>
											<fo:table-cell number-columns-spanned="2" padding="2pt" display-align="center">
												<fo:block>
													<fo:block/>
													<fo:inline font-family="Times New Roman" font-size="9pt" font-weight="bold">
														<xsl:text>&#160;&#160;&#160;&#160; This proposal has financial interest disclosures associated with it which are in Pending or Incomplete status.</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
										</fo:table-row>
													...
													<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
														...
														<fo:table-body start-indent="0pt">
															...
															<fo:table-row>
																...
																<fo:table-cell padding-right="30pt" padding="2pt" text-align="center" display-align="after">
																	<fo:block>
																		<fo:block/>
																		<fo:block/>
																		<fo:block text-align="center">
															...
															<fo:table-body start-indent="0pt">
																...
																<fo:table-row>
																	...
																	<fo:table-cell padding="2pt" display-align="center">
																		<fo:block>
																			<xsl:for-each select="InstituteProposal">
																				<xsl:for-each select="opportunityID">
																					<xsl:variable name="value-of-template">
																						<xsl:apply-templates/>
																					</xsl:variable>
																					<xsl:choose>
														...
														<xsl:if test="principalInvFlag = &apos;true&apos;">
															...
															<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
																...
																<fo:table-body start-indent="0pt">
																	...
																	<fo:table-row>
																		<fo:table-cell padding-left="60pt" number-columns-spanned="3" padding="2pt" display-align="before">
																			<fo:block>
																				<fo:inline-container>
																					<fo:block>
																						<xsl:text>&#x2029;</xsl:text>
							...
							<xsl:if test="boolean( InstituteProposal/mailingInfo/deadlineType ) or  boolean(  InstituteProposal/mailingInfo/mailByOSP  ) or  boolean(  InstituteProposal/mailingInfo/mailType  ) or  string-length(  InstituteProposal/mailingInfo/comments  ) &gt; 0">
								...
								<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
									...
									<fo:table-body start-indent="0pt">
										<fo:table-row>
											<fo:table-cell font-family="Arial" font-size="9pt" padding="0" padding-left="30pt" display-align="center">
												<fo:block>
													<xsl:if test="boolean( InstituteProposal/mailingInfo/deadlineType ) or  boolean(  InstituteProposal/mailingInfo/mailByOSP  ) or  boolean(  InstituteProposal/mailingInfo/mailType  ) or  string-length(  InstituteProposal/mailingInfo/comments  ) &gt; 0">
															...
															<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
																...
																<fo:table-body start-indent="0pt">
																	<fo:table-row>
																		...
																		<fo:table-cell font-family="Arial" font-size="9pt" padding-left="1pt" padding="2pt" display-align="before">
																			<fo:block/>
																		</fo:table-cell>
																		<fo:table-cell font-family="Arial" font-size="9pt" padding-left="1pt" padding="2pt" display-align="before">
																			<fo:block>
																...
																<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
																	...
																	<fo:table-body start-indent="0pt">
																		<xsl:for-each select="specialReviews">
																			...
																			<fo:table-row>
																				<fo:table-cell font-family="Arial" font-size="9pt" padding-left="30pt" padding-top="0" padding="2pt" display-align="before">
																					<fo:block>
																				...
																				<fo:table-cell font-family="Arial" font-size="9pt" padding-top="0" number-columns-spanned="4" padding="2pt" display-align="before">
																					<fo:block>
																						<xsl:if test="string-length(  comments  ) &gt;0">
																							<xsl:for-each select="comments">
																								<fo:inline-container>
