										...
										<fo:table-cell padding="2pt" text-align="center" display-align="center">
											<fo:block>
												<fo:inline font-family="Times New Roman" font-size="15pt" font-weight="bold">
													<xsl:text>Negotiation Report</xsl:text>
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
															...
															<fo:table-body start-indent="0pt">
																<xsl:for-each select="negotiationData">
																	...
																	<fo:table-row>
																		...
																		<fo:table-cell padding-left="0" padding-right="0" number-columns-spanned="2" padding="2pt" display-align="center">
																			<fo:block/>
																		</fo:table-cell>
																	</fo:table-row>
																	<fo:table-row>
																				...
																				<fo:block margin="0pt">
																					<fo:block>
																						<fo:inline font-size="10pt" font-weight="bold">
																							<xsl:text>Most Recent Activity</xsl:text>
																						</fo:inline>
																					</fo:block>
																				</fo:block>
																			</fo:block>
																	...
																	<fo:table-row>
																		<fo:table-cell padding-left="6pt" number-columns-spanned="6" padding="2pt" display-align="center">
																			<fo:block>
																				<fo:inline-container>
																					<fo:block>
																						<xsl:text>&#x2029;</xsl:text>
																				...
																				<fo:block padding-left="6pt" white-space="pre" white-space-collapse="false" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" margin="0pt">
																					<fo:block>
																						<xsl:for-each select="activities">
