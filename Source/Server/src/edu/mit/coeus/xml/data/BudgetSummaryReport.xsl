                            ...
                            <fo:table-row>
                                ...
                                <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                                    <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                                        ...
                                        $<xsl:value-of select="format-number(ReportPage/BudgetSummary/TotalDirectCost, '#,###,###,###,###,##0.00')"/>
                                    </fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                        </fo:table-body>
                ...
                <fo:table-row>
                    ...
                    <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                            ...
                            $<xsl:value-of select="format-number(sum(ReportPage/BudgetSummary/SalarySummaryFromEDI/Group/Details/SalaryRequested),'#,###,###,###,###,###,##0.00')"/>
                        </fo:block>
                    </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                    ...
                    <fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
                        <fo:block white-space-collapse="true" text-align="end" color="#000000"  font-size="8.0pt">
                            ...
                            $<xsl:value-of select="format-number(sum(ReportPage/BudgetSummary/SalarySummaryFromEDI/Group/Details/Fringe),'#,###,###,###,###,###,##0.00')"/>
                        </fo:block>
                    </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
