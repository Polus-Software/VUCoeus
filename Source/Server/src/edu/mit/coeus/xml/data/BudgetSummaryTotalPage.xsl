...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="default-page" page-height="8.5in" page-width="11in" margin-left="1.0in" margin-right="1.5in">
				<fo:region-body margin-top="auto" margin-bottom="0.2in"/>
				<fo:region-before extent="auto"/>
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:block>
						<xsl:for-each select="$XML">
							...
							<fo:table border-color="black" border-width="10%" table-layout="fixed" width="100%" border-spacing="2pt">
								...
								<fo:table-body start-indent="0pt">
									...
									<fo:table-row>
										<fo:table-cell padding="0" padding-bottom="0" padding-top="10pt" number-columns-spanned="4" height="10" text-align="center" display-align="center">
											<fo:block>
												<fo:block/>
									...
									<fo:table-row>
										...
										<fo:table-cell font-family="Times New Roman" font-size="9pt" padding-bottom="0" padding-right="10pt" number-columns-spanned="3" padding="2pt" text-align="left" display-align="before">
											<fo:block>
												<fo:inline-container>
													<fo:block>
														<xsl:text>&#x2029;</xsl:text>
							...
							<xsl:if test="budgetSalary/PrintBudgetComment = &apos;Yes&apos;">
								<fo:inline-container>
									<fo:block>
										<xsl:text>&#x2029;</xsl:text>
									</fo:block>
								...
								<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
									...
									<fo:table-body start-indent="0pt">
										<fo:table-row>
											...
											<fo:table-cell font-family="Times New Roman" font-size="9pt" number-columns-spanned="3" padding="2pt" display-align="center">
												<fo:block>
													<fo:inline-container>
														<fo:block>
															<xsl:text>&#x2029;</xsl:text>
							...
							<xsl:choose>
												...
												<fo:table-body start-indent="0pt">
													<xsl:for-each select="salary">
														<fo:table-row>
															...
															<fo:table-cell border="solid 1pt gray" padding="0" height="1" text-align="right" display-align="center">
																<fo:block>
																	<xsl:for-each select="Period">
																		<xsl:for-each select="periodCost">
																			<xsl:choose>
											...
											<fo:table font-family="Times New Roman" font-size="8pt" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="-1pt">
												...
												<fo:table-header start-indent="0pt">
													<fo:table-row>
														...
														<fo:table-cell border="solid 1pt gray" padding="0" height="13" display-align="center">
															<fo:block>
																<fo:inline font-size="10pt" font-weight="bold">
																	<xsl:text>Total</xsl:text>
																</fo:inline>
											...
											<fo:table font-family="Times New Roman" font-size="8pt" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="-1pt">
												...
												<fo:table-header start-indent="0pt">
													<fo:table-row>
														...
														<fo:table-cell border="solid 1pt gray" padding="0" height="19" display-align="center">
															<fo:block>
																<fo:inline font-size="10pt" font-weight="bold">
																	<xsl:text>Description</xsl:text>
																</fo:inline>
											...
											<fo:table font-family="Times New Roman" font-size="8pt" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="-1pt">
												...
												<fo:table-header start-indent="0pt">
													<fo:table-row>
														...
														<fo:table-cell border="solid 1pt gray" padding="0" height="23" display-align="center">
															<fo:block>
																<fo:inline font-size="10pt" font-weight="bold">
																	<xsl:text>Description</xsl:text>
																</fo:inline>
															...
															<fo:table-cell border="solid 1pt gray" padding="0" text-align="right" display-align="center">
																<fo:block>
																	<xsl:for-each select="Period">
																		<xsl:for-each select="periodCost">
																			<xsl:choose>
																				<xsl:when test="../budgetPeriodID  = 14  and  ../../name  != &quot;Total&quot;">
																					<fo:inline>
																						<xsl:text>$</xsl:text>
																					</fo:inline>
																					<fo:inline>
								...
								<xsl:when test="budgetSalary/totalPeriod =15">
									<xsl:for-each select="budgetSalary">
										<fo:inline-container>
											<fo:block>
												<xsl:text>&#x2029;</xsl:text>
															...
															<fo:table-cell border="solid 1pt gray" padding="0" text-align="right" display-align="center">
																<fo:block>
																	<xsl:for-each select="Period">
																		<xsl:for-each select="periodCost">
																			<xsl:choose>
																				<xsl:when test="../budgetPeriodID  = 15  and  ../../name  != &quot;Total&quot;">
																					<fo:inline>
																						<xsl:text>$</xsl:text>
																					</fo:inline>
																					<fo:inline>
		...
		<fo:static-content flow-name="xsl-region-after">
			<fo:block>
				<xsl:for-each select="$XML">
					...
					<fo:table padding-bottom="10pt" table-layout="fixed" width="100%" border-spacing="2pt">
						<fo:table-column column-width="proportional-column-width(1)"/>
