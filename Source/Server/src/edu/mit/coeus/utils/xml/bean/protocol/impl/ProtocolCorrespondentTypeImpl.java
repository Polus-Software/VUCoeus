...
public class ProtocolCorrespondentTypeImpl implements edu.mit.coeus.utils.xml.bean.protocol.ProtocolCorrespondentType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.ValidatableObject
{
    ...
    protected boolean has_CorrespondentTypeCode;
    protected int _CorrespondentTypeCode;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.protocol.ProtocolCorrespondentType.class);
    }
    ...
    public int getCorrespondentTypeCode() {
        return _CorrespondentTypeCode;
    }

    public void setCorrespondentTypeCode(int value) {
        _CorrespondentTypeCode = value;
        has_CorrespondentTypeCode = true;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolCorrespondentTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        if (!has_CorrespondentTypeCode) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "CorrespondentTypeCode"));
        }
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "CorrespondentTypeCode");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printInt(((int) _CorrespondentTypeCode)), "CorrespondentTypeCode");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
...
+"ppq\u0000~\u0000\u0016sq\u0000~\u0000)ppsq\u0000~\u0000+q\u0000~\u0000\u0018pq\u0000~\u0000-q\u0000~\u00006q\u0000~\u0000:sq\u0000~\u00004t\u0000\bPersonIdq"
+"\u0000~\u0000>sq\u0000~\u0000\u000epp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0016sq\u0000~\u0000)ppsq\u0000~\u0000+q\u0000~\u0000\u0018pq\u0000~\u0000-q\u0000~\u00006q\u0000~\u0000"
+":sq\u0000~\u00004t\u0000\nPersonNameq\u0000~\u0000>sq\u0000~\u0000\u000epp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0016sq\u0000~\u0000)ppsq\u0000~\u0000"
+"+q\u0000~\u0000\u0018pq\u0000~\u0000-q\u0000~\u00006q\u0000~\u0000:sq\u0000~\u00004t\u0000\u000fNonEmployeeFlagq\u0000~\u0000>sq\u0000~\u0000\u000epp\u0000"
+"sq\u0000~\u0000\u0000ppq\u0000~\u0000Asq\u0000~\u0000)ppsq\u0000~\u0000+q\u0000~\u0000\u0018pq\u0000~\u0000-q\u0000~\u00006q\u0000~\u0000:sq\u0000~\u00004t\u0000\u0015Cor"
+"respondentTypeCodeq\u0000~\u0000>sq\u0000~\u0000\u000epp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0016sq\u0000~\u0000)ppsq\u0000~\u0000+q"
+"\u0000~\u0000\u0018pq\u0000~\u0000-q\u0000~\u00006q\u0000~\u0000:sq\u0000~\u00004t\u0000\u0015CorrespondentTypeDescq\u0000~\u0000>sq\u0000~\u0000"
+"\u000epp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0016sq\u0000~\u0000)ppsq\u0000~\u0000+q\u0000~\u0000\u0018pq\u0000~\u0000-q\u0000~\u00006q\u0000~\u0000:sq\u0000~\u00004t\u0000"
+"\bCommentsq\u0000~\u0000>sq\u0000~\u0000\u000epp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0013ppsr\u0000%com.sun.msv.datat"
+"ype.xsd.DateTimeType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000)com.sun.msv.datatype.xsd."
+"DateTimeBaseType\u0014W\u001a@3\u00a5\u00b4\u00e5\u0002\u0000\u0000xq\u0000~\u0000\u001aq\u0000~\u0000 t\u0000\bdateTimeq\u0000~\u00002q\u0000~\u0000&s"
+"q\u0000~\u0000\'q\u0000~\u0000\u0097q\u0000~\u0000 sq\u0000~\u0000)ppsq\u0000~\u0000+q\u0000~\u0000\u0018pq\u0000~\u0000-q\u0000~\u00006q\u0000~\u0000:sq\u0000~\u00004t\u0000\u000fU"
+"pdateTimestampq\u0000~\u0000>sq\u0000~\u0000\u000epp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0016sq\u0000~\u0000)ppsq\u0000~\u0000+q\u0000~\u0000\u0018"
+"pq\u0000~\u0000-q\u0000~\u00006q\u0000~\u0000:sq\u0000~\u00004t\u0000\nUpdateUserq\u0000~\u0000>sr\u0000\"com.sun.msv.gram"
...
+"\u0000\rq\u0000~\u0000\fq\u0000~\u0000\u0092q\u0000~\u0000\tq\u0000~\u0000\u0005q\u0000~\u0000*q\u0000~\u0000iq\u0000~\u0000oq\u0000~\u0000uq\u0000~\u0000\u000bq\u0000~\u0000{q\u0000~\u0000\u0081q\u0000~"
+"\u0000\u0087q\u0000~\u0000\u008dq\u0000~\u0000\u0099q\u0000~\u0000\u009fq\u0000~\u0000\u0012q\u0000~\u0000nq\u0000~\u0000tq\u0000~\u0000zq\u0000~\u0000\u0086q\u0000~\u0000\bq\u0000~\u0000\u008cq\u0000~\u0000\u009eq\u0000~"
+"\u0000\u0006q\u0000~\u0000@q\u0000~\u0000\u0080q\u0000~\u0000\u0007x"));
        }
        ...
        extends edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolCorrespondentTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  21 :
                        ...
                        break;
                    case  15 :
                        if (("CorrespondentTypeCode" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 16;
                            return ;
                        }
        ...
        {
            try {
                _CorrespondentTypeCode = javax.xml.bind.DatatypeConverter.parseInt(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_CorrespondentTypeCode = true;
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
