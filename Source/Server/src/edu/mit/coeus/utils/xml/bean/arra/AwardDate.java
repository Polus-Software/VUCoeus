...
/**
 * Award Date. The date the award was signed.
 * Java content class for AwardDate element declaration.
 * <p>The following schema fragment specifies the expected content contained within this java content object. (defined at file:/D:/Backup%20%20-%20Mohan/CoeusDocs/Proposal%20Printing/schemas/FederalReportingDataElements_v1/RecoveryRR/Version%201/Version%201.0/Schemas/Extension/recoveryrr-ec.xsd line 393)
 * <p>
 * <pre>
 * &lt;element name="AwardDate" type="{http://niem.gov/niem/proxy/xsd/2.0}date"/>
 * </pre>
 * 
 */
public interface AwardDate
    extends javax.xml.bind.Element, edu.mit.coeus.utils.xml.bean.arra.Date
{
