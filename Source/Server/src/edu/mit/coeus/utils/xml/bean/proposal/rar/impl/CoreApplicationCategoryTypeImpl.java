...
public class CoreApplicationCategoryTypeImpl implements edu.mit.coeus.utils.xml.bean.proposal.rar.CoreApplicationCategoryType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.ValidatableObject
{

    protected edu.mit.coeus.utils.xml.bean.proposal.rar.CoreApplicationRevisionType _RevisionAction;
    protected java.lang.String _CategoryIdentifier;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.proposal.rar.CoreApplicationCategoryType.class);
    }

    public edu.mit.coeus.utils.xml.bean.proposal.rar.CoreApplicationRevisionType getRevisionAction() {
        return _RevisionAction;
    }

    public void setRevisionAction(edu.mit.coeus.utils.xml.bean.proposal.rar.CoreApplicationRevisionType value) {
        _RevisionAction = value;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.proposal.rar.impl.CoreApplicationCategoryTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "CategoryIdentifier");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(((java.lang.String) _CategoryIdentifier), "CategoryIdentifier");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        if (_RevisionAction!= null) {
            context.startElement("", "RevisionAction");
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _RevisionAction), "RevisionAction");
            context.endNamespaceDecls();
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _RevisionAction), "RevisionAction");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _RevisionAction), "RevisionAction");
            context.endElement();
        }
    }
...
+"n\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003sq\u0000~\u0000\u001e\u0001q\u0000~\u00001sq\u0000~\u0000+t\u0000\u0012CategoryIdentifiert\u0000\u0000"
...
+"\u0000\u0003q\u0000~\u00002q\u0000~\u0000@sr\u0000 com.sun.msv.grammar.AnyNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000x"
+"q\u0000~\u0000,q\u0000~\u00001sq\u0000~\u0000+t\u0000Eedu.mit.coeus.utils.xml.bean.proposal.rar"
+".CoreApplicationRevisionTypet\u0000+http://java.sun.com/jaxb/xjc/"
+"dummy-elementssq\u0000~\u0000\"ppsq\u0000~\u0000$q\u0000~\u0000\u001fpq\u0000~\u0000&q\u0000~\u0000-q\u0000~\u00001sq\u0000~\u0000+t\u0000\u000eRe"
+"visionActionq\u0000~\u00005q\u0000~\u00001sr\u0000\"com.sun.msv.grammar.ExpressionPool"
...
+"sv/grammar/ExpressionPool;xp\u0000\u0000\u0000\b\u0001pq\u0000~\u0000\nq\u0000~\u0000=q\u0000~\u0000\u0005q\u0000~\u00008q\u0000~\u0000:q"
+"\u0000~\u00006q\u0000~\u0000#q\u0000~\u0000Fx"));
        }
        ...
        extends edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.proposal.rar.impl.CoreApplicationCategoryTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  6 :
                        ...
                        return ;
                    case  4 :
                        if (("ActionCode" == ___local)&&("" == ___uri)) {
                            _RevisionAction = ((edu.mit.coeus.utils.xml.bean.proposal.rar.impl.CoreApplicationRevisionTypeImpl) spawnChildFromEnterElement((edu.mit.coeus.utils.xml.bean.proposal.rar.impl.CoreApplicationRevisionTypeImpl.class), 5, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  3 :
                        if (("RevisionAction" == ___local)&&("" == ___uri)) {
        ...
        {
            try {
                _CategoryIdentifier = com.sun.xml.bind.WhiteSpaceProcessor.collapse(value);
            } catch (java.lang.Exception e) {
