...
public class ProtocolCorrespondenceTypeImpl implements edu.mit.coeus.utils.xml.bean.protocol.ProtocolCorrespondenceType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.ValidatableObject
{
    ...
    protected java.lang.String _CorrespondentTypeDesc;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.protocol.ProtocolCorrespondenceType.class);
    }
    ...
    public java.lang.String getCorrespondentTypeDesc() {
        return _CorrespondentTypeDesc;
    }

    public void setCorrespondentTypeDesc(java.lang.String value) {
        _CorrespondentTypeDesc = value;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolCorrespondenceTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx6 = 0;
        final int len6 = ((_ProtocolCorrespondents == null)? 0 :_ProtocolCorrespondents.size());
        ...
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "FinalFlag");
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "CorrespondentTypeDesc");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(((java.lang.String) _CorrespondentTypeDesc), "CorrespondentTypeDesc");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        ...
        while (idx6 != len6) {
            ...
            int idx_16 = idx6;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _ProtocolCorrespondents.get(idx_16 ++)), "ProtocolCorrespondents");
            context.endNamespaceDecls();
            int idx_17 = idx6;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _ProtocolCorrespondents.get(idx_17 ++)), "ProtocolCorrespondents");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _ProtocolCorrespondents.get(idx6 ++)), "ProtocolCorrespondents");
            context.endElement();
        }
    }
...
+"$EpsilonExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003sq\u0000~\u0000\u0016\u0001psq\u0000~\u00003t\u0000\tFinalFla"
+"gt\u0000,http://www.w3.org/2001/ProtocolSummarySchemasq\u0000~\u0000\rpp\u0000sq\u0000"
+"~\u0000\u0000ppq\u0000~\u0000\u0015sq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\u000eProtoc"
+"olNumberq\u0000~\u0000=sq\u0000~\u0000\rpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0012ppsr\u0000 com.sun.msv.dataty"
+"pe.xsd.IntType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000+com.sun.msv.datatype.xsd.Intege"
+"rDerivedType\u0099\u00f1]\u0090&6k\u00be\u0002\u0000\u0001L\u0000\nbaseFacetst\u0000)Lcom/sun/msv/datatype"
+"/xsd/XSDatatypeImpl;xq\u0000~\u0000\u0019q\u0000~\u0000\u001ft\u0000\u0003intq\u0000~\u00001sr\u0000*com.sun.msv.da"
...
+"\u0000~\u0000IL\u0000\fconcreteTypet\u0000\'Lcom/sun/msv/datatype/xsd/ConcreteType"
+";L\u0000\tfacetNameq\u0000~\u0000\u001cxq\u0000~\u0000\u001bppq\u0000~\u00001\u0000\u0001sr\u0000*com.sun.msv.datatype.xs"
+"d.MinInclusiveFacet\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000Mppq\u0000~\u00001\u0000\u0000sr\u0000!com.sun.msv"
+".datatype.xsd.LongType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000Hq\u0000~\u0000\u001ft\u0000\u0004longq\u0000~\u00001sq\u0000~"
+"\u0000Lppq\u0000~\u00001\u0000\u0001sq\u0000~\u0000Sppq\u0000~\u00001\u0000\u0000sr\u0000$com.sun.msv.datatype.xsd.Integ"
+"erType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000Hq\u0000~\u0000\u001ft\u0000\u0007integerq\u0000~\u00001sr\u0000,com.sun.msv.d"
+"atatype.xsd.FractionDigitsFacet\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001I\u0000\u0005scalexr\u0000;com.su"
+"n.msv.datatype.xsd.DataTypeWithLexicalConstraintFacetT\u0090\u001c>\u001azb"
+"\u00ea\u0002\u0000\u0000xq\u0000~\u0000Pppq\u0000~\u00001\u0001\u0000sr\u0000#com.sun.msv.datatype.xsd.NumberType\u0000\u0000"
+"\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0019q\u0000~\u0000\u001ft\u0000\u0007decimalq\u0000~\u00001q\u0000~\u0000at\u0000\u000efractionDigits\u0000\u0000\u0000"
+"\u0000q\u0000~\u0000[t\u0000\fminInclusivesr\u0000\u000ejava.lang.Long;\u008b\u00e4\u0090\u00cc\u008f#\u00df\u0002\u0000\u0001J\u0000\u0005valuexr"
+"\u0000\u0010java.lang.Number\u0086\u00ac\u0095\u001d\u000b\u0094\u00e0\u008b\u0002\u0000\u0000xp\u0080\u0000\u0000\u0000\u0000\u0000\u0000\u0000q\u0000~\u0000[t\u0000\fmaxInclusives"
+"q\u0000~\u0000e\u007f\u00ff\u00ff\u00ff\u00ff\u00ff\u00ff\u00ffq\u0000~\u0000Vq\u0000~\u0000dsr\u0000\u0011java.lang.Integer\u0012\u00e2\u00a0\u00a4\u00f7\u0081\u00878\u0002\u0000\u0001I\u0000\u0005va"
+"luexq\u0000~\u0000f\u0080\u0000\u0000\u0000q\u0000~\u0000Vq\u0000~\u0000hsq\u0000~\u0000j\u007f\u00ff\u00ff\u00ffq\u0000~\u0000%sq\u0000~\u0000&q\u0000~\u0000Kq\u0000~\u0000\u001fsq\u0000~\u0000("
+"ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\u000eSequenceNumberq\u0000~\u0000=sq\u0000"
+"~\u0000\rpp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000Fsq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003"
+"t\u0000\bActionIdq\u0000~\u0000=sq\u0000~\u0000\rpp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000Fsq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000"
+"~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\u0014ProtoCorrespTypeCodeq\u0000~\u0000=sq\u0000~\u0000\rpp\u0000sq\u0000~"
+"\u0000\u0000ppq\u0000~\u0000\u0015sq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\u0015Corresp"
+"ondentTypeDescq\u0000~\u0000=sq\u0000~\u0000\rpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0012ppsr\u0000%com.sun.msv."
+"datatype.xsd.DateTimeType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000)com.sun.msv.datatype"
+".xsd.DateTimeBaseType\u0014W\u001a@3\u00a5\u00b4\u00e5\u0002\u0000\u0000xq\u0000~\u0000\u0019q\u0000~\u0000\u001ft\u0000\bdateTimeq\u0000~\u00001q"
+"\u0000~\u0000%sq\u0000~\u0000&q\u0000~\u0000\u008aq\u0000~\u0000\u001fsq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u0000"
+"3t\u0000\u000fUpdateTimestampq\u0000~\u0000=sq\u0000~\u0000\rpp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0015sq\u0000~\u0000(ppsq\u0000~\u0000*"
+"q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\nUpdateUserq\u0000~\u0000=sq\u0000~\u0000(ppsr\u0000 com"
+".sun.msv.grammar.OneOrMoreExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000\u001ccom.sun.msv.gram"
+"mar.UnaryExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\u0003expq\u0000~\u0000\u0002xq\u0000~\u0000\u0003q\u0000~\u0000\u0017psq\u0000~\u0000\rq\u0000~\u0000\u0017p\u0000s"
+"q\u0000~\u0000\u0000ppsq\u0000~\u0000\rpp\u0000sq\u0000~\u0000(ppsq\u0000~\u0000\u0097q\u0000~\u0000\u0017psq\u0000~\u0000*q\u0000~\u0000\u0017psr\u00002com.sun."
+"msv.grammar.Expression$AnyStringExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003q"
+"\u0000~\u0000:psr\u0000 com.sun.msv.grammar.AnyNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u00004q\u0000"
+"~\u00009sq\u0000~\u00003t\u0000?edu.mit.coeus.utils.xml.bean.protocol.ProtocolCo"
+"rrespondentTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-element"
+"ssq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\u0016ProtocolCorresp"
+"ondentsq\u0000~\u0000=q\u0000~\u00009sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000"
...
+"ammar/ExpressionPool;xp\u0000\u0000\u0000\u001e\u0001pq\u0000~\u0000\u0099q\u0000~\u0000\bq\u0000~\u0000\u0085q\u0000~\u0000)q\u0000~\u0000@q\u0000~\u0000nq"
+"\u0000~\u0000tq\u0000~\u0000zq\u0000~\u0000\u0080q\u0000~\u0000\u008cq\u0000~\u0000\u0092q\u0000~\u0000\u00a7q\u0000~\u0000\u009dq\u0000~\u0000\u0011q\u0000~\u0000?q\u0000~\u0000\u007fq\u0000~\u0000\u0091q\u0000~\u0000\u0096q"
+"\u0000~\u0000\u000bq\u0000~\u0000\fq\u0000~\u0000\u009bq\u0000~\u0000\u0006q\u0000~\u0000\u009eq\u0000~\u0000\u0005q\u0000~\u0000Eq\u0000~\u0000sq\u0000~\u0000yq\u0000~\u0000\u0007q\u0000~\u0000\tq\u0000~\u0000\nx"));
        }
        ...
        extends edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolCorrespondenceTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  12 :
                        ...
                        break;
                    case  15 :
                        if (("CorrespondentTypeDesc" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 16;
                            return ;
                        }
                    ...
                    case  25 :
                        if (("ProtocolNumber" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            _getProtocolCorrespondents().add(((edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolCorrespondentTypeImpl) spawnChildFromEnterElement((edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolCorrespondentTypeImpl.class), 26, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :
