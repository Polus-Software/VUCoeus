...
public class PaymentMethodTypeImpl implements edu.mit.coeus.utils.xml.bean.template.PaymentMethodType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.impl.runtime.ValidatableObject
{

    protected java.lang.String _PaymentMethodDesc;
    protected java.lang.String _PaymentMethodCode;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.template.PaymentMethodType.class);
    }

    public java.lang.String getPaymentMethodDesc() {
        return _PaymentMethodDesc;
    }

    public void setPaymentMethodDesc(java.lang.String value) {
        _PaymentMethodDesc = value;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.template.impl.PaymentMethodTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        if (_PaymentMethodCode!= null) {
            context.startElement("", "paymentMethodCode");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(((java.lang.String) _PaymentMethodCode), "PaymentMethodCode");
            } catch (java.lang.Exception e) {
                edu.mit.coeus.utils.xml.bean.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
        }
        if (_PaymentMethodDesc!= null) {
            context.startElement("", "paymentMethodDesc");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(((java.lang.String) _PaymentMethodDesc), "PaymentMethodDesc");
            } catch (java.lang.Exception e) {
                edu.mit.coeus.utils.xml.bean.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
...
+"mmar.ChoiceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0001\u0003\u00d0\u00d4\u00cfppsr\u0000\'com.sun.msv.grammar"
+".trex.ElementPattern\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\tnameClasst\u0000\u001fLcom/sun/msv/g"
+"rammar/NameClass;xr\u0000\u001ecom.sun.msv.grammar.ElementExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002"
+"\u0000\u0002Z\u0000\u001aignoreUndeclaredAttributesL\u0000\fcontentModelq\u0000~\u0000\u0002xq\u0000~\u0000\u0003\u0003\u00d0\u00d4"
+"\u00c4sr\u0000\u0011java.lang.Boolean\u00cd r\u0080\u00d5\u009c\u00fa\u00ee\u0002\u0000\u0001Z\u0000\u0005valuexp\u0000p\u0000sq\u0000~\u0000\u0000\u0003\u00d0\u00d4\u00b9ppsr"
...
+"L\u0000\tlocalNameq\u0000~\u0000\u0017L\u0000\fnamespaceURIq\u0000~\u0000\u0017xpq\u0000~\u0000\u001bq\u0000~\u0000\u001asq\u0000~\u0000\u0006\u0003@L#p"
+"psr\u0000 com.sun.msv.grammar.AttributeExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0003expq\u0000~\u0000\u0002L"
+"\u0000\tnameClassq\u0000~\u0000\txq\u0000~\u0000\u0003\u0003@L\u0018q\u0000~\u0000\rpsq\u0000~\u0000\u000f\u0001\u00e4\u0085Oppsr\u0000\"com.sun.msv."
...
+"\u0011paymentMethodCodet\u0000\u0000q\u0000~\u00003sq\u0000~\u0000\u0006\u0003mGfppsq\u0000~\u0000\b\u0003mG[q\u0000~\u0000\rp\u0000sq\u0000~\u0000"
+"\u0000\u0003mGPppq\u0000~\u0000\u0012sq\u0000~\u0000\u0006\u0002\u00dc\u00be\u00bappsq\u0000~\u0000$\u0002\u00dc\u00be\u00afq\u0000~\u0000\rpq\u0000~\u0000&sq\u0000~\u0000-q\u0000~\u00000q\u0000~\u0000"
+"1q\u0000~\u00003sq\u0000~\u0000-t\u0000\u0011paymentMethodDescq\u0000~\u00007q\u0000~\u00003sr\u0000\"com.sun.msv.gr"
...
+"entq\u0000~\u0000A[\u0000\u0005tablet\u0000![Lcom/sun/msv/grammar/Expression;xp\u0000\u0000\u0000\u0007\u0000\u0000"
+"\u00009pur\u0000![Lcom.sun.msv.grammar.Expression;\u00d68D\u00c3]\u00ad\u00a7\n\u0002\u0000\u0000xp\u0000\u0000\u0000\u00bfppp"
+"ppppppppppppppq\u0000~\u0000\u0005ppppppppppppppppppq\u0000~\u0000:ppppppppq\u0000~\u0000#ppppp"
+"pppppppq\u0000~\u00008pppppppppppppppppppppppppppppppppppppppppppppppp"
+"ppppppppppppppppq\u0000~\u0000\u000epppppppppppppppppppppq\u0000~\u0000\u0007pppq\u0000~\u0000;ppppp"
+"pppppppppppppppppppppppppppppppppppp"));
        ...
        extends edu.mit.coeus.utils.xml.bean.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.template.impl.PaymentMethodTypeImpl.this;
        }
