...
public class ProtocolLocationTypeImpl implements edu.mit.coeus.utils.xml.bean.protocol.ProtocolLocationType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.ValidatableObject
{

    protected boolean has_ProtocolOrgTypeCode;
    protected int _ProtocolOrgTypeCode;
    protected boolean has_RolodexId;
    protected int _RolodexId;
    ...
    protected java.lang.String _OrgName;
    protected java.lang.String _ProtocolOrgTypeDesc;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.protocol.ProtocolLocationType.class);
    }

    public int getProtocolOrgTypeCode() {
        return _ProtocolOrgTypeCode;
    }

    public void setProtocolOrgTypeCode(int value) {
        _ProtocolOrgTypeCode = value;
        has_ProtocolOrgTypeCode = true;
    }
    ...
    public void setRolodexId(int value) {
        _RolodexId = value;
        has_RolodexId = true;
    }
    ...
    public java.lang.String getProtocolOrgTypeDesc() {
        return _ProtocolOrgTypeDesc;
    }

    public void setProtocolOrgTypeDesc(java.lang.String value) {
        _ProtocolOrgTypeDesc = value;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolLocationTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        if (!has_ProtocolOrgTypeCode) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "ProtocolOrgTypeCode"));
        }
        if (!has_RolodexId) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "RolodexId"));
        }
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "ProtocolOrgTypeCode");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printInt(((int) _ProtocolOrgTypeCode)), "ProtocolOrgTypeCode");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "ProtocolOrgTypeDesc");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(((java.lang.String) _ProtocolOrgTypeDesc), "ProtocolOrgTypeDesc");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "OrganizationId");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "RolodexId");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printInt(((int) _RolodexId)), "RolodexId");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "Address");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "OrgName");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(((java.lang.String) _OrgName), "OrgName");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
...
+"\u0018pq\u0000~\u0000-q\u0000~\u00006q\u0000~\u0000:sq\u0000~\u00004t\u0000\u000eSequenceNumberq\u0000~\u0000>sq\u0000~\u0000\u000epp\u0000sq\u0000~\u0000\u0000"
+"ppq\u0000~\u0000Asq\u0000~\u0000)ppsq\u0000~\u0000+q\u0000~\u0000\u0018pq\u0000~\u0000-q\u0000~\u00006q\u0000~\u0000:sq\u0000~\u00004t\u0000\u0013ProtocolO"
+"rgTypeCodeq\u0000~\u0000>sq\u0000~\u0000\u000epp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0016sq\u0000~\u0000)ppsq\u0000~\u0000+q\u0000~\u0000\u0018pq\u0000~"
+"\u0000-q\u0000~\u00006q\u0000~\u0000:sq\u0000~\u00004t\u0000\u0013ProtocolOrgTypeDescq\u0000~\u0000>sq\u0000~\u0000\u000epp\u0000sq\u0000~\u0000\u0000"
+"ppq\u0000~\u0000\u0016sq\u0000~\u0000)ppsq\u0000~\u0000+q\u0000~\u0000\u0018pq\u0000~\u0000-q\u0000~\u00006q\u0000~\u0000:sq\u0000~\u00004t\u0000\u000eOrganizat"
+"ionIdq\u0000~\u0000>sq\u0000~\u0000\u000epp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000Asq\u0000~\u0000)ppsq\u0000~\u0000+q\u0000~\u0000\u0018pq\u0000~\u0000-q\u0000~"
+"\u00006q\u0000~\u0000:sq\u0000~\u00004t\u0000\tRolodexIdq\u0000~\u0000>sq\u0000~\u0000\u000epp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0013ppsr\u0000%c"
+"om.sun.msv.datatype.xsd.DateTimeType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000)com.sun.m"
+"sv.datatype.xsd.DateTimeBaseType\u0014W\u001a@3\u00a5\u00b4\u00e5\u0002\u0000\u0000xq\u0000~\u0000\u001aq\u0000~\u0000 t\u0000\bdat"
+"eTimeq\u0000~\u00002q\u0000~\u0000&sq\u0000~\u0000\'q\u0000~\u0000\u008bq\u0000~\u0000 sq\u0000~\u0000)ppsq\u0000~\u0000+q\u0000~\u0000\u0018pq\u0000~\u0000-q\u0000~\u0000"
+"6q\u0000~\u0000:sq\u0000~\u00004t\u0000\u000fUpdateTimestampq\u0000~\u0000>sq\u0000~\u0000\u000epp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0016sq\u0000"
+"~\u0000)ppsq\u0000~\u0000+q\u0000~\u0000\u0018pq\u0000~\u0000-q\u0000~\u00006q\u0000~\u0000:sq\u0000~\u00004t\u0000\nUpdateUserq\u0000~\u0000>sq\u0000~"
+"\u0000\u000epp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0016sq\u0000~\u0000)ppsq\u0000~\u0000+q\u0000~\u0000\u0018pq\u0000~\u0000-q\u0000~\u00006q\u0000~\u0000:sq\u0000~\u00004t"
+"\u0000\u0007Addressq\u0000~\u0000>sq\u0000~\u0000\u000epp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0016sq\u0000~\u0000)ppsq\u0000~\u0000+q\u0000~\u0000\u0018pq\u0000~\u0000"
+"-q\u0000~\u00006q\u0000~\u0000:sq\u0000~\u00004t\u0000\u0007OrgNameq\u0000~\u0000>sr\u0000\"com.sun.msv.grammar.Expr"
...
+"Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u001d\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\rq\u0000~\u0000\bq"
+"\u0000~\u0000\u0086q\u0000~\u0000*q\u0000~\u0000iq\u0000~\u0000oq\u0000~\u0000\fq\u0000~\u0000uq\u0000~\u0000{q\u0000~\u0000\u0081q\u0000~\u0000\u008dq\u0000~\u0000\u0093q\u0000~\u0000\u0099q\u0000~\u0000\u009fq"
+"\u0000~\u0000\u0012q\u0000~\u0000tq\u0000~\u0000zq\u0000~\u0000\u0092q\u0000~\u0000\u0098q\u0000~\u0000\u009eq\u0000~\u0000\nq\u0000~\u0000@q\u0000~\u0000nq\u0000~\u0000\u0080q\u0000~\u0000\u000bq\u0000~\u0000\u0007q"
+"\u0000~\u0000\u0006q\u0000~\u0000\tx"));
        }
        ...
        extends edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolLocationTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  18 :
                        ...
                        break;
                    case  24 :
                        if (("Address" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 25;
                            return ;
                        }
                        break;
                    case  27 :
                        if (("OrgName" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 28;
                            return ;
                        }
                    ...
                    case  30 :
                        ...
                        return ;
                    case  12 :
                        if (("OrganizationId" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 13;
                            return ;
                        }
                    ...
                    case  3 :
                        ...
                        break;
                    case  9 :
                        if (("ProtocolOrgTypeDesc" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 10;
                            return ;
                        }
                        break;
                    case  15 :
                        if (("RolodexId" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 16;
                            return ;
                        }
        ...
        {
            try {
                _ProtocolOrgTypeCode = javax.xml.bind.DatatypeConverter.parseInt(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_ProtocolOrgTypeCode = true;
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
        ...
        {
            try {
                _RolodexId = javax.xml.bind.DatatypeConverter.parseInt(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_RolodexId = true;
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
