    ...
    implements edu.mit.coeus.utils.xml.bean.subcontractingReports.NameAndAddressType, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.subcontractingReports.NameAndAddressType.class);
    }
    ...
    public edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.subcontractingReports.impl.NameAndAddressTypeImpl.Unmarshaller(context);
    }
...
+"\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0004sq\u0000~\u0000(\u0001q\u0000~\u00007sq\u0000~\u00001t\u0000\u0004Namet\u0000\u0000sq\u0000~\u0000$ppsq\u0000~\u0000\u0000q\u0000"
+"~\u0000)p\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\u0013sq\u0000~\u0000$ppsq\u0000~\u0000&q\u0000~\u0000)pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t"
+"\u0000\rStreetAddressq\u0000~\u0000;q\u0000~\u00007sq\u0000~\u0000$ppsq\u0000~\u0000\u0000q\u0000~\u0000)p\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\u0013s"
+"q\u0000~\u0000$ppsq\u0000~\u0000&q\u0000~\u0000)pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\u0004Cityq\u0000~\u0000;q\u0000~\u00007sq\u0000"
+"~\u0000$ppsq\u0000~\u0000\u0000q\u0000~\u0000)p\u0000sq\u0000~\u0000\u0007ppq\u0000~\u0000\u0013sq\u0000~\u0000$ppsq\u0000~\u0000&q\u0000~\u0000)pq\u0000~\u0000*q\u0000~\u0000"
+"3q\u0000~\u00007sq\u0000~\u00001t\u0000\u0005Stateq\u0000~\u0000;q\u0000~\u00007sq\u0000~\u0000$ppsq\u0000~\u0000\u0000q\u0000~\u0000)p\u0000sq\u0000~\u0000\u0007ppq"
+"\u0000~\u0000\u0013sq\u0000~\u0000$ppsq\u0000~\u0000&q\u0000~\u0000)pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\u0007ZipCodeq\u0000~\u0000;"
+"q\u0000~\u00007sq\u0000~\u0000$ppsq\u0000~\u0000&q\u0000~\u0000)pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\u0012NameAndAddr"
+"essTypeq\u0000~\u0000;sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000"
...
+"/ExpressionPool;xp\u0000\u0000\u0000\u0014\u0001pq\u0000~\u0000<q\u0000~\u0000Cq\u0000~\u0000Jq\u0000~\u0000Qq\u0000~\u0000\nq\u0000~\u0000\rq\u0000~\u0000\u000fq"
+"\u0000~\u0000>q\u0000~\u0000Eq\u0000~\u0000Lq\u0000~\u0000Sq\u0000~\u0000\fq\u0000~\u0000\u000bq\u0000~\u0000%q\u0000~\u0000?q\u0000~\u0000Fq\u0000~\u0000Mq\u0000~\u0000Tq\u0000~\u0000Xq"
+"\u0000~\u0000\tx"));
        }
        ...
        extends edu.mit.coeus.utils.xml.bean.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.subcontractingReports.impl.NameAndAddressTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("Name" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.mit.coeus.utils.xml.bean.subcontractingReports.impl.NameAndAddressTypeTypeImpl)edu.mit.coeus.utils.xml.bean.subcontractingReports.impl.NameAndAddressTypeImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                }
