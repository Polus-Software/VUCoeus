...
public class ContractReportImpl
    extends edu.mit.coeus.utils.xml.bean.arra.impl.ContractReportTypeImpl
    implements edu.mit.coeus.utils.xml.bean.arra.ContractReport, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.arra.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.arra.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.arra.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.arra.ContractReport.class);
    }
    ...
    public edu.mit.coeus.utils.xml.bean.arra.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.arra.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.arra.impl.ContractReportImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.mit.coeus.utils.xml.bean.arra.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("urn:us:gov:recoveryrr", "ContractReport");
        if (_Nil) {
...
+"sq\u0000~\u0000\"t\u00006edu.mit.coeus.utils.xml.bean.arra.ContractReportHea"
+"dert\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u0000pp\u0000sq"
+"\u0000~\u0000\u0007ppsq\u0000~\u0000\nppq\u0000~\u0000\u0010sq\u0000~\u0000\"q\u0000~\u0000%q\u0000~\u0000&sq\u0000~\u0000\'ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007pp"
+"sq\u0000~\u00001q\u0000~\u00004psq\u0000~\u0000\nq\u0000~\u00004pq\u0000~\u00007q\u0000~\u00009q\u0000~\u0000;sq\u0000~\u0000\"t\u0000:edu.mit.coeu"
+"s.utils.xml.bean.arra.ContractReportHeaderTypeq\u0000~\u0000>sq\u0000~\u0000\u0007pps"
...
+"\u0000~\u00004psq\u0000~\u0000\u001dq\u0000~\u0000Pq\u0000~\u0000\u0018sq\u0000~\u0000\"t\u0000\u0004typeq\u0000~\u0000&q\u0000~\u0000;sq\u0000~\u0000\"t\u0000\u0014Contrac"
+"tReportHeadert\u0000\u0019urn:us:gov:recoveryrr-extsq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0007q\u0000~\u00004"
+"psq\u0000~\u0000\u0000q\u0000~\u00004p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u00001q\u0000~\u00004psq\u0000~\u0000\nq\u0000~\u00004pq\u0000~\u00007q\u0000~\u00009q\u0000~\u0000"
+";sq\u0000~\u0000\"t\u0000>edu.mit.coeus.utils.xml.bean.arra.ContractPrimeRec"
+"ipientReportq\u0000~\u0000>sq\u0000~\u0000\u0000q\u0000~\u00004p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\nppq\u0000~\u0000\u0010sq\u0000~\u0000\"q\u0000~"
+"\u0000%q\u0000~\u0000&sq\u0000~\u0000\'ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u00001q\u0000~\u00004psq\u0000~\u0000\nq\u0000~\u00004pq\u0000~\u0000"
+"7q\u0000~\u00009q\u0000~\u0000;sq\u0000~\u0000\"t\u0000Bedu.mit.coeus.utils.xml.bean.arra.Contra"
+"ctPrimeRecipientReportTypeq\u0000~\u0000>sq\u0000~\u0000\u0007ppsq\u0000~\u0000\nq\u0000~\u00004pq\u0000~\u0000Mq\u0000~\u0000"
+"Tq\u0000~\u0000;sq\u0000~\u0000\"t\u0000\u001cContractPrimeRecipientReportq\u0000~\u0000Xq\u0000~\u0000;sq\u0000~\u0000\u0007p"
+"psq\u0000~\u00001q\u0000~\u00004psq\u0000~\u0000\u0007q\u0000~\u00004psq\u0000~\u0000\u0000q\u0000~\u00004p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u00001q\u0000~\u00004psq"
+"\u0000~\u0000\nq\u0000~\u00004pq\u0000~\u00007q\u0000~\u00009q\u0000~\u0000;sq\u0000~\u0000\"t\u00004edu.mit.coeus.utils.xml.be"
+"an.arra.SubRecipientReportq\u0000~\u0000>sq\u0000~\u0000\u0000q\u0000~\u00004p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\npp"
+"q\u0000~\u0000\u0010sq\u0000~\u0000\"q\u0000~\u0000%q\u0000~\u0000&sq\u0000~\u0000\'ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u00001q\u0000~\u00004psq"
+"\u0000~\u0000\nq\u0000~\u00004pq\u0000~\u00007q\u0000~\u00009q\u0000~\u0000;sq\u0000~\u0000\"t\u00008edu.mit.coeus.utils.xml.be"
+"an.arra.SubRecipientReportTypeq\u0000~\u0000>sq\u0000~\u0000\u0007ppsq\u0000~\u0000\nq\u0000~\u00004pq\u0000~\u0000M"
+"q\u0000~\u0000Tq\u0000~\u0000;sq\u0000~\u0000\"t\u0000\u0012SubRecipientReportq\u0000~\u0000Xq\u0000~\u0000;sq\u0000~\u0000\u0007ppsq\u0000~\u0000"
+"\nq\u0000~\u00004psq\u0000~\u0000Lppsr\u0000\u001fcom.sun.msv.datatype.xsd.IDType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000"
...
+"IDq\u0000~\u0000\u001c\u0000q\u0000~\u0000Rsq\u0000~\u0000\u001dq\u0000~\u0000\u0090q\u0000~\u0000\u0018sq\u0000~\u0000\"t\u0000\u0002idt\u0000#http://niem.gov/n"
+"iem/structures/2.0q\u0000~\u0000;sq\u0000~\u0000\u0007ppsq\u0000~\u0000\nq\u0000~\u00004psq\u0000~\u0000Lppsr\u0000*com.s"
+"un.msv.datatype.xsd.DatatypeFactory$1\u00a1\u00f3\u000b\u00e3`rj\u000e\u0002\u0000\u0000xr\u0000\u001ecom.sun."
+"msv.datatype.xsd.Proxy\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\bbaseTypet\u0000)Lcom/sun/msv/"
+"datatype/xsd/XSDatatypeImpl;xq\u0000~\u0000\u0014q\u0000~\u0000\u0018t\u0000\u0006IDREFSq\u0000~\u0000\u001csr\u0000\'com"
...
+"facetNameq\u0000~\u0000\u0015xq\u0000~\u0000\u0014ppq\u0000~\u0000\u001c\u0000\u0000sr\u0000!com.sun.msv.datatype.xsd.Li"
+"stType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\bitemTypeq\u0000~\u0000\u009axq\u0000~\u0000\u0013ppq\u0000~\u0000\u001csr\u0000\"com.sun.ms"
+"v.datatype.xsd.IDREFType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u008cq\u0000~\u0000\u0018t\u0000\u0005IDREFq\u0000~\u0000\u001c\u0000"
+"q\u0000~\u0000\u00a3t\u0000\tminLength\u0000\u0000\u0000\u0001q\u0000~\u0000Rpsq\u0000~\u0000\"t\u0000\flinkMetadataq\u0000~\u0000\u0094q\u0000~\u0000;sq"
+"\u0000~\u0000\u0007ppsq\u0000~\u0000\nq\u0000~\u00004pq\u0000~\u0000\u0097sq\u0000~\u0000\"t\u0000\bmetadataq\u0000~\u0000\u0094q\u0000~\u0000;sq\u0000~\u0000\u0007ppsq"
+"\u0000~\u0000\nq\u0000~\u00004pq\u0000~\u0000Mq\u0000~\u0000Tq\u0000~\u0000;sq\u0000~\u0000\"t\u0000\u000eContractReportt\u0000\u0015urn:us:go"
...
+"/ExpressionPool;xp\u0000\u0000\u0000&\u0001pq\u0000~\u0000rq\u0000~\u0000\u0095q\u0000~\u0000Cq\u0000~\u0000eq\u0000~\u0000Zq\u0000~\u0000-q\u0000~\u0000}q"
+"\u0000~\u0000Jq\u0000~\u0000lq\u0000~\u0000\u0084q\u0000~\u0000\u00aeq\u0000~\u00003q\u0000~\u0000Fq\u0000~\u0000]q\u0000~\u0000hq\u0000~\u0000uq\u0000~\u0000\u0080q\u0000~\u0000pq\u0000~\u0000bq"
+"\u0000~\u0000.q\u0000~\u0000\tq\u0000~\u0000\u0088q\u0000~\u0000,q\u0000~\u0000qq\u0000~\u0000)q\u0000~\u0000\u00aaq\u0000~\u0000zq\u0000~\u0000@q\u0000~\u00000q\u0000~\u0000Eq\u0000~\u0000\\q"
+"\u0000~\u0000gq\u0000~\u0000tq\u0000~\u0000\u007fq\u0000~\u0000+q\u0000~\u0000*q\u0000~\u0000Yq\u0000~\u0000(x"));
        }
        ...
        extends edu.mit.coeus.utils.xml.bean.arra.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.arra.impl.ContractReportImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        ...
                        if (("ContractReportHeader" == ___local)&&("urn:us:gov:recoveryrr-ext" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.mit.coeus.utils.xml.bean.arra.impl.ContractReportTypeImpl)edu.mit.coeus.utils.xml.bean.arra.impl.ContractReportImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("ContractReportHeader" == ___local)&&("urn:us:gov:recoveryrr-ext" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.mit.coeus.utils.xml.bean.arra.impl.ContractReportTypeImpl)edu.mit.coeus.utils.xml.bean.arra.impl.ContractReportImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                    ...
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("ContractReport" == ___local)&&("urn:us:gov:recoveryrr" == ___uri)) {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        ...
                        spawnHandlerFromLeaveElement((((edu.mit.coeus.utils.xml.bean.arra.impl.ContractReportTypeImpl)edu.mit.coeus.utils.xml.bean.arra.impl.ContractReportImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
                ...
                switch (state) {
                    case  1 :
                        ...
                        if (("id" == ___local)&&("http://niem.gov/niem/structures/2.0" == ___uri)) {
                            spawnHandlerFromEnterAttribute((((edu.mit.coeus.utils.xml.bean.arra.impl.ContractReportTypeImpl)edu.mit.coeus.utils.xml.bean.arra.impl.ContractReportImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        ...
                        spawnHandlerFromLeaveAttribute((((edu.mit.coeus.utils.xml.bean.arra.impl.ContractReportTypeImpl)edu.mit.coeus.utils.xml.bean.arra.impl.ContractReportImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
                ...
                try {
                    switch (state) {
                        case  1 :
                            ...
                            spawnHandlerFromText((((edu.mit.coeus.utils.xml.bean.arra.impl.ContractReportTypeImpl)edu.mit.coeus.utils.xml.bean.arra.impl.ContractReportImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
