...
public class GroupsTypeImpl implements edu.mit.coeus.utils.xml.bean.budget.GroupsType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.budget.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.budget.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.budget.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.budget.GroupsType.class);
    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getDetails() {
        if (_Details == null) {
            _Details = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Details;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.budget.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.budget.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.budget.impl.GroupsTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx2 = 0;
        final int len2 = ((_Details == null)? 0 :_Details.size());
        ...
        while (idx2 != len2) {
            ...
            int idx_2 = idx2;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Details.get(idx_2 ++)), "Details");
            context.endNamespaceDecls();
            int idx_3 = idx2;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Details.get(idx_3 ++)), "Details");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Details.get(idx2 ++)), "Details");
            context.endElement();
        }
    }
...
+"-t\u0000\u000bDescriptiont\u0000\u0000q\u0000~\u00003sr\u0000 com.sun.msv.grammar.OneOrMoreExp\u0000"
+"\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000\u001ccom.sun.msv.grammar.UnaryExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\u0003expq"
+"\u0000~\u0000\u0002xq\u0000~\u0000\u0003ppsq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u0006ppsq\u0000~\u00008q\u0000~\u0000\rpsq"
+"\u0000~\u0000$q\u0000~\u0000\rpsr\u00002com.sun.msv.grammar.Expression$AnyStringExpres"
+"sion\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003q\u0000~\u00004psr\u0000 com.sun.msv.grammar.AnyNameCl"
+"ass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000.q\u0000~\u00003sq\u0000~\u0000-t\u0000.edu.mit.coeus.utils.xml.be"
+"an.budget.ReportTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-el"
+"ementssq\u0000~\u0000\u0006ppsq\u0000~\u0000$q\u0000~\u0000\rpq\u0000~\u0000&q\u0000~\u0000/q\u0000~\u00003sq\u0000~\u0000-t\u0000\u0007Detailsq\u0000~"
...
+"nPool;xp\u0000\u0000\u0000\t\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\u000eq\u0000~\u0000\u0007q\u0000~\u0000>q\u0000~\u0000:q\u0000~\u0000<q\u0000~\u0000?q\u0000~\u0000#q\u0000~\u0000Hx"));
        }
        ...
        extends edu.mit.coeus.utils.xml.bean.budget.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.budget.impl.GroupsTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  4 :
                        if (("StartDate" == ___local)&&("" == ___uri)) {
                            _getDetails().add(((edu.mit.coeus.utils.xml.bean.budget.impl.ReportTypeImpl) spawnChildFromEnterElement((edu.mit.coeus.utils.xml.bean.budget.impl.ReportTypeImpl.class), 5, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  5 :
                        ...
                        break;
                    case  4 :
                        _getDetails().add(((edu.mit.coeus.utils.xml.bean.budget.impl.ReportTypeImpl) spawnChildFromLeaveElement((edu.mit.coeus.utils.xml.bean.budget.impl.ReportTypeImpl.class), 5, ___uri, ___local, ___qname)));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        continue outer;
                    case  4 :
                        _getDetails().add(((edu.mit.coeus.utils.xml.bean.budget.impl.ReportTypeImpl) spawnChildFromEnterAttribute((edu.mit.coeus.utils.xml.bean.budget.impl.ReportTypeImpl.class), 5, ___uri, ___local, ___qname)));
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        continue outer;
                    case  4 :
                        _getDetails().add(((edu.mit.coeus.utils.xml.bean.budget.impl.ReportTypeImpl) spawnChildFromLeaveAttribute((edu.mit.coeus.utils.xml.bean.budget.impl.ReportTypeImpl.class), 5, ___uri, ___local, ___qname)));
                        return ;
                }
                ...
                try {
                    switch (state) {
                        ...
                        case  0 :
                            ...
                            continue outer;
                        case  4 :
                            _getDetails().add(((edu.mit.coeus.utils.xml.bean.budget.impl.ReportTypeImpl) spawnChildFromText((edu.mit.coeus.utils.xml.bean.budget.impl.ReportTypeImpl.class), 5, value)));
                            return ;
                    }
