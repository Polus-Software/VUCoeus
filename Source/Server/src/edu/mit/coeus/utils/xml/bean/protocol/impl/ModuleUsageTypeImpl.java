...
public class ModuleUsageTypeImpl implements edu.mit.coeus.utils.xml.bean.protocol.ModuleUsageType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.ValidatableObject
{

    protected edu.mit.coeus.utils.xml.bean.protocol.ModuleInfoType _ModuleInfo;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.protocol.ModuleUsageType.class);
    }

    public edu.mit.coeus.utils.xml.bean.protocol.ModuleInfoType getModuleInfo() {
        return _ModuleInfo;
    }

    public void setModuleInfo(edu.mit.coeus.utils.xml.bean.protocol.ModuleInfoType value) {
        _ModuleInfo = value;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.protocol.impl.ModuleUsageTypeImpl.Unmarshaller(context);
    }
    ...
    {
        if (_ModuleInfo!= null) {
            context.startElement("http://www.w3.org/2001/QuesionnaireSchema", "ModuleInfo");
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _ModuleInfo), "ModuleInfo");
            context.endNamespaceDecls();
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _ModuleInfo), "ModuleInfo");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _ModuleInfo), "ModuleInfo");
            context.endElement();
        }
    }
...
+"amet\u0000\u0012Ljava/lang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001exq\u0000~\u0000\u0019t\u00004edu.mit"
+".coeus.utils.xml.bean.protocol.ModuleInfoTypet\u0000+http://java."
...
+"\u001csq\u0000~\u0000\u001dt\u0000\nModuleInfot\u0000)http://www.w3.org/2001/QuesionnaireSc"
+"hemaq\u0000~\u0000\u001csr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000"
...
+"pressionPool;xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\"q\u0000~\u0000\u000fq\u0000~\u0000\rq\u0000~\u0000\u0012x"));
        ...
        extends edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.protocol.impl.ModuleUsageTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("ModuleCode" == ___local)&&("http://www.w3.org/2001/QuesionnaireSchema" == ___uri)) {
                            _ModuleInfo = ((edu.mit.coeus.utils.xml.bean.protocol.impl.ModuleInfoTypeImpl) spawnChildFromEnterElement((edu.mit.coeus.utils.xml.bean.protocol.impl.ModuleInfoTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  3 :
