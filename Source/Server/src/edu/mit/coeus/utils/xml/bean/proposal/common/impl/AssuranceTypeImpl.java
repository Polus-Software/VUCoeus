...
public class AssuranceTypeImpl implements edu.mit.coeus.utils.xml.bean.proposal.common.AssuranceType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.ValidatableObject
{

    protected java.lang.String _Explanation;
    protected boolean has_YesNoAnswer;
    protected boolean _YesNoAnswer;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.proposal.common.AssuranceType.class);
    }
    ...
    public void setYesNoAnswer(boolean value) {
        _YesNoAnswer = value;
        has_YesNoAnswer = true;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.proposal.common.impl.AssuranceTypeImpl.Unmarshaller(context);
    }
    ...
    {
        if (!has_YesNoAnswer) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "YesNoAnswer"));
        }
        context.startElement("", "YesNoAnswer");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printBoolean(((boolean) _YesNoAnswer)), "YesNoAnswer");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        if (_Explanation!= null) {
            context.startElement("", "Explanation");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(((java.lang.String) _Explanation), "Explanation");
            } catch (java.lang.Exception e) {
                edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
...
+"\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003sq\u0000~\u0000\u001d\u0001q\u0000~\u00000sq\u0000~\u0000*t\u0000\u000bYesNoAnswert\u0000\u0000sq\u0000~\u0000!ppsq"
...
+"~\u0000,q\u0000~\u00000sq\u0000~\u0000*t\u0000\u000bExplanationq\u0000~\u00004q\u0000~\u00000sr\u0000\"com.sun.msv.gramma"
...
+"q\u0000~\u00007q\u0000~\u0000\"q\u0000~\u0000?q\u0000~\u0000\u0005x"));
        ...
        extends edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.proposal.common.impl.AssuranceTypeImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        if (("Explanation" == ___local)&&("" == ___uri)) {
        ...
        {
            try {
                _YesNoAnswer = javax.xml.bind.DatatypeConverter.parseBoolean(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_YesNoAnswer = true;
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
