...
public class ScheduleImpl
    extends edu.mit.coeus.utils.xml.bean.reviewcomments.impl.ScheduleTypeImpl
    implements edu.mit.coeus.utils.xml.bean.reviewcomments.Schedule, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.reviewcomments.Schedule.class);
    }
    ...
    public edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.reviewcomments.impl.ScheduleImpl.Unmarshaller(context);
    }
...
+"tils.xml.bean.reviewcomments.ScheduleMasterDatat\u0000+http://jav"
+"a.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000s"
+"q\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u0000\u001cq\u0000~\u0000 q\u0000~\u0000\"sq\u0000~\u0000#t\u0000Bedu.m"
+"it.coeus.utils.xml.bean.reviewcomments.ScheduleMasterDataTyp"
...
+".w3.org/2001/XMLSchema-instanceq\u0000~\u0000\"sq\u0000~\u0000#t\u0000\u0012ScheduleMasterD"
+"atat\u0000\u001fhttp://irb.mit.edu/irbnamespacesq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000"
+"~\u0000\u0010q\u0000~\u0000\u0018psq\u0000~\u0000\u0000q\u0000~\u0000\u0018p\u0000sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u0000\u001cq"
+"\u0000~\u0000 q\u0000~\u0000\"sq\u0000~\u0000#t\u0000>edu.mit.coeus.utils.xml.bean.reviewcomment"
+"s.ProtocolSubmissionq\u0000~\u0000\'sq\u0000~\u0000\u0000q\u0000~\u0000\u0018p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000"
+"\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u0000\u001cq\u0000~\u0000 q\u0000~\u0000\"sq\u0000~\u0000#t\u0000Bedu.mit.c"
+"oeus.utils.xml.bean.reviewcomments.ProtocolSubmissionTypeq\u0000~"
+"\u0000\'sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u00005q\u0000~\u0000Eq\u0000~\u0000\"sq\u0000~\u0000#t\u0000\u0012ProtocolSubmis"
+"sionq\u0000~\u0000Jq\u0000~\u0000\"sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0000q\u0000~\u0000\u0018p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000"
+"\u0000pp\u0000sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u0000\u001cq\u0000~\u0000 q\u0000~\u0000\"sq\u0000~\u0000#t\u0000J"
+"edu.mit.coeus.utils.xml.bean.reviewcomments.ScheduleType.Oth"
+"erBusinessTypeq\u0000~\u0000\'sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u00005q\u0000~\u0000Eq\u0000~\u0000\"sq\u0000~\u0000#"
+"t\u0000\rOtherBusinessq\u0000~\u0000Jq\u0000~\u0000\"sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0010q\u0000~\u0000\u0018psq"
+"\u0000~\u0000\u0000q\u0000~\u0000\u0018p\u0000sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u0000\u001cq\u0000~\u0000 q\u0000~\u0000\"sq"
+"\u0000~\u0000#t\u00003edu.mit.coeus.utils.xml.bean.reviewcomments.Minutesq\u0000"
+"~\u0000\'sq\u0000~\u0000\u0000q\u0000~\u0000\u0018p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0019q"
+"\u0000~\u0000\u0018pq\u0000~\u0000\u001cq\u0000~\u0000 q\u0000~\u0000\"sq\u0000~\u0000#t\u00007edu.mit.coeus.utils.xml.bean.re"
+"viewcomments.MinutesTypeq\u0000~\u0000\'sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u00005q\u0000~\u0000Eq"
+"\u0000~\u0000\"sq\u0000~\u0000#t\u0000\u0007Minutesq\u0000~\u0000Jq\u0000~\u0000\"sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0000q\u0000~\u0000"
+"\u0018p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u0000\u001cq\u0000~"
+"\u0000 q\u0000~\u0000\"sq\u0000~\u0000#t\u0000Gedu.mit.coeus.utils.xml.bean.reviewcomments."
+"ScheduleType.AttendentsTypeq\u0000~\u0000\'sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u00005q\u0000~"
+"\u0000Eq\u0000~\u0000\"sq\u0000~\u0000#t\u0000\nAttendentsq\u0000~\u0000Jq\u0000~\u0000\"sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0018p\u0000sq\u0000"
+"~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u0000\u001cq\u0000~\u0000 q\u0000~\u0000"
+"\"sq\u0000~\u0000#t\u0000Iedu.mit.coeus.utils.xml.bean.reviewcomments.Schedu"
+"leType.NextScheduleTypeq\u0000~\u0000\'sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u00005q\u0000~\u0000Eq\u0000"
+"~\u0000\"sq\u0000~\u0000#t\u0000\fNextScheduleq\u0000~\u0000Jq\u0000~\u0000\"sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0000q\u0000~\u0000\u0018p\u0000sq\u0000~\u0000"
+"\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u0000\u001cq\u0000~\u0000 q\u0000~\u0000\"s"
+"q\u0000~\u0000#t\u0000Medu.mit.coeus.utils.xml.bean.reviewcomments.Schedule"
+"Type.PreviousScheduleTypeq\u0000~\u0000\'sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u00005q\u0000~\u0000E"
+"q\u0000~\u0000\"sq\u0000~\u0000#t\u0000\u0010PreviousScheduleq\u0000~\u0000Jq\u0000~\u0000\"sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0019q\u0000~\u0000\u0018p"
+"q\u0000~\u00005q\u0000~\u0000Eq\u0000~\u0000\"sq\u0000~\u0000#t\u0000\bScheduleq\u0000~\u0000Jsr\u0000\"com.sun.msv.grammar"
...
+"ntt\u0000$Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u00007\u0001pq\u0000~\u0000\u0091q\u0000~\u0000\u009eq"
+"\u0000~\u0000Lq\u0000~\u0000oq\u0000~\u00000q\u0000~\u0000\\q\u0000~\u0000jq\u0000~\u0000\u007fq\u0000~\u0000\u008dq\u0000~\u0000\u009aq\u0000~\u0000\rq\u0000~\u0000\u00a7q\u0000~\u0000\u00abq\u0000~\u0000)q"
+"\u0000~\u0000Uq\u0000~\u0000cq\u0000~\u0000xq\u0000~\u0000\u0086q\u0000~\u0000\u0093q\u0000~\u0000\u00a0q\u0000~\u0000\u0013q\u0000~\u0000+q\u0000~\u0000Oq\u0000~\u0000Wq\u0000~\u0000eq\u0000~\u0000rq"
+"\u0000~\u0000zq\u0000~\u0000\u0088q\u0000~\u0000\u0095q\u0000~\u0000\u00a2q\u0000~\u0000\u0011q\u0000~\u0000Mq\u0000~\u0000pq\u0000~\u0000\u000eq\u0000~\u0000\tq\u0000~\u0000\u000bq\u0000~\u0000`q\u0000~\u0000\u0083q"
+"\u0000~\u0000\fq\u0000~\u0000Kq\u0000~\u0000nq\u0000~\u0000aq\u0000~\u0000\u0084q\u0000~\u0000\u0016q\u0000~\u0000,q\u0000~\u0000Pq\u0000~\u0000Xq\u0000~\u0000fq\u0000~\u0000sq\u0000~\u0000{q"
+"\u0000~\u0000\u0089q\u0000~\u0000\u0096q\u0000~\u0000\u00a3q\u0000~\u0000\u000fq\u0000~\u0000\nx"));
        }
        ...
        extends edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.reviewcomments.impl.ScheduleImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("ScheduleMasterData" == ___local)&&("http://irb.mit.edu/irbnamespace" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.mit.coeus.utils.xml.bean.reviewcomments.impl.ScheduleTypeImpl)edu.mit.coeus.utils.xml.bean.reviewcomments.impl.ScheduleImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("ScheduleMasterData" == ___local)&&("http://irb.mit.edu/irbnamespace" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.mit.coeus.utils.xml.bean.reviewcomments.impl.ScheduleTypeImpl)edu.mit.coeus.utils.xml.bean.reviewcomments.impl.ScheduleImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
