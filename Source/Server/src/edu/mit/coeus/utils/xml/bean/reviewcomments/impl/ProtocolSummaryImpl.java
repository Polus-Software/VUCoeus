...
public class ProtocolSummaryImpl
    extends edu.mit.coeus.utils.xml.bean.reviewcomments.impl.ProtocolSummaryTypeImpl
    implements edu.mit.coeus.utils.xml.bean.reviewcomments.ProtocolSummary, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.reviewcomments.ProtocolSummary.class);
    }
    ...
    public edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.reviewcomments.impl.ProtocolSummaryImpl.Unmarshaller(context);
    }
...
+"tocolMasterDatat\u0000+http://java.sun.com/jaxb/xjc/dummy-element"
+"ssq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\fppsq\u0000~\u0000\u0010q\u0000~\u0000\u0014psq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq"
+"\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000Bedu.mit.coeus.utils.xml.bean.reviewco"
+"mments.ProtocolMasterDataTypeq\u0000~\u0000#sq\u0000~\u0000\fppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014psr\u0000\u001bco"
...
+"spacesq\u0000~\u0000\u0010ppsq\u0000~\u0000\fppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\fppsq\u0000~\u0000\u0010q\u0000~\u0000\u0014psq\u0000~\u0000\u0015q\u0000~\u0000"
+"\u0014pq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u00008edu.mit.coeus.utils.xml.bean.revie"
+"wcomments.Investigatorq\u0000~\u0000#sq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\fp"
+"psq\u0000~\u0000\u0010q\u0000~\u0000\u0014psq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000<edu.mit.coe"
+"us.utils.xml.bean.reviewcomments.InvestigatorTypeq\u0000~\u0000#sq\u0000~\u0000\f"
+"ppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u00001q\u0000~\u0000Aq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\fInvestigatorq\u0000~\u0000Fsq\u0000~\u0000"
+"\fppsq\u0000~\u0000\u0010q\u0000~\u0000\u0014psq\u0000~\u0000\u0000q\u0000~\u0000\u0014p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\fppsq\u0000~\u0000\u0010q"
+"\u0000~\u0000\u0014psq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000Qedu.mit.coeus.utils"
+".xml.bean.reviewcomments.ProtocolSummaryType.FundingSourceTy"
+"peq\u0000~\u0000#sq\u0000~\u0000\fppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u00001q\u0000~\u0000Aq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\rFundingSo"
+"urceq\u0000~\u0000Fq\u0000~\u0000\u001esq\u0000~\u0000\fppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u00001q\u0000~\u0000Aq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u000fPr"
+"otocolSummaryq\u0000~\u0000Fsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000"
...
+"q\u0000~\u0000\\q\u0000~\u0000\u0012q\u0000~\u0000(q\u0000~\u0000Kq\u0000~\u0000Sq\u0000~\u0000aq\u0000~\u0000\u000bx"));
        ...
        extends edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.reviewcomments.impl.ProtocolSummaryImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("ProtocolMasterData" == ___local)&&("http://irb.mit.edu/irbnamespace" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.mit.coeus.utils.xml.bean.reviewcomments.impl.ProtocolSummaryTypeImpl)edu.mit.coeus.utils.xml.bean.reviewcomments.impl.ProtocolSummaryImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("ProtocolMasterData" == ___local)&&("http://irb.mit.edu/irbnamespace" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.mit.coeus.utils.xml.bean.reviewcomments.impl.ProtocolSummaryTypeImpl)edu.mit.coeus.utils.xml.bean.reviewcomments.impl.ProtocolSummaryImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
