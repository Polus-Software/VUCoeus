...
public class CoreFederalDebtDelinquencyQuestionsTypeImpl implements edu.mit.coeus.utils.xml.bean.proposal.rar.CoreFederalDebtDelinquencyQuestionsType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.ValidatableObject
{

    protected boolean has_ApplicantDelinquentIndicator;
    protected boolean _ApplicantDelinquentIndicator;
    protected java.lang.String _DelinquencyExplanation;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.proposal.rar.CoreFederalDebtDelinquencyQuestionsType.class);
    }

    public boolean isApplicantDelinquentIndicator() {
        return _ApplicantDelinquentIndicator;
    }

    public void setApplicantDelinquentIndicator(boolean value) {
        _ApplicantDelinquentIndicator = value;
        has_ApplicantDelinquentIndicator = true;
    }

    public java.lang.String getDelinquencyExplanation() {
        return _DelinquencyExplanation;
    }

    public void setDelinquencyExplanation(java.lang.String value) {
        _DelinquencyExplanation = value;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.proposal.rar.impl.CoreFederalDebtDelinquencyQuestionsTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        if (!has_ApplicantDelinquentIndicator) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "ApplicantDelinquentIndicator"));
        }
        context.startElement("", "ApplicantDelinquentIndicator");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printBoolean(((boolean) _ApplicantDelinquentIndicator)), "ApplicantDelinquentIndicator");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        if (_DelinquencyExplanation!= null) {
            context.startElement("", "DelinquencyExplanation");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(((java.lang.String) _DelinquencyExplanation), "DelinquencyExplanation");
            } catch (java.lang.Exception e) {
                edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
...
+"\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003sq\u0000~\u0000\u001d\u0001q\u0000~\u00000sq\u0000~\u0000*t\u0000\u001cApplicantDelinquentIndic"
+"atort\u0000\u0000sq\u0000~\u0000!ppsq\u0000~\u0000\u0006q\u0000~\u0000\u001ep\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000bq\u0000~\u0000\u001epsr\u0000#com.sun."
+"msv.datatype.xsd.StringType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001Z\u0000\risAlwaysValidxq\u0000~\u0000\u0010"
+"q\u0000~\u0000\u0016t\u0000\u0006stringsr\u00005com.sun.msv.datatype.xsd.WhiteSpaceProcess"
+"or$Preserve\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0019\u0001q\u0000~\u0000\u001csq\u0000~\u0000\u001fq\u0000~\u0000;q\u0000~\u0000\u0016sq\u0000~\u0000!ppsq"
+"\u0000~\u0000#q\u0000~\u0000\u001epq\u0000~\u0000%q\u0000~\u0000,q\u0000~\u00000sq\u0000~\u0000*t\u0000\u0016DelinquencyExplanationq\u0000~\u0000"
+"4q\u0000~\u00000sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\bex"
...
+"ssionPool;xp\u0000\u0000\u0000\u0006\u0001pq\u0000~\u0000\nq\u0000~\u00005q\u0000~\u00007q\u0000~\u0000\"q\u0000~\u0000?q\u0000~\u0000\u0005x"));
        ...
        extends edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.proposal.rar.impl.CoreFederalDebtDelinquencyQuestionsTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        ...
                        break;
                    case  3 :
                        if (("DelinquencyExplanation" == ___local)&&("" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 4;
                            return ;
                        }
        ...
        {
            try {
                _ApplicantDelinquentIndicator = javax.xml.bind.DatatypeConverter.parseBoolean(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_ApplicantDelinquentIndicator = true;
            } catch (java.lang.Exception e) {
