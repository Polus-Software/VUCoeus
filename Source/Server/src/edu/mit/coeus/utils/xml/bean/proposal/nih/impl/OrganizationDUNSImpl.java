...
public class OrganizationDUNSImpl
    extends org.w3._2001.xmlschema.impl.AnyTypeImpl
    implements edu.mit.coeus.utils.xml.bean.proposal.nih.OrganizationDUNS, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.proposal.nih.OrganizationDUNS.class);
    }
    ...
    public edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.proposal.nih.impl.OrganizationDUNSImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://era.nih.gov/Projectmgmt/SBIR/CGAP/nihspecific.namespace", "OrganizationDUNS");
...
+"tanceq\u0000~\u0000!sq\u0000~\u00007t\u0000\u0010OrganizationDUNSt\u0000>http://era.nih.gov/Pro"
+"jectmgmt/SBIR/CGAP/nihspecific.namespacesr\u0000\"com.sun.msv.gram"
...
+"arentt\u0000$Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000\fq\u0000~"
+"\u0000\u0010q\u0000~\u0000\u000eq\u0000~\u0000\"q\u0000~\u0000\tx"));
        }
        ...
        extends edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.proposal.nih.impl.OrganizationDUNSImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        if (true) {
                            spawnHandlerFromEnterElement((((org.w3._2001.xmlschema.impl.AnyTypeImpl)edu.mit.coeus.utils.xml.bean.proposal.nih.impl.OrganizationDUNSImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((org.w3._2001.xmlschema.impl.AnyTypeImpl)edu.mit.coeus.utils.xml.bean.proposal.nih.impl.OrganizationDUNSImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("OrganizationDUNS" == ___local)&&("http://era.nih.gov/Projectmgmt/SBIR/CGAP/nihspecific.namespace" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveElement((((org.w3._2001.xmlschema.impl.AnyTypeImpl)edu.mit.coeus.utils.xml.bean.proposal.nih.impl.OrganizationDUNSImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((org.w3._2001.xmlschema.impl.AnyTypeImpl)edu.mit.coeus.utils.xml.bean.proposal.nih.impl.OrganizationDUNSImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((org.w3._2001.xmlschema.impl.AnyTypeImpl)edu.mit.coeus.utils.xml.bean.proposal.nih.impl.OrganizationDUNSImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((org.w3._2001.xmlschema.impl.AnyTypeImpl)edu.mit.coeus.utils.xml.bean.proposal.nih.impl.OrganizationDUNSImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
