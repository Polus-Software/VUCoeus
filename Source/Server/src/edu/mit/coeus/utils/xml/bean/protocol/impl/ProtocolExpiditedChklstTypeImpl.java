...
public class ProtocolExpiditedChklstTypeImpl implements edu.mit.coeus.utils.xml.bean.protocol.ProtocolExpiditedChklstType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.ValidatableObject
{

    protected boolean has_SubmissionNumber;
    protected int _SubmissionNumber;
    protected java.lang.String _ExpeditedRevChklstCode;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.protocol.ProtocolExpiditedChklstType.class);
    }
    ...
    public java.lang.String getExpeditedRevChklstCode() {
        return _ExpeditedRevChklstCode;
    }

    public void setExpeditedRevChklstCode(java.lang.String value) {
        _ExpeditedRevChklstCode = value;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolExpiditedChklstTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "ExpeditedRevChklstCode");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(((java.lang.String) _ExpeditedRevChklstCode), "ExpeditedRevChklstCode");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
...
+"\u0000\u0012sq\u0000~\u0000%ppsq\u0000~\u0000\'q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00002q\u0000~\u00006sq\u0000~\u00000t\u0000\u0016ExpeditedRevCh"
...
+"\u0000~\u0000#q\u0000~\u0000{q\u0000~\u0000\u001csq\u0000~\u0000%ppsq\u0000~\u0000\'q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00002q\u0000~\u00006sq\u0000~\u00000t\u0000\u000fUp"
+"dateTimestampq\u0000~\u0000:sq\u0000~\u0000\npp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0012sq\u0000~\u0000%ppsq\u0000~\u0000\'q\u0000~\u0000\u0014p"
+"q\u0000~\u0000)q\u0000~\u00002q\u0000~\u00006sq\u0000~\u00000t\u0000\nUpdateUserq\u0000~\u0000:sr\u0000\"com.sun.msv.gramm"
...
+"\u0082q\u0000~\u0000<q\u0000~\u0000jq\u0000~\u0000\u0007x"));
        ...
        extends edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolExpiditedChklstTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  15 :
                        ...
                        break;
                    case  9 :
                        if (("ExpeditedRevChklstCode" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 10;
                            return ;
                        }
