...
public class ModuleUsageTypeImpl implements edu.mit.coeus.utils.xml.bean.questionnaire.ModuleUsageType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.questionnaire.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.questionnaire.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.questionnaire.impl.runtime.ValidatableObject
{

    protected edu.mit.coeus.utils.xml.bean.questionnaire.ModuleInfoType _ModuleInfo;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.questionnaire.ModuleUsageType.class);
    }

    public edu.mit.coeus.utils.xml.bean.questionnaire.ModuleInfoType getModuleInfo() {
        return _ModuleInfo;
    }

    public void setModuleInfo(edu.mit.coeus.utils.xml.bean.questionnaire.ModuleInfoType value) {
        _ModuleInfo = value;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.questionnaire.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.questionnaire.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.questionnaire.impl.ModuleUsageTypeImpl.Unmarshaller(context);
    }
    ...
    {
        if (_ModuleInfo!= null) {
            context.startElement("", "ModuleInfo");
...
+"amet\u0000\u0012Ljava/lang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001exq\u0000~\u0000\u0019t\u00009edu.mit"
+".coeus.utils.xml.bean.questionnaire.ModuleInfoTypet\u0000+http://"
...
+"eq\u0000~\u0000\u001csq\u0000~\u0000\u001dt\u0000\nModuleInfot\u0000\u0000q\u0000~\u0000\u001csr\u0000\"com.sun.msv.grammar.Exp"
...
+"q\u0000~\u0000\u000fq\u0000~\u0000\rx"));
        ...
        extends edu.mit.coeus.utils.xml.bean.questionnaire.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.questionnaire.impl.ModuleUsageTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("ModuleCode" == ___local)&&("" == ___uri)) {
                            _ModuleInfo = ((edu.mit.coeus.utils.xml.bean.questionnaire.impl.ModuleInfoTypeImpl) spawnChildFromEnterElement((edu.mit.coeus.utils.xml.bean.questionnaire.impl.ModuleInfoTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                }
