...
public class ProtocolSubjectsTypeImpl implements edu.mit.coeus.utils.xml.bean.protocol.ProtocolSubjectsType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.ValidatableObject
{

    protected boolean has_VulnerableSubjectTypeCode;
    protected int _VulnerableSubjectTypeCode;
    protected java.util.Calendar _UpdateTimestamp;
    protected boolean has_SubjectCount;
    protected int _SubjectCount;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.protocol.ProtocolSubjectsType.class);
    }
    ...
    public void setVulnerableSubjectTypeCode(int value) {
        _VulnerableSubjectTypeCode = value;
        has_VulnerableSubjectTypeCode = true;
    }
    ...
    public void setSubjectCount(int value) {
        _SubjectCount = value;
        has_SubjectCount = true;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolSubjectsTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        if (!has_VulnerableSubjectTypeCode) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "VulnerableSubjectTypeCode"));
        }
        if (!has_SubjectCount) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "SubjectCount"));
        }
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "VulnerableSubjectTypeCode");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printInt(((int) _VulnerableSubjectTypeCode)), "VulnerableSubjectTypeCode");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "VulnerableSubjectTypeDesc");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "SubjectCount");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printInt(((int) _SubjectCount)), "SubjectCount");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
...
+"\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\u0019VulnerableSubjectTypeCodeq\u0000~\u0000;sq\u0000"
+"~\u0000\u000bpp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0013sq\u0000~\u0000&ppsq\u0000~\u0000(q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001"
+"t\u0000\u0019VulnerableSubjectTypeDescq\u0000~\u0000;sq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000>sq\u0000~\u0000"
+"&ppsq\u0000~\u0000(q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\fSubjectCountq\u0000~\u0000;sq\u0000~"
...
+"~\u0000&ppsq\u0000~\u0000(q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\u000fUpdateTimestampq\u0000~\u0000"
+";sq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0013sq\u0000~\u0000&ppsq\u0000~\u0000(q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq"
...
+"\u0000~\u0000kq\u0000~\u0000wq\u0000~\u0000\bx"));
        ...
        extends edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolSubjectsTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  21 :
                        ...
                        return ;
                    case  9 :
                        if (("VulnerableSubjectTypeDesc" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                        ...
                        break;
                    case  6 :
                        if (("VulnerableSubjectTypeCode" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 7;
                            return ;
                        }
                    ...
                    case  15 :
                        ...
                        break;
                    case  12 :
                        if (("SubjectCount" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 13;
                            return ;
                        }
        ...
        {
            try {
                _VulnerableSubjectTypeCode = javax.xml.bind.DatatypeConverter.parseInt(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_VulnerableSubjectTypeCode = true;
            } catch (java.lang.Exception e) {
        ...
        {
            try {
                _SubjectCount = javax.xml.bind.DatatypeConverter.parseInt(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_SubjectCount = true;
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
