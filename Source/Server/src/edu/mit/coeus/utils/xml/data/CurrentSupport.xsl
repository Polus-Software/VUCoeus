...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="default-page" page-height="8.5in" page-width="11in" margin-left="0.1in" margin-right="0.1in">
					...
					<fo:block>
						<xsl:for-each select="$XML">
							...
							<xsl:if test="CurrentAndPendingSupport/CurrentSupport">
								<fo:table font-family="Arial" font-size="8pt" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="-1pt">
									...
									<fo:table-header start-indent="0pt">
										<fo:table-row font-weight="bold">
											<fo:table-cell border="solid 1pt gray" padding="1" text-align="center" display-align="center">
												<fo:block>
													<fo:inline>
											...
											<fo:table-cell border="solid 1pt gray" padding="1" text-align="center" display-align="center">
												<fo:block>
													<fo:inline>
														<xsl:text>Academic Year Effort%</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell border="solid 1pt gray" padding="1" text-align="center" display-align="center">
											...
											<fo:table-cell border="solid 1pt gray" padding="1" text-align="center" display-align="center">
												<fo:block>
													<fo:inline>
														<xsl:text>Calendar Year Effort%</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell border="solid 1pt gray" padding="1" text-align="center" display-align="center">
										...
										<xsl:for-each select="CurrentAndPendingSupport">
											<xsl:for-each select="CurrentSupport">
												<fo:table-row>
													...
													<fo:table-cell border="solid 1pt gray" padding="1" text-align="right" display-align="center">
														<fo:block>
													...
													<fo:table-cell border="solid 1pt gray" padding="1" text-align="center" display-align="center">
														<fo:block>
															...
															<fo:block white-space="pre" white-space-collapse="false" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" margin="0pt">
																<fo:block>
																	<xsl:for-each select="CEColumnValue1">
																		<xsl:variable name="value-of-template">
																			<xsl:apply-templates/>
																		</xsl:variable>
																		<xsl:choose>
													...
													<fo:table-cell border="solid 1pt gray" padding="1" text-align="center" display-align="center">
														<fo:block>
															...
															<fo:block white-space="pre" white-space-collapse="false" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" margin="0pt">
																<fo:block>
																	<xsl:for-each select="CEColumnValue2">
																		<xsl:variable name="value-of-template">
																			<xsl:apply-templates/>
																		</xsl:variable>
																		<xsl:choose>
													...
													<fo:table-cell border="solid 1pt gray" padding="1" text-align="center" display-align="center">
														<fo:block>
															...
															<fo:block white-space="pre" white-space-collapse="false" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" margin="0pt">
																<fo:block>
																	<xsl:for-each select="CEColumnValue3">
																		<xsl:variable name="value-of-template">
																			<xsl:apply-templates/>
																		</xsl:variable>
																		<xsl:choose>
