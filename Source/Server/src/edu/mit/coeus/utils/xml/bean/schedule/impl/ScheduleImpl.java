...
public class ScheduleImpl
    extends edu.mit.coeus.utils.xml.bean.schedule.impl.ScheduleTypeImpl
    implements edu.mit.coeus.utils.xml.bean.schedule.Schedule, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.schedule.Schedule.class);
    }
    ...
    public edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.schedule.impl.ScheduleImpl.Unmarshaller(context);
    }
...
+"ava/lang/String;L\u0000\fnamespaceURIq\u0000~\u0000$xq\u0000~\u0000\u001ft\u00008edu.mit.coeus.u"
+"tils.xml.bean.schedule.ScheduleMasterDatat\u0000+http://java.sun."
+"com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0010p"
+"psq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u0000\u001cq\u0000~\u0000 q\u0000~\u0000\"sq\u0000~\u0000#t\u0000<edu.mit.coe"
+"us.utils.xml.bean.schedule.ScheduleMasterDataTypeq\u0000~\u0000\'sq\u0000~\u0000\u0010"
...
+"2001/XMLSchema-instanceq\u0000~\u0000\"sq\u0000~\u0000#t\u0000\u0012ScheduleMasterDatat\u0000\u001fht"
+"tp://irb.mit.edu/irbnamespacesq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0010q\u0000~\u0000\u0018"
+"psq\u0000~\u0000\u0000q\u0000~\u0000\u0018p\u0000sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u0000\u001cq\u0000~\u0000 q\u0000~\u0000"
+"\"sq\u0000~\u0000#t\u00008edu.mit.coeus.utils.xml.bean.schedule.ProtocolSubm"
+"issionq\u0000~\u0000\'sq\u0000~\u0000\u0000q\u0000~\u0000\u0018p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018"
+"psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u0000\u001cq\u0000~\u0000 q\u0000~\u0000\"sq\u0000~\u0000#t\u0000<edu.mit.coeus.utils.xml"
+".bean.schedule.ProtocolSubmissionTypeq\u0000~\u0000\'sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0019q\u0000~\u0000"
+"\u0018pq\u0000~\u00005q\u0000~\u0000Eq\u0000~\u0000\"sq\u0000~\u0000#t\u0000\u0012ProtocolSubmissionq\u0000~\u0000Jq\u0000~\u0000\"sq\u0000~\u0000\u0010"
+"ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0000q\u0000~\u0000\u0018p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000"
+"~\u0000\u0018psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u0000\u001cq\u0000~\u0000 q\u0000~\u0000\"sq\u0000~\u0000#t\u0000Dedu.mit.coeus.utils."
+"xml.bean.schedule.ScheduleType.OtherBusinessTypeq\u0000~\u0000\'sq\u0000~\u0000\u0010p"
+"psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u00005q\u0000~\u0000Eq\u0000~\u0000\"sq\u0000~\u0000#t\u0000\rOtherBusinessq\u0000~\u0000Jq\u0000~\u0000\""
+"sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0010q\u0000~\u0000\u0018psq\u0000~\u0000\u0000q\u0000~\u0000\u0018p\u0000sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q"
+"\u0000~\u0000\u0018psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u0000\u001cq\u0000~\u0000 q\u0000~\u0000\"sq\u0000~\u0000#t\u0000-edu.mit.coeus.utils"
+".xml.bean.schedule.Minutesq\u0000~\u0000\'sq\u0000~\u0000\u0000q\u0000~\u0000\u0018p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp"
+"\u0000sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u0000\u001cq\u0000~\u0000 q\u0000~\u0000\"sq\u0000~\u0000#t\u00001edu"
+".mit.coeus.utils.xml.bean.schedule.MinutesTypeq\u0000~\u0000\'sq\u0000~\u0000\u0010pps"
+"q\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u00005q\u0000~\u0000Eq\u0000~\u0000\"sq\u0000~\u0000#t\u0000\u0007Minutesq\u0000~\u0000Jq\u0000~\u0000\"sq\u0000~\u0000\u0010pp"
+"sq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0000q\u0000~\u0000\u0018p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000"
+"\u0018psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u0000\u001cq\u0000~\u0000 q\u0000~\u0000\"sq\u0000~\u0000#t\u0000Aedu.mit.coeus.utils.xm"
+"l.bean.schedule.ScheduleType.AttendentsTypeq\u0000~\u0000\'sq\u0000~\u0000\u0010ppsq\u0000~"
+"\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u00005q\u0000~\u0000Eq\u0000~\u0000\"sq\u0000~\u0000#t\u0000\nAttendentsq\u0000~\u0000Jq\u0000~\u0000\"sq\u0000~\u0000\u0010pp"
+"sq\u0000~\u0000\u0000q\u0000~\u0000\u0018p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0019q\u0000~\u0000"
+"\u0018pq\u0000~\u0000\u001cq\u0000~\u0000 q\u0000~\u0000\"sq\u0000~\u0000#t\u0000Cedu.mit.coeus.utils.xml.bean.sched"
+"ule.ScheduleType.NextScheduleTypeq\u0000~\u0000\'sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000"
+"~\u00005q\u0000~\u0000Eq\u0000~\u0000\"sq\u0000~\u0000#t\u0000\fNextScheduleq\u0000~\u0000Jq\u0000~\u0000\"sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0000q\u0000"
+"~\u0000\u0018p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0014q\u0000~\u0000\u0018psq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u0000\u001cq"
+"\u0000~\u0000 q\u0000~\u0000\"sq\u0000~\u0000#t\u0000Gedu.mit.coeus.utils.xml.bean.schedule.Sche"
+"duleType.PreviousScheduleTypeq\u0000~\u0000\'sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0019q\u0000~\u0000\u0018pq\u0000~\u00005q"
+"\u0000~\u0000Eq\u0000~\u0000\"sq\u0000~\u0000#t\u0000\u0010PreviousScheduleq\u0000~\u0000Jq\u0000~\u0000\"sq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0019q\u0000"
+"~\u0000\u0018pq\u0000~\u00005q\u0000~\u0000Eq\u0000~\u0000\"sq\u0000~\u0000#t\u0000\bScheduleq\u0000~\u0000Jsr\u0000\"com.sun.msv.gra"
...
+"~\u0000Uq\u0000~\u0000cq\u0000~\u0000xq\u0000~\u0000\u0086q\u0000~\u0000\u0093q\u0000~\u0000\u00a0q\u0000~\u0000\u000bq\u0000~\u0000\tq\u0000~\u0000Lq\u0000~\u0000oq\u0000~\u0000Kq\u0000~\u0000aq\u0000"
+"~\u0000nq\u0000~\u0000\u0084q\u0000~\u0000\u0011q\u0000~\u0000Mq\u0000~\u0000pq\u0000~\u0000\u0013q\u0000~\u0000+q\u0000~\u0000\u0016q\u0000~\u0000,q\u0000~\u0000Pq\u0000~\u0000Oq\u0000~\u0000Xq\u0000"
+"~\u0000Wq\u0000~\u0000fq\u0000~\u0000\u000fq\u0000~\u0000eq\u0000~\u0000sq\u0000~\u0000rq\u0000~\u0000{q\u0000~\u0000zq\u0000~\u0000\rq\u0000~\u0000\u0089q\u0000~\u0000\u0088q\u0000~\u0000\u0096q\u0000"
+"~\u0000\u0095q\u0000~\u0000\u00a3q\u0000~\u0000\u00a2q\u0000~\u0000\nq\u0000~\u0000\u000eq\u0000~\u0000\u0091q\u0000~\u0000\u009eq\u0000~\u0000\fq\u0000~\u00000q\u0000~\u0000\\q\u0000~\u0000jq\u0000~\u0000\u007fq\u0000"
+"~\u0000\u008dq\u0000~\u0000\u009aq\u0000~\u0000\u00a7q\u0000~\u0000\u00abq\u0000~\u0000`q\u0000~\u0000\u0083x"));
        }
        ...
        extends edu.mit.coeus.utils.xml.bean.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.schedule.impl.ScheduleImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("ScheduleMasterData" == ___local)&&("http://irb.mit.edu/irbnamespace" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.mit.coeus.utils.xml.bean.schedule.impl.ScheduleTypeImpl)edu.mit.coeus.utils.xml.bean.schedule.impl.ScheduleImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("ScheduleMasterData" == ___local)&&("http://irb.mit.edu/irbnamespace" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.mit.coeus.utils.xml.bean.schedule.impl.ScheduleTypeImpl)edu.mit.coeus.utils.xml.bean.schedule.impl.ScheduleImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
