...
public class ProtocolLinksTypeImpl implements edu.mit.coeus.utils.xml.bean.protocol.ProtocolLinksType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.ValidatableObject
{
    ...
    protected boolean has_ModuleItemSequenceNumber;
    protected int _ModuleItemSequenceNumber;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.protocol.ProtocolLinksType.class);
    }
    ...
    public int getModuleItemSequenceNumber() {
        return _ModuleItemSequenceNumber;
    }

    public void setModuleItemSequenceNumber(int value) {
        _ModuleItemSequenceNumber = value;
        has_ModuleItemSequenceNumber = true;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolLinksTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        if (!has_ModuleItemSequenceNumber) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "ModuleItemSequenceNumber"));
        }
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "ModuleCode");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "ModuleItemKey");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "ModuleItemSequenceNumber");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printInt(((int) _ModuleItemSequenceNumber)), "ModuleItemSequenceNumber");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "ActionType");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(((java.lang.String) _ActionType), "ActionType");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
...
+"\u0000~\u0000\rpp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0015sq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u0000"
+"3t\u0000\rModuleItemKeyq\u0000~\u0000=sq\u0000~\u0000\rpp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000@sq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000"
+"~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\u0018ModuleItemSequenceNumberq\u0000~\u0000=sq\u0000"
+"~\u0000\rpp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0015sq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003"
+"t\u0000\nActionTypeq\u0000~\u0000=sq\u0000~\u0000\rpp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0015sq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017p"
+"q\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\bCommentsq\u0000~\u0000=sq\u0000~\u0000\rpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0012"
+"ppsr\u0000%com.sun.msv.datatype.xsd.DateTimeType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000)co"
+"m.sun.msv.datatype.xsd.DateTimeBaseType\u0014W\u001a@3\u00a5\u00b4\u00e5\u0002\u0000\u0000xq\u0000~\u0000\u0019q\u0000~\u0000"
+"\u001ft\u0000\bdateTimeq\u0000~\u00001q\u0000~\u0000%sq\u0000~\u0000&q\u0000~\u0000\u0090q\u0000~\u0000\u001fsq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000"
+"~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\u000fUpdateTimestampq\u0000~\u0000=sq\u0000~\u0000\rpp\u0000sq\u0000~\u0000\u0000ppq"
+"\u0000~\u0000\u0015sq\u0000~\u0000(ppsq\u0000~\u0000*q\u0000~\u0000\u0017pq\u0000~\u0000,q\u0000~\u00005q\u0000~\u00009sq\u0000~\u00003t\u0000\nUpdateUserq\u0000"
...
+"onPool;xp\u0000\u0000\u0000\u001a\u0001pq\u0000~\u0000\fq\u0000~\u0000\u008bq\u0000~\u0000\bq\u0000~\u0000\u0006q\u0000~\u0000)q\u0000~\u0000hq\u0000~\u0000nq\u0000~\u0000\u000bq\u0000~\u0000t"
+"q\u0000~\u0000zq\u0000~\u0000\u0080q\u0000~\u0000\u0086q\u0000~\u0000\u0092q\u0000~\u0000\u0098q\u0000~\u0000\u0011q\u0000~\u0000sq\u0000~\u0000\tq\u0000~\u0000\u007fq\u0000~\u0000\u0085q\u0000~\u0000\u0097q\u0000~\u0000\u0007"
+"q\u0000~\u0000\u0005q\u0000~\u0000?q\u0000~\u0000mq\u0000~\u0000yq\u0000~\u0000\nx"));
        }
        ...
        extends edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolLinksTypeImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  15 :
                        if (("ActionType" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  9 :
                        if (("ModuleItemKey" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 10;
                            return ;
                        }
                    ...
                    case  27 :
                        ...
                        return ;
                    case  12 :
                        if (("ModuleItemSequenceNumber" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 13;
                            return ;
                        }
                        break;
                    case  6 :
                        if (("ModuleCode" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 7;
                            return ;
                        }
        ...
        {
            try {
                _ModuleItemSequenceNumber = javax.xml.bind.DatatypeConverter.parseInt(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_ModuleItemSequenceNumber = true;
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
