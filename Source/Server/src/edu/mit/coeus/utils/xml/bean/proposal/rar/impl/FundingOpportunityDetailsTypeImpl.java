...
public class FundingOpportunityDetailsTypeImpl implements edu.mit.coeus.utils.xml.bean.proposal.rar.FundingOpportunityDetailsType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.proposal.rar.FundingOpportunityDetailsType.class);
    }
    ...
    public edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.proposal.rar.impl.FundingOpportunityDetailsTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "FundingOpportunityNumber");
        ...
        context.endElement();
        context.startElement("", "FundingOpportunityTitle");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
...
+"n\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003sq\u0000~\u0000\u001e\u0001q\u0000~\u00001sq\u0000~\u0000+t\u0000\u0018FundingOpportunityNum"
+"bert\u0000\u0000sq\u0000~\u0000\u0006pp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000bq\u0000~\u0000\u001fpsq\u0000~\u0000\u0010q\u0000~\u0000\u0017t\u0000\u0006stringsr\u00005c"
+"om.sun.msv.datatype.xsd.WhiteSpaceProcessor$Preserve\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001"
+"\u0002\u0000\u0000xq\u0000~\u0000\u001a\u0001q\u0000~\u0000\u001dsq\u0000~\u0000 q\u0000~\u0000:q\u0000~\u0000\u0017sq\u0000~\u0000\"ppsq\u0000~\u0000$q\u0000~\u0000\u001fpq\u0000~\u0000&q\u0000~\u0000"
+"-q\u0000~\u00001sq\u0000~\u0000+t\u0000\u0017FundingOpportunityTitleq\u0000~\u00005sr\u0000\"com.sun.msv.g"
...
+"q\u0000~\u00007q\u0000~\u0000#q\u0000~\u0000>q\u0000~\u0000\u0005x"));
        ...
        extends edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.proposal.rar.impl.FundingOpportunityDetailsTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  3 :
                        if (("FundingOpportunityTitle" == ___local)&&("" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 4;
                            return ;
                        }
        ...
        {
            try {
                _FundingOpportunityNumber = com.sun.xml.bind.WhiteSpaceProcessor.collapse(value);
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
        }
