...
public class QuestionsTypeImpl implements edu.mit.coeus.utils.xml.bean.protocol.QuestionsType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _QuestionInfo;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.protocol.QuestionsType.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getQuestionInfo() {
        if (_QuestionInfo == null) {
            _QuestionInfo = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _QuestionInfo;
    }

    public java.util.List getQuestionInfo() {
        return _getQuestionInfo();
    }
    ...
    public edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.protocol.impl.QuestionsTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_QuestionInfo == null)? 0 :_QuestionInfo.size());
        while (idx1 != len1) {
            context.startElement("http://www.w3.org/2001/QuesionnaireSchema", "QuestionInfo");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _QuestionInfo.get(idx_0 ++)), "QuestionInfo");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _QuestionInfo.get(idx_1 ++)), "QuestionInfo");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _QuestionInfo.get(idx1 ++)), "QuestionInfo");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u00006edu.mit.coeus.utils.xml.bean.protocol.QuestionInfoTypet"
...
+"a-instanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\fQuestionInfot\u0000)http://www.w3.org/200"
+"1/QuesionnaireSchemaq\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.ExpressionP"
...
+"\u0000\u0010q\u0000~\u0000\u0013x"));
        ...
        extends edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.protocol.impl.QuestionsTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("QuestionId" == ___local)&&("http://www.w3.org/2001/QuesionnaireSchema" == ___uri)) {
                            _getQuestionInfo().add(((edu.mit.coeus.utils.xml.bean.protocol.impl.QuestionInfoTypeImpl) spawnChildFromEnterElement((edu.mit.coeus.utils.xml.bean.protocol.impl.QuestionInfoTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :
