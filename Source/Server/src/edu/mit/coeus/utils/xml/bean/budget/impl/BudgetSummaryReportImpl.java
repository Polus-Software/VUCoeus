...
public class BudgetSummaryReportImpl
    extends edu.mit.coeus.utils.xml.bean.budget.impl.BudgetSummaryReportTypeImpl
    implements edu.mit.coeus.utils.xml.bean.budget.BudgetSummaryReport, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.budget.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.budget.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.budget.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.budget.BudgetSummaryReport.class);
    }
    ...
    public edu.mit.coeus.utils.xml.bean.budget.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.budget.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.budget.impl.BudgetSummaryReportImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.mit.coeus.utils.xml.bean.budget.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "BudgetSummaryReport");
...
+"q\u0000~\u0000!xq\u0000~\u0000\u001ct\u00004edu.mit.coeus.utils.xml.bean.budget.ReportHead"
...
+"MLSchema-instanceq\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\fReportHeadert\u0000\u0000sq\u0000~\u0000\u0011ppsq\u0000~\u0000\u0000"
+"pp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000fppsq\u0000~\u0000\u0011q\u0000~\u0000\u0015psq\u0000~\u0000\u0016q\u0000~\u0000\u0015pq\u0000~\u0000\u0019q\u0000~"
+"\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 t\u00002edu.mit.coeus.utils.xml.bean.budget.ReportPa"
+"geTypeq\u0000~\u0000$sq\u0000~\u0000\u000fppsq\u0000~\u0000\u0016q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\nRepor"
+"tPageq\u0000~\u0000?sq\u0000~\u0000\u000fppsq\u0000~\u0000\u0000q\u0000~\u0000\u0015p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000fppsq\u0000~"
+"\u0000\u0011q\u0000~\u0000\u0015psq\u0000~\u0000\u0016q\u0000~\u0000\u0015pq\u0000~\u0000\u0019q\u0000~\u0000\u001dq\u0000~\u0000\u001fsq\u0000~\u0000 q\u0000~\u0000Hq\u0000~\u0000$sq\u0000~\u0000\u000fpps"
+"q\u0000~\u0000\u0016q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u000eCumilativePageq\u0000~\u0000?q\u0000~\u0000\u001fs"
+"q\u0000~\u0000\u000fppsq\u0000~\u0000\u0016q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u0000:q\u0000~\u0000\u001fsq\u0000~\u0000 t\u0000\u0013BudgetSummaryRepo"
+"rtq\u0000~\u0000?sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\be"
...
+"\u0000~\u0000Bq\u0000~\u0000Oq\u0000~\u0000Mq\u0000~\u0000\u0013q\u0000~\u0000Eq\u0000~\u0000Rq\u0000~\u0000%q\u0000~\u0000Iq\u0000~\u0000Uq\u0000~\u0000Yx"));
        ...
        extends edu.mit.coeus.utils.xml.bean.budget.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.budget.impl.BudgetSummaryReportImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("BudgetSummaryReport" == ___local)&&("" == ___uri)) {
                    ...
                    case  1 :
                        if (("ReportHeader" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.mit.coeus.utils.xml.bean.budget.impl.BudgetSummaryReportTypeImpl)edu.mit.coeus.utils.xml.bean.budget.impl.BudgetSummaryReportImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                }
