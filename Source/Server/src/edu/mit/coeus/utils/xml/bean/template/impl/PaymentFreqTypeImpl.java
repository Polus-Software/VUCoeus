...
public class PaymentFreqTypeImpl implements edu.mit.coeus.utils.xml.bean.template.PaymentFreqType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.impl.runtime.ValidatableObject
{

    protected java.lang.String _PaymentFreqDesc;
    protected java.lang.String _PaymentFreqCode;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.template.PaymentFreqType.class);
    }

    public java.lang.String getPaymentFreqDesc() {
        return _PaymentFreqDesc;
    }

    public void setPaymentFreqDesc(java.lang.String value) {
        _PaymentFreqDesc = value;
    }

    public java.lang.String getPaymentFreqCode() {
        return _PaymentFreqCode;
    }

    public void setPaymentFreqCode(java.lang.String value) {
        _PaymentFreqCode = value;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.template.impl.PaymentFreqTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.mit.coeus.utils.xml.bean.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        if (_PaymentFreqCode!= null) {
            context.startElement("", "paymentFreqCode");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(((java.lang.String) _PaymentFreqCode), "PaymentFreqCode");
            } catch (java.lang.Exception e) {
                edu.mit.coeus.utils.xml.bean.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
        }
        if (_PaymentFreqDesc!= null) {
            context.startElement("", "paymentFreqDesc");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(((java.lang.String) _PaymentFreqDesc), "PaymentFreqDesc");
            } catch (java.lang.Exception e) {
                edu.mit.coeus.utils.xml.bean.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
...
+"/lang/Boolean;L\u0000\u000bexpandedExpq\u0000~\u0000\u0002xp\u0006\u0091\u00ccsppsr\u0000\u001dcom.sun.msv.gra"
...
+"\u0095sr\u0000\u0011java.lang.Boolean\u00cd r\u0080\u00d5\u009c\u00fa\u00ee\u0002\u0000\u0001Z\u0000\u0005valuexp\u0000p\u0000sq\u0000~\u0000\u0000\u0003^G\u008appsr"
...
+"L\u0000\tlocalNameq\u0000~\u0000\u0017L\u0000\fnamespaceURIq\u0000~\u0000\u0017xpq\u0000~\u0000\u001bq\u0000~\u0000\u001asq\u0000~\u0000\u0006\u0002\u00cd\u00be\u00f4p"
+"psr\u0000 com.sun.msv.grammar.AttributeExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0003expq\u0000~\u0000\u0002L"
+"\u0000\tnameClassq\u0000~\u0000\txq\u0000~\u0000\u0003\u0002\u00cd\u00be\u00e9q\u0000~\u0000\rpsq\u0000~\u0000\u000f\u0001\u00e4\u0085Oppsr\u0000\"com.sun.msv."
...
+"\u000fpaymentFreqCodet\u0000\u0000q\u0000~\u00003sq\u0000~\u0000\u0006\u00033\u0084\u00ceppsq\u0000~\u0000\b\u00033\u0084\u00c3q\u0000~\u0000\rp\u0000sq\u0000~\u0000\u0000\u0003"
+"3\u0084\u00b8ppq\u0000~\u0000\u0012sq\u0000~\u0000\u0006\u0002\u00a2\u00fc\"ppsq\u0000~\u0000$\u0002\u00a2\u00fc\u0017q\u0000~\u0000\rpq\u0000~\u0000&sq\u0000~\u0000-q\u0000~\u00000q\u0000~\u00001q"
+"\u0000~\u00003sq\u0000~\u0000-t\u0000\u000fpaymentFreqDescq\u0000~\u00007q\u0000~\u00003sr\u0000\"com.sun.msv.gramma"
...
+"ppppppppq\u0000~\u00008pppppppppppq\u0000~\u0000\u000epppppppppppppppppppppq\u0000~\u0000\u0007ppppp"
+"pppppppppppppppppppppppppppppppp"));
        ...
        extends edu.mit.coeus.utils.xml.bean.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.template.impl.PaymentFreqTypeImpl.this;
        }
