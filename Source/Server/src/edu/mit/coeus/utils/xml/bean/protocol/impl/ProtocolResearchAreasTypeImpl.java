...
public class ProtocolResearchAreasTypeImpl implements edu.mit.coeus.utils.xml.bean.protocol.ProtocolResearchAreasType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.protocol.ProtocolResearchAreasType.class);
    }

    public java.lang.String getResearchAreaDesc() {
        return _ResearchAreaDesc;
    }

    public void setResearchAreaDesc(java.lang.String value) {
        _ResearchAreaDesc = value;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolResearchAreasTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "ResearchAreaCode");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "ResearchAreaDesc");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(((java.lang.String) _ResearchAreaDesc), "ResearchAreaDesc");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
...
+"q\u0000~\u00002q\u0000~\u00006sq\u0000~\u00000t\u0000\u0010ResearchAreaCodeq\u0000~\u0000:sq\u0000~\u0000\npp\u0000sq\u0000~\u0000\u0000ppq\u0000~"
+"\u0000\u0012sq\u0000~\u0000%ppsq\u0000~\u0000\'q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00002q\u0000~\u00006sq\u0000~\u00000t\u0000\u0010ResearchAreaDe"
...
+"~\u0000{q\u0000~\u0000\u001csq\u0000~\u0000%ppsq\u0000~\u0000\'q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00002q\u0000~\u00006sq\u0000~\u00000t\u0000\u000fUpdateTi"
+"mestampq\u0000~\u0000:sq\u0000~\u0000\npp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0012sq\u0000~\u0000%ppsq\u0000~\u0000\'q\u0000~\u0000\u0014pq\u0000~\u0000)q"
+"\u0000~\u00002q\u0000~\u00006sq\u0000~\u00000t\u0000\nUpdateUserq\u0000~\u0000:sr\u0000\"com.sun.msv.grammar.Exp"
...
+"q\u0000~\u0000\u0005q\u0000~\u0000<x"));
        ...
        extends edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolResearchAreasTypeImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  6 :
                        if (("ResearchAreaCode" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                    ...
                    case  12 :
                        ...
                        break;
                    case  9 :
                        if (("ResearchAreaDesc" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 10;
                            return ;
                        }
