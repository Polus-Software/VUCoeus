    ...
    implements edu.mit.coeus.utils.xml.bean.arra.TelephoneNumberRepresentation, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.arra.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.arra.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.arra.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.arra.TelephoneNumberRepresentation.class);
    }
    ...
    public edu.mit.coeus.utils.xml.bean.arra.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.arra.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.arra.impl.TelephoneNumberRepresentationImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.mit.coeus.utils.xml.bean.arra.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://niem.gov/niem/niem-core/2.0", "TelephoneNumberRepresentation");
...
+"ExpressionPool;xp\u0000\u0000\u0000\u0000\u0001px"));
        ...
        extends edu.mit.coeus.utils.xml.bean.arra.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.arra.impl.TelephoneNumberRepresentationImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        if (true) {
                            spawnHandlerFromEnterElement((((edu.mit.coeus.utils.xml.bean.arra.impl.AnyTypeImpl)edu.mit.coeus.utils.xml.bean.arra.impl.TelephoneNumberRepresentationImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((edu.mit.coeus.utils.xml.bean.arra.impl.AnyTypeImpl)edu.mit.coeus.utils.xml.bean.arra.impl.TelephoneNumberRepresentationImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("TelephoneNumberRepresentation" == ___local)&&("http://niem.gov/niem/niem-core/2.0" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveElement((((edu.mit.coeus.utils.xml.bean.arra.impl.AnyTypeImpl)edu.mit.coeus.utils.xml.bean.arra.impl.TelephoneNumberRepresentationImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  2 :
                        if (("TelephoneNumberRepresentation" == ___local)&&("http://niem.gov/niem/niem-core/2.0" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((edu.mit.coeus.utils.xml.bean.arra.impl.AnyTypeImpl)edu.mit.coeus.utils.xml.bean.arra.impl.TelephoneNumberRepresentationImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((edu.mit.coeus.utils.xml.bean.arra.impl.AnyTypeImpl)edu.mit.coeus.utils.xml.bean.arra.impl.TelephoneNumberRepresentationImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((edu.mit.coeus.utils.xml.bean.arra.impl.AnyTypeImpl)edu.mit.coeus.utils.xml.bean.arra.impl.TelephoneNumberRepresentationImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :
