...
public class TermDetailsTypeImpl implements edu.mit.coeus.utils.xml.bean.template.TermDetailsType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.impl.runtime.ValidatableObject
{

    protected boolean has_TermCode;
    protected int _TermCode;
    protected java.lang.String _TermDescription;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.template.TermDetailsType.class);
    }
    ...
    public edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.template.impl.TermDetailsTypeImpl.Unmarshaller(context);
    }
    ...
    {
        if (has_TermCode) {
            context.startElement("", "TermCode");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(javax.xml.bind.DatatypeConverter.printInt(((int) _TermCode)), "TermCode");
            } catch (java.lang.Exception e) {
                edu.mit.coeus.utils.xml.bean.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
        }
        if (_TermDescription!= null) {
            context.startElement("", "TermDescription");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(((java.lang.String) _TermDescription), "TermDescription");
            } catch (java.lang.Exception e) {
                edu.mit.coeus.utils.xml.bean.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
...
+"/lang/Boolean;L\u0000\u000bexpandedExpq\u0000~\u0000\u0002xp\u0007n\u00b2vppsr\u0000\u001dcom.sun.msv.gra"
+"mmar.ChoiceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0001\u0003(\u00d3Fppsr\u0000\'com.sun.msv.grammar"
...
+";sr\u0000\u0011java.lang.Boolean\u00cd r\u0080\u00d5\u009c\u00fa\u00ee\u0002\u0000\u0001Z\u0000\u0005valuexp\u0000p\u0000sq\u0000~\u0000\u0000\u0003(\u00d30ppsr"
...
+"\u0000~\u0000\f\u0001psq\u0000~\u0000Nt\u0000\bTermCodet\u0000\u0000q\u0000~\u0000Tsq\u0000~\u0000\u0006\u0004E\u00df+ppsq\u0000~\u0000\b\u0004E\u00df q\u0000~\u0000\rp\u0000"
+"sq\u0000~\u0000\u0000\u0004E\u00df\u0015ppsq\u0000~\u0000\u000f\u0000\u0090\u0088\u0091ppsr\u0000#com.sun.msv.datatype.xsd.StringT"
+"ype\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001Z\u0000\risAlwaysValidxq\u0000~\u0000\u0016q\u0000~\u0000\u001ct\u0000\u0006stringsr\u00005com.su"
+"n.msv.datatype.xsd.WhiteSpaceProcessor$Preserve\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq"
+"\u0000~\u0000\u001f\u0001q\u0000~\u0000Csq\u0000~\u0000Dq\u0000~\u0000_q\u0000~\u0000\u001csq\u0000~\u0000\u0006\u0003\u00b5V\u007fppsq\u0000~\u0000G\u0003\u00b5Vtq\u0000~\u0000\rpq\u0000~\u0000Is"
+"q\u0000~\u0000Nq\u0000~\u0000Qq\u0000~\u0000Rq\u0000~\u0000Tsq\u0000~\u0000Nt\u0000\u000fTermDescriptionq\u0000~\u0000Xq\u0000~\u0000Tsr\u0000\"co"
...
+"\u0002\u0000\u0000xp\u0000\u0000\u0000\u00bfppppppppppppppppppppppppppppppppppppppppq\u0000~\u0000cpppq\u0000~"
+"\u0000\u0005pppppppppppppppppppppppq\u0000~\u0000\u000epppppppppppppppppppppq\u0000~\u0000\u0007pppp"
+"pppppppppppppppppppppppq\u0000~\u0000[pppppppppppppppppppppq\u0000~\u0000Ypppppp"
+"ppppppppppppppppppppppppppppppppppq\u0000~\u0000Fppppppppp"));
        }
        ...
        extends edu.mit.coeus.utils.xml.bean.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.template.impl.TermDetailsTypeImpl.this;
        }
        ...
        {
            try {
                _TermCode = javax.xml.bind.DatatypeConverter.parseInt(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_TermCode = true;
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
