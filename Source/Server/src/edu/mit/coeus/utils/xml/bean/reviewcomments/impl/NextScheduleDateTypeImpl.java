...
public class NextScheduleDateTypeImpl implements edu.mit.coeus.utils.xml.bean.reviewcomments.NextScheduleDateType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.reviewcomments.NextScheduleDateType.class);
    }
    ...
    public void setScheduleDate(java.util.Calendar value) {
        _ScheduleDate = value;
    }
    ...
    public void setScheduleNumber(int value) {
        _ScheduleNumber = value;
        has_ScheduleNumber = true;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.reviewcomments.impl.NextScheduleDateTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        if (!has_ScheduleNumber) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "ScheduleNumber"));
        }
        context.startElement("http://irb.mit.edu/irbnamespace", "ScheduleNumber");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printInt(((int) _ScheduleNumber)), "ScheduleNumber");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        context.startElement("http://irb.mit.edu/irbnamespace", "ScheduleDate");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printDate(((java.util.Calendar) _ScheduleDate)), "ScheduleDate");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
...
+"Ssq\u0000~\u0000Mt\u0000\u000eScheduleNumbert\u0000\u001fhttp://irb.mit.edu/irbnamespacesq"
+"\u0000~\u0000\u0006pp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000bq\u0000~\u0000Gpsr\u0000!com.sun.msv.datatype.xsd.Date"
+"Type\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000)com.sun.msv.datatype.xsd.DateTimeBaseType"
+"\u0014W\u001a@3\u00a5\u00b4\u00e5\u0002\u0000\u0000xq\u0000~\u0000\u0012q\u0000~\u0000\u0018t\u0000\u0004dateq\u0000~\u0000\u001cq\u0000~\u0000?sq\u0000~\u0000@q\u0000~\u0000^q\u0000~\u0000\u0018sq\u0000~\u0000"
+"Bppsq\u0000~\u0000Dq\u0000~\u0000Gpq\u0000~\u0000Hq\u0000~\u0000Oq\u0000~\u0000Ssq\u0000~\u0000Mt\u0000\fScheduleDateq\u0000~\u0000Wsr\u0000\""
...
+"xp\u0000\u0000\u0000\u0005\u0001pq\u0000~\u0000\nq\u0000~\u0000Yq\u0000~\u0000Cq\u0000~\u0000`q\u0000~\u0000\u0005x"));
        ...
        extends edu.mit.coeus.utils.xml.bean.reviewcomments.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.reviewcomments.impl.NextScheduleDateTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  6 :
                        ...
                        return ;
                    case  3 :
                        if (("ScheduleDate" == ___local)&&("http://irb.mit.edu/irbnamespace" == ___uri)) {
        ...
        {
            try {
                _ScheduleNumber = javax.xml.bind.DatatypeConverter.parseInt(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_ScheduleNumber = true;
            } catch (java.lang.Exception e) {
        ...
        {
            try {
                _ScheduleDate = javax.xml.bind.DatatypeConverter.parseDate(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
        }
