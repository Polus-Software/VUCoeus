...
public class CoreStateReceiptQualifiersTypeImpl implements edu.mit.coeus.utils.xml.bean.proposal.rar.CoreStateReceiptQualifiersType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.ValidatableObject
{

    protected java.lang.String _StateApplicationIdentifier;
    protected java.util.Calendar _StateReceiptDate;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.proposal.rar.CoreStateReceiptQualifiersType.class);
    }

    public java.lang.String getStateApplicationIdentifier() {
        return _StateApplicationIdentifier;
    }

    public void setStateApplicationIdentifier(java.lang.String value) {
        _StateApplicationIdentifier = value;
    }

    public java.util.Calendar getStateReceiptDate() {
        return _StateReceiptDate;
    }

    public void setStateReceiptDate(java.util.Calendar value) {
        _StateReceiptDate = value;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.proposal.rar.impl.CoreStateReceiptQualifiersTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "StateReceiptDate");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printDate(((java.util.Calendar) _StateReceiptDate)), "StateReceiptDate");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        if (_StateApplicationIdentifier!= null) {
            context.startElement("", "StateApplicationIdentifier");
            context.endNamespaceDecls();
            context.endAttributes();
            try {
                context.text(((java.lang.String) _StateApplicationIdentifier), "StateApplicationIdentifier");
            } catch (java.lang.Exception e) {
                edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
...
+"q\u0000~\u0000\u0003sq\u0000~\u0000\u001e\u0001q\u0000~\u00001sq\u0000~\u0000+t\u0000\u0010StateReceiptDatet\u0000\u0000sq\u0000~\u0000\"ppsq\u0000~\u0000\u0006q"
+"\u0000~\u0000\u001fp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000bppsr\u0000\"com.sun.msv.datatype.xsd.TokenType"
+"\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000#com.sun.msv.datatype.xsd.StringType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000"
+"\u0001Z\u0000\risAlwaysValidxq\u0000~\u0000\u0011q\u0000~\u0000\u0017t\u0000\u0005tokenq\u0000~\u0000\u001b\u0001q\u0000~\u0000\u001dsq\u0000~\u0000 q\u0000~\u0000=q\u0000"
+"~\u0000\u0017sq\u0000~\u0000\"ppsq\u0000~\u0000$q\u0000~\u0000\u001fpq\u0000~\u0000&q\u0000~\u0000-q\u0000~\u00001sq\u0000~\u0000+t\u0000\u001aStateApplicat"
+"ionIdentifierq\u0000~\u00005q\u0000~\u00001sr\u0000\"com.sun.msv.grammar.ExpressionPoo"
...
+"q\u0000~\u0000?x"));
        ...
        extends edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.proposal.rar.impl.CoreStateReceiptQualifiersTypeImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        if (("StateApplicationIdentifier" == ___local)&&("" == ___uri)) {
        ...
        {
            try {
                _StateApplicationIdentifier = com.sun.xml.bind.WhiteSpaceProcessor.collapse(value);
            } catch (java.lang.Exception e) {
        ...
        {
            try {
                _StateReceiptDate = javax.xml.bind.DatatypeConverter.parseDate(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
        }
