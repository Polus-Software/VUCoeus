...
public class ProtocolNotesTypeImpl implements edu.mit.coeus.utils.xml.bean.protocol.ProtocolNotesType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.ValidatableObject
{
    ...
    protected boolean has_EntryNumber;
    protected int _EntryNumber;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.protocol.ProtocolNotesType.class);
    }
    ...
    public edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolNotesTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        if (!has_EntryNumber) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "EntryNumber"));
        }
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "EntryNumber");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printInt(((int) _EntryNumber)), "EntryNumber");
        } catch (java.lang.Exception e) {
            edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/ProtocolSummarySchema", "RestrictedView");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
...
+"\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\u000bEntryNumberq\u0000~\u0000;sq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\u0000pp"
+"q\u0000~\u0000\u0013sq\u0000~\u0000&ppsq\u0000~\u0000(q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007sq\u0000~\u00001t\u0000\bCommentsq\u0000~"
+"\u0000;sq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0013sq\u0000~\u0000&ppsq\u0000~\u0000(q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000~\u00007s"
+"q\u0000~\u00001t\u0000\u000eRestrictedViewq\u0000~\u0000;sq\u0000~\u0000\u000bpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0010ppsr\u0000%com."
+"sun.msv.datatype.xsd.DateTimeType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000)com.sun.msv."
+"datatype.xsd.DateTimeBaseType\u0014W\u001a@3\u00a5\u00b4\u00e5\u0002\u0000\u0000xq\u0000~\u0000\u0017q\u0000~\u0000\u001dt\u0000\bdateTi"
+"meq\u0000~\u0000/q\u0000~\u0000#sq\u0000~\u0000$q\u0000~\u0000\u0082q\u0000~\u0000\u001dsq\u0000~\u0000&ppsq\u0000~\u0000(q\u0000~\u0000\u0015pq\u0000~\u0000*q\u0000~\u00003q\u0000"
...
+"\u0000\u0000\u0014\u0001pq\u0000~\u0000\nq\u0000~\u0000}q\u0000~\u0000\'q\u0000~\u0000fq\u0000~\u0000lq\u0000~\u0000\tq\u0000~\u0000rq\u0000~\u0000xq\u0000~\u0000\u0084q\u0000~\u0000\u008aq\u0000~\u0000\u000f"
+"q\u0000~\u0000qq\u0000~\u0000wq\u0000~\u0000\u0089q\u0000~\u0000\u0007q\u0000~\u0000\u0006q\u0000~\u0000=q\u0000~\u0000kq\u0000~\u0000\u0005q\u0000~\u0000\bx"));
        }
        ...
        extends edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolNotesTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  6 :
                        if (("EntryNumber" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 7;
                            return ;
                        }
                    ...
                    case  3 :
                        ...
                        break;
                    case  12 :
                        if (("RestrictedView" == ___local)&&("http://www.w3.org/2001/ProtocolSummarySchema" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 13;
                            return ;
                        }
        ...
        {
            try {
                _EntryNumber = javax.xml.bind.DatatypeConverter.parseInt(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                has_EntryNumber = true;
            } catch (java.lang.Exception e) {
                handleParseConversionException(e);
            }
