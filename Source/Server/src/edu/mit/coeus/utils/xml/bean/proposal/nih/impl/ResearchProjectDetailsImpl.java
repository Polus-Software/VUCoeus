...
public class ResearchProjectDetailsImpl
    extends edu.mit.coeus.utils.xml.bean.proposal.nih.impl.ResearchProjectDetailsTypeImpl
    implements edu.mit.coeus.utils.xml.bean.proposal.nih.ResearchProjectDetails, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.proposal.nih.ResearchProjectDetails.class);
    }
    ...
    public edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.proposal.nih.impl.ResearchProjectDetailsImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://era.nih.gov/Projectmgmt/SBIR/CGAP/nihspecific.namespace", "ResearchProjectDetails");
...
+"\u0000\u001at\u0000Cedu.mit.coeus.utils.xml.bean.proposal.nih.ResearchAndRe"
+"latedProjectt\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq"
+"\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000bppsq\u0000~\u0000\u000fq\u0000~\u0000\u0013psq\u0000~\u0000\u0014q\u0000~\u0000\u0013pq\u0000~\u0000"
+"\u0017q\u0000~\u0000\u001bq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000Gedu.mit.coeus.utils.xml.bean.proposal.ni"
+"h.ResearchAndRelatedProjectTypeq\u0000~\u0000\"sq\u0000~\u0000\u000bppsq\u0000~\u0000\u0014q\u0000~\u0000\u0013psr\u0000\u001b"
...
+"tanceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0019ResearchAndRelatedProjectt\u0000>http://era.ni"
+"h.gov/Projectmgmt/SBIR/CGAP/nihspecific.namespacesq\u0000~\u0000\u000bppsq\u0000"
+"~\u0000\u0000pp\u0000sq\u0000~\u0000\u000bppsq\u0000~\u0000\u000fq\u0000~\u0000\u0013psq\u0000~\u0000\u0014q\u0000~\u0000\u0013pq\u0000~\u0000\u0017q\u0000~\u0000\u001bq\u0000~\u0000\u001dsq\u0000~\u0000\u001et"
+"\u0000Fedu.mit.coeus.utils.xml.bean.proposal.nih.ResearchApplicat"
+"ionExtensionq\u0000~\u0000\"sq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000bppsq\u0000~\u0000\u000fq\u0000~"
+"\u0000\u0013psq\u0000~\u0000\u0014q\u0000~\u0000\u0013pq\u0000~\u0000\u0017q\u0000~\u0000\u001bq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000Jedu.mit.coeus.utils.x"
+"ml.bean.proposal.nih.ResearchApplicationExtensionTypeq\u0000~\u0000\"sq"
+"\u0000~\u0000\u000bppsq\u0000~\u0000\u0014q\u0000~\u0000\u0013pq\u0000~\u00000q\u0000~\u0000@q\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u001cResearchApplicatio"
+"nExtensionq\u0000~\u0000Esq\u0000~\u0000\u000bppsq\u0000~\u0000\u0014q\u0000~\u0000\u0013pq\u0000~\u00000q\u0000~\u0000@q\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0016R"
+"esearchProjectDetailsq\u0000~\u0000Esr\u0000\"com.sun.msv.grammar.Expression"
...
+"~\u0000Qq\u0000~\u0000$q\u0000~\u0000Nq\u0000~\u0000\u000eq\u0000~\u0000&q\u0000~\u0000Hq\u0000~\u0000Pq\u0000~\u0000\fq\u0000~\u0000+q\u0000~\u0000Uq\u0000~\u0000Fq\u0000~\u0000Yq\u0000"
+"~\u0000\tx"));
        }
        ...
        extends edu.mit.coeus.utils.xml.bean.proposal.common.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.proposal.nih.impl.ResearchProjectDetailsImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("ResearchAndRelatedProject" == ___local)&&("http://era.nih.gov/Projectmgmt/SBIR/CGAP/nihspecific.namespace" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.mit.coeus.utils.xml.bean.proposal.nih.impl.ResearchProjectDetailsTypeImpl)edu.mit.coeus.utils.xml.bean.proposal.nih.impl.ResearchProjectDetailsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("ResearchAndRelatedProject" == ___local)&&("http://era.nih.gov/Projectmgmt/SBIR/CGAP/nihspecific.namespace" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.mit.coeus.utils.xml.bean.proposal.nih.impl.ResearchProjectDetailsTypeImpl)edu.mit.coeus.utils.xml.bean.proposal.nih.impl.ResearchProjectDetailsImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
