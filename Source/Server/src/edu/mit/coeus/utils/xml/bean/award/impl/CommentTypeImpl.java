...
public class CommentTypeImpl implements edu.mit.coeus.utils.xml.bean.award.CommentType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.award.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.award.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.award.impl.runtime.ValidatableObject
{

    protected java.lang.String _Description;
    protected edu.mit.coeus.utils.xml.bean.award.CommentDetailsType _CommentDetails;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.award.CommentType.class);
    }
    ...
    public edu.mit.coeus.utils.xml.bean.award.CommentDetailsType getCommentDetails() {
        return _CommentDetails;
    }

    public void setCommentDetails(edu.mit.coeus.utils.xml.bean.award.CommentDetailsType value) {
        _CommentDetails = value;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.award.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.award.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.award.impl.CommentTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        if (_CommentDetails!= null) {
            context.startElement("", "CommentDetails");
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _CommentDetails), "CommentDetails");
            context.endNamespaceDecls();
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _CommentDetails), "CommentDetails");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _CommentDetails), "CommentDetails");
            context.endElement();
        }
    }
...
+"q\u0000~\u0000-t\u0000\u000bDescriptiont\u0000\u0000q\u0000~\u00003sq\u0000~\u0000\u0006ppsq\u0000~\u0000\bq\u0000~\u0000\rp\u0000sq\u0000~\u0000\u0000ppsq\u0000~"
...
+"nyNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000.q\u0000~\u00003sq\u0000~\u0000-t\u00005edu.mit.coeus.util"
+"s.xml.bean.award.CommentDetailsTypet\u0000+http://java.sun.com/ja"
+"xb/xjc/dummy-elementssq\u0000~\u0000\u0006ppsq\u0000~\u0000$q\u0000~\u0000\rpq\u0000~\u0000&q\u0000~\u0000/q\u0000~\u00003sq\u0000~"
+"\u0000-t\u0000\u000eCommentDetailsq\u0000~\u00007q\u0000~\u00003sr\u0000\"com.sun.msv.grammar.Express"
...
+":q\u0000~\u0000#q\u0000~\u0000Hq\u0000~\u0000?q\u0000~\u0000\u0005q\u0000~\u00008x"));
        ...
        extends edu.mit.coeus.utils.xml.bean.award.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.award.impl.CommentTypeImpl.this;
        }
                ...
                switch (state) {
                    case  4 :
                        if (("AwardNumber" == ___local)&&("" == ___uri)) {
                            _CommentDetails = ((edu.mit.coeus.utils.xml.bean.award.impl.CommentDetailsTypeImpl) spawnChildFromEnterElement((edu.mit.coeus.utils.xml.bean.award.impl.CommentDetailsTypeImpl.class), 5, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        ...
                        return ;
                    case  3 :
                        if (("CommentDetails" == ___local)&&("" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  4 :
                        _CommentDetails = ((edu.mit.coeus.utils.xml.bean.award.impl.CommentDetailsTypeImpl) spawnChildFromLeaveElement((edu.mit.coeus.utils.xml.bean.award.impl.CommentDetailsTypeImpl.class), 5, ___uri, ___local, ___qname));
                        return ;
                    case  2 :
                        if (("Description" == ___local)&&("" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  4 :
                        _CommentDetails = ((edu.mit.coeus.utils.xml.bean.award.impl.CommentDetailsTypeImpl) spawnChildFromEnterAttribute((edu.mit.coeus.utils.xml.bean.award.impl.CommentDetailsTypeImpl.class), 5, ___uri, ___local, ___qname));
                        return ;
                    case  3 :
                        state = 6;
                        continue outer;
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  4 :
                        _CommentDetails = ((edu.mit.coeus.utils.xml.bean.award.impl.CommentDetailsTypeImpl) spawnChildFromLeaveAttribute((edu.mit.coeus.utils.xml.bean.award.impl.CommentDetailsTypeImpl.class), 5, ___uri, ___local, ___qname));
                        return ;
                    case  3 :
                        state = 6;
                        continue outer;
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  4 :
                            _CommentDetails = ((edu.mit.coeus.utils.xml.bean.award.impl.CommentDetailsTypeImpl) spawnChildFromText((edu.mit.coeus.utils.xml.bean.award.impl.CommentDetailsTypeImpl.class), 5, value));
                            return ;
                        case  1 :
                            eatText1(value);
                            state = 2;
