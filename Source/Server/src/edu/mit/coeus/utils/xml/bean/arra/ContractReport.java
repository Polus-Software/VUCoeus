...
/**
 * The recipient report for reporting contracts
 * Java content class for ContractReport element declaration.
 * <p>The following schema fragment specifies the expected content contained within this java content object. (defined at file:/D:/Backup%20%20-%20Mohan/CoeusDocs/Proposal%20Printing/schemas/FederalReportingDataElements_v1/RecoveryRR/Version%201/Version%201.0/Schemas/Exchange/recoveryrr-xc.xsd line 60)
 * <p>
 * <pre>
 * &lt;element name="ContractReport" type="{urn:us:gov:recoveryrr}ContractReportType"/>
 * </pre>
 * 
 */
public interface ContractReport
    extends javax.xml.bind.Element, edu.mit.coeus.utils.xml.bean.arra.ContractReportType
{
