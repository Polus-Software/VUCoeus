...
public class ProtocolInfoTypeImpl implements edu.mit.coeus.utils.xml.bean.protocol.ProtocolInfoType, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.ValidatableObject
{

    protected edu.mit.coeus.utils.xml.bean.protocol.Person _Investigator;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.protocol.ProtocolInfoType.class);
    }

    public edu.mit.coeus.utils.xml.bean.protocol.Person getInvestigator() {
        return _Investigator;
    }

    public void setInvestigator(edu.mit.coeus.utils.xml.bean.protocol.Person value) {
        _Investigator = value;
    }
    ...
    public edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolInfoTypeImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://www.w3.org/2001/QuesionnaireSchema", "Title");
        ...
        context.endElement();
        context.startElement("http://www.w3.org/2001/QuesionnaireSchema", "Investigator");
...
+"et\u0000)http://www.w3.org/2001/QuesionnaireSchemasq\u0000~\u0000\u0006pp\u0000sq\u0000~\u0000\u0000"
+"ppsq\u0000~\u0000\u0006pp\u0000sq\u0000~\u0000!ppsr\u0000 com.sun.msv.grammar.OneOrMoreExp\u0000\u0000\u0000\u0000\u0000"
+"\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000\u001ccom.sun.msv.grammar.UnaryExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\u0003expq\u0000~\u0000\u0002"
+"xq\u0000~\u0000\u0003q\u0000~\u0000\u0010psq\u0000~\u0000#q\u0000~\u0000\u0010psr\u00002com.sun.msv.grammar.Expression$A"
+"nyStringExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003q\u0000~\u00003psr\u0000 com.sun.msv.gra"
+"mmar.AnyNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000-q\u0000~\u00002sq\u0000~\u0000,t\u0000,edu.mit.coeu"
+"s.utils.xml.bean.protocol.Persont\u0000+http://java.sun.com/jaxb/"
+"xjc/dummy-elementssq\u0000~\u0000!ppsq\u0000~\u0000#q\u0000~\u0000\u0010pq\u0000~\u0000%q\u0000~\u0000.q\u0000~\u00002sq\u0000~\u0000,t"
+"\u0000\fInvestigatorq\u0000~\u00006sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000"
...
+"grammar/ExpressionPool;xp\u0000\u0000\u0000\u0007\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\"q\u0000~\u0000Fq\u0000~\u0000:q\u0000~\u0000\nq\u0000~\u0000"
+"8q\u0000~\u0000=x"));
        }
        ...
        extends edu.mit.coeus.utils.xml.bean.protocol.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.protocol.impl.ProtocolInfoTypeImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  6 :
                        ...
                        return ;
                    case  3 :
                        if (("Investigator" == ___local)&&("http://www.w3.org/2001/QuesionnaireSchema" == ___uri)) {
                    ...
                    case  4 :
                        if (("PersonID" == ___local)&&("http://www.w3.org/2001/QuesionnaireSchema" == ___uri)) {
                            _Investigator = ((edu.mit.coeus.utils.xml.bean.protocol.impl.PersonImpl) spawnChildFromEnterElement((edu.mit.coeus.utils.xml.bean.protocol.impl.PersonImpl.class), 5, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  0 :
