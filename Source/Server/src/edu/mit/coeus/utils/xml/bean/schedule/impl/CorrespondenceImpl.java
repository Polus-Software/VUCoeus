...
public class CorrespondenceImpl
    extends edu.mit.coeus.utils.xml.bean.schedule.impl.CorrespondenceTypeImpl
    implements edu.mit.coeus.utils.xml.bean.schedule.Correspondence, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallableObject, edu.mit.coeus.utils.xml.bean.impl.runtime.XMLSerializable, edu.mit.coeus.utils.xml.bean.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.mit.coeus.utils.xml.bean.schedule.Correspondence.class);
    }
    ...
    public edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.mit.coeus.utils.xml.bean.impl.runtime.UnmarshallingContext context) {
        return new edu.mit.coeus.utils.xml.bean.schedule.impl.CorrespondenceImpl.Unmarshaller(context);
    }
...
+"\u0000~\u0000 xq\u0000~\u0000\u001bt\u0000.edu.mit.coeus.utils.xml.bean.schedule.Protocolt"
+"\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007"
+"ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\fppsq\u0000~\u0000\u0010q\u0000~\u0000\u0014psq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000\u0018q\u0000~\u0000\u001cq\u0000~\u0000\u001esq"
+"\u0000~\u0000\u001ft\u00002edu.mit.coeus.utils.xml.bean.schedule.ProtocolTypeq\u0000~"
...
+".w3.org/2001/XMLSchema-instanceq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\bProtocolt\u0000\u001fhttp"
+"://irb.mit.edu/irbnamespacesq\u0000~\u0000\fppsq\u0000~\u0000\u0000q\u0000~\u0000\u0014p\u0000sq\u0000~\u0000\u0007ppsq\u0000~"
+"\u0000.q\u0000~\u0000\u0014psr\u0000#com.sun.msv.datatype.xsd.StringType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001Z\u0000"
+"\risAlwaysValidxq\u0000~\u00003q\u0000~\u00008t\u0000\u0006stringsr\u00005com.sun.msv.datatype.x"
+"sd.WhiteSpaceProcessor$Preserve\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000;\u0001q\u0000~\u0000>sq\u0000~\u0000?"
+"q\u0000~\u0000Mq\u0000~\u00008sq\u0000~\u0000\fppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u00001q\u0000~\u0000Aq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u000bCurren"
+"tUserq\u0000~\u0000Fq\u0000~\u0000\u001esq\u0000~\u0000\fppsq\u0000~\u0000\u0000q\u0000~\u0000\u0014p\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000.q\u0000~\u0000\u0014psr\u0000!"
+"com.sun.msv.datatype.xsd.DateType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000)com.sun.msv."
+"datatype.xsd.DateTimeBaseType\u0014W\u001a@3\u00a5\u00b4\u00e5\u0002\u0000\u0000xq\u0000~\u00003q\u0000~\u00008t\u0000\u0004dateq\u0000"
+"~\u0000<q\u0000~\u0000>sq\u0000~\u0000?q\u0000~\u0000\\q\u0000~\u00008sq\u0000~\u0000\fppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u00001q\u0000~\u0000Aq\u0000~\u0000\u001es"
+"q\u0000~\u0000\u001ft\u0000\u000bCurrentDateq\u0000~\u0000Fq\u0000~\u0000\u001esq\u0000~\u0000\fppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u00001q\u0000~\u0000Aq"
+"\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u000eCorrespondenceq\u0000~\u0000Fsr\u0000\"com.sun.msv.grammar.Expr"
...
+"\u0000~\u0000Wq\u0000~\u0000Ix"));
        ...
        extends edu.mit.coeus.utils.xml.bean.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.mit.coeus.utils.xml.bean.schedule.impl.CorrespondenceImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("Protocol" == ___local)&&("http://irb.mit.edu/irbnamespace" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.mit.coeus.utils.xml.bean.schedule.impl.CorrespondenceTypeImpl)edu.mit.coeus.utils.xml.bean.schedule.impl.CorrespondenceImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        if (("Protocol" == ___local)&&("http://irb.mit.edu/irbnamespace" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.mit.coeus.utils.xml.bean.schedule.impl.CorrespondenceTypeImpl)edu.mit.coeus.utils.xml.bean.schedule.impl.CorrespondenceImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
