		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			<fo:layout-master-set>
				<fo:simple-page-master master-name="BudgetSummaryWithoutHeader" page-height="11in" page-width="8.5in">
					<fo:region-body margin-left=".79in" margin-top=".79in" margin-bottom=".79in" margin-right=".79in">

      </fo:region-body>
					<fo:region-before extent="66pt" precedence="true"/>
				...
				<fo:simple-page-master master-name="CalculationMethodologyWithoutHeader" page-height="11in" page-width="8.5in">
					...
					<fo:region-before extent="72pt" precedence="true"/>
					<fo:region-after extent="28pt" precedence="true"/>
					<fo:region-start extent="28pt" precedence="false"/>
			...
			<fo:flow flow-name="xsl-region-body">
				...
				<fo:block span="none">
					<fo:table table-layout="fixed">
						<fo:table-column column-width="131pt"/>
						...
						<fo:table-header>
							<fo:table-row>
								...
								<fo:table-cell text-align="start" display-align="center">
									<fo:block white-space-collapse="true" text-align="start" color="#000000" font-family="Arial" font-size="8.0pt" font-weight="bold">
								...
								<fo:table-cell text-align="end" display-align="center">
									<fo:block white-space-collapse="true" text-align="end" color="#000000" font-family="Arial" font-size="8.0pt" font-weight="bold">
...
Total Direct Costs</fo:block>
								...
								<fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
									<fo:block white-space-collapse="true" text-align="end" color="#000000" font-family="Arial" font-size="8.0pt">
...
$<xsl:value-of select="format-number(TotalCostToSponsor,'#,###,###,###,###,###,###')"/>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
								<fo:table-row>
...
$<xsl:value-of select="format-number(TotalUnderrecoveryAmount,'#,###,###,###,###,###,###')"/>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
								<fo:table-row>
...
$<xsl:value-of select="format-number(TotalCostSharingAmount,'#,###,###,###,###,###,###')"/>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
								<fo:table-row>
									...
									<fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
										<fo:block white-space-collapse="true" text-align="end" color="#000000" font-family="Arial" font-size="8.0pt">
											<xsl:variable name="Sponsor">
												<xsl:value-of select="round(TotalCostToSponsor)"/>
											</xsl:variable>
											<xsl:variable name="Underrecovery">
												<xsl:value-of select="round(TotalUnderrecoveryAmount)"/>
											</xsl:variable>
											<xsl:variable name="CostSharing">
												<xsl:value-of select="round(TotalCostSharingAmount)"/>
											</xsl:variable>



$<xsl:value-of select="format-number(($Sponsor+$Underrecovery+$CostSharing),'#,###,###,###,###,###')"/>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
							</xsl:for-each>
...
$<xsl:value-of select="format-number(sum(CalculatedCost),'###,###,###,###,###,###')"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</xsl:for-each>
...
'##,###,###,###,###,###,###')"/>
				...
				<xsl:for-each select="Details">
					<fo:table-row>
						<fo:table-cell padding-left="15.0pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="start" display-align="center">
							<fo:block white-space-collapse="true" text-align="start" color="#000000" font-family="Arial" font-size="8.0pt">
						...
						<fo:table-cell padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
							<fo:block white-space-collapse="true" text-align="end" color="#000000" font-family="Arial" font-size="8.0pt">
								<xsl:text>$</xsl:text>
								<xsl:value-of disable-output-escaping="no" select="format-number(CalculatedCost, '##,###,###,###,###,###')"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</xsl:for-each>
	...
	<xsl:template name="SalarySummaryForEDI">
		...
		<fo:table table-layout="fixed">
			...
			<fo:table-footer>
				<fo:table-row>
					<fo:table-cell padding-top="2.0pt" padding-bottom="2.0pt" number-columns-spanned="6" text-align="end" display-align="center">
						<fo:block white-space-collapse="true" text-align="end" color="#000000" font-family="Arial" font-size="8.0pt" font-weight="bold">
...
'##,###,###,###,###,###,###')"/>
				...
				<xsl:for-each select="Details">
					<fo:table-row>
						...
						<fo:table-cell padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
							<fo:block white-space-collapse="true" text-align="end" color="#000000" font-family="Arial" font-size="8.0pt">
								<xsl:text>$</xsl:text>
								<xsl:value-of disable-output-escaping="no" select="format-number(Fringe, '##,###,###,###,###,###,###')"/>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="end" display-align="before">
							<fo:block white-space-collapse="true" text-align="end" color="#000000" font-family="Arial" font-size="8.0pt">
								<xsl:text>$</xsl:text>
								<xsl:value-of disable-output-escaping="no" select="format-number(SalaryRequested, '##,###,###,###,###,###,###')"/>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</xsl:for-each>
	...
	<xsl:template name="SalarySummaryForEDITotals">
		...
		<fo:table table-layout="fixed">
			...
			<fo:table-column column-width="355pt"/>
			<fo:table-column column-width="94pt"/>
			<fo:table-body>
				<fo:table-row>
...
TOTAL SALARIES &amp; WAGES &amp; FRINGE BENEFITS</fo:block>
					</fo:table-cell>
					<fo:table-cell border-bottom-style="solid" border-bottom-width="0.5pt" padding-top="2.0pt" padding-bottom="2.0pt" text-align="end" display-align="center">
						<fo:block white-space-collapse="true" text-align="end" color="#000000" font-family="Arial" font-size="8.0pt">
							...
							<xsl:variable name="totSalariesAndWages">
								<xsl:value-of select="format-number(($totSalaries + $totFringe), 
				...
				<fo:block span="none">
					<fo:table table-layout="fixed">
						...
						<fo:table-body>
							<fo:table-row>
								<fo:table-cell text-align="start" display-align="before">
									<fo:block white-space-collapse="true" text-align="start" color="#000000" font-family="Arial" font-size="10.0pt" font-weight="bold">
...
##############################-->
	<xsl:template name="BudgetHeader">
		<fo:block-container position="absolute" top="12pt" left="28pt" height="15.0pt" width="384.0pt" border-width="1.0pt" display-align="before">
			<fo:block span="none" white-space-collapse="true" color="#000000" font-family="Arial" font-size="12.0pt" font-weight="bold" text-align="start" position="relative" top="12pt" left="28pt" height="15.0pt" width="384.0pt">
				<xsl:text>Coeus Proposal Development - Budget 
...
Summary</xsl:text>
		...
		<fo:block-container position="absolute" top="30pt" left="28pt" height="15.0pt" width="100.0pt" border-width="1.0pt" display-align="before">
			<fo:block span="none" white-space-collapse="true" color="#000000" font-family="Arial" font-size="10.0pt" font-weight="bold" text-align="start" position="relative" top="30pt" left="28pt" height="15.0pt" width="100.0pt">
		...
		<fo:block-container position="absolute" top="30pt" left="140pt" height="15.0pt" width="132.0pt" border-width="1.0pt" display-align="before">
			<fo:block span="none" white-space-collapse="true" color="#000000" font-family="Arial" font-size="10.0pt" text-align="start" position="relative" top="30pt" left="140pt" height="15.0pt" width="132.0pt">
				<xsl:value-of disable-output-escaping="no" select="ReportHeader/ProposalNumber"/>
			</fo:block>
		</fo:block-container>
		<fo:block-container position="absolute" top="30pt" left="420pt" height="15.0pt" width="148.0pt" border-width="1.0pt" display-align="before">
			<fo:block span="none" white-space-collapse="true" color="#000000" font-family="Arial" font-size="10.0pt" font-weight="bold" text-align="end" position="relative" top="30pt" left="420pt" height="15.0pt" width="148.0pt">

Budget Version <xsl:value-of select="ReportHeader/BudgetVersion"/>
			</fo:block>
		</fo:block-container>
		<fo:block-container position="absolute" top="48pt" left="28pt" height="15.0pt" width="100.0pt" border-width="1.0pt" display-align="before">
			<fo:block span="none" white-space-collapse="true" color="#000000" font-family="Arial" font-size="10.0pt" font-weight="bold" text-align="start" position="relative" top="48pt" left="28pt" height="15.0pt" width="100.0pt">

Period <xsl:value-of select="ReportHeader/Period"/>
			</fo:block>
		</fo:block-container>
		<fo:block-container position="absolute" top="48pt" left="140pt" height="15.0pt" width="135.0pt" border-width="1.0pt" display-align="before">
			<fo:block span="none" white-space-collapse="true" color="#000000" font-family="Arial" font-size="10.0pt" text-align="start" position="relative" top="48pt" left="140pt" height="15.0pt" width="135.0pt">
...
##################################-->
	<xsl:template name="BudgetFooter">
		<fo:block-container position="absolute" top="1pt" left="28pt" height="15.0pt" width="268.0pt" border-width="1.0pt" display-align="before">
			<fo:block text-align="left" font-family="Arial" font-size="8.0pt">
