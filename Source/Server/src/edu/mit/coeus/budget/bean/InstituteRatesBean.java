...
public class InstituteRatesBean extends RatesBean{
 // Commented by Shivakumar as this bean extends InstituteRatesBean in rates module 
...
//    
    ...
    public boolean equals(Object obj) {
        ...
        if(instituteRatesBean.getActivityCode()==getActivityCode() &&
        instituteRatesBean.getRateTypeCode() == getRateTypeCode() &&
        instituteRatesBean.getRateClassCode() == getRateClassCode()&&
        instituteRatesBean.getFiscalYear().equals(getFiscalYear())&&
        instituteRatesBean.getStartDate().equals(getStartDate())&&
        instituteRatesBean.isOnOffCampusFlag()==(isOnOffCampusFlag())){
            return true;
        }else{
            return false;
        }
