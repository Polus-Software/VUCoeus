 ...
 * @author sharathk
 */
public class BudgetSubawardTrainBudgetImpl implements BudgetSubawardXmlModifier{
    ...
    public BudgetSubAwardBean updateXML(byte xmlContents[], Map fileMap, BudgetSubAwardBean budgetSubAwardBean) throws Exception {
        ...
        org.w3c.dom.NodeList lstRoot = document.getElementsByTagName("PHS398_TrainingSubawardBudget");
        Element oldRoot = (Element)lstRoot.item(0);

        Element root = document.createElement("ns1:PHS398_TrainingSubawardBudget");
        NodeList attachList = oldRoot.getElementsByTagName("BudgetAttachments");
        ...
        root.setAttribute("xmlns:ns1","http://apply.grants.gov/forms/PHS398_TrainingSubawardBudget-V1.0");
        root.setAttribute("xmlns:PHS398_TrainingBudget", "http://apply.grants.gov/forms/PHS398_TrainingBudget-V1.0");
        root.setAttribute("xsi:schemaLocation","http://apply.grants.gov/forms/PHS398_TrainingSubawardBudget-V1.0 http://at07apply.grants.gov/apply/forms/schemas/PHS398_TrainingSubawardBudget-V1.0.xsd");
        root.setAttribute("ns1:FormVersion","1.0");
        //Modify Document - END
