...
public class KeyPersonUnitBean extends SyncInfoBean implements java.io.Serializable, CoeusBean,IBaseDataBean {
   ...
   // private String ospAdministratorName;
    ...
    public KeyPersonUnitBean() {
    }

    /** Creates new AwardUnitBean */
    public KeyPersonUnitBean(KeyPersonUnitBean investigatorUnitBean) {
