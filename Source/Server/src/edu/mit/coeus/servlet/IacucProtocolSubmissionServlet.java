 ...
 *
 */
public class IacucProtocolSubmissionServlet extends CoeusBaseServlet {
...
//    private UtilFactory UtilFactory = null;
    ...
    //Right Ids
    private final static String CREATE_SUBMISSION = "SUBMIT_IACUC_PROTOCOL"; 
    //prps start - May 13 2004
    private final static String SUBMIT_ANY_PROTOCOL = "SUBMIT_ANY_IACUC_PROTOCOL" ;
...
//            UtilFactory = new UtilFactory();
            ...
            if (functionType == ADD_MODE || functionType == MODIFY_MODE ) {
                ...
                if(functionType == ADD_MODE){
                    ...
                    //prps start - May 13 2004
                    isAuthorised = txnData.getUserHasIACUCProtocolRight(loggedinUser, CREATE_SUBMISSION, requester.getId());
                    if (!isAuthorised)
                    {
                ...
                if(isAuthorised){                
                    ...
                    // Added for COEUSQA-2707 : Available Recommended Actions for IACUC Reviewers - End
                        //4
                        dataObjects.addElement(new Vector());
                        //5
                        dataObjects.addElement(new Vector());
...
//                   dataObjects.addElement(vecRecommendedActions);
                   HashMap hmRecommendedActions = protocolSubmissionTxnBean.getRecommendedActionsForAllReview();
                   dataObjects.addElement(hmRecommendedActions);
                   ...
                   Vector vecDeterminationTypes = protocolSubmissionTxnBean.getProtocolReviewerDeterminationTypes();
                   dataObjects.addElement(vecDeterminationTypes);
...
//            }else if(functionType == UPD_PROT_SUBMISSION_STATUS){
            ...
            //COEUSQA:3503 - Protocol Copying - Option to Copy Attachments and Questionnaires - Start
                ...
                if(vecParameter!=null && vecParameter.size()>0){
                    ...
                    if (questionnaireTxnBean.checkAnyQuestionIsAnsweredInModule(ModuleConstants.IACUC_MODULE_CODE, protocolNumber, 0, sequenceNumber)) {
                        strHasQnr = "YES";
                    }
