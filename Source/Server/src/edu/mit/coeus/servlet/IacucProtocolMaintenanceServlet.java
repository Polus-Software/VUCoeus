/*
 * @(#)IacucProtocolMaintenanceServlet.java 1.0 10/25/02
 *
...
public class IacucProtocolMaintenanceServlet extends CoeusBaseServlet implements TypeConstants{
...
//    private final char GET_ROLE_RIGHTS = 'K';
    ...
    private final char MAX_CONTINUING_REVIEW_AMEND_VER = '*';
    
    private final char MAX_CONTINUING_REVIEW_VER = '+';
    
    private final char MAX_AMEND_REVISION_VER = '=';
    
    private final char RENEWAL_WITH_AMENDMENT = 'L';
    
    /*COEUSQA-1724-New Constants added for new Amendment/Renewal Type-Start*/
    private final char  NEW_CONTINUATION_REVIEW = '#';
    
    private final char  NEW_CONTINUATION_REVIEW_AMEND = '&';
    /*COEUSQA-1724-New Constants added for new Amendment/Renewal Type-End*/
    //Added for case 4278 -In Comments on Action Details, indicate Renewal with Amendment for submissions created via New Am -start
...
//    private final char GET_SPECIFIC_CORRESPONDENCE = 'e';
    ...
    private static final char DELETE_IACUC_PROTOCOL = 'i';
    ...
    private static final char IS_PAIN_CATEGORY_MANDATORY = 'Y';
...
//    private final String REF_COL_4 = "REF_COL_4";
    ...
    //Right Ids - start
    private final String ADD_PROTOCOL = "CREATE_IACUC_PROTOCOL";
    private final String MODIFY_PROTOCOL = "MODIFY_IACUC_PROTOCOL";
    private final String ADD_AMENDMENT = "CREATE_IACUC_AMENDMENT";     
    private final String ADD_RENEWAL = "CREATE_IACUC_RENEWAL";
    private final String VIEW_PROTOCOL = "VIEW_IACUC_PROTOCOL";
    private final String MAINTAIN_PROTOCOL_RELATED_PROJ = "MAINTAIN_PROTOCOL_RELATED_PROJ";
    private final String MAINTAIN_PROTOCOL_ACCESS = "MAINTAIN_IACUC_PROTOCOL_ACCESS";
    private final String VIEW_ANY_PROTOCOL = "VIEW_ANY_IACUC_PROTOCOL";
    private final String MODIFY_ANY_PROTOCOL = "MODIFY_ANY_IACUC_PROTOCOL";
    ...
    /*COEUSQA-1724-New Constants added for new Amendment/Renewal Type-Start*/
    private final String ADD_IACUC_RENEWAL_AMENDMENT = "CREATE_IACUC_RENEWAL_AMENDMENT";
    private final String CREATE_ANY_IACUC_REN_AMEN  = "CREATE_ANY_IACUC_REN_AMEN";
    private final String ADD_IACUC_CONT_REVIEW = "CREATE_IACUC_CONT_REVIEW";
    private final String CREATE_ANY_IACUC_CONT_REVIEW  = "CREATE_ANY_IACUC_CONT_REVIEW";
    private final String ADD_IACUC_CONT_REV_AM = "CREATE_IACUC_CONT_REV_AM";
    private final String CREATE_ANY_IACUC_CONT_REV_AM  = "CREATE_ANY_IACUC_CONT_REV_AM";
    /*COEUSQA-1724-New Constants added for new Amendment/Renewal Type-Start*/
    
    private final String MAINTAIN_ANY_IACUC_PROT_ACCESS = "MAINTAIN_ANY_IACUC_PROT_ACCESS";
    private final String VIEW_IACUC_RESTRICTED_NOTES = "VIEW_IACUC_RESTRICTED_NOTES";
    private final String ADD_PROTOCOL_NOTES = "ADD_IACUC_PROTOCOL_NOTES";
    private final String ADD_ANY_PROTOCOL_NOTES = "ADD_ANY_IACUC_PROTOCOL_NOTES";
    //Right Ids - end
    ...
    private final String ADMINISTRATIVE_CORRECTION = "IACUC_ADMINISTRATIVE_CORRECT";
    ...
    private final String SPECIES_TRAINING = "SPECIES_TRAINING";
    private final String SPECIES_TRAINING_DETAIL = "SPECIES_TRAINING_DETAIL";
...
//    private static final int SPECIES_TYPE_INDEX = 1;
    ...
    private static final char ALTERNATIVE_SEARCH_DB = '%';
    private static final char GET_SCIENTIFIC_JUSTIFICATION_DATA ='~';
    private static final char GET_ALTERNATIVE_SEARCH_DATA ='0';
    ...
    private static final int SPECIES_COUNT_TYPE_INDEX = 4;
    ...
    private static final char GET_EXCEPTION_CATEGORY = '$';
...
//            String strPersonId = userBean.getPersonId();
            ...
            // Create an irb protocol data txn bean for reading special review list
            edu.mit.coeus.irb.bean.ProtocolDataTxnBean irbProtoTxnBean = new edu.mit.coeus.irb.bean.ProtocolDataTxnBean();
        ...
        if(functionType == PROTOCOL_LOCK_CHECK) {
               ...
               isAuthorisedForSubmitEnabled = txnData.getUserHasIACUCProtocolRight(loggedinUser, "SUBMIT_IACUC_PROTOCOL", protocolNumber)
                || txnData.getUserHasRight(loggedinUser, "SUBMIT_ANY_IACUC_PROTOCOL", unitNumber);
...
//                    || functionType == ADMINISTRATIVE_CORRECTION_MODE ) { //Added by Vyjayanthi - 02/08/2004 for IRB Enhancement
            /*Added for COEUSQA_1724 In Comments on Action Details, indicate Renewal with Amendment for submissions created via New Am -start*/                    
            else if(isAmendReviewFunctionType(functionType)){
            /*Added for COEUSQA_1724 In Comments on Action Details, indicate Renewal with Amendment for submissions created via New Am -end*/  
                ...
                if (functionType == ADD_MODE){
                    ...
                    if (txnData.getUserHasIACUCProtocolRight(loggedinUser, MODIFY_PROTOCOL, protocolNumber)
                    ||  txnData.getUserHasIACUCProtocolRight(loggedinUser, VIEW_PROTOCOL, protocolNumber)) {
                        isAuthorised = txnData.getUserHasRightInAnyUnit(loggedinUser, ADD_PROTOCOL);
                ...
                //following contion check is used to check the rights for new Amendment/Renewal creation.
                else if(functionType == GET_FOR_NEW_AMENDMENT){                     
                      //Commented for COEUSQA-2878:IACUC - change message displayed when New Amendment option is selected
//                     isAuthorised = txnData.getUserHasIACUCProtocolRight(loggedinUser, ADD_AMENDMENT, protocolNumber);                   
//                    if(!isAuthorised){
//                        isAuthorised = txnData.getUserHasRight(loggedinUser, CREATE_ANY_IACUC_AMENDMENT, unitNumber);
//                    }                   
...
//                    if(isAuthorised){
                        ...
                        if(protocolSubmissionInfoBean!=null){
                            ...
                            actionBean.setActionTypeCode(IacucProtocolActionsConstants.AMENDMENT_CREATED);
                            ...
                            if(exceptionId==1){
                                ...
                                exceptionCode = "iacucProtocolAction_exceptionCode." + exceptionId;
                                isAuthorised = false;
                            }
                        } else{                            
                            exceptionCode = "iacucProtocolAction_exceptionCode.4043";
                            isAuthorised = false;
                        }
                        //COEUSQA-2878:IACUC - change message displayed when New Amendment option is selected
                        if(isAuthorised){
                             isAuthorised = txnData.getUserHasIACUCProtocolRight(loggedinUser, ADD_AMENDMENT, protocolNumber);                   
                             if(!isAuthorised){
                                isAuthorised = txnData.getUserHasRight(loggedinUser, CREATE_ANY_IACUC_AMENDMENT, unitNumber);
...
//                    }
                      ...
                      //Commented for COEUSQA-2878:IACUC - change message displayed when New Amendment option is selected
//                    isAuthorised = txnData.getUserHasIACUCProtocolRight(loggedinUser, ADD_RENEWAL, protocolNumber);                    
//                    if(!isAuthorised){
//                        isAuthorised = txnData.getUserHasRight(loggedinUser, CREATE_ANY_IACUC_RENEWAL, unitNumber);
//                    }                  
...
//                    if(isAuthorised){
                        ...
                        if(protocolSubmissionInfoBean!=null){
                            ...
                            ActionTransaction actionTxn = new ActionTransaction(loggedinUser);
                            actionBean.setProtocolNumber(protocolNumber);
                            actionBean.setActionTypeCode(IacucProtocolActionsConstants.RENEWAL_CREATED);
                            actionBean.setSubmissionNumber(protocolSubmissionInfoBean.getSubmissionNumber());
                            actionBean.setScheduleId(protocolSubmissionInfoBean.getScheduleId());
                            actionBean.setSequenceNumber(protocolSubmissionInfoBean.getSequenceNumber());
                            exceptionId = actionTxn.performStatusChangeValidation(actionBean);
                            ...
                            exceptionCode = "iacucProtocolAction_exceptionCode.4044";
                            isAuthorised = false;
                        }
                        //COEUSQA-2878:IACUC - change message displayed when New Amendment option is selected
                        if(isAuthorised){
...
//                    }
                     ...
                     //Commented for COEUSQA-2878:IACUC - change message displayed when New Amendment option is selected
//                   isAuthorised = txnData.getUserHasIACUCProtocolRight(loggedinUser, ADD_IACUC_RENEWAL_AMENDMENT, protocolNumber);                     
//                    if(!isAuthorised){
//                        isAuthorised = txnData.getUserHasRight(loggedinUser, CREATE_ANY_IACUC_REN_AMEN, unitNumber);
//                    }                     
//                    exceptionCode = "protocolAuthorization_exceptionCode." + 3012;                   
//                    if(isAuthorised){
                        protocolSubmissionTxnBean = new ProtocolSubmissionTxnBean();
                        ProtocolSubmissionInfoBean protocolSubmissionInfoBean = null;
                        protocolSubmissionInfoBean = protocolSubmissionTxnBean.getProtocolSubmissionDetails(protocolNumber);
                        if(protocolSubmissionInfoBean!=null){
                            ...
                            ActionTransaction actionTxn = new ActionTransaction(loggedinUser);
                            actionBean.setProtocolNumber(protocolNumber);
                            actionBean.setActionTypeCode(IacucProtocolActionsConstants.RENEWAL_WITH_AMEND_CREATED);
                            actionBean.setSubmissionNumber(protocolSubmissionInfoBean.getSubmissionNumber());
                            actionBean.setScheduleId(protocolSubmissionInfoBean.getScheduleId());
                            actionBean.setSequenceNumber(protocolSubmissionInfoBean.getSequenceNumber());
                            exceptionId = actionTxn.performStatusChangeValidation(actionBean);
                            ...
                            exceptionCode = "iacucProtocolAction_exceptionCode.4050";
                            isAuthorised = false;
                        }
                        //COEUSQA-2878:IACUC - change message displayed when New Amendment option is selected
                        if(isAuthorised){
...
//                    }
                     ...
                     //Commented for COEUSQA-2878:IACUC - change message displayed when New Amendment option is selected
//                   isAuthorised = txnData.getUserHasIACUCProtocolRight(loggedinUser, ADD_IACUC_CONT_REVIEW, protocolNumber);
//                    
//                    if(!isAuthorised){
//                        isAuthorised = txnData.getUserHasRight(loggedinUser, CREATE_ANY_IACUC_CONT_REVIEW, unitNumber);
//                    }                    
//                    exceptionCode = "protocolAuthorization_exceptionCode." + 3013;                    
//                    if(isAuthorised){
                        protocolSubmissionTxnBean = new ProtocolSubmissionTxnBean();
                        ProtocolSubmissionInfoBean protocolSubmissionInfoBean = null;
                        protocolSubmissionInfoBean = protocolSubmissionTxnBean.getProtocolSubmissionDetails(protocolNumber);
                        if(protocolSubmissionInfoBean!=null){
                            ...
                            ActionTransaction actionTxn = new ActionTransaction(loggedinUser);
                            actionBean.setProtocolNumber(protocolNumber);
                            actionBean.setActionTypeCode(IacucProtocolActionsConstants.CONTINUATION_REVIEW_CREATED);
                            actionBean.setSubmissionNumber(protocolSubmissionInfoBean.getSubmissionNumber());
                            actionBean.setScheduleId(protocolSubmissionInfoBean.getScheduleId());
                            actionBean.setSequenceNumber(protocolSubmissionInfoBean.getSequenceNumber());
                            exceptionId = actionTxn.performStatusChangeValidation(actionBean);
                            ...
                            exceptionCode = "iacucProtocolAction_exceptionCode.4051";
                            isAuthorised = false;
                        }
                        //COEUSQA-2878:IACUC - change message displayed when New Amendment option is selected
                        if(isAuthorised){
...
//                    }
                     ...
                     //Commented for COEUSQA-2878:IACUC - change message displayed when New Amendment option is selected
//                   isAuthorised = txnData.getUserHasIACUCProtocolRight(loggedinUser, ADD_IACUC_CONT_REV_AM, protocolNumber);                   
//                    if(!isAuthorised){
//                        isAuthorised = txnData.getUserHasRight(loggedinUser, CREATE_ANY_IACUC_CONT_REV_AM, unitNumber);
//                    }                    
//                    exceptionCode = "protocolAuthorization_exceptionCode." + 3014;                    
//                    if(isAuthorised){
                        protocolSubmissionTxnBean = new ProtocolSubmissionTxnBean();
                        ProtocolSubmissionInfoBean protocolSubmissionInfoBean = null;
                        protocolSubmissionInfoBean = protocolSubmissionTxnBean.getProtocolSubmissionDetails(protocolNumber);
                        if(protocolSubmissionInfoBean!=null){
                            ...
                            ActionTransaction actionTxn = new ActionTransaction(loggedinUser);
                            actionBean.setProtocolNumber(protocolNumber);
                            actionBean.setActionTypeCode(IacucProtocolActionsConstants.CONTINUATION_REVIEW_WITH_AMEND_CREATED);
                            actionBean.setSubmissionNumber(protocolSubmissionInfoBean.getSubmissionNumber());
                            actionBean.setScheduleId(protocolSubmissionInfoBean.getScheduleId());
                            actionBean.setSequenceNumber(protocolSubmissionInfoBean.getSequenceNumber());
                            exceptionId = actionTxn.performStatusChangeValidation(actionBean);
                            ...
                            exceptionCode = "iacucProtocolAction_exceptionCode.4052";
                            isAuthorised = false;
                        }
                        //COEUSQA-2878:IACUC - change message displayed when New Amendment option is selected
                        if(isAuthorised){
...
//                    }
                ...
                /*Added For case#4278 -In Comments on Action Details, indicate Renewal with Amendment for submissions created via New Am - End   */
                    ...
                    if( isAuthorised ){
                        ...
                        if( exceptionId == 1 ){
                            ...
                            exceptionCode = "iacucAdministrativeCorrection_exceptionCode." + exceptionId;
                            isAuthorised = false;
                        }
                    }else {
                        ...
                        String errMsg = coeusMessageResourcesBean.parseMessageKey(
                                "iacucAdministrativeCorrection_exceptionCode.4010");
                        responder.setMessage(errMsg);
                        CoeusException ex = new CoeusException(errMsg,1);
                        responder.setDataObject(ex);
                        exceptionCode = "iacucAdministrativeCorrection_exceptionCode.4010";
                    }
                    // Modified for COEUSQA-2675_Remaining IACUC Protocol Actions(Administrative Correction)_end
                ...
                if(!isAuthorised){
                    ...
                    vecTypes.add(PROTOCOL_TYPES_INDEX,protocolDataTxnBean.getProtocolTypes());
                    vecTypes.add(PROTOCOL_PROJECT_TYPES_INDEX,protocolDataTxnBean.getProjectTypes());
                    vecTypes.add(SPECIES_INDEX,protocolDataTxnBean.getSpeciesCodes());
                    // Added for COEUSQA-2627_Move pain category in IACUC protocol to Protocol SpeciesGroup level_start                    
                    vecTypes.add(PAIN_CATEGORY_INDEX,protocolDataTxnBean.getStudyGroupPainCategory());
                    // Added for COEUSQA-2627_Move pain category in IACUC protocol to Protocol SpeciesGroup level_end
                    //Added for-COEUSQA-2798 Add count type to species/group screen-Start
                    vecTypes.add(SPECIES_COUNT_TYPE_INDEX,protocolDataTxnBean.getSpeciesCountType());
                    //Added for-COEUSQA-2798 Add count type to species/group screen-End
                    dataObjects.addElement(vecTypes);
                    ...
                    //Modified for COEUSQA-2540 Need ability to separate Correspondent Types-start
                    Vector vecCorrrespType = protocolDataTxnBean.getCorrespondentTypes();
                    //Modified for COEUSQA-2540 Need ability to separate Correspondent Types-end
                    ...
                    // COEUSQA-2320 Show in Lite for Special Review in Code table
                    dataObjects.addElement(irbProtoTxnBean.getSpecialReviewTypesForModule(ModuleConstants.IACUC_MODULE_CODE));
                    // Added By Raghunath P.V. for getting the Special Review Codes
                    ...
                    //8 - Vector of ComboBoxBean that contains Affiliation Code list and Person role code with description
                    Vector vecRoleAndAffiliation = new Vector();
                    vecRoleAndAffiliation.add(0,protocolDataTxnBean.getAffiliationTypes());
                    vecRoleAndAffiliation.add(1,protocolDataTxnBean.getPersonRoleTypes());
                    dataObjects.addElement(vecRoleAndAffiliation);
                    ...
                    if (!protocolNumber.equals("")) {
                        ...
                        //If User does not have VIEW_IACUC_RESTRICTED_NOTES right
...
//                        hasViewRestrictedNotes = txnData.getUserHasRight(loggedinUser, VIEW_IACUC_RESTRICTED_NOTES, unitNumber);
                        ...
                        hasViewRestrictedNotes = txnData.getUserHasRight(loggedinUser, VIEW_IACUC_RESTRICTED_NOTES, protocolLeadUnit);
                        //COEUSDEV-165 : END
...
//                                    = protocolDataTxnBean.getProtocolInfo(protocolNumber);
                            ...
                            /*COEUSQA-1724-New condition added for New Amendment/Renewal Type*/
                            if(!hasViewRestrictedNotes && isAmendRenewFunctionType(functionType)
                                    ){
...
//                            protocolData = protocolDataTxnBean.getProtocolInfo(protocolNumber);
                           ...
                           // NEW_CONTINUATION_REVIEW
                            if(functionType == GET_FOR_NEW_AMENDMENT){
                                ...
                                protocolData.setPendingAmmendRenewal( protocolDataTxnBean.hasPendingAmendmentsRenewals(protocolNumber, Character.toString(CoeusConstants.IACUC_AMENDMENT)));
                            }else if( functionType == GET_FOR_NEW_REVISION){
                                // Check if the protocol has any Pending Renewal/Amendment
                                protocolData.setPendingAmmendRenewal( protocolDataTxnBean.hasPendingAmendmentsRenewals(protocolNumber, Character.toString(CoeusConstants.IACUC_RENEWAL)));
                            }else if( functionType == RENEWAL_WITH_AMENDMENT){
                                // Check if the protocol has any Pending Renewal/Amendment
                                protocolData.setPendingAmmendRenewal( protocolDataTxnBean.hasPendingAmendmentsRenewals(protocolNumber, Character.toString(CoeusConstants.IACUC_RENEWAL_WITH_AMENDMENT)));
                            }
                            //*COEUSQA-1724-added for new Amendment/Renewal Type-Start*/
                            else if( functionType == NEW_CONTINUATION_REVIEW){
                                // Check if the protocol has any Pending Renewal/Amendment
                                protocolData.setPendingAmmendRenewal( protocolDataTxnBean.hasPendingAmendmentsRenewals(protocolNumber, Character.toString(CoeusConstants.IACUC_CONTINUATION_CONTINUING_REVIEW)));
                            } else if( functionType == NEW_CONTINUATION_REVIEW_AMEND){
                                // Check if the protocol has any Pending Renewal/Amendment
                            protocolData.setPendingAmmendRenewal( protocolDataTxnBean.hasPendingAmendmentsRenewals(protocolNumber, Character.toString(CoeusConstants.IACUC_CONTI_CONTINUING_REVIEW_WITH_AMEND)));
                            } 
                           //*COEUSQA-1724-added for new Amendment/Renewal Type-Start*/
                            else {
                            ...
                            //if(functionType==MODIFY_MODE && (protocolNumber.indexOf("R") != -1) || (protocolNumber.indexOf("A") != -1) || (protocolNumber.indexOf("E") != -1)){
                            if(functionType==MODIFY_MODE 
                               && isProtocolAmendRenew(protocolNumber)){
                            ...
                            else if(isAmendRenewFunctionType(functionType)) {
                        ...
                        moduleCode = departmentPersonTxnBean.getParameterValues("COEUS_MODULE_IACUC");
                    ...
                    //15 th Position
//                    dataObjects.add( protocolDataTxnBean.getProtocolSpecies(protocolNumber));
                    //System.out.println("1>>>>>>>>>>>>>>>>>");
...
//                hasViewRestrictedNotes = txnData.getUserHasRight(loggedinUser, VIEW_IACUC_RESTRICTED_NOTES, unitNumber);
                ...
                if(success){
                    ...
                    UserMaintDataTxnBean txnData = new UserMaintDataTxnBean();
                    boolean hasViewRestrictedNotes = txnData.getUserHasRight(loggedinUser, VIEW_IACUC_RESTRICTED_NOTES, protocolLeadUnit);
                    //COEUSDEV-165 : END
...
//                    protocolUpdateTxnBean.copyProtocolUploadDoc(newProtocolData, parentProtoNumber);
                ...
                if(isProtocolAmendRenew(protocolNumber)){
                    isAmendRenewal = true;
                ...
                in OSP$PROTOCOL and see whether the protocol is valid */
                    ...
                    isProtoValid = coeusDataTxnBean.validateIacucProtocolNumber(protocolNumber);
                }      
                if(isProtoValid) {
//                Modification for Case:4356 -Coeus Premium: Improper message in Amendments/ Renewals Tab - end
                ...
                if(!isAmendRenewalApproved){
                    ...
                    //First check for Modify rights
                     isAuthorised = txnData.getUserHasIACUCProtocolRight(loggedinUser, MODIFY_PROTOCOL, protocolNumber);
                   ...
                   */
                   if(!isAuthorised) {
                    ...
                    if(!isAmendRenewal){
                        ...
                        //Status 4001 - If Protocol Status is Submitted to IACUC
                        //Status 4002 - If Protocol Status is Active
                        //Status 4003 - If Protocol Status is Active - On Hold                        
                        /*Previous values for 4001/4002
                         * Status 4001 - If Protocol Status is Active/Active - On Hold
                         * Status 4002 - If Protocol Status is in Closed Administratively for lack of response/Closed by Investigator
                         */
                        if(canModifyInDisplay){
                           //if (status != 1 && status != 4001 && status != 4002 && status != 4003 ){
...
//                        }
                    ...
                    if(!isAuthorised){
                        ...
                        isAuthorised = txnData.getUserHasIACUCProtocolRight(loggedinUser, VIEW_PROTOCOL, protocolNumber);
                        //If no rights check at Unit level right- 15/10/2003 - start
                        if(!isAuthorised){
                            //prps start jan 27 2004
                            // this will retrieve the lead unit for a protocol, with which u
                    ...
                    if(!isAuthorised){
                        ...
                        if(protocolInfoBean != null && !checkStatusInProgress(protocolInfoBean.getProtocolStatusCode())){   
                            ...
                            String departmentNumber = EMPTY_STRING;
                    ...
                    if(isAuthorised){
                        ...
                        dataObjects.addElement(protocolDataTxnBean.getSpeciesCodes());
                        dataObjects.addElement(protocolDataTxnBean.getStudyGroupPainCategory());
                        dataObjects.addElement(protocolDataTxnBean.getSpeciesCountType());
...
//                    protocolSubmissionVoteFormBean = protocolSubmissionTxnBean.getProtocolVotingDetails(protocolNumber);
                   ...
                   */
                    ...
                    if(isAuthorised){
                        ...
                        if (status == 1) {
                            ...
                            String errorMsg = setErrorMessage(protocolNumber);
                            responder.setResponseStatus(false);
                            CoeusMessageResourcesBean coeusMessageResourcesBean
                                    =new CoeusMessageResourcesBean();
                            String errMsg=
           ...
           else if(functionType == MAX_AMEND_VERSION){
                protocolNumber  = requester.getId() ;
                int  versionNumber = protocolDataTxnBean.getMaxVersionNumber(protocolNumber);
            ...
            else if(functionType == MAX_AMEND_REVISION_VER){
                protocolNumber  = requester.getId();
                int  versionNumber = protocolDataTxnBean.getMaxAmendRevisionVersionNumber(protocolNumber);
                dataObjects.addElement(new Integer(versionNumber));
                responder.setDataObjects(dataObjects);
                responder.setResponseStatus(true);
            }
            /*COEUSQA-1724-New Condition added for New Amendment Type - Start */
            else if(functionType == MAX_CONTINUING_REVIEW_VER){
                protocolNumber  = requester.getId();
                int  versionNumber = protocolDataTxnBean.getMaxContinuingReviewNumber(protocolNumber);
                dataObjects.addElement(new Integer(versionNumber));
                responder.setDataObjects(dataObjects);
                responder.setResponseStatus(true);
            }else if(functionType == MAX_CONTINUING_REVIEW_AMEND_VER){
                protocolNumber  = requester.getId();
                int  versionNumber = protocolDataTxnBean.getMaxContinuingReviewAmendNumber(protocolNumber);
                dataObjects.addElement(new Integer(versionNumber));
                responder.setDataObjects(dataObjects);
                responder.setResponseStatus(true);
            }
            /*COEUSQA-1724-New Condition added for New Amendment Type - End */
...
//                responder.setResponseStatus(true);
                ...
                isAuthorised = txnData.getUserHasIACUCProtocolRight(loggedinUser, MAINTAIN_PROTOCOL_RELATED_PROJ, protocolNumber);
                if(isAuthorised){
                    responder.setResponseStatus(true);
                    responder.setMessage(null);
                }else{
                ...
                isAuthorised = txnData.getUserHasIACUCProtocolRight(loggedinUser, MAINTAIN_PROTOCOL_ACCESS, protocolNumber);
                //If no rights check at Unit level right- 15/10/2003 - start
                if(!isAuthorised){
                    isAuthorised = txnData.getUserHasRight(loggedinUser, MAINTAIN_ANY_IACUC_PROT_ACCESS, unitNumber);
                }
                //Unit level right- 15/10/2003 - end
                if(isAuthorised){
                    responder.setResponseStatus(true);
...
//                }
                ...
                boolean hasRight = userMaintDataTxnBean.getUserHasRight(userBean.getUserId(), "PERFORM_IACUC_ACTIONS_ON_PROTO", unitNumber);
                //COEUSQA:3400 - End
...
//                }
                ...
                UserMaintDataTxnBean txnData = new UserMaintDataTxnBean();
                boolean isAuthorised = false;
                //isAuthorised = txnData.getUserHasIACUCProtocolRight(loggedinUser, VIEW_IACUC_RESTRICTED_NOTES, protocolNumber);
                //Should be unit level right - 10/17/2003 - Prasanna
                isAuthorised = txnData.getUserHasRight(loggedinUser, VIEW_IACUC_RESTRICTED_NOTES, unitNumber);
                if(isAuthorised){
                    responder.setResponseStatus(true);
                    responder.setMessage(null);
                }else{
                ...
                UserMaintDataTxnBean txnData = new UserMaintDataTxnBean();
                boolean isAuthorised = false;
                isAuthorised = txnData.getUserHasIACUCProtocolRight(loggedinUser, ADD_PROTOCOL_NOTES, protocolNumber);
...
//                UserDetailsBean userDetailsBean = new UserDetailsBean();
            ...
            //Coeus enhancement 32.2 - step 2 : start
                ...
                if(requesterId != null && requesterId.length()>0){
                    ...
                    if(SPECIES_TRAINING.equals(requesterId)){                        
                        Vector personSpeciesData = (Vector)requester.getDataObjects();
                        String personId = personSpeciesData.get(0).toString();
                        int speciesCode = (Integer) personSpeciesData.get(1);
                        int procedureCode = (Integer) personSpeciesData.get(2);
                        boolean isTraining = trainingBean.getSpeciesTrainingFlag(personId, speciesCode, procedureCode);
                        responder.setDataObject(new Boolean(isTraining));
                        responder.setResponseStatus(true);
                        responder.setMessage(null);
                    }else if(SPECIES_TRAINING_DETAIL.equals(requesterId)){
                        String personId = (String)requester.getDataObject();
                        Vector vecTrainingDetail = trainingBean.getSpeciesTrainingDetails(personId);
                        responder.setDataObjects(vecTrainingDetail);
                        responder.setResponseStatus(true);
                        responder.setMessage(null);
                    } 
                }else{
            ...
            //Protocol Enhancement -  Administrative Correction Start 2
                ...
                if(protocolNumber != null){
                    CoeusDataTxnBean coeusDataTxnBean =  new CoeusDataTxnBean();
                    boolean isValid = coeusDataTxnBean.validateIacucProtocolNumber(protocolNumber);
                    ProtocolInfoBean protocolInfoBean = null;
...
//                        protocolNumber,documentId);
                ...
                // To get history for a particular document
                //String protocolNumber = (String)requester.getDataObject();
...
//                }
            ...
            //Added for Coeus 4.3 enhancement PT ID 2210- View Protocol History - starts
                ...
                boolean userHasViewRight = ((txnData.getUserHasRight(loggedinUser, MODIFY_ANY_PROTOCOL, unitNumber)) ||
                        (txnData.getUserHasIACUCProtocolRight(loggedinUser, MODIFY_PROTOCOL, protocolNumber)) ||
                        (txnData.getUserHasIACUCProtocolRight(loggedinUser, VIEW_PROTOCOL, protocolNumber))||
...
//                            historyDataObjects.add(2,historyBean);
            ...
            /*Added for Case# 3018 -create ability to delete pending studies - Start*/
                ...
                protocolNumber  = requester.getId() ;
                UserMaintDataTxnBean txnData = new UserMaintDataTxnBean();
                boolean isAuthorised = txnData.getUserHasIACUCProtocolRight(loggedinUser, "DELETE_IACUC_PROTOCOL", protocolNumber);
                //If no rights check at Unit level right
                if(!isAuthorised){
                    isAuthorised = txnData.getUserHasRight(loggedinUser, "DELETE_ANY_IACUC_PROTOCOL", unitNumber);
                }
                responder.setDataObject(new Boolean(isAuthorised));
                responder.setResponseStatus(true);
                
            }else if(functionType == DELETE_IACUC_PROTOCOL){
                protocolNumber  = requester.getId() ;
                UserMaintDataTxnBean txnData = new UserMaintDataTxnBean();                
                int protoDeleted = -1;
                ...
                String errMsg = null;   
                    ...
                    if(canDelete == 0 || canDelete == 1){
                        ...
                        responder.setDataObject(new Boolean(false));
                        errMsg = "deleteIacucProtocol_exceptionCode.100"+canDelete;
                        responder.setMessage(errMsg);
                        responder.setResponseStatus(true);
                    }
            }
            //COEUSQA-1433 - Allow Recall from Routing - Start
            else if(functionType == IACUC_PROTOCOL_RECALL_LOCK_CHECK){
                ...
                //lockingBean = protocolDataTxnBean.lockProtocol(protocolNumber, loggedinUser, unitNumber);
                lockingBean = protocolDataTxnBean.lockIacucProtocolRouting(protocolNumber, loggedinUser, unitNumber);
                ...
                responder.setDataObject(new Boolean(lockCheck));
            } else if(functionType == IACUC_PROTOCOL_ACTION_UPDATE){
                ProtocolActionsBean  iacucProtocolActionsBean = (ProtocolActionsBean)requester.getDataObject();
                if(iacucProtocolActionsBean != null){
                    int actionCode = iacucProtocolActionsBean.getActionId();
                    ActionTransaction actionTxn = new ActionTransaction(actionCode) ;
                    if ( actionTxn.logStatusChangeToProtocolAction(iacucProtocolActionsBean.getProtocolNumber(),
                            iacucProtocolActionsBean.getSequenceNumber(), iacucProtocolActionsBean.getSubmissionNumber(), loggedinUser ) != -1 ) {
                        responder.setResponseStatus(true);
                    } else {
                        responder.setResponseStatus(false);
                        responder.setMessage(null);
...
//            }
            ...
            //COEUSDEV-86 : End
            else if(functionType == GET_STUDY_GROUP_DATA){
                Vector vecProtocolDetail = requester.getDataObjects();
                protocolNumber = (String)vecProtocolDetail.get(PROTOCOL_NUMBER_INDEX);
                int sequenceNumber = Integer.parseInt(vecProtocolDetail.get(SEQUENCE_NUMBER_INDEX).toString());
                char funcType = ((Character)vecProtocolDetail.get(FUNCTION_TYPE_INDEX)).charValue();
                Vector vecStudyGroup = new CoeusVector();
                if(funcType == TypeConstants.DISPLAY_MODE){
                    vecStudyGroup = protocolDataTxnBean.getStudyGroups(protocolNumber,sequenceNumber);
                }else{
                    if(funcType == TypeConstants.MODIFY_MODE || funcType == 'P' || funcType == TypeConstants.AMEND_MODE){
                        vecStudyGroup.add(STUDY_GROUP_DATA_INDEX,
                                protocolDataTxnBean.getStudyGroups(protocolNumber,sequenceNumber));
                    }else if(funcType == TypeConstants.ADD_MODE){
                        vecStudyGroup.add(STUDY_GROUP_DATA_INDEX,new Vector());
                    }
//                        vecStudyGroup.add(SPECIES_TYPE_INDEX,
//                                protocolDataTxnBean.getProtocolSpeciesType(protocolNumber,sequenceNumber));
                    CoeusVector cvProcCatTypes = protocolDataTxnBean.getProcedureCategoryTypes();
                    vecStudyGroup.add(PROC_CATEGORY_INDEX,cvProcCatTypes);
                    HashMap hmProcForCategory = new HashMap();
                    if(cvProcCatTypes != null && cvProcCatTypes.size() > 0){
                        for(int index=0;index<cvProcCatTypes.size();index++){
                            ComboBoxBean procedureCat = (ComboBoxBean)cvProcCatTypes.get(index);
                            String procedureCatCode = procedureCat.getCode();
                            CoeusVector vecProcForCat =
                                    protocolDataTxnBean.getProcedureForCategory(Integer.parseInt(procedureCatCode));
                            hmProcForCategory.put(procedureCatCode,vecProcForCat);
                        }
                    }
                    vecStudyGroup.add(PROCEDURE_INDEX,
                            hmProcForCategory);
                    
                    vecStudyGroup.add(PAIN_CATEGORY_INDEX,
                            protocolDataTxnBean.getStudyGroupPainCategory());
                    vecStudyGroup.add(LOCATION_TYPE_INDEX,
                            protocolDataTxnBean.getStudyGroupLocationTypes());
                    vecStudyGroup.add(LOCATION_NAME_INDEX,
                            protocolDataTxnBean.getStudyGroupLocationNames());
                    HashMap hmProcCustomData = new HashMap();
                    if(cvProcCatTypes != null && cvProcCatTypes.size() > 0){
                        for(int index=0;index<cvProcCatTypes.size();index++){
                            ComboBoxBean procedureCat = (ComboBoxBean)cvProcCatTypes.get(index);
                            String procedureCatCode = procedureCat.getCode();
                            Vector vecCustomDataCat =
                                    protocolDataTxnBean.getProcedureCatCustomData(Integer.parseInt(procedureCatCode));
                            hmProcCustomData.put(procedureCatCode,vecCustomDataCat);
                        }
                    }
                    vecStudyGroup.add(PROCEDURE_CUSTOM_DATA_INDEX,hmProcCustomData);
                    
                    //COEUSQA:3005 - Dependency between the Location Name and Location Type in IACUC - Start
                    HashMap hmLocationForType = new HashMap();
                    if(protocolDataTxnBean.getStudyGroupLocationTypes() != null && protocolDataTxnBean.getStudyGroupLocationTypes().size() > 0){
                        for(int index=0;index<protocolDataTxnBean.getStudyGroupLocationTypes().size();index++){
                            ComboBoxBean LocationType = (ComboBoxBean)protocolDataTxnBean.getStudyGroupLocationTypes().get(index);
                            String locationTypeCode = LocationType.getCode();
                            CoeusVector vecLocationForType =
                                    protocolDataTxnBean.getLocationForType(Integer.parseInt(locationTypeCode));
                            hmLocationForType.put(locationTypeCode,vecLocationForType);
                        }
                    }
                    vecStudyGroup.add(LOCATION_TYPE_CODE, hmLocationForType);
                    //COEUSQA:3005 - End
                            
                }
                
                responder.setDataObjects(vecStudyGroup);
                responder.setResponseStatus(true);
            } else if(functionType == GET_SCIENTIFIC_JUSTIFICATION_DATA){
                Vector vecProtocolDetail = requester.getDataObjects();
                protocolNumber = (String)vecProtocolDetail.get(PROTOCOL_NUMBER_INDEX);
                int sequenceNumber = Integer.parseInt(vecProtocolDetail.get(SEQUENCE_NUMBER_INDEX).toString());
                //Commented for COEUSQA-2724-Exceptions should be moved from Scientific Justification in IACUC
               // Vector vecExceptionsData = protocolDataTxnBean.getIacucProtocolExceptions(protocolNumber,sequenceNumber);
                Vector vecPrinciples = protocolDataTxnBean.getIacucProtocolPrinciples(protocolNumber,sequenceNumber);
                //Commented for COEUSQA-2724-Exceptions should be moved from Scientific Justification in IACUC
                // Added for getting 'ExceptionCategory'
                //CoeusVector cvExceptionCategory = protocolDataTxnBean.getIacucProtocolExceptionsCategory();
                Vector vecResponse = new Vector();
                //vecResponse.add(vecExceptionsData);
                vecResponse.add(vecPrinciples); 
                //vecResponse.add(cvExceptionCategory); 
                responder.setDataObjects(vecResponse);
                responder.setResponseStatus(true);
             }
            //COEUSQA-2724-Exceptions should be moved from Scientific Justification in IACUC
            else if(functionType == GET_EXCEPTION_CATEGORY) {
                CoeusVector cvExceptionCategory = protocolDataTxnBean.getIacucProtocolExceptionsCategory();
                Vector vecResponse = new Vector();
                vecResponse.add(cvExceptionCategory); 
                responder.setDataObjects(vecResponse);
             ...
             else if(functionType == GET_ALTERNATIVE_SEARCH_DATA){
                Vector vecProtocolDetail = requester.getDataObjects();
                protocolNumber = (String)vecProtocolDetail.get(PROTOCOL_NUMBER_INDEX);
                int sequenceNumber = Integer.parseInt(vecProtocolDetail.get(SEQUENCE_NUMBER_INDEX).toString());
                Vector vecAlterSerachesData = protocolDataTxnBean.getIacucProtocolAlterDBSearches(protocolNumber,sequenceNumber);
                responder.setDataObjects(vecAlterSerachesData);
                responder.setResponseStatus(true);
             }
            //Added For IACUC get altenativesearch category-Start
            else if(functionType == ALTERNATIVE_SEARCH_DB){              
            String moduleCode = (String)requester.getId();
            CoeusVector cvProcCategoryType = protocolDataTxnBean.getAltSearchDB();        
            responder.setDataObjects(cvProcCategoryType);   
            responder.setResponseStatus(true);
            responder.setMessage(null); 
            }//Added For IACUC get altenativesearch category-End  
            //Added for-COEUSQA-2508 Some schools do not use pain category-Start
            else if(functionType == IS_PAIN_CATEGORY_MANDATORY){              
            String moduleCode = (String)requester.getId();
            String painCategorycode = protocolDataTxnBean.getPainCategoryParameterValue();        
            responder.setId(painCategorycode);
            responder.setResponseStatus(true);
            responder.setMessage(null); 
            }//Added for-COEUSQA-2508 Some schools do not use pain category-End
        //COEUSQA 1457 STARTS
                ...
                String enableSendNotif=coeusFunctions.getParameterValue(CoeusConstants.ENABLE_IACUC_PERSONNEL_NOTIFICATION);
                if (enableSendNotif != null && enableSendNotif.equalsIgnoreCase("1")) {
                    responder.setDataObject(1);
                    UserMaintDataTxnBean txnData = new UserMaintDataTxnBean();
                    boolean isAuthorisedForSendNotif=txnData.getUserHasIACUCProtocolRight(loggedinUser, NOTIFY_IACUC_PROTOCOL_PERSON, protocolNumber);   
        ...
        && (protocolData.getAcType().equalsIgnoreCase("I") )){
            ...
            if(protocolData.getProtocolNumber() == null 
                ...
                protocolNumber = decimalFormat.format( Integer.parseInt(
                        protocolNumber));
                protocolData.setProtocolNumber(protocolNumber);
                protocolData.setSequenceNumber(1);
                protocolData.setVersionNumber(1);
            }
        }
                /*else if ((protocolData.getAcType() != null)
                        && (protocolData.getAcType().equalsIgnoreCase("U") )
...
//        }
   ...
   /*This method is used to check different status' for which the protocol
    * can be modified in Display mode
    * @param int status 
    * @throws Exception
    * @return boolean value
    */
   private boolean checkStatus(int status) throws Exception{
      boolean isStatus = false;
      // Modified with COEUSQA-2666: Complete Administrative Review functionality in IACUC
      if (status != 1 && status != 4001 && status != 4002 && status != 4003 && status != 4010 ){
        isStatus = true;  
      }       
       return isStatus;
   }  
   
   //COEUSQA-1724-Added new methods for IACUC new Amendment/Renewal type -start
   /*This method is used to check  the protocol is Amendment/renewal
    * @param String protocolNumber      
    * @return boolean status
    */
  private boolean isProtocolAmendRenew(String protocolNumber){
      boolean status = false;
      if((protocolNumber.indexOf(CoeusConstants.IACUC_AMENDMENT) != -1)
        || (protocolNumber.indexOf(CoeusConstants.IACUC_RENEWAL) != -1)
        || (protocolNumber.indexOf(CoeusConstants.IACUC_RENEWAL_WITH_AMENDMENT) != -1) 
        || (protocolNumber.indexOf(CoeusConstants.IACUC_CONTINUATION_CONTINUING_REVIEW) != -1)
        || (protocolNumber.indexOf(CoeusConstants.IACUC_CONTI_CONTINUING_REVIEW_WITH_AMEND) != -1)){                
        status = true;
      }
      return status;
  }
  
    /*This method is used set the Exception type code for Amendment/Renewal Protocol
    * @param String protocolNumber 
    * @return String errorMsg value
    */
  private String setErrorMessage(final String protocolNumber) {         
        String errorMsg = "iacucProtocoledit_exceptionCode.";
        if( protocolNumber.indexOf(CoeusConstants.IACUC_AMENDMENT) != -1 ) {
            errorMsg = "iacucamendedit_exceptionCode.";
        }else if( protocolNumber.indexOf(CoeusConstants.IACUC_RENEWAL) != -1 ){
            errorMsg = "iacucrenewaledit_exceptionCode.";
        }else if( protocolNumber.indexOf(CoeusConstants.IACUC_RENEWAL_WITH_AMENDMENT) != -1 ){
            errorMsg = "iacucrenewalamendedit_exceptionCode.";
        }else if( protocolNumber.indexOf(CoeusConstants.IACUC_CONTINUATION_CONTINUING_REVIEW) != -1 ){
            errorMsg = "iacuccontinuationreviewedit_exceptionCode.";
        }else if( protocolNumber.indexOf(CoeusConstants.IACUC_CONTI_CONTINUING_REVIEW_WITH_AMEND) != -1 ){
            errorMsg = "iacuccontinuationreviewamendedit_exceptionCode.";
        }
        return errorMsg;
    }
  
    /*This method is used to check isfunsction type is true/false
    * @param char functionType    
    * @return boolean value
    */
  private boolean isAmendRenewFunctionType(char functionType){
      boolean isFunctionType = false;
    if(functionType != GET_FOR_NEW_AMENDMENT 
    && functionType != GET_FOR_NEW_REVISION   
    && functionType != RENEWAL_WITH_AMENDMENT
    ...
    * @return boolean value
    */
  private boolean isAmendReviewFunctionType(char functionType){
      boolean isFunctionType = false;
      if(functionType == ADD_MODE 
         || functionType == MODIFY_MODE 
         || functionType == AMEND_MODE
         || functionType == GET_FOR_NEW_AMENDMENT 
         || functionType == GET_FOR_NEW_REVISION
         || functionType == ADMINISTRATIVE_CORRECTION_MODE 
         || functionType == GET_FOR_AMENDMENT_RENEWAL 
         || functionType == RENEWAL_WITH_AMENDMENT 
         || functionType == NEW_CONTINUATION_REVIEW
         || functionType == NEW_CONTINUATION_REVIEW_AMEND){
            isFunctionType = true;
  ...
  //COEUSQA-1724-Added new methods for IACUC new Amendment/Renewal type -End
  //Added new methods for code refactor- end
  
  //COEUSQA-2314 : IRB Admin should have ability to assign committee based on lead unit of the protocol - Start
  /*
  ...
  //COEUSQA-2314 : IRB Admin should have ability to assign committee based on lead unit of the protocol - End
}
