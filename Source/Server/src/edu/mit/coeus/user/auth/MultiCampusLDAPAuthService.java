 ...
 * @author  Geo Thomas
 */
public class MultiCampusLDAPAuthService extends AuthServiceServerBase{
    ...
    CoeusMessageResourcesBean cmrb;
    /** Creates a new instance of KerberosAuthService */
    public MultiCampusLDAPAuthService() {
        cmrb = new CoeusMessageResourcesBean();
    }


    private Properties initPropsForCampus(String campusCode) throws CoeusException{
        MultiCampusNodeReader nodeReader = new MultiCampusNodeReader();
        props = nodeReader.getNodeProps(campusCode);
        return props;
    }
...
//            if(props.getProperty("LDAP_SECURITY_PROTOCOL")!=null)
//                env.put(Context.SECURITY_PROTOCOL, props.getProperty("LDAP_SECURITY_PROTOCOL",LDAP_SECURITY_PROTOCOL));
    ...
    public boolean authenticate() throws CoeusException {
        ...
        if(requester==null){
            ...
            campusCode = logonForm.getCampusCode();
        }else{
            MultiCampusLoginBean loginBean = (MultiCampusLoginBean)requester.getDataObject();
            userId = loginBean.getUserId();
            password = loginBean.getPassword();
            campusCode = loginBean.getCampusCode();
        }
