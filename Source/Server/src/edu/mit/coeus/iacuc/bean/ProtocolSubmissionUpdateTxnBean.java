...
import static edu.mit.coeus.utils.mail.MailPropertyKeys.IACUC_NOTIFICATION;
...
//    private static final String INSERT = "I";
    ...
    private static final int SUB_STATUS_SUBMITTED_TO_COMMITTEE = 102;
    private static final int SUB_STATUS_PENDING = 101;
    ...
    private static final int REQUEST_TO_LIFT_HOLD = 103;
    private static final int REQUEST_TO_DEACTIVATE = 102;
/** Creates a new instance of ProtocolSubmissionUpdateTxnBean */
    ...
    public boolean addUpdProtocolSubmission(
        ...
        if(submissionInfoBean.getCommitteeId()==null && submissionInfoBean.getSubmissionStatusCode() != SUB_STATUS_ROUTING_IN_PROGRESS){ 
  
            submissionInfoBean.setSubmissionStatusCode(SUB_STATUS_PENDING);  
        }else{
            if(submissionInfoBean.getSubmissionStatusCode() == SUB_STATUS_PENDING){  
                submissionInfoBean.setSubmissionStatusCode(SUB_STATUS_SUBMITTED_TO_COMMITTEE);     
            }  
        }
        ...
        StringBuffer sqlAssignment = new StringBuffer(
                                            "call UPDATE_AC_PROTOCOL_SUBMISSION(");
...
//            if(submissionInfoBean.getSubmissionTypeCode() == REQUEST_TO_LIFT_HOLD){
//                actionCode = IacucProtocolActionsConstants.REQUEST_TO_LIFT_HOLD;
//            }else if(submissionInfoBean.getSubmissionTypeCode() == REQUEST_TO_DEACTIVATE){  
...
//            }
    ...
    public int addUpdProtocolSubmissionForRequest(
        ...
        seqNumber = submissionInfoBean.getSequenceNumber();
        verNumber = submissionInfoBean.getVersionNumber();
...
//        protocolNumber  = protocolInfoBean.getProtocolNumber();
     ...
     */
     public boolean addUpdProtocolVoteSubmission(ProtocolSubmissionVoteFormBean 
        ...
        //prps end
        StringBuffer sqlAssignment = new StringBuffer(
                                            "call UPD_AC_PROTO_SUBMISSION_VOTE(");
        sqlAssignment.append(" <<PROTOCOL_NUMBER>> , ");
        sqlAssignment.append(" <<SEQUENCE_NUMBER>> , ");
        sqlAssignment.append(" <<SCHEDULE_ID>> , ");
        sqlAssignment.append(" <<YES_VOTE_COUNT>> , ");
...
//        }
    ...
    public ProcReqParameter addUpdProtocolReviewer( ProtocolReviewerInfoBean
        ...
        StringBuffer sqlReviewer = new StringBuffer(
                                        "call UPDATE_AC_PROTOCOL_REVIEWERS(");
...
//        }
        ...
        if(reviewComments!=null){
            ...
            for(int rowIndex=0; rowIndex < reviewCommentslength; rowIndex++){
                ...
                if(minuteEntryInfoBean!=null){
                    ...
                    {
                        minuteEntryInfoBean.setScheduleId("9999999998") ;
                    }
    ...
    public ProcReqParameter addUpdProtocolExpitedCheckList( ProtocolReviewTypeCheckListBean
        ...
        StringBuffer sqlReviewer = new StringBuffer(
                                        "call UPD_IACUC_EXPIDITED_CHKLST(");
        sqlReviewer.append(" <<PROTOCOL_NUMBER>> , ");
        sqlReviewer.append(" <<SEQUENCE_NUMBER>> , ");
        sqlReviewer.append(" <<SUBMISSION_NUMBER>> , ");
    ...
    public ProcReqParameter addUpdProtocolExemptCheckList( ProtocolReviewTypeCheckListBean
        ...
        StringBuffer sqlReviewer = new StringBuffer(
                                        "call UPD_IACUC_PROTO_EXEMPT_CHKLST(");
        sqlReviewer.append(" <<PROTOCOL_NUMBER>> , ");
        sqlReviewer.append(" <<SEQUENCE_NUMBER>> , ");
        sqlReviewer.append(" <<SUBMISSION_NUMBER>> , ");        
...
//                                            "call UPD_IACUC_ASSIGN_TO_SCHEDULE(");
...
//        boolean isUpdate = false;
        int PROTOCOL_APPROVER_ROLE_ID = 301;
...
//        CoeusVector filteredData = new CoeusVector();
        ...
        int mapsExist = routingUpdateTxnBean.buildMapsForRouting(protocolNumber,
                unitNumber,ModuleConstants.IACUC_MODULE_CODE, moduleItemKeySeq, option);
...
//        if(mapsExist > 0 && approvalSeq == 2 && option.equals("S")){
        ...
        if(mapsExist > 0 && option.equals("S")){
            ...
            CoeusVector cvApprovers = routingTxnBean.getAllRoutingApprovers(ModuleConstants.IACUC_MODULE_CODE + "", protocolNumber, moduleItemKeySeq);
            ...
            //Added For COEUSQA-1724:Email Notifications For All Actions In IACUC 
            routingUpdateTxnBean.sendNotification(ModuleConstants.IACUC_MODULE_CODE, protocolNumber, moduleItemKeySeq, unitNumber);
...
//                    protocolRolesFormBean.setSequenceNumber(moduleItemKeySeq);
                    ...
                    protocolRolesFormBean.setRoleId(ProtocolRoleInfoBean.APPROVER_ROLE_ID);
    ...
    public boolean updateProtoSubmissionStatus(String protocolNumber, 
        ...
        StringBuffer sql = new StringBuffer("{ <<OUT INTEGER STATUS>> = call FN_UPD_AC_PROTO_SUB_STATUS(");
    ...
    public boolean updateProtocolAction(ProtocolActionsBean protocolActionsBean)throws CoeusException, DBException {
        ...
        StringBuffer sqlProtoAction = new StringBuffer("call UPDATE_AC_PROTOCOL_ACTION(");
    ...
    public boolean updateProtocolSubmission(ProtocolSubmissionInfoBean submissionInfoBean)throws CoeusException, DBException{
        ...
        StringBuffer sqlAssignment = new StringBuffer("call UPDATE_AC_PROTOCOL_SUBMISSION(");
        sqlAssignment.append(" <<PROTOCOL_NUMBER>> , ");
        sqlAssignment.append(" <<SEQUENCE_NUMBER>> , ");
        sqlAssignment.append(" <<SCHEDULE_ID>> , ");
        sqlAssignment.append(" <<SUBMISSION_TYPE_CODE>> , ");
     ...
     */
     public boolean cleanTemporarySubmissionDetails(String protocolNumber)throws CoeusException, DBException {
        ...
        StringBuffer sql = new StringBuffer("{ <<OUT INTEGER STATUS>> = call FN_DELETE_TEMP_AC_PROTO_SUB(");
        sql.append(" <<PROTOCOL_NUMBER>> )} ");
            ...
            if(TypeConstants.INSERT_RECORD.equalsIgnoreCase(protocolReviewerInfoBean.getAcType())){
                ...
                try {
                    ...
                    if( mailMsgInfoBeanForRole!= null && mailMsgInfoBeanForRole.isActive()){
                      ...
                      //  mailMsgInfoBeanForRole.setMessage(mailBody);
                        ...
                        //COEUSQA-1724:Email Notification For All Actions In IACUC 
                        String message = MailProperties.getProperty(IACUC_NOTIFICATION+DOT+REVIEWER_ADDED_ACTION_CODE+DOT+MESSAGE, "");
                ...
                try {
                    ...
                    if(mailMsgInfoBeanForRole.isActive()){
                        ...
                        //COEUSQA-1724:Email Notification For All Actions In IACUC 
                        String message = MailProperties.getProperty(IACUC_NOTIFICATION+DOT+REVIEWER_REMOVED_FROM_REVIEWER_LIST_ACTION_CODE+DOT+MESSAGE, "");
                        message = MessageFormat.format(message, arguments);
                        mailMsgInfoBeanForRole.appendMessage(message, "\n");
                        // Added for COEUSQA-3336 - Issues in reviewer notification - Start
    ...
    /**
     * Method to update the review determination details
     * @param reviewDeterminationBean 
     * @throws edu.mit.coeus.exception.CoeusException 
     * @throws edu.mit.coeus.utils.dbengine.DBException 
     */
    public void updReviewDetermination(ProtocolReviewDeterminationBean reviewDeterminationBean)
    throws CoeusException, DBException{
        
        Vector parmReviewDetermination = new Vector();
        CoeusFunctions coeusFunctions = new CoeusFunctions();
        Vector procedures = new Vector(5,3);
        
        Timestamp dbTimestamp = coeusFunctions.getDBTimestamp();
        
        parmReviewDetermination.addElement(new Parameter("PROTOCOL_NUMBER",
                DBEngineConstants.TYPE_STRING,reviewDeterminationBean.getProtocolNumber()));
        
        parmReviewDetermination.addElement(new Parameter("SEQUENCE_NUMBER",
                DBEngineConstants.TYPE_INT,""+reviewDeterminationBean.getSequenceNumber()));
        
        parmReviewDetermination.addElement(new Parameter("SUBMISSION_NUMBER",
                DBEngineConstants.TYPE_INT,""+reviewDeterminationBean.getSubmissionNumber()));
        
        parmReviewDetermination.addElement(new Parameter("PERSON_ID",
                DBEngineConstants.TYPE_STRING,""+reviewDeterminationBean.getPersonId()));
        
        parmReviewDetermination.addElement(new Parameter("RECOMMENDED_REVIEW_TYPE_CODE",
                DBEngineConstants.TYPE_STRING,""+reviewDeterminationBean.getRecommendedReviewTypeCode()));
        
        parmReviewDetermination.addElement(new Parameter("DETERMINATION_DUE_DATE",
                DBEngineConstants.TYPE_DATE,reviewDeterminationBean.getDeterminationDueDate()));
        
        parmReviewDetermination.addElement(new Parameter("SEND_NOTIFICATION_DATE",
                DBEngineConstants.TYPE_DATE,dbTimestamp));
        
        parmReviewDetermination.addElement(new Parameter("UPDATE_TIMESTAMP",
                DBEngineConstants.TYPE_TIMESTAMP,dbTimestamp));
        
        parmReviewDetermination.addElement(new Parameter("UPDATE_USER",
                DBEngineConstants.TYPE_STRING, userId));
        
        parmReviewDetermination.addElement(new Parameter("AW_UPDATE_TIMESTAMP",
                DBEngineConstants.TYPE_TIMESTAMP,reviewDeterminationBean.getAwUpdateTimestamp()));
        
        parmReviewDetermination.addElement(new Parameter("AW_UPDATE_USER",
                DBEngineConstants.TYPE_STRING, reviewDeterminationBean.getUpdateUser()));
        
        parmReviewDetermination.addElement(new Parameter("AC_TYPE",
                DBEngineConstants.TYPE_STRING, reviewDeterminationBean.getAcType()));
        
        StringBuffer sqlReviewDetermination = new StringBuffer(
                "call UPDATE_AC_REVIEW_DETERMINATION(");
        sqlReviewDetermination.append(" <<PROTOCOL_NUMBER>> , ");
        sqlReviewDetermination.append(" <<SEQUENCE_NUMBER>> , ");
        sqlReviewDetermination.append(" <<SUBMISSION_NUMBER>> , ");
        sqlReviewDetermination.append(" <<PERSON_ID>> , ");
        sqlReviewDetermination.append(" <<RECOMMENDED_REVIEW_TYPE_CODE>> , ");
        sqlReviewDetermination.append(" <<DETERMINATION_DUE_DATE>> , ");
        sqlReviewDetermination.append(" <<SEND_NOTIFICATION_DATE>> , ");
        sqlReviewDetermination.append(" <<UPDATE_TIMESTAMP>> , ");
        sqlReviewDetermination.append(" <<UPDATE_USER>> , ");
        sqlReviewDetermination.append(" <<AW_UPDATE_TIMESTAMP>> , ");
        sqlReviewDetermination.append(" <<AW_UPDATE_USER>> , ");
        sqlReviewDetermination.append(" <<AC_TYPE>> )");
        
        ProcReqParameter procReviewDetermination = new ProcReqParameter();
        procReviewDetermination.setDSN(DSN);
        procReviewDetermination.setParameterInfo(parmReviewDetermination);
        procReviewDetermination.setSqlCommand(sqlReviewDetermination.toString());
        
        procedures.add(procReviewDetermination);
    ...
    /**
     * Method to delete the review determination details
     * @param protocolNumber 
     ...
     * @throws edu.mit.coeus.exception.CoeusException 
     */
    public void cleanReviewDeterminationDetails(String protocolNumber, int sequenceNumber, int submissionNumber) throws DBException, CoeusException{
        ...
        param.addElement(new Parameter("AV_SEQUENCE_NUMBER",
                DBEngineConstants.TYPE_INT, ""+sequenceNumber));
        param.addElement(new Parameter("AV_SUBMISSION_NUMBER",
                DBEngineConstants.TYPE_INT, ""+submissionNumber));
        
        StringBuffer sql = new StringBuffer("{ <<OUT INTEGER STATUS>> = call FN_DEL_REVIEW_DETERMINATION(");
        sql.append(" <<AV_PROTOCOL_NUMBER>> , ");
        sql.append(" <<AV_SEQUENCE_NUMBER>> , ");
        sql.append(" <<AV_SUBMISSION_NUMBER>> )} ");
        if(dbEngine!=null){
            try{
                result = dbEngine.executeFunctions("Coeus", sql.toString(), param);
            }catch (DBException dbEx){
