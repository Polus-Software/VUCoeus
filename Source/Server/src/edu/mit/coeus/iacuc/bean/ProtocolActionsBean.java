...
public class ProtocolActionsBean implements java.io.Serializable {
    // holds the Type code 
...
//    private byte[] fileBytes;
   ...
   //Added for Case id COEUSQA-1724_Reviewer View of Protocol start
    //will identifies from which window action has been triggered
    private String actionTriggeredFrom;
    
    /**
     * Method used to get the Action Triggered location
     * @return actionTriggeredFrom String
     */
    ...
    /**
     * Method used to set Action Triggered location
     * @param actionTriggeredFrom String
     */
   ...
   //Added for case 2176 - Risk Level Category - end
     ...
     * @return protocolActionDocumentDescription
     */
