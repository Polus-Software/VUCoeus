/*
 * @(#)DepartmentPersonFormBean.java 1.0 03/11/03 9:56 AM
 *
...
/* PMD check performed, and commented unused imports and variables on 17-MAY-2007
 * by Leena
 */
...
/**
 * The class used to hold the information of <code>Department Person</code>
 *
 * @author  Mukundan.C
 * @version 1.0
 * Created on March 11, 2003, 9:56 AM
 */

public class DepartmentPersonFormBean implements java.io.Serializable, BaseBean {
    ...
    private static final String SALARY_ANNIVERSARY_DATE = "salaryAnniversaryDate";
    ...
    public DepartmentPersonFormBean(){
        propertySupport = new PropertyChangeSupport( this );
    }
    
    public DepartmentPersonFormBean( DepartmentPersonFormBean copyBean ) {
        ...
        setFaculty( copyBean.getFaculty() );
        setFirstName( copyBean.getFirstName() );
        setFullName( copyBean.getFullName() );
        setGender( copyBean.getGender() );
        setGraduateStudentStaff( copyBean.getGraduateStudentStaff() );
        setHandicap( copyBean.getHandicap() );
        setHandiCapType( copyBean.getHandiCapType() );
        setHasVisa( copyBean.getHasVisa() );
        ...
        setVeteran( copyBean.getVeteran() );
        ...
        //COEUSQA-1674 - Allow Division Lead Unit to be modified in the person details - Start        
        setDivision( copyBean.getDivision() );
        //COEUSQA-1674 - Allow Division Lead Unit to be modified in the person details - End
    }
    ...
    public boolean getGraduateStudentStaff() {
    ...
    //Added for Coeus 4.3 PT ID - 2388:Person Enhancements - start
    //Added the getter and setter methods for the status field
    /**
    ...
    /**
     * Getter for property salaryAnniversaryDate.
     * @return Value of property salaryAnniversaryDate.
     */
    ...
    /**
     * Setter for property salaryAnniversaryDate.
     * @param salaryAnniversaryDate New value of property salaryAnniversaryDate.
     */
    public void setSalaryAnniversaryDate(Date salaryAnniversaryDate) {
        Date oldSalaryAnniversaryDate = this.salaryAnniversaryDate;
        this.salaryAnniversaryDate = salaryAnniversaryDate;
        propertySupport.firePropertyChange(
                SALARY_ANNIVERSARY_DATE, oldSalaryAnniversaryDate, salaryAnniversaryDate);
    }
    ...
    public void setDivision(java.lang.String newDivision) {
        ...
        propertySupport.firePropertyChange(DIVISION,oldDivision, division);
    }
    //COEUSQA-1674 - Allow Division Lead Unit to be modified in the person details - End
}
