 ...
 * RateTypeBean.java
 *
 * Created on August 17, 2004, 1:14 PM
 */
...
//     }
    ...
    public boolean equals(Object obj) {
        RateTypeBean rateTypeBean = (RateTypeBean)obj;        
        if((rateTypeBean.getRateTypeCode() == getRateTypeCode()) && 
            (rateTypeBean.getRateClassCode() == getRateClassCode())) {
            return true;       
        }else {
            return false;
        }
