/**
 * BudgetYear10DataTypeStream_V1_4.java
 */
...
import edu.vanderbilt.coeus.s2s.generator.stream.KeyPersonStreamForBud10_V1_4;
import edu.vanderbilt.coeus.s2s.generator.stream.OtherPersonnelStreamforBud10_V1_4;
...
public class BudgetYear10DataTypeStream_V1_4 extends AttachmentValidator {
    ...
    private void setOtherPersonnel(BudgetPeriodDataBean periodBean) throws CoeusException, JAXBException, DBException {
        ...
        OtherPersonnelStreamforBud10_V1_4 otherPersonnelStream = new OtherPersonnelStreamforBud10_V1_4();
    ...
    private void setKeyPersons(BudgetPeriodDataBean periodBean) throws JAXBException, CoeusException, DBException {
        ...
        KeyPersonStreamForBud10_V1_4 keyPersonStream = new KeyPersonStreamForBud10_V1_4();
    ...
    private AttachedFileDataType getKeyPersonAttachment(BudgetYearDataType.KeyPersonsType keyPersonType, BudgetPeriodDataBean periodBean) throws JAXBException, CoeusException, DBException {
        ...
        if (keyPersonsAttachment.getContent() != null) {
            ...
            try {
                ...
                ex.printStackTrace();
                UtilFactory.log((String)ex.getMessage(), (Throwable)ex, (String)"BudgetYear10DataTypeStream_V1_4", (String)"getKeyPersonAttachment");
                throw new JAXBException(ex);
            }
    ...
    private AttachedFileDataType getEquipmentAttachment(BudgetYearDataType.EquipmentType equipType, BudgetPeriodDataBean periodBean) throws JAXBException, CoeusException, DBException {
        ...
        if (equipAttachment.getContent() != null) {
            ...
            try {
                ...
                ex.printStackTrace();
                UtilFactory.log((String)ex.getMessage(), (Throwable)ex, (String)"BudgetYear10DataTypeStream_V1_4", (String)"getEquipmentAttachment");
                throw new JAXBException(ex);
            }
    ...
    private AttachedFileDataType getAttachedFileType(Attachment attachment) throws JAXBException {
        ...
        try {
            ...
            ex.printStackTrace();
            UtilFactory.log((String)ex.getMessage(), (Throwable)ex, (String)"RROtherProjectInfoStream", (String)"getAttachedFile");
            throw new JAXBException(ex);
        }
