...
import edu.mit.coeus.s2s.generator.SubAwardStream_V1_2;
...
import gov.grants.apply.forms.rr_subawardbudget30_1_4_v1.ObjectFactory;
import gov.grants.apply.forms.rr_subawardbudget30_1_4_v1.RRSubawardBudget3014;
import gov.grants.apply.forms.rr_subawardbudget30_1_4_v1.RRSubawardBudget3014Type;
...
public class RR_SubAwardBudgetStream_30_V1_4 extends SubAwardStream {
    ...
    protected Object getRRSubawardBudget() throws CoeusException, DBException {
        try {
            RRSubawardBudget3014 subAwd = this.subObjFactory.createRRSubawardBudget3014();
            RRSubawardBudget3014Type.BudgetAttachmentsType att = this.subObjFactory.createRRSubawardBudget3014TypeBudgetAttachmentsType();
            ...
            UtilFactory.log((String)jxbEx.getMessage(), (Throwable)jxbEx, (String)"RR_SubAwardBudgetStream_30_V1_4", (String)"getRRSubawardBudget");
    ...
    protected javax.xml.bind.Element prepareSubAwardObj(BudgetSubAwardBean subAwdBean) throws CoeusException, JAXBException, DBException {
        ...
        if (subAwdNodeList.getLength() == 0) {
            try {
                ...
                UtilFactory.log((String)"Just a warning : can be ignored", (Throwable)ex, (String)"RR_SubAwardBudgetStream_30_V1_4", (String)"prepapreSubAwardObj");
        ...
        try {
            ...
            UtilFactory.log((String)ex.getMessage(), (Throwable)ex, (String)"RR_SubAwardBudgetStream_30_V1_4", (String)"prepareSubAwardObj");
    ...
    public static void main(String[] args) throws Exception {
        JAXBContext jaxbContext = JAXBContext.newInstance("gov.grants.apply.forms.rr_subawardbudget_30_v1_4");
