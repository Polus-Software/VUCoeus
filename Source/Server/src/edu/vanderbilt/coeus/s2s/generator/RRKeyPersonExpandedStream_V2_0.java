/*
 * RRKeyPersonExpandedStream_V2_0.java
 *
 */
...
import gov.grants.apply.forms.rr_keypersonexpanded_2_0_v2.*;
...
import org.w3c.dom.Document;
 ...
 public class RRKeyPersonExpandedStream_V2_0 extends S2SBaseStream {

    private gov.grants.apply.forms.rr_keypersonexpanded_2_0_v2.ObjectFactory objFactory;
    ...
    public RRKeyPersonExpandedStream_V2_0(){
      
        objFactory = new gov.grants.apply.forms.rr_keypersonexpanded_2_0_v2.ObjectFactory();
    ...
    private RRKeyPersonExpanded20Type getRRKeyPerson() throws CoeusXMLException,
                                                CoeusException,DBException{

        RRKeyPersonExpanded20Type rrKeyPerson = null;
        ...
        try {
           ...
           rrKeyPerson = objFactory.createRRKeyPersonExpanded20();
           ...
           //For case of more than 100 key persons.  Attach one pdf with all
           ...
           if(otherBioSketchs != null){
               gov.grants.apply.forms.rr_keypersonexpanded_2_0_v2.RRKeyPersonExpanded20Type.BioSketchsAttachedType
                            otherBioSketchsAttached =
                            objFactory.createRRKeyPersonExpanded20TypeBioSketchsAttachedType();
           ...
           if(otherCurrentPending != null){
               gov.grants.apply.forms.rr_keypersonexpanded_2_0_v2.RRKeyPersonExpanded20Type.SupportsAttachedType
                            otherSupportsAttached =
                            objFactory.createRRKeyPersonExpanded20TypeSupportsAttachedType();
               gov.grants.apply.system.attachments_v1.AttachedFileDataType
           ...
           if(additionalProfile != null){
               gov.grants.apply.forms.rr_keypersonexpanded_2_0_v2.RRKeyPersonExpanded20Type.AdditionalProfilesAttachedType
                    additionalProfilesAttached =
                    objFactory.createRRKeyPersonExpanded20TypeAdditionalProfilesAttachedType();
               gov.grants.apply.system.attachments_v1.AttachedFileDataType
           ...
           //Set form version
           rrKeyPerson.setFormVersion("2.0");

         }catch (JAXBException jaxbEx){
            UtilFactory.log(jaxbEx.getMessage(),jaxbEx,"RRKeyPersonExpandedStream_V2_0",
                                                            "getRRKeyPerson()");
    ...
    private void genAttForExKeyPersons() throws CoeusException{
        ...
        if (extraKeyPersons != null){
            ...
            try{
                ...
                UtilFactory.log(ex.getMessage(),ex, "RRKeyPersonExpandedStreamV2_0", "genExKeyPersonAttachment");
        ...
        if (extraKeyPersons != null){
           ...
           List extraPersonList = extraPersonProfileList.getExtraKeyPerson();
            ...
            for (int i=0; i<extraKeyPersons.size();i++){
                ...
                gov.grants.apply.forms.rr_keypersonexpanded_2_0_v2.PersonProfileDataType.ProfileType.OtherProjectRoleCategoryType otherRole;
           ...
           //marshell it to XML doc
            ...
            "gov.grants.apply.coeus.personprofile");
                ...
                UtilFactory.log(ex.getMessage(),ex, "RRKeyPersonStreamV20", "genExKeyPersonAttachment");
                throw new CoeusException(ex.getMessage());
                ...
                UtilFactory.log(ex.getMessage(),ex, "KeyPersonStreamV20", "genExKeyPersonAttachment");
                throw new CoeusException(ex.getMessage());
            }
    ...
    private void populatePIAndKeyPersons() throws CoeusException, DBException{
        ArrayList allKeyPersons = s2sTxnBean.getInvestAndKeyPersons(propNumber,100);
//      allKeyPersons contains two vectors- 1st vector is the first 100 key person
...
//        //end case 4337
        ...
        if(keyPersonBean.getNonMITPersonFlag()){
            RolodexMaintenanceDataTxnBean rolodexTxn = new RolodexMaintenanceDataTxnBean();
            RolodexDetailsBean rolodexDetails = rolodexTxn.getRolodexMaintenanceDetails(keyPersonBean.getPersonId());
            profile.setOrganizationName(rolodexDetails.getOrganization());
        }
        /* JM 5-16-2016 updated to get organization based on person unit rather than proposal unit */
        else {
        	OrganizationAddressFormBean personOrganizationFormBean = 
        			proposalPersonTxnBean.getOrganizationForUnit(proposalPersonForm.getHomeUnit());
            profile.setOrganizationName(personOrganizationFormBean.getOrganizationName());
        }
        /* JM END */
        ...
        boolean otherProjectRole = false; //Added for COEUSQA-4077  
...
//                  keyPersonBean.setRole("Co-Investigator");
            ...
            otherProjectRole = true;
            //profile.setProjectRole(keyPersonBean.getRole());//Added for COEUSQA-4077
            profile.setProjectRole(OTHER);
        }
       
        if(otherProjectRole){//Added for COEUSQA-4077
