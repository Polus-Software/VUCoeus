...
import edu.vanderbilt.coeus.s2s.generator.BudgetYear10DataTypeStream_V1_4;
...
import gov.grants.apply.forms.rr_budget10_1_4_v1.RRBudget1014Type;
...
public class RR_Budget10Stream_V1_4 extends S2SBaseStream {
    ...
    private RRBudget1014Type getRRBudget() throws CoeusXMLException, CoeusException, DBException {
        RRBudget1014 rrBudget = null;
        try {
            ...
            rrBudget = this.objFactory.createRRBudget1014();
            ...
            RRBudget1014Type.BudgetSummaryType budgetSummaryType = this.objFactory.createRRBudget1014TypeBudgetSummaryType();
            ...
            UtilFactory.log((String)jaxbEx.getMessage(), (Throwable)jaxbEx, (String)"RRBudget10Stream_V1_4", (String)"getRRBudget()");
    ...
    private AttachedFileDataType getBudgetJustification() throws JAXBException, CoeusException, DBException {
        ...
        if (budgJustAttachment.getContent() != null) {
            ...
            try {
                ...
                ex.printStackTrace();
                UtilFactory.log((String)ex.getMessage(), (Throwable)ex, (String)"RRBudget10Stream_V1_4", (String)"getBudgetJustification");
    ...
    private BudgetYearDataType getBudgetYear(CoeusVector cvPeriod) throws JAXBException, CoeusException, DBException {
        ...
        BudgetYear10DataTypeStream_V1_4 budgetYearDataStream = new BudgetYear10DataTypeStream_V1_4();
        this.attachmentMap = this.getAttachmentMap();
    ...
    private BudgetYearDataType getBudgetYear(int period, CoeusVector cvPeriod) throws JAXBException, CoeusException, DBException {
        ...
        BudgetYear10DataTypeStream_V1_4 budgetYear10DataStream = new BudgetYear10DataTypeStream_V1_4();
        budgetYear10DataStream.setAttachmentMap(this.attachmentMap);
        BudgetYearDataType budgetYearDataType = this.objFactory.createBudgetYearDataType();
        budgetYearDataType = budgetYear10DataStream.getBudgetYear(periodBean, this.attachmentMap);
        this.extraAttachments.addAll(budgetYear10DataStream.getExtraAttachments());
        return budgetYearDataType;
    }
