/**
 * RR_SubAwardBudget10_10Stream_V1_4.java
 */
...
import gov.grants.apply.forms.rr_subawardbudget10_10_1_4_v1.ObjectFactory;
import gov.grants.apply.forms.rr_subawardbudget10_10_1_4_v1.RRSubawardBudget101014;
import gov.grants.apply.forms.rr_subawardbudget10_10_1_4_v1.RRSubawardBudget101014Type;
...
public class RR_SubawardBudget10_10Stream_V1_4 extends SubAwardStream {
    ...
    protected Object getRRSubawardBudget() throws CoeusException, DBException {
        try {
            RRSubawardBudget101014 subAwd = this.subObjFactory.createRRSubawardBudget101014();
            RRSubawardBudget101014Type.BudgetAttachmentsType att = this.subObjFactory.createRRSubawardBudget101014TypeBudgetAttachmentsType();
            ...
            UtilFactory.log((String)jxbEx.getMessage(), (Throwable)jxbEx, (String)"RR_SubawardBudget10_10Stream_V1_4", (String)"getRRSubawardBudget");
    ...
    protected javax.xml.bind.Element prepareSubAwardObj(BudgetSubAwardBean subAwdBean) throws CoeusException, JAXBException, DBException {
        ...
        if (subAwdNodeList.getLength() == 0) {
            try {
                ...
                UtilFactory.log((String)"Just a warning : can be ignored", (Throwable)ex, (String)"RR_SubawardBudget10_10Stream_V1_4", (String)"prepapreSubAwardObj");
        ...
        try {
            ...
            UtilFactory.log((String)ex.getMessage(), (Throwable)ex, (String)"RR_SubawardBudget10_10Stream_V1_4", (String)"prepareSubAwardObj");
...
/*
    public static void main(String[] args) throws Exception {
        JAXBContext jaxbContext = JAXBContext.newInstance("gov.grants.apply.forms.rr_subawardbudget10_10_1_4_v1");
