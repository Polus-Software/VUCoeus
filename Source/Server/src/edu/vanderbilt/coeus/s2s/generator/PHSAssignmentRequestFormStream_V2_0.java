/*
 * PHSAssignmentRequestFormStream_V2_0.java
 *
...
import gov.grants.apply.forms.phs_assignmentrequestform_2_0_v2.*;
 ...
 * @author Jill McAfee
 */
public class PHSAssignmentRequestFormStream_V2_0 extends S2SBaseStream { 
    private gov.grants.apply.forms.phs_assignmentrequestform_2_0_v2.ObjectFactory objFactory;
    ...
    private final static String EXPERTISE_AREAS = "604";
     ...
     /** Creates a new instance of PHSAssignmentRequestFormStream_V2_0 */
    public PHSAssignmentRequestFormStream_V2_0(){
    	objFactory = new gov.grants.apply.forms.phs_assignmentrequestform_2_0_v2.ObjectFactory();
    ...
    private PHSAssignmentRequestForm20Type getPHSAssignmentRequestForm()
		   throws CoeusXMLException,CoeusException,DBException,JAXBException {
     
    	PHSAssignmentRequestForm20Type phsAssignmentRequestFormType = objFactory.createPHSAssignmentRequestForm20();
    	questionnaireData = getQuestionnaireAnswers();
    	
    	phsAssignmentRequestFormType.setFormVersion("2.0");
