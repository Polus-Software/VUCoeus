/**
 * RR_FedNonFedSubAwardBudgetStream_V1_3.java
 */
...
import gov.grants.apply.forms.rr_fednonfed_subawardbudget_1_3_v1.ObjectFactory;
import gov.grants.apply.forms.rr_fednonfed_subawardbudget_1_3_v1.RRFedNonFedSubawardBudget13;
import gov.grants.apply.forms.rr_fednonfed_subawardbudget_1_3_v1.RRFedNonFedSubawardBudget13Type;
...
public class RR_FedNonFedSubAwardBudgetStream_V1_3 extends SubAwardStream {
    ...
    protected Object getRRSubawardBudget() throws CoeusException, DBException {
        try {
        	RRFedNonFedSubawardBudget13 subAwd = this.subObjFactory.createRRFedNonFedSubawardBudget13();
        	RRFedNonFedSubawardBudget13Type.BudgetAttachmentsType att = this.subObjFactory.createRRFedNonFedSubawardBudget13TypeBudgetAttachmentsType();
            ...
            if (attList == null || attList.isEmpty()) {
                try {
                    S2SValidator.addCustError((String) params.get("PROPOSAL_NUMBER"), S2SErrorMessages.getProperty("RR_FedNonFedSubAwardBudgetStream_V1_3.min_attachment"));
                } catch (IOException ioEx) {
                    S2SValidator.addCustError((String) params.get("PROPOSAL_NUMBER"), "Could Not read Property 'RR_FedNonFedSubAwardBudgetStream_V1_3.min_attachment' in S2SErrorMessages.properties");
                }
            }
            return subAwd;
        }
        catch (JAXBException jxbEx) {
            UtilFactory.log((String)jxbEx.getMessage(), (Throwable)jxbEx, (String)"RR_FedNonFedSubAwardBudgetStream_V1_3", (String)"getRRSubawardBudget");
    ...
    protected javax.xml.bind.Element prepareSubAwardObj(BudgetSubAwardBean subAwdBean) throws CoeusException, JAXBException, DBException {
        ...
        if (subAwdNodeList.getLength() == 0) {
            try {
                ...
                UtilFactory.log((String)"Just a warning : can be ignored", (Throwable)ex, (String)"RR_FedNonFedSubAwardBudgetStream_V1_3", (String)"prepapreSubAwardObj");
        ...
        try {
            ...
            UtilFactory.log((String)ex.getMessage(), (Throwable)ex, (String)"RR_FedNonFedSubAwardBudgetStream_V1_3", (String)"prepareSubAwardObj");
