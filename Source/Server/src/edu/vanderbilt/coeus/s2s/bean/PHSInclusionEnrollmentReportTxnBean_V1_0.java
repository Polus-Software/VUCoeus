...
public class PHSInclusionEnrollmentReportTxnBean_V1_0 {
    ...
    /* Creates a new instance of PHSInclusionEnrollmentReportTxnBean_V1_0 */
    public PHSInclusionEnrollmentReportTxnBean_V1_0() {
    	...
    	throws CoeusException, DBException {
         ...
         if (dbEngine != null){
             result = dbEngine.executeRequest("Coeus",
                     "call S2S_FORMSET_D.getInclusionEnrollmentRepV1_0( <<PROPOSAL_NUMBER>> , "+
