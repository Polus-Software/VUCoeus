...
public class CumulativeInclusionReportTxnBean {
    ...
    /* Creates a new instance of CumulativeInclusionReportTxnBean */
    public CumulativeInclusionReportTxnBean() {
    	...
    	throws CoeusException, DBException {
         ...
         if (dbEngine != null){
             result = dbEngine.executeRequest("Coeus",
                     "call VU_CUMULATIVE_INCL_REPORT( <<PROPOSAL_NUMBER>> , "+
