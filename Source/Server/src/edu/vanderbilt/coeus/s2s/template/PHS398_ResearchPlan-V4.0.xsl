...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
                              xmlns:PHS398_ResearchPlan_4_0="http://apply.grants.gov/forms/PHS398_ResearchPlan_4_0-V4.0" 
                            ...
                            <fo:table font-size="9px" table-layout="fixed" 
	                            ...
	                            <fo:table-body start-indent="0pt">
	                               ...
	                               <fo:table-row>
										...
										<fo:table-cell font-size="9pt" padding="7" display-align="before">
	                                       	<fo:block>
	                                            <xsl:for-each select="//PHS398_ResearchPlan_4_0:PHS398_ResearchPlan_4_0">
	                                                <xsl:for-each select="PHS398_ResearchPlan_4_0:ResearchPlanAttachments">
	                                                    <xsl:for-each select="PHS398_ResearchPlan_4_0:IntroductionToApplication">
	                                                        <xsl:for-each select="PHS398_ResearchPlan_4_0:attFile">
	                                ...
	                                <fo:table-row>
										...
										<fo:table-cell font-size="9pt" padding="7" display-align="before">
											<fo:block>
	                                            <xsl:for-each select="//PHS398_ResearchPlan_4_0:PHS398_ResearchPlan_4_0">
	                                                <xsl:for-each select="PHS398_ResearchPlan_4_0:ResearchPlanAttachments">
	                                                    <xsl:for-each select="PHS398_ResearchPlan_4_0:SpecificAims">
	                                                        <xsl:for-each select="PHS398_ResearchPlan_4_0:attFile">
	                                                            <xsl:for-each select="att:FileName">
	                                                                <xsl:variable name="value-of-template">
	                                                                    <xsl:apply-templates/>
                                    ...
                                    <fo:table-row>
										...
										<fo:table-cell font-size="9pt" padding="7" display-align="before">
	                                         <fo:block>
	                                             <xsl:for-each select="//PHS398_ResearchPlan_4_0:PHS398_ResearchPlan_4_0">
	                                                 <xsl:for-each select="PHS398_ResearchPlan_4_0:ResearchPlanAttachments">
	                                                     <xsl:for-each select="PHS398_ResearchPlan_4_0:ResearchStrategy">
	                                                         <xsl:for-each select="PHS398_ResearchPlan_4_0:attFile">
	                                                             <xsl:for-each select="att:FileName">
	                                                                 <xsl:variable name="value-of-template">
	                                                                     <xsl:apply-templates/>
                                     ...
                                     <fo:table-row>
										...
										<fo:table-cell font-size="9pt" padding="7" display-align="before">
                                        	<fo:block>
	                                            <xsl:for-each select="//PHS398_ResearchPlan_4_0:PHS398_ResearchPlan_4_0">
	                                                <xsl:for-each select="PHS398_ResearchPlan_4_0:ResearchPlanAttachments">
	                                                    <xsl:for-each select="PHS398_ResearchPlan_4_0:ProgressReportPublicationList">
	                                                        <xsl:for-each select="PHS398_ResearchPlan_4_0:attFile">
	                                                            <xsl:for-each select="att:FileName">
	                                                                <xsl:variable name="value-of-template">
	                                                                    <xsl:apply-templates/>
	                                 ...
	                                 <fo:table-row>
                                        ...
                                        <fo:table-cell font-size="9pt" padding="7" display-align="before">
                                        	<fo:block>
	                                            <xsl:for-each select="//PHS398_ResearchPlan_4_0:PHS398_ResearchPlan_4_0">
	                                                <xsl:for-each select="PHS398_ResearchPlan_4_0:ResearchPlanAttachments">
	                                                        <xsl:for-each select="PHS398_ResearchPlan_4_0:VertebrateAnimals">
	                                                            <xsl:for-each select="PHS398_ResearchPlan_4_0:attFile">
	                                                                <xsl:for-each select="att:FileName">
	                                                                    <xsl:variable name="value-of-template">
	                                                                        <xsl:apply-templates/>
	                                ...
	                                <fo:table-row>
                                        ...
                                        <fo:table-cell font-size="9pt" padding="7" display-align="before">
                                        	<fo:block>
	                                            <xsl:for-each select="//PHS398_ResearchPlan_4_0:PHS398_ResearchPlan_4_0">
	                                                <xsl:for-each select="PHS398_ResearchPlan_4_0:ResearchPlanAttachments">
	                                                        <xsl:for-each select="PHS398_ResearchPlan_4_0:SelectAgentResearch">
	                                                            <xsl:for-each select="PHS398_ResearchPlan_4_0:attFile">
	                                                                <xsl:for-each select="att:FileName">
	                                                                    <xsl:variable name="value-of-template">
	                                                                        <xsl:apply-templates/>
	                               ...
	                               <fo:table-row>
                                        ...
                                        <fo:table-cell font-size="9pt" padding="7" display-align="before">
                                        	<fo:block>
	                                            <xsl:for-each select="//PHS398_ResearchPlan_4_0:PHS398_ResearchPlan_4_0">
	                                                <xsl:for-each select="PHS398_ResearchPlan_4_0:ResearchPlanAttachments">
	                                                        <xsl:for-each select="PHS398_ResearchPlan_4_0:MultiplePDPILeadershipPlan">
	                                                            <xsl:for-each select="PHS398_ResearchPlan_4_0:attFile">
	                                                                <xsl:for-each select="att:FileName">
	                                                                    <xsl:variable name="value-of-template">
	                                                                        <xsl:apply-templates/>
	                                ...
	                                <fo:table-row>
                                        ...
                                        <fo:table-cell font-size="9pt" padding="7" display-align="before">
                                       		<fo:block>
	                                            <xsl:for-each select="//PHS398_ResearchPlan_4_0:PHS398_ResearchPlan_4_0">
	                                                <xsl:for-each select="PHS398_ResearchPlan_4_0:ResearchPlanAttachments">
	                                                        <xsl:for-each select="PHS398_ResearchPlan_4_0:ConsortiumContractualArrangements">
	                                                            <xsl:for-each select="PHS398_ResearchPlan_4_0:attFile">
	                                                                <xsl:for-each select="att:FileName">
	                                                                    <xsl:variable name="value-of-template">
	                                                                        <xsl:apply-templates/>
                                     ...
                                     <fo:table-row>
                                        ...
                                        <fo:table-cell font-size="9pt" padding="7" display-align="before">
                                        	<fo:block>
	                                            <xsl:for-each select="//PHS398_ResearchPlan_4_0:PHS398_ResearchPlan_4_0">
	                                                <xsl:for-each select="PHS398_ResearchPlan_4_0:ResearchPlanAttachments">
	                                                        <xsl:for-each select="PHS398_ResearchPlan_4_0:LettersOfSupport">
	                                                            <xsl:for-each select="PHS398_ResearchPlan_4_0:attFile">
	                                                                <xsl:for-each select="att:FileName">
	                                                                    <xsl:variable name="value-of-template">
	                                                                        <xsl:apply-templates/>
	                              	...
	                              	<fo:table-row>
                                        ...
                                        <fo:table-cell font-size="9pt" padding="7" display-align="before">
                                        	<fo:block>
	                                            <xsl:for-each select="//PHS398_ResearchPlan_4_0:PHS398_ResearchPlan_4_0">
	                                                <xsl:for-each select="PHS398_ResearchPlan_4_0:ResearchPlanAttachments">
	                                                        <xsl:for-each select="PHS398_ResearchPlan_4_0:ResourceSharingPlans">
	                                                            <xsl:for-each select="PHS398_ResearchPlan_4_0:attFile">
	                                                                <xsl:for-each select="att:FileName">
	                                                                    <xsl:variable name="value-of-template">
	                                                                        <xsl:apply-templates/>
									...
									<fo:table-row>
                                		...
                                		<fo:table-cell font-size="9pt" padding="7" display-align="before">
											<fo:block>
											    <xsl:for-each select="//PHS398_ResearchPlan_4_0:PHS398_ResearchPlan_4_0">
													<xsl:for-each select="PHS398_ResearchPlan_4_0:ResearchPlanAttachments">
														<xsl:for-each select="PHS398_ResearchPlan_4_0:KeyBiologicalAndOrChemicalResources">
														    <xsl:for-each select="PHS398_ResearchPlan_4_0:attFile">
																<xsl:for-each select="att:FileName">
																    <xsl:variable name="value-of-template">
																	<xsl:apply-templates/>
                                    ...
                                    <fo:table-row>
                                        ...
                                        <fo:table-cell font-size="9pt" padding="7" display-align="before">
                                        	<fo:block>
	                                            <xsl:if test="//PHS398_ResearchPlan_4_0:PHS398_ResearchPlan_4_0/PHS398_ResearchPlan_4_0:ResearchPlanAttachments/PHS398_ResearchPlan_4_0:Appendix/att:AttachedFile">
	                                                <fo:table table-layout="fixed" width="100%" border-spacing="2pt">
	                                                    <fo:table-column column-width="proportional-column-width(1)"/>
	                                                    <fo:table-body start-indent="0pt">
	                                                        <xsl:for-each select="//PHS398_ResearchPlan_4_0:PHS398_ResearchPlan_4_0">
	                                                            <xsl:for-each select="PHS398_ResearchPlan_4_0:ResearchPlanAttachments">
	                                                                <xsl:for-each select="PHS398_ResearchPlan_4_0:Appendix">
