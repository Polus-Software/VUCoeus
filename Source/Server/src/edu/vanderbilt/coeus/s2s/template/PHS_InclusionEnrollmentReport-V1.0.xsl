						...
						<fo:table width="100%" space-before.optimum="3pt"
							...
							<fo:table-body>
								<fo:table-row>
									...
									<fo:table-cell number-columns-spanned="4" text-align="center" padding-start="2pt" 
									...
									<fo:table-cell hyphenate="true" language="en" 										line-height="0px"
										display-align="center" text-align="right" border="none">
								...
								<fo:table-row>
									...
									<fo:table-cell hyphenate="true" language="en"
										line-height="0px" padding-start="0pt" padding-end="0pt"
										display-align="center" text-align="right" border="none">
										<fo:block font-size="8pt">
			...
			<fo:table font-size="12pt" width="100%"
				...
				<fo:table-body>
					...
					<fo:table-row height="20px">
						<fo:table-cell hyphenate="true" language="en"
							line-height="11pt" number-columns-spanned="1" 
							display-align="center" text-align="start" border="none">
							<fo:block>
								<fo:inline font-size="9pt" font-weight="bold">*Study Title (must be unique):
								</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell hyphenate="true" language="en"
							line-height="11pt" number-columns-spanned="12" 
							display-align="before" text-align="start" border-style="solid"
							border-width="1pt" border-color="black" padding="2">
							<fo:block>
					...
					<fo:table-row height="16px">
						<fo:table-cell hyphenate="true" language="en"
							...
							display-align="center" text-align="start" border="none">
							<fo:block>
								<fo:inline font-size="9pt" font-weight="bold">*Delayed Onset Study?
								</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell hyphenate="true" language="en"
							...
							<fo:block>
								...
								<fo:block-container background-color="transparent"
									...
									<fo:block background-color="transparent" color="#000000"
										...
										font-weight="normal" padding-top="2">
										<xsl:choose>
								...
								<!-- end -->
								<fo:block-container background-color="transparent"
									border-style="none" position="absolute" left="70px"
									hyphenate="true" language="en" keep-together="always">
									<fo:block>
										<fo:inline font-size="9pt">
					...
					<fo:table-row height="16px">
						...
						<fo:table-cell hyphenate="true" language="en"
							...
							display-align="center" text-align="start" border="none">
							<fo:block>
								<fo:inline font-size="9pt" font-weight="bold">Enrollment Type
								</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell hyphenate="true" language="en"
							...
							<fo:block>
								...
								<!-- end -->
								<fo:block-container background-color="transparent"
										border-style="none" position="absolute" left="80px"
										hyphenate="true" language="en" keep-together="always">
										<fo:block>
									<fo:inline font-size="9pt">
					...
					<fo:table-row height="16px">
						...
						<fo:table-cell hyphenate="true" language="en"
							...
							display-align="center" text-align="start" border="none">
							<fo:block>
								<fo:inline font-size="9pt" font-weight="bold">Using an Existing Dataset or Resource
								</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell hyphenate="true" language="en"
					...
					<fo:table-row height="16px">
						...
						<fo:table-cell hyphenate="true" language="en"
							...
							display-align="center" text-align="start" border="none">
							<fo:block>
								<fo:inline font-size="9pt" font-weight="bold">Enrollment Location
								</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell hyphenate="true" language="en"
					...
					<fo:table-row height="16px">
						...
						<fo:table-cell hyphenate="true" language="en"
							...
							display-align="center" text-align="start" border="none">
							<fo:block>
								<fo:inline font-size="9pt" font-weight="bold">Clinical Trial
								</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell hyphenate="true" language="en"
						...
						<fo:table-cell hyphenate="true" language="en"
							number-columns-spanned="3" padding-left="16px"
							display-align="center" text-align="start" border="none">
							<fo:block>
								<fo:inline font-size="9pt" font-weight="bold">NIH-Defined Phase III Clinical Trial
								</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell hyphenate="true" language="en"
					...
					<fo:table-row height="40px">
						<fo:table-cell hyphenate="true" language="en"
							line-height="11pt" number-columns-spanned="1" padding-start="2pt"
							padding-end="2pt" padding-before="1pt" padding-after="1pt"
							display-align="before" text-align="start" border="none">
							<fo:block>
								<fo:inline font-size="9pt" font-weight="bold">Comments:
								</fo:inline>
							</fo:block>
						</fo:table-cell>
						<fo:table-cell hyphenate="true" language="en"
							line-height="11pt" number-columns-spanned="12" padding-start="2pt"
							padding-end="2pt" padding-before="1pt" padding-after="1pt"
							display-align="before" text-align="start" border-style="solid"
							border-width="1pt" border-color="black">
							<fo:block>
					...
					<fo:table-row height="20px">
						...
						<!-- ============================ -->
						<fo:table-cell hyphenate="true" language="en"
							line-height="9pt" number-columns-spanned="3" 
							number-rows-spanned="3" padding="2px"
							display-align="center" text-align="center"
							border-style="solid" border-width="1pt" border-color="black">
							<fo:block font-size="9pt" font-weight="bold">Racial Categories
							</fo:block>
						</fo:table-cell>
						...
						<fo:table-cell hyphenate="true" language="en"
							...
							border-bottom-style="solid" border-bottom-width="1pt" border-bottom-color="black">
                           	<fo:block font-size="9pt" font-weight="bold">Ethnic	Categories</fo:block>
						</fo:table-cell>
					</fo:table-row>
					<!-- ================= -->
					<!-- Ethnicity Headers -->
					<!-- ================= -->
					<fo:table-row>
						<fo:table-cell number-columns-spanned="3" text-align="center" display-align="center"
                            border-right-style="solid" border-right-width="1pt" border-right-color="black"
							border-bottom-style="solid" border-bottom-width="1pt" border-bottom-color="black">
							<fo:block font-size="9pt" font-weight="bold">Not Hispanic or Latino</fo:block>
						</fo:table-cell>
						<fo:table-cell number-columns-spanned="3" text-align="center" display-align="center"
                            border-right-style="solid" border-right-width="1pt" border-right-color="black"
							border-bottom-style="solid" border-bottom-width="1pt" border-bottom-color="black">
							<fo:block font-size="9pt" font-weight="bold">Hispanic or Latino</fo:block>
						</fo:table-cell>
						<fo:table-cell number-columns-spanned="3" text-align="center" display-align="center"
                            border-right-style="solid" border-right-width="1pt" border-right-color="black"
							border-bottom-style="solid" border-bottom-width="1pt" border-bottom-color="black">
							<fo:block font-size="9pt" font-weight="bold">Unknown/Not Reported Ethnicity</fo:block>
						</fo:table-cell>
						<fo:table-cell text-align="center" display-align="center"
                            border-right-style="solid" border-right-width="1pt" border-right-color="black"
							border-bottom-style="solid" border-bottom-width="1pt" border-bottom-color="black">
							<fo:block font-size="9pt" font-weight="bold">Total</fo:block>
						</fo:table-cell>
					</fo:table-row>
					...
					<fo:table-row>
						...
						<fo:table-cell hyphenate="true" language="en"
                            ...
                            border-right-style="solid" border-right-width="1pt" border-right-color="black"
							border-bottom-style="solid" border-bottom-width="1pt" border-bottom-color="black">
							<fo:block font-size="9pt" font-weight="bold">Female</fo:block>
						</fo:table-cell>
						<fo:table-cell hyphenate="true" language="en"
							padding-start="0pt" padding-end="0pt" padding-before="1pt"
							padding-after="0pt" display-align="center" text-align="center"
                            border-right-style="solid" border-right-width="1pt" border-right-color="black"
							border-bottom-style="solid" border-bottom-width="1pt" border-bottom-color="black">
							<fo:block font-size="9pt" font-weight="bold">Male</fo:block>
						</fo:table-cell>
						<fo:table-cell hyphenate="true" language="en"
							padding-start="0pt" padding-end="0pt" padding-before="1pt"
							padding-after="0pt" display-align="center" text-align="center"
                            border-right-style="solid" border-right-width="1pt" border-right-color="black"
							border-bottom-style="solid" border-bottom-width="1pt" border-bottom-color="black">
							<fo:block font-size="9pt" font-weight="bold">Unknown/Not Reported</fo:block>
						</fo:table-cell>
						<!-- Hispanic or Latino -->
						<fo:table-cell hyphenate="true" language="en"
							padding-start="0pt" padding-end="0pt" padding-before="1pt"
						...
						<!-- Total -->
						<fo:table-cell hyphenate="true" language="en" background-color="#EEEEEE"
							padding-start="0pt" padding-end="0pt" padding-before="1pt"
							padding-after="0pt" display-align="center" text-align="center"
                            border-right-style="solid" border-right-width="1pt" border-right-color="black"
							border-bottom-style="solid" border-bottom-width="1pt" border-bottom-color="black">
					...
					<fo:table-row height="20px">
						...
						<!-- ===================================== -->
						<fo:table-cell hyphenate="true" language="en"
							line-height="9pt" number-columns-spanned="3" padding-start="0pt"
							...
							border-bottom-style="solid" border-bottom-width="1pt" border-bottom-color="black">
							<fo:block>
								<fo:inline font-size="8pt">American Indian/Alaska Native</fo:inline>
							</fo:block>
						</fo:table-cell>
						<!-- ============================= -->
					...
					<fo:table-row height="20px">
						...
						<fo:table-cell hyphenate="true" language="en"
							...
							background-color="#EEEEEE">
							<fo:block>
								<fo:inline font-size="9pt" font-weight="bold">Total
								</fo:inline>
							</fo:block>
						</fo:table-cell>
						<!-- ============================= -->
