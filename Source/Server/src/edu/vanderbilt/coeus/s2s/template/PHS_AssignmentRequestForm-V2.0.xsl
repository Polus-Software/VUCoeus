						...
						<fo:table-body>
							...
							<fo:table-row>
								...
								<fo:table-cell number-columns-spanned="4" keep-together="always"
									border-width="1px" border-style="solid" border-color="black"
									padding="4px" number-rows-spanned="2">
									<fo:block font-size="9pt" font-weight="normal">
										<xsl:choose>
											<xsl:when
							...
							<fo:table-row>
								<fo:table-cell number-columns-spanned="5">
									<fo:block font-size="9pt" font-weight="normal">
										If you have a preference for an awarding component (e.g., NIH Institute/Center) assignment, use the link 
										below to identify the appropriate short abbreviation and enter it below.  All
										<fo:block> </fo:block>
							...
							<fo:table-row>
								<fo:table-cell number-columns-spanned="5">
									<fo:block font-size="9pt" font-weight="normal">
										If you have a preference for study section assignment, use the link below to identify the appropriate study 
										section (e.g., NIH Scientific Review Group or Special Emphasis Panel) and
										<fo:block> </fo:block>
										enter it below. Remove all hyphens, parentheses, and spaces. All requests will be considered; however, 
										assignment requests cannot always be honored.
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
