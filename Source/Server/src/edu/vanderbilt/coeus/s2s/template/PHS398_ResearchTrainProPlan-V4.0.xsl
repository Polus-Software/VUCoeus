...
<xsl:stylesheet version="1.0"
	...
	xmlns:PHS398_ResearchTrainingProgramPlan_4_0="http://apply.grants.gov/forms/PHS398_ResearchTrainingProgramPlan_4_0-V4.0"
	                            ...
	                            <fo:table-body start-indent="0pt">
									...
									<fo:table-row>
										...
										<fo:table-cell font-size="9pt" padding="7" display-align="before">
											<fo:block>
												<xsl:for-each
													select="//PHS398_ResearchTrainingProgramPlan_4_0:PHS398_ResearchTrainingProgramPlan_4_0">
													<xsl:for-each
														select="PHS398_ResearchTrainingProgramPlan_4_0:ResearchTrainingProgramPlanAttachments">
														<xsl:for-each
															select="PHS398_ResearchTrainingProgramPlan_4_0:IntroductionToApplication">
															<xsl:for-each
																select="PHS398_ResearchTrainingProgramPlan_4_0:attFile">
											...
											<fo:block>
												<xsl:for-each
													...
													<xsl:for-each
														select="PHS398_ResearchTrainingProgramPlan_4_0:ResearchTrainingProgramPlanAttachments">
														<xsl:for-each
															select="PHS398_ResearchTrainingProgramPlan_4_0:ProgramPlan">
															<xsl:for-each
																select="PHS398_ResearchTrainingProgramPlan_4_0:attFile">
																<xsl:for-each select="att:FileName">
																	<xsl:variable name="value-of-template">
											...
											<fo:block>
												<xsl:for-each
													...
													<xsl:for-each
														select="PHS398_ResearchTrainingProgramPlan_4_0:ResearchTrainingProgramPlanAttachments">
														<xsl:for-each
															select="PHS398_ResearchTrainingProgramPlan_4_0:ResponsibleConductOfResearch">
															<xsl:for-each
																select="PHS398_ResearchTrainingProgramPlan_4_0:attFile">
																<xsl:for-each select="att:FileName">
																	<xsl:variable name="value-of-template">
											...
											<fo:block>
												<xsl:for-each
													...
													<xsl:for-each
														select="PHS398_ResearchTrainingProgramPlan_4_0:ResearchTrainingProgramPlanAttachments">
														<xsl:for-each
															select="PHS398_ResearchTrainingProgramPlan_4_0:MethodsForEnhancingReproducibility">
															<xsl:for-each
																select="PHS398_ResearchTrainingProgramPlan_4_0:attFile">
																<xsl:for-each select="att:FileName">
																	<xsl:variable name="value-of-template">
											...
											<fo:block>
												<xsl:for-each
													...
													<xsl:for-each
														select="PHS398_ResearchTrainingProgramPlan_4_0:ResearchTrainingProgramPlanAttachments">
														<xsl:for-each
															select="PHS398_ResearchTrainingProgramPlan_4_0:MultiplePDPILeadershipPlan">
															<xsl:for-each
																select="PHS398_ResearchTrainingProgramPlan_4_0:attFile">
																<xsl:for-each select="att:FileName">
																	<xsl:variable name="value-of-template">
											...
											<fo:block>
												<xsl:for-each
													...
													<xsl:for-each
														select="PHS398_ResearchTrainingProgramPlan_4_0:ResearchTrainingProgramPlanAttachments">
														<xsl:for-each
															select="PHS398_ResearchTrainingProgramPlan_4_0:ProgressReport">
															<xsl:for-each
																select="PHS398_ResearchTrainingProgramPlan_4_0:attFile">
																<xsl:for-each select="att:FileName">
																	<xsl:variable name="value-of-template">
											...
											<fo:block>
												<xsl:for-each
													...
													<xsl:for-each
														select="PHS398_ResearchTrainingProgramPlan_4_0:ResearchTrainingProgramPlanAttachments">
														<xsl:for-each
															select="PHS398_ResearchTrainingProgramPlan_4_0:ParticipatingFacultyBiosketches">
															<xsl:for-each
																select="PHS398_ResearchTrainingProgramPlan_4_0:attFile">
																<xsl:for-each select="att:FileName">
																	<xsl:variable name="value-of-template">
											...
											<fo:block>
												<xsl:for-each
													...
													<xsl:for-each
														select="PHS398_ResearchTrainingProgramPlan_4_0:ResearchTrainingProgramPlanAttachments">
														<xsl:for-each
															select="PHS398_ResearchTrainingProgramPlan_4_0:LettersOfSupport">
															<xsl:for-each
																select="PHS398_ResearchTrainingProgramPlan_4_0:attFile">
																<xsl:for-each select="att:FileName">
																	<xsl:variable name="value-of-template">
											...
											<fo:block>
												<xsl:for-each
													...
													<xsl:for-each
														select="PHS398_ResearchTrainingProgramPlan_4_0:ResearchTrainingProgramPlanAttachments">
														<xsl:for-each
															select="PHS398_ResearchTrainingProgramPlan_4_0:DataTables">
															<xsl:for-each
																select="PHS398_ResearchTrainingProgramPlan_4_0:attFile">
																<xsl:for-each select="att:FileName">
																	<xsl:variable name="value-of-template">
											...
											<fo:block>
												<xsl:for-each
													...
													<xsl:for-each
														select="PHS398_ResearchTrainingProgramPlan_4_0:ResearchTrainingProgramPlanAttachments">
														<xsl:for-each
															select="PHS398_ResearchTrainingProgramPlan_4_0:VertebrateAnimals">
															<xsl:for-each
																select="PHS398_ResearchTrainingProgramPlan_4_0:attFile">
																<xsl:for-each select="att:FileName">
																	<xsl:variable name="value-of-template">
											...
											<fo:block>
												<xsl:for-each
													...
													<xsl:for-each
														select="PHS398_ResearchTrainingProgramPlan_4_0:ResearchTrainingProgramPlanAttachments">
														<xsl:for-each
															select="PHS398_ResearchTrainingProgramPlan_4_0:SelectAgentResearch">
															<xsl:for-each
																select="PHS398_ResearchTrainingProgramPlan_4_0:attFile">
																<xsl:for-each select="att:FileName">
																	<xsl:variable name="value-of-template">
											...
											<fo:block>
												<xsl:for-each
													...
													<xsl:for-each
														select="PHS398_ResearchTrainingProgramPlan_4_0:ResearchTrainingProgramPlanAttachments">
														<xsl:for-each
															select="PHS398_ResearchTrainingProgramPlan_4_0:ConsortiumContractualArrangements">
															<xsl:for-each
																select="PHS398_ResearchTrainingProgramPlan_4_0:attFile">
																<xsl:for-each select="att:FileName">
																	<xsl:variable name="value-of-template">
									...
									<fo:table-row>
										...
										<fo:table-cell font-size="9pt" padding="7" display-align="before">
											<fo:block>
												<xsl:if test="//PHS398_ResearchTrainingProgramPlan_4_0:PHS398_ResearchTrainingProgramPlan_4_0/PHS398_ResearchTrainingProgramPlan_4_0:ResearchTrainingProgramPlanAttachments/PHS398_ResearchTrainingProgramPlan_4_0:Appendix/att:AttachedFile">
													<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
														<fo:table-column column-width="proportional-column-width(1)" />
														<fo:table-body start-indent="0pt">
															<xsl:for-each select="//PHS398_ResearchTrainingProgramPlan_4_0:PHS398_ResearchTrainingProgramPlan_4_0">
																<xsl:for-each select="PHS398_ResearchTrainingProgramPlan_4_0:ResearchTrainingProgramPlanAttachments">
																	<xsl:for-each select="PHS398_ResearchTrainingProgramPlan_4_0:Appendix">
