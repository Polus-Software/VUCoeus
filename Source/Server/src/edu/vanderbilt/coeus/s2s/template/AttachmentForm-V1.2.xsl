...
xmlns:AttachmentForm_1_2="http://apply.grants.gov/forms/AttachmentForm_1_2-V1.2" 
	...
	<fo:root>
		<xsl:variable name="fo:layout-master-set">
			<fo:layout-master-set>
				<fo:simple-page-master master-name="default-page" page-height="11in" page-width="8.5in" margin-left="0.6in" margin-right="0.65in">
					...
					<fo:table width="100%">	
						...
						<fo:table-body>				
							<fo:table-row>
								...
								<fo:table-cell width="6.8in">
									<fo:block text-align="center" font-family="Helvetica,Times,Courier" font-size="11pt" font-weight="bold">
							        	ATTACHMENTS FORM
							        </fo:block>
							        <fo:block>&#160;</fo:block>
							        <fo:block font-size="8pt" hyphenate="true" line-height="1.5">
							       		<fo:inline font-weight="bold" font-size="8pt">Instructions:</fo:inline>  On this form, you will attach the various files that make up your grant application.  Please consult with the appropriate
							       		Agency Guidelines for more information about each needed file.  Please remember that any files you attach must be in the document format and named as specified in the Guidelines.
									</fo:block>
									<fo:block line-height="10pt">&#160;</fo:block>
									<fo:block font-size="8pt" hyphenate="true" line-height="1.5">
										<fo:inline font-weight="bold" font-size="8pt">Important:</fo:inline>  Please attach your files in the proper sequence.  See the appropriate Agency Guidelines for details.
									</fo:block>
							        <fo:block>&#160;</fo:block>
								</fo:table-cell>
								<fo:table-cell width="0.2in">
					...
					<fo:table width="100%">
						...
						<fo:table-body>
							<xsl:call-template name="attach_block">
								...
								<xsl:with-param name="block_title">1) Attachment 1</xsl:with-param>
							...
							<xsl:call-template name="attach_block">
								<xsl:with-param name="block_num"></xsl:with-param>
								<xsl:with-param name="block_title">2) Attachment 2</xsl:with-param>
								<xsl:with-param name="filename">
							...
							<xsl:call-template name="attach_block">
								<xsl:with-param name="block_num"></xsl:with-param>
								<xsl:with-param name="block_title">3) Attachment 3</xsl:with-param>
								<xsl:with-param name="filename">
							...
							<xsl:call-template name="attach_block">
								<xsl:with-param name="block_num"></xsl:with-param>
								<xsl:with-param name="block_title">4) Attachment 4</xsl:with-param>
								<xsl:with-param name="filename">
							...
							<xsl:call-template name="attach_block">
								<xsl:with-param name="block_num"></xsl:with-param>
								<xsl:with-param name="block_title">5) Attachment 5</xsl:with-param>
								<xsl:with-param name="filename">
							...
							<xsl:call-template name="attach_block">
								<xsl:with-param name="block_num"></xsl:with-param>
								<xsl:with-param name="block_title">6) Attachment 6</xsl:with-param>
								<xsl:with-param name="filename">
							...
							<xsl:call-template name="attach_block">
								<xsl:with-param name="block_num"></xsl:with-param>
								<xsl:with-param name="block_title">7) Attachment 7</xsl:with-param>
								<xsl:with-param name="filename">
							...
							<xsl:call-template name="attach_block">
								<xsl:with-param name="block_num"></xsl:with-param>
								<xsl:with-param name="block_title">8) Attachment 8</xsl:with-param>
								<xsl:with-param name="filename">
							...
							<xsl:call-template name="attach_block">
								<xsl:with-param name="block_num"></xsl:with-param>
								<xsl:with-param name="block_title">9) Attachment 9</xsl:with-param>
								<xsl:with-param name="filename">
							...
							<xsl:call-template name="attach_block">
								<xsl:with-param name="block_num"></xsl:with-param>
								<xsl:with-param name="block_title">10) Attachment 10</xsl:with-param>
								<xsl:with-param name="filename">
							...
							<xsl:call-template name="attach_block">
								<xsl:with-param name="block_num"></xsl:with-param>
								<xsl:with-param name="block_title">11) Attachment 11</xsl:with-param>
								<xsl:with-param name="filename">
							...
							<xsl:call-template name="attach_block">
								<xsl:with-param name="block_num"></xsl:with-param>
								<xsl:with-param name="block_title">12) Attachment 12</xsl:with-param>
								<xsl:with-param name="filename">
							...
							<xsl:call-template name="attach_block">
								<xsl:with-param name="block_num"></xsl:with-param>
								<xsl:with-param name="block_title">13) Attachment 13</xsl:with-param>
								<xsl:with-param name="filename">
							...
							<xsl:call-template name="attach_block">
								<xsl:with-param name="block_num"></xsl:with-param>
								<xsl:with-param name="block_title">14) Attachment 14</xsl:with-param>
								<xsl:with-param name="filename">
							...
							<xsl:call-template name="attach_block">
								<xsl:with-param name="block_num"></xsl:with-param>
								<xsl:with-param name="block_title">15) Attachment 15</xsl:with-param>
								<xsl:with-param name="filename">
