/**
 * $Header: /home/cvs/cvsroot/coeus/Source/WEB-INF/classes/edu/umdnj/coeus/reporting/bean/Attic/GetGrantsByPIBean.java,v 1.1.2.12 2007/09/18 18:23:05 cvs Exp $
 * $Log: GetGrantsByPIBean.java,v $
 * Revision 1.1.2.12  2007/09/18 18:23:05  cvs
 * Modify code for GAFA and START_DATE handling
 *
 * Revision 1.1.2.11  2007/09/06 19:29:44  cvs
 ...
 *
 * Revision 1.1.2.9  2007/08/16 15:30:09  cvs
 ...
 *
 * Revision 1.1.2.6  2007/07/17 15:59:26  cvs
 ...
 *
 * Revision 1.1.2.4  2007/03/27 15:19:20  cvs
 ...
 *
 * Revision 1.1.2.2  2007/02/14 16:34:38  cvs
 * Check for empty reports
 *
 * Revision 1.1.2.1  2007/01/26 16:36:47  cvs
 * Add support for Awards by Investigators Report
 *
 *
 */
/*
 * @(#)GetGrantsByPIBean.java 
 *
...
public class GetGrantsByPIBean extends ReportingBaseBean
{
    ...
    /** Creates a new instance of GetGrantsByPIBean */
    public GetGrantsByPIBean() 
    {
	super();
        fiscalYear = 0;
        Initialization();
    ...
    public GetGrantsByPIBean(String UnitName, String FiscalYearType, String FiscalYear)
    {
        super();
        fiscalYear = 0;
    	...
    	throws DocumentException
	{
        ...
        FormatDataCell(subtable,grantsobj.getSponsorName(),Color.white,Color.white,Element.ALIGN_LEFT,Font.PLAIN,7,3);
