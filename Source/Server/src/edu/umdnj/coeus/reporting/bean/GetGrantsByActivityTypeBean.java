/**
 * $Header: /home/cvs/cvsroot/coeus/Source/WEB-INF/classes/edu/umdnj/coeus/reporting/bean/Attic/GetGrantsByActivityTypeBean.java,v 1.1.2.18 2007/09/18 18:23:05 cvs Exp $
 * $Log: GetGrantsByActivityTypeBean.java,v $
 * Revision 1.1.2.18  2007/09/18 18:23:05  cvs
 * Modify code for GAFA and START_DATE handling
 *
 * Revision 1.1.2.17  2007/09/06 19:29:44  cvs
 ...
 *
 * Revision 1.1.2.15  2007/08/21 19:02:39  cvs
 * Address NullPointer exception with Fiscal Year and PDF type reports
 *
 * Revision 1.1.2.14  2007/08/16 15:30:09  cvs
 * Add support for Headers per page
 *
 * Revision 1.1.2.13  2007/08/02 19:19:05  cvs
...
public class GetGrantsByActivityTypeBean extends ReportingBaseBean
{
    ...
    /** Creates a new instance of GetGrantsByActivityTypeBean */
    public GetGrantsByActivityTypeBean() 
    {
	super();
        fiscalYear = 0;
        Initialization();
    ...
    public GetGrantsByActivityTypeBean(String UnitName, String FiscalYearType, String FiscalYear)
    {
        super();
        fiscalYear = 0;
    ...
    {
        Vector result = pobj.getGrantsByActivityType(UnitName);
        ...
        if (result != null && result.size() > 0)
        {
            ...
            if (result != null)
             ...
             if (listSize > 0)
             {
                ...
                buf.append("<h2>Detailed Award List by Activity Type for "+UnitSchool+"</h2>");
		buf.append("<table border=1>");	
                buf.append("<tr>");
                    buf.append(printObj("<b><u>Award Number</u></b>"));
    		    buf.append(printObj("<b><u>Activity Type</u></b>"));
        ...
        if (result != null && result.size() > 0)
        {
            ...
            if (result != null)
             ...
             if (listSize > 0)
             {
                    ...
                    buf.append(",");
    		    buf.append(printPlainObj("Activity Type"));
                    buf.append(",");
