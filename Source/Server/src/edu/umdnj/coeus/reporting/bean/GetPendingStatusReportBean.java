/**
 * $Header: /home/cvs/cvsroot/coeus/Source/WEB-INF/classes/edu/umdnj/coeus/reporting/bean/Attic/GetPendingStatusReportBean.java,v 1.1.2.2 2007/09/21 17:50:36 cvs Exp $
 * $Log: GetPendingStatusReportBean.java,v $
 * Revision 1.1.2.2  2007/09/21 17:50:36  cvs
 * Address Null Pointer exception in non-PDF reports
 *
 * Revision 1.1.2.1  2007/08/20 15:50:15  cvs
 * Add feature Pending Status Report of Proposals by School
 *
 *
 */
/*
 * @(#)GetPendingStatusReportBean.java 
 *
...
public class GetPendingStatusReportBean extends ReportingBaseBean
{
    ...
    /** Creates a new instance of GetPendingStatusReportBean */
    public GetPendingStatusReportBean() 
    {
	super();
        Initialization();
    }
    
    public GetPendingStatusReportBean(String SchoolName)
    {
        super();
    ...
    {
        Vector result = pobj.getPendingStatusReport(SchoolName);
        ...
        if (result != null && result.size() > 0)
        {
            ...
            if (result != null)
             ...
             if (listSize > 0)
             {
                buf.append("<h2>Pending Status Report of Proposals for "+SchoolName+"</h2>");
...
//JM 5-27-2011 updated account to center per 4.4.2
                buf.append(printObj("<b><u>CURRENT_CENTER_NUMBER</u></b>"));
            	...
            	for(int rowNum = 0; rowNum < listSize; rowNum++)
		{
                    ...
                    Object comparedatecell = row.get("REQUESTED_START_DATE_INITIAL");
                    Timestamp canddate = getTimeStampCellValue(comparedatecell); 
                    if (canddate != null && currentdate != null && canddate.getTime() > currentdate.getTime())
                       continue;
         ...
         throws ServletException, IOException
    {
	    ...
	    ////////////////////////////////////////////////////////////////////////
            ...
            {           
                ...
                if (canddate != null)
                {
                    if (canddate.getTime() <= currentdate.getTime())
      ...
      else
      {
          ...
          writer.print(SchoolName + " does not have grants");
    	...
    	throws DocumentException
    {
        ...
        a.add(new Chunk(SchoolName+" - Pending Status Report of Proposals",
         ...
         throws ServletException, IOException
    {
	    ...
	    headerStyle.setFont(headerFont);
            ...
            for (int i=0; i < listSize; i++) 
            {
                ...
                Object comparedatecell = dbrow.get("REQUESTED_START_DATE_INITIAL");
                Timestamp canddate = getTimeStampCellValue(comparedatecell); 
                if (canddate != null && currentdate != null && canddate.getTime() > currentdate.getTime())
                   continue;
    ...
    private void InitializeDateFilter()
    {
        ...
        currentdate = new Timestamp(currdate.getTime());
    }
