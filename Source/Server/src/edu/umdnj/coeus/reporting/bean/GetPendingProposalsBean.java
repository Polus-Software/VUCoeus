/**
 * $Header: /home/cvs/cvsroot/coeus/Source/WEB-INF/classes/edu/umdnj/coeus/reporting/bean/Attic/GetPendingProposalsBean.java,v 1.1.2.7 2007/09/18 18:23:05 cvs Exp $
 * $Log: GetPendingProposalsBean.java,v $
 * Revision 1.1.2.7  2007/09/18 18:23:05  cvs
 * Modify code for GAFA and START_DATE handling
 *
 * Revision 1.1.2.6  2007/08/16 15:30:09  cvs
 * Add support for Headers per page
 *
 * Revision 1.1.2.5  2007/08/02 19:19:05  cvs
 * Enforce Snippet integrity in PDF output
 *
 * Revision 1.1.2.4  2007/06/11 15:39:13  cvs
 * Make sure that Sponsor Name and Project Title have nowrap = FALSE
 *
 * Revision 1.1.2.3  2007/02/14 16:34:38  cvs
 * Check for empty reports
 *
 * Revision 1.1.2.2  2007/01/18 21:26:53  cvs
 * Add support for wider PDF tables
 *
 * Revision 1.1.2.1  2007/01/18 14:59:05  cvs
 * Add Pending Proposal support
 *
 *
 */
/*
 * @(#)GetPendingProposalsBean.java 
 *
...
public class GetPendingProposalsBean extends ReportingBaseBean
{
    ...
    /** Creates a new instance of GetPendingProposalsBean */
    public GetPendingProposalsBean() 
    {
	super();
        Initialization();
    }
    
    public GetPendingProposalsBean(String SchoolName, String DateFilter)
    {
        super();
    ...
    {
        Vector result = pobj.getPendingProposals(SchoolName);
        ...
        if (result != null && result.size() > 0)
        {
            ...
            if (result != null)
             ...
             if (listSize > 0)
             {
                buf.append("<h2>Detailed Pending Proposals for "+SchoolName+"</h2>");
...
//JM 5-27-2011 updated account to center per 4.4.2; added hook for testing
                final String CURRENT_CENTER_NUMBER = "<b><u>CURRENT_CENTER_NUMBER</u></b>";
                buf.append(printObj(CURRENT_CENTER_NUMBER));
// END                
    	...
    	throws DocumentException
    {
        ...
        a.add(new Chunk(SchoolName+" - Pending Proposals to ORSP",
