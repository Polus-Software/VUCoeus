/**
 * $Header: /home/cvs/cvsroot/coeus/Source/WEB-INF/classes/edu/umdnj/coeus/servlet/Attic/GetGrantsByActivityTypeServlet.java,v 1.1.2.5 2007/09/05 19:09:05 cvs Exp $
 * $Log: GetGrantsByActivityTypeServlet.java,v $
 * Revision 1.1.2.5  2007/09/05 19:09:05  cvs
 * Server-side modifications for Fiscal Year Delineation
 *
 * Revision 1.1.2.4  2007/01/23 20:44:49  cvs
 * Add support for Graph Activity Types
 *
 * Revision 1.1.2.3  2007/01/17 17:18:58  cvs
 * Add NIH support
 *
 * Revision 1.1.2.2  2007/01/17 15:25:38  cvs
 * Add CSV Support
 *
 * Revision 1.1.2.1  2006/12/28 16:18:54  cvs
 *  Add support for grants by activity type data retrieval
 *
 *
 */
/*
 * @(#)GetGrantsByActivityTypeServlet.java 
 *
...
import edu.umdnj.coeus.reporting.bean.GetGrantsByActivityTypeBean;


/////////////////////////////////////////////////////////////////////
/* GetGrantsByActivityTypeServlet - specific class to get the list
 *
 */
public class GetGrantsByActivityTypeServlet extends HttpServlet
{
         ...
         throws ServletException, IOException
  {
    ...
    GetGrantsByActivityTypeBean bean = new GetGrantsByActivityTypeBean(UnitName, FiscalYearType, FiscalYear);
    bean.setNIH(NIH);
    bean.setActivityType(ActivityType);
