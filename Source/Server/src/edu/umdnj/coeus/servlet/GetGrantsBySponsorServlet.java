/**
 * $Header: /home/cvs/cvsroot/coeus/Source/WEB-INF/classes/edu/umdnj/coeus/servlet/Attic/GetGrantsBySponsorServlet.java,v 1.1.2.4 2007/09/05 19:09:05 cvs Exp $
 * $Log: GetGrantsBySponsorServlet.java,v $
 * Revision 1.1.2.4  2007/09/05 19:09:05  cvs
 ...
 * Add CSV Support
 *
 * Revision 1.1.2.1  2006/12/27 17:52:14  cvs
 *  Add support for grants by sponsor type data retrieval
 *
 *
 */
/*
 * @(#)GetGrantsBySponsorServlet.java 
 *
...
import edu.umdnj.coeus.reporting.bean.GetGrantsBySponsorBean;


/////////////////////////////////////////////////////////////////////
/* GetGrantsBySponsorServlet - specific class to get the list
 *
 */
public class GetGrantsBySponsorServlet extends HttpServlet
{
         ...
         throws ServletException, IOException
  {
    ...
    GetGrantsBySponsorBean bean = new GetGrantsBySponsorBean(UnitName, FiscalYearType, FiscalYear);
    bean.setNIH(NIH);
    bean.setSponsorType(SponsorType);
