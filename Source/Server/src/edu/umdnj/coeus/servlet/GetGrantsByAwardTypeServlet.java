/**
 * $Header: /home/cvs/cvsroot/coeus/Source/WEB-INF/classes/edu/umdnj/coeus/servlet/Attic/GetGrantsByAwardTypeServlet.java,v 1.1.2.3 2007/09/05 19:09:05 cvs Exp $
 * $Log: GetGrantsByAwardTypeServlet.java,v $
 * Revision 1.1.2.3  2007/09/05 19:09:05  cvs
 * Server-side modifications for Fiscal Year Delineation
 *
 * Revision 1.1.2.2  2007/01/23 18:12:29  cvs
 * Add GUI support for Graph Sponsor Types
 *
 * Revision 1.1.2.1  2007/01/23 15:40:04  cvs
 * Add Award Type Grant support
 *
 *
 */
/*
 * @(#)GetGrantsByAwardTypeServlet.java 
 *
...
import edu.umdnj.coeus.reporting.bean.GetGrantsByAwardTypeBean;


/////////////////////////////////////////////////////////////////////
/* GetGrantsByAwardTypeServlet - specific class to get the list
 *
 */
public class GetGrantsByAwardTypeServlet extends HttpServlet
{
         ...
         throws ServletException, IOException
  {
    ...
    GetGrantsByAwardTypeBean bean = new GetGrantsByAwardTypeBean(UnitName, FiscalYearType, FiscalYear);
    bean.setNIH(NIH);
    bean.setAwardType(AwardType);
