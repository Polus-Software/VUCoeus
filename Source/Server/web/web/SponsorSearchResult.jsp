<!--
/*
 * @(#)SponsorSearchResult.jsp	1.0	2002/06/11	23:12:30
 *
...
function populateResultData(spNum,rowId){
        var sponsorName = eval("document.frmSponsorSearchResult.hdnSponsorName"+rowId).value;
        //set sponsor id in opener form
        window.opener.document.forms[0].sponsorId.value = spNum;
        //set sponsor name in opener form
        window.opener.document.forms[0].sponsorName.value = sponsorName;
        window.close();
}
</script>
</head>
<body>
<FORM name='frmSponsorSearchResult'>
<%
...
<%--
            <input type=hidden name='hdnSponsorName<%=index%>' value='<%=value%>'>
--%>
<%--
<!-- CASE #448 Comment End -->
<!-- CASE #448 Begin -->
            <input type=hidden name='hdnSponsorName<%=index%>' value="<%=value%>">
<!-- CASE #448 End -->
