<!--
/*
 * @(#)FESubmitSuccess.jsp	1.0  02/20/2004
 *
...
-->
<!--
Display confirmation for successfully added/edited financial entity.
...
<template:insert template='HNCTemplate.jsp'>
  ...
  <template:put name='title'> <bean:message key='FESubmitSuccess.title'/> </template:put>
  ...
  <template:put name='actualContent' content='FESubmitSuccessContent.jsp'/>
