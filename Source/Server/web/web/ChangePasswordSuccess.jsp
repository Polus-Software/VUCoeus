...
--%>
<%--
A View component that displays a success message when user's password has been successfully changed.
...
<coeusPrivilege:checkLogin
		requestedURL="ChangePasswordSuccess.jsp"
...
<template:insert template='HNCTemplate.jsp'>
  ...
  <template:put name='title'> <bean:message key='changePasswordSuccess.title'/> </template:put>
  ...
  <template:put name='actualContent' content='ChangePasswordSuccessContent.jsp'/>
</template:insert>
