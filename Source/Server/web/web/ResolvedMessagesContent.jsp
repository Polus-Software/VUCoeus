...
<% System.out.println("Inside resolvedMessagesContent.jsp"); %>

<jsp:useBean id="userInfoBean"
		class="edu.mit.coeus.bean.UserInfoBean"
		scope="session" />
<html:form action="/updateInboxMessages.do?messageType=resolved" method="POST">
...
<table border="0"   cellpadding="0" cellspacing="0" width="98%" align="right">
	...
	<tr>
		...
		<b>
		&nbsp;Resolved Messages for <bean:write name="userInfoBean" property="userName" />
		</b>
		</td>
	</tr>
</table>
...
<table width="98%" align="right" border="0">
	<tr>
		<td>
			<b>There are no resolved messages for
...
<table width="98%" align="right" border="0">
	<tr>
		<td>
                  <html:image page="/images/deleteSelected.gif" onclick="submit"  border="0" />
                </td>
...
<table width="98%" align="right" cellpadding="2" cellspacing="2" >
	<tr bgcolor="#CC9999">
		...
		<td>	<html:link page="/getInboxMessages.do?messageType=resolved" anchor="legend">
...
<tr>
<td>
<table border="0"  bgcolor="#cccccc" cellpadding="10" cellspacing="0" width="98%" >
	<tr >
		...
		<td width="25%">
 		      <a href="javascript:openwintext('<bean:write name="ctxtPath"/>/coeusSearch.do?searchname=proposalSearchCoeusWeb&fieldName=proposalNum','proposal');">
			<b><u><span style="color:#660000">
                    	Proposal Search
			</u></b></span>
                  </a>
