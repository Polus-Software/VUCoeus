<!--
/*
 * @(#)CoeusSearch.jsp	1.0	2002/06/11	23:12:30
 *
...
<%	System.out.println("inside CoeusSearch.jsp");
%>
...
function search(){
    var objElements = document.frmCoeusSearch.elements;
    var flag = false;
    ...
    if(flag){
        document.frmCoeusSearch.submit();
    }else{
...
<body>
<form name='frmCoeusSearch' action='coeusSearchResult.do' method='POST'>
...
<ul>
	<li>
	To search for an award or proposal whose title <b>contains cell</b>, type <b>like %cell%</b> in the Title field.
	</li>
	<li>
	To search for an award or proposal whose title <b>begins with cell</b>, type <b>like cell%</b> in the Title field.
	</li>
	<li>
	To search for an award or proposal whose title <b>ends with cell</b>, type <b>like %cell</b> in the Title field.
	</li>
</ul>
</div>
-->
<!-- CASE #275 End -->
    ...
    <!-- CASE #1374 End -->
    <tr bgcolor="cc9999" width='100%'><td width='100%'>
