<%--
/*
 * @(#)COIDisclosure.jsp	1.0  05/10/2002
 *
...
<jsp:useBean id='collCOIDisclosures' class='java.util.Vector' scope='session' />
<jsp:useBean id='collCOIDisclosuresStatus' class='java.util.ArrayList'  scope='session'/>
...
<template:insert template='HNCTemplate.jsp'>
  ...
  <template:put name='title'> <bean:message key='coiDisclosure.title'/> </template:put>
  ...
  <template:put name='actualContent' content='COIDisclosureContent.jsp'/>
