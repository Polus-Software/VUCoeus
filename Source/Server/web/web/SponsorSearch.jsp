<!--
/*
 * @(#)SponsorSearch.jsp	1.0	2002/06/11	23:12:30
 *
...
.header {font-family:verdana, helvetica, sans-serif; font-size:12px; font-weight:bold}
</style>
</head>
<script langauge="javascript">
function search(){
    var objElements = document.frmSponsorSearch.elements;
    var flag = false;
    ...
    if(flag){
        document.frmSponsorSearch.submit();
    }else{
...
<body>
<form name='frmSponsorSearch' action='coeusSearchResult.do' method='POST'>
...
<ul>
	<li>
	To search for a sponsor whose name <b>contains science</b>, type <b>like %science%</b> in the Sponsor Name field.
	</li>
	<li>
	To search for a sponsor whose name <b>begins with science</b>, type <b>like science%</b> in the Sponsor Name field.
	</li>
	<li>
	To search for a sponsor whose name <b>ends with science</b>, type <b>like %science</b> in the Sponsor Name field.
	</li>
</ul>
</div>
<!-- CASE #275 End -->
