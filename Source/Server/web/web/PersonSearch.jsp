<!--
/*
 * @(#)PersonSearch.jsp	1.0	2002/06/11	23:12:30
 *
...
function search(){
    var objElements = document.frmPersonSearch.elements;
    var flag = false;
...
<body>
<form name='frmPersonSearch' action='coeusSearchResult.do' method='POST'>
...
<ul>
	<li>
	To search for a person whose last name <b>contains wil</b>, type <b>like %wil%</b> in the Last Name field.
	</li>
	<li>
	To search for a person whose last name <b>begins with wil</b>, type <b>like wil%</b> in the Last Name field.
	</li>
	<li>
	To search for a person whose last name <b>ends with son</b>, type <b>like %son</b> in the Last Name field.
	</li>
</ul>
</div>
-->
...
%>
 ...
 <table>
 <tr>
      <td colspan='7' width="30%" height="40">
        <div align="left">
