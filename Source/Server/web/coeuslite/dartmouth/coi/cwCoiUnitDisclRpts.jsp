	...
	<table width="982" align="left" border="0" cellpadding="0"
		...
		<tr height="20px" id="row0">
			<td class="copybold" valign="top"><a
				href="javascript:selectRow('row0','historyRow0','historyData0','toggle0','historyFrame0','<%=path%>/getDisclRpts.do?mode=F&due=0')"
				id="toggle0"><img
		...
		<tr height="20px" id="row1">
			<td class="copybold" valign="top"><a
				href="javascript:selectRow('row1','historyRow1','historyData1','toggle1','historyFrame1','<%=path%>/getDisclRpts.do?mode=D&due=90')"
				id="toggle1"><img
					src='<%=request.getContextPath()%>/coeusliteimages/plus.gif'
		...
		<tr height="20px" id="row2">
			<td class="copybold" valign="top"><a
				href="javascript:selectRow('row2','historyRow2','historyData2','toggle2','historyFrame2','<%=path%>/getDisclRpts.do?mode=D&due=60')"
				id="toggle2"><img
					src='<%=request.getContextPath()%>/coeusliteimages/plus.gif'
		...
		<tr height="20px" id="row3">
			<td class="copybold" valign="top"><a
				href="javascript:selectRow('row3','historyRow3','historyData3','toggle3','historyFrame3','<%=path%>/getDisclRpts.do?mode=D&due=30')"
				id="toggle3"><img
					src='<%=request.getContextPath()%>/coeusliteimages/plus.gif'
		...
		<tr height="20px" id="row4">
			<td class="copybold" valign="top"><a
				href="javascript:selectRow('row4','historyRow4','historyData4','toggle4','historyFrame4','<%=path%>/getDisclRpts.do?mode=D&due=-90')"
				id="toggle4"><img
					src='<%=request.getContextPath()%>/coeusliteimages/plus.gif'
		...
		<tr height="20px" id="row5">
			<td class="copybold" valign="top"><a
				href="javascript:selectRow('row5','historyRow5','historyData5','toggle5','historyFrame5','<%=path%>/getDisclRpts.do?mode=D&due=-60')"
				id="toggle5"><img
					src='<%=request.getContextPath()%>/coeusliteimages/plus.gif'
		...
		<tr height="20px" id="row6">
			<td class="copybold" valign="top"><a
				href="javascript:selectRow('row6','historyRow6','historyData6','toggle6','historyFrame6','<%=path%>/getDisclRpts.do?mode=D&due=-30')"
				id="toggle6"><img
					src='<%=request.getContextPath()%>/coeusliteimages/plus.gif'
		...
		<tr height="20px" id="row7">
			<td class="copybold" valign="top"><a
				href="javascript:selectRow('row7','historyRow7','historyData7','toggle7','historyFrame7','<%=path%>/getDisclRpts.do?mode=D&due=-1')"
				id="toggle7"><img
					src='<%=request.getContextPath()%>/coeusliteimages/plus.gif'
