...
<title>COI Disclosure Details</title>
	  ...
	  if(style==""){
        ...
        function toggleImage(toggleId,teggleText){
          ...
          function openFinEntity(entityNumber, sequenceNum) {
                var url = "<%=path%>/reviewAnnFinEntityHist.do?entityNumber="+entityNumber+"&seqNum="+sequenceNum+"&header=disclosure";
                window.open(url, "History", "scrollbars=1,resizable=yes, width=1000, height=800, left=100, top = 100");
            }
...
<body>
	<table align="center" width='984' border="0" cellpadding="0"
		...
		<tr>
			<td align="right" colspan="2" height="30px" class="theader"><a
				href="javascript:self.close();"><u>Close</u></a></td>
		</tr>
		<tr></tr>
		<tr>
			<td class='theader' colspan="2" height="22px" align='left' style=""><bean:message
					bundle="coi" key="AnnualDisclosure.Review.Details" /> <%=person.getFullName()%></td>
		</tr>
		<tr>
     ...
     AND END TAG :(-->
		...
		<tr>
			<td class="theaderBlue" width="10px" height="20px"><a
   ...
   /*   if(ht>maxht){
     ...
     AND END TAG :(-->
				...
				<div id="historyData1"
					style="overflow:hidden; position: absolute;height:<%=ht%>px">
 ...
 /*   if(mode!=null && !mode.equals("")){   
     ...
     AND END TAG :(-->
                     ...
                     int disclIndex = 0;%>
							...
							<logic:notEqual name="totentity" value='0'>
                                ...
                                %>
                                  ...
                                  <td  height='20px'>&nbsp;</td> --%>
										<td><a
											href="javascript:selectRow('row<%=disclIndex+10%>','projectRow<%=disclIndex+10%>','projectData<%=disclIndex+10%>','toggle<%=disclIndex+10%>','projectFrame<%=disclIndex+10%>','<%=path%>/getFinEntPrj.do?entityNumber=<bean:write name="finEntDet" property="entityNumber"/>&entitySequenceNumber=<bean:write name="finEntDet" property="entitySequenceNumber"/>')"
										...
										<td class="copy"><a
											href="javascript:openFinEntity('<bean:write name="finEntDet" property="entityNumber"/>','<bean:write name="finEntDet" property="entitySequenceNumber"/>')"><coeusUtils:formatOutput
      ...
      <td height="22"  width="984" class="theaderBlue" style="font-size:13px"><bean:message bundle="coi" key="AnnualDisclosure.Proposals.Header"/></td>
      
    </tr>   
    <%
          ht=140+totProposals.intValue()*23;
     /* if(ht>maxht){
     ht=maxht; 
      }*/
     ...
     AND END TAG :(-->
                    ...
                    %>     
                     ...
                     <div id="historyData3" style="overflow:none; position:absolute; height:<%=ht%>px;">
