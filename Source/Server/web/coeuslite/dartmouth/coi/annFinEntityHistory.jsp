...
<script>
            ...
            function openFinEntity(entityNumber, sequenceNum) {
                ...
                window.open(url, "History", "resizable=yes,scrollbars=1, width=1000, height=800, left=100, top = 100");
            }
        </script>
</head>
<body class="table">
	...
	<logic:present name="AnnFinEntityHistory" scope="request">
		<table width="100%" align="center" border="0" cellspacing="0"
			...
			<tr>
				...
				<%--             <!--   <td width="20%" align="left" class="theader" nowrap><bean:message bundle="coi" key="label.entityRelType"/></td>
               <td width="45%" align="left" class="theader" nowrap><bean:message bundle="coi" key="label.entityRelDescription"/></td>-->--%>
				<td width="20%" align="left" class="theader" nowrap><bean:message
						bundle="coi" key="label.updated" /></td>
				<noscript>
			...
			<logic:iterate id="data" name="AnnFinEntityHistory"
				...
				<tr class="rowLine" id="row<%=ctr%>"
					...
					<td align="left" class="copy"><logic:present name="data"
							property="statusCode">
					...
					<td><coeusUtils:formatOutput name="data"
							property="relationShipTypeDesc" /></td>
					<td><bean:write name="data" property="relationShipDesc" /></td>
					<td nowrap><coeusUtils:formatDate name="data"
							formatString="MM-dd-yyyy  hh:mm a" property="updtimestamp" /> <b>by</b>
						<bean:write name="data" property="upduser" /></td>
					<noscript>
						<td class='copy'><a target="_blank"
							href='<%=path%>/reviewAnnFinEntityHist.do?entityNumber=<bean:write name="data" property="entityNumber"/>&seqNum=<bean:write name="data" property="sequenceNum"/>&header=no'>view</a>
						</td>
					</noscript>
				</tr>
			</logic:iterate>
