...
<tiles:definition  id="clBudgetVersions" page="/coeuslite/wmc/utils/layouts/clBudgetLayout.jsp" scope="request">
	
  <tiles:put name="header"  value="/coeuslite/wmc/budget/common/clBudgetHeader.jsp" />
  
  <tiles:put name="menu"    value="/coeuslite/wmc/budget/common/clBudgetVersionsMenu.jsp" />
