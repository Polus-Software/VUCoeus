...
<table width="980"   border="0" cellpadding="0" cellspacing="0" class="table">
  ...
  <tr>
    <td height="20" align="left" valign="top" class="theader"> &nbsp;   </td>
  </tr>
      ...
      <td height="50" align="left" valign="top"><table width="99%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tabtable">
          <tr>
            <td colspan="4" align="left" valign="top"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" class="tableheader">
                <tr>
                  <td> <bean:message bundle="proposal" key="question.certQuestion"/>   </td>
                </tr>
            </table></td>
          </tr>
           <logic:present name="questionDetails" scope="session" >
                   <logic:iterate name="questionDetails" id="questionData" type="org.apache.commons.beanutils.DynaBean"> 
                    ...
                    <tr>
                        <td class="copy" width='5%' colspan="0" height="30" >
                             <div align="left"> &nbsp; <bean:write name="questionData" property="questionId" /> : </div>
                        </td>

                        <td height="30" width='90%' class="copy">
                            <div align="left">
                            <bean:write name="questionData" property="description" /> </div>
                        </td>
                    </tr>
  ...
  <tr>
      <td height="52" align="left" valign="top"><table width="99%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tabtable">
          <tr>
            <td colspan="4" align="left" valign="top"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" class="tableheader">
                <tr>
                  <td> <bean:message bundle="proposal" key="question.explanation"/>    </td>
                </tr>
            </table></td>
          </tr>   
             <tr>
                    ...
                    <td class="copy" colspan="0">        
                         &nbsp;  <%=session.getAttribute("questionExplanation")%>
            ...
            <table width="99%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tabtable">
                        <tr>
                          <td align="left" valign="top"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" class="tableheader">
                              <tr>
                                <td> <bean:message bundle="proposal" key="question.policy"/>  </td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
                                ...
                                <td class="copy" colspan="0">        
                                     &nbsp;  <%=session.getAttribute("questionPolicy")%>
                                         <!--bean:write name="questionData" property="explanation" /-->                                                                   
                                </td>
                        </tr> 
                        <tr>
        ...
        <td height="30" align="left" valign="top"><br>
            <table width="99%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tabtable">
                        <tr>
                          <td align="left" valign="top"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" class="tableheader">
                              <tr>
                                <td> <bean:message bundle="proposal" key="question.regulation"/> </td>
                              </tr>
                          </table></td>
                        </tr>                     
                            <tr>
                                    ...
                                    <td class="copy" colspan="0">        
                                        &nbsp;   <%=session.getAttribute("questionRegulation")%>
                                             <!--bean:write name="questionData" property="explanation" /-->                                                                   
                                    </td>
                            </tr>
                            <tr>
    ...
    <tr>
        <td height='45' align="left"> &nbsp; &nbsp;
            ...
            <html:link href="javascript:window.close();" styleClass="copybold">
                <bean:message bundle="proposal" key="proposalInvCertify.close"/>
            </html:link>
