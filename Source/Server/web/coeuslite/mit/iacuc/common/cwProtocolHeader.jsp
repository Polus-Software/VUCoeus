							...
							<table width="100%" border="0" class="tablemain">
								<tr>
									<td width="12%" align="right" styleClass="menu">
										<%  Vector subHeaderVector = (Vector) session.getAttribute("iacucsubHeaderVector"+session.getId());
