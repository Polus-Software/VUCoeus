...
<jsp:useBean id="iacucScheduleMenuItemsVector" scope="session"
	class="java.util.Vector" />

<% 
String scheduleId = (String)session.getAttribute("IACUC_SCHEDULE_ID"+session.getId());
String contextPath =  request.getContextPath();
String agendaNum = (String)session.getAttribute("IACUC_AGENDA_NUMBER"+session.getId());
%>
		...
		<tr>
			<td align="left" valign="top">
				<table width="170" border="0" align="center" cellpadding="0"
					...
					<logic:iterate name="iacucScheduleMenuItemsVector"
						id="schedulemenubean" type="edu.mit.coeuslite.utils.bean.MenuBean">
