                                ...
                                %>
                                    ...
                                    %>
												...
												<td align="left" nowrap class="copy"><a
													href="<%=request.getContextPath()%>/getIacucData.do?SEARCH_ACTION=SEARCH_ACTION&protocolNumber=<%=protocolNumber.trim()%>&PAGE=<%=destPage.trim()%>&sequenceNumber=<%=sequenceNumber%>&submissionNumber=<%=submissionNumber%>&fromIsReviewer=true&isAgenda=true&openAgenda=false"><u>
															<%=value%>
													</u> </a></td>
												<%
                                            }
