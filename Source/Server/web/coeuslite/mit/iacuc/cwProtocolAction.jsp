...
<link rel="stylesheet"
	...
	type="text/css" />
<!--Modified for the COEUSQA-3120 :IACUC - Major and Minor Revisions required letters do not appear under View History/Protocol Action Details in Lite - start-->
...
<!--Modified for the COEUSQA-3120 - end -->
<script>
            ...
            function viewDocument(protocolNumber, sequenceNumber, submissionNumber, documentId, fileName){
                window.open("<%=request.getContextPath()%>/viewIacucSubAtt.do?protocolNumber="
                                                                                        +protocolNumber
                                                                                        +"&sequenceNumber="
                                                                                        +sequenceNumber
                                                                                        +"&submissionNumber="
            ...
            function viewAnsweredQuestionsForQnr(qnrLink, submissionNumber) {
                ...
                var loc = '<bean:write name='ctxtPath'/>/coeuslite/mit/utils/dialogs/cwViewIacucAnsweredQuestionsForQnr.jsp?submissionNumber='+submissionNumber+'&linkFromHistoryPage=true&link='+qnrLink;
	...
	<html:form action="/getProtocolAction.do" method="post">
		<table width="100%" height="100%" border="0" cellpadding="0"
			...
			<tr>
				...
				<td height="2%" align="left" valign="top" class="tableheader">
					<bean:message key="protocolActions.ProtocolAction" />
				</td>
			</tr>
			<tr align="center">
				<td colspan="3">
														...
														<tr>
															<td>
																<table width="100%" height="100%" border="0"
																	...
																	<tr class="copy">
																		<td colspan="3"><b><bean:message
																					key="protocolActions.CommitteeName" /> :</b>&nbsp;<bean:write
																				name="submissionList" property="committeeName" /></td>
																	</tr>
																</table>
															</td>
														</tr>
                                                            ...
                                                            %>
                                                                    ...
                                                                    if(actionDocDescription != null){
                                                                        ...
                                                                        if(!"".equals(actionDocDescription) && actionDocDescription.length() > 50){
																			...
																			<td class="copy" width="50%">
																				<%--Uncommeneted for COEUSQA-3461 : IACUC CoeusLite View FYI Attachments - start--%>
																				<html:link href="<%=docLink%>">
																					<%=fileName%>
																				</html:link> <%--Uncommeneted for COEUSQA-3461 : IACUC CoeusLite View FYI Attachments - end--%>
																			</td>
																		</tr>
																		<% count++;%>
																	</logic:iterate>
                                            ...
                                            // %>
														...
														<tr>
															<td>
                                                                ...
                                                                String qnrLink = "/getIacucSubmissionQuestionnaire.do?questionnaireId="+qnrAnsHeaderBean.getQuestionnaireId()+"&questionaireLabel="+qnrAnsHeaderBean.getLabel();
