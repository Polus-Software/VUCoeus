...
<%      int count=0;    
        ...
        String protocolSubmissionMode = (String) session.getAttribute("getIacucProtocolSubmissionMode");
...
function protocolSubmission(){
    document.submitForReviewList.action ="<%=request.getContextPath()%>/iacucProtocolSubmission.do"; 
...
function showSchedule(){
  ...
  //  document.submitForReviewList.committeeName.value = selectedValueCommitteeName;
    document.submitForReviewList.action ="<%=request.getContextPath()%>/getIacucScheduleDetails.do"; 
    document.submitForReviewList.submit();
}
...
function showCommittee(){
   ...
   //Added for case#3529 - Coeus Lite - Expedited Review Checklist Display- End
    ...
    document.submitForReviewList.action = "<%=request.getContextPath()%>/getIacucCommitteeDetails.do";
    document.submitForReviewList.submit();
}
function showReviewer(){
    ...
    // document.submitForReviewList.committeeId.value = selectedValueCommitteeId;
    // document.submitForReviewList.committeeName.value = selectedValueCommitteeName;
    document.submitForReviewList.action ="<%=request.getContextPath()%>/getIacucReviewerDetails.do"; 
    document.submitForReviewList.submit();
}
function showAll(){
    ...
    document.submitForReviewList.action ="<%=request.getContextPath()%>/getIacucAllCommitteeList.do"; 
    document.submitForReviewList.submit();
}
...
<body>
    ...
    document.getElementById('txt').innerHTML = '<bean:message bundle="iacuc" key="helpPageTextProtocol.Actions"/>';
     ...
     document.submitForReviewList.action ="<%=request.getContextPath()%>/getIacucData.do?PAGE=G"; 
     //document.submitForReviewList.action ="<%=request.getContextPath()%>/getIacucData.do?PAGE=G"; 
     document.submitForReviewList.submit();
					...
					<table width='100%' cellpadding='1' cellspacing='1'
						...
						<logic:notEmpty name="submitForReviewList" property="list"
							...
							<logic:iterate id="dynaFormData" name="submitForReviewList"
								...
								<tr>
									<td class='copybold' align="right"><font color="red">*</font>
									...
									<td>
										...
										<html:select name="dynaFormData" property="submissionType"
											...
											<html:options collection="getIacucSubmissionTypes"
								...
								<tr>
									...
									<td><html:select name="dynaFormData" property="reviewType"
											styleClass="clcombobox-bigger" disabled="<%=modeValue%>"
											onchange="">
											<html:option value="">
												<bean:message key="protocolSubmission.pleaseSelect" />
											</html:option>
								...
								<tr>
									...
									<td colspan='4' align="left">
										...
										<html:select name="dynaFormData" property="typeQualifier"
											onchange="dataChanged()" styleClass="clcombobox-bigger"
											disabled="<%=modeValue%>">
											<html:option value="">
												<bean:message key="protocolSubmission.pleaseSelect" />
											</html:option>
        ...
        %>
												<tr bgcolor="<%=strBgColor1%>">
													...
													<td width='20%' class='copy'><html:select
															...
															<html:options collection="getIacucReviewerList"
...
<% } %>
 ...
 if (confirm("<bean:message key="protocolSubmission.protocolSubmitWithoutCommittee"/>")== true){     
     document.submitForReviewList.action ="<%=request.getContextPath()%>/iacucProtocolSubmission.do?submitWithoutComm=YES"; 
     document.submitForReviewList.submit();
 }
 ...
 if (confirm("<bean:message key="protocolSubmission.protocolSubitWithouSchedule"/>")== true){     
     document.submitForReviewList.action ="<%=request.getContextPath()%>/iacucProtocolSubmission.do?submitWithoutSchedule=YES"; 
     document.submitForReviewList.submit();
 }
 <% } %>
 ...
 if (confirm("<bean:message key="protocolSubmission.protocolSubmitWithoutReviewer"/>") != true){     
     document.submitForReviewList.action ="<%=request.getContextPath()%>/iacucProtocolSubmission.do?submitWithoutReviewer=YES"; 
     document.submitForReviewList.submit();
 }
 <% } %>
...
//var selectedValueScheduleDate = document.submitForReviewList.scheduleDate.value;
	...
	<script>
          ...
          LINK = "<%=request.getContextPath()%>/iacucProtocolSubmission.do";
