...
<jsp:useBean  id="dynaForm" scope="request" class="org.apache.struts.validator.DynaValidatorForm"/>
<jsp:useBean id="person" scope="session" class="edu.mit.coeus.bean.PersonInfoBean" />
<jsp:useBean  id="frmAddCOIDisclosure" scope="session" class="org.apache.struts.validator.DynaValidatorForm"/>
...
<html:javascript formName="coiDisclosure"
                 dynamicJavascript="true" 
                 staticJavascript="true"/>
<body>
<%--  ************  START OF BODY TABLE  ************************--%>
<html:form action="/addCoiDisclosure.do" method="post" onsubmit="return validateForm(this)" >

<div id="disclFormDiv"> 
    <table width="980" border="0" cellpadding="2" cellspacing="0" class="table">
        
        <tr>
            <td height="20" align="left" valign="top" class="theader"> <bean:message bundle="coi" key="coiDisclosure.headerDiscl"/> <%=person.getFullName()%>   </td>
        </tr>
        <tr>
            <td class="copybold">&nbsp;&nbsp;
                <b><font color="red">*</font></b>
                <font class="fontBrown"><bean:message bundle ="coi" key="coi.indicatesReqField"/></font>
            </td>
        </tr>
        <tr>
            <td>
                        ...
                        <td class='copy'>
                            <font color="red">                
                                <logic:messagesPresent message = "true">   
                                    <%-- Case 3513 - START --%>
                                    <html:messages id="message" message="true" property="proposalTitleLength" bundle="coi">
                                        <li><bean:write name = "message"/></li>
                                    </html:messages>
                                    <%-- Case 3513 - END --%>
                                    <html:messages id="message" message="true" property="invalidConflictStatus" bundle="coi">
                                        <li><bean:write name = "message"/></li>
                                    </html:messages>                                            
                                    <html:messages id="message" message="true" property="invalidConflictStatusHasMaintain" bundle="coi">
                                        <li><bean:write name = "message"/></li>
                                    </html:messages>                                            
                                    <html:messages id="message" message="true" property="answersRequired" bundle="coi">
                                        <li><bean:write name = "message"/></li>
                                    </html:messages>
                                    <html:messages id="message" message="true" property="initialdDisclosureTypeInvalid" bundle="coi">
                                        <li><bean:write name = "message"/></li>
                                    </html:messages>
                                    <html:messages id="message" message="true" property="invalidDisclosureStatus" bundle="coi">
                                        <li><bean:write name = "message"/></li>
                                    </html:messages>
                                    <html:messages id="message" message="true" property="duplicateSubmission" bundle="coi">
                                        <li><bean:write name = "message"/></li>
                                    </html:messages>
                    ...
                    <tr>
                        <td>            
                            <table width="85%"  border="0" cellspacing="2" cellpadding="0">                                   
                                <tr>
                                    <td valign="top" width="15%" class='copybold'>
                                        <logic:present name="frmAddCOIDisclosure" scope="session">
                                            <logic:equal name="frmAddCOIDisclosure" scope="session" property="disclosureTypeCode" value="1">
                                                &nbsp;&nbsp; <%--Award--%><bean:message bundle="coi" key="label.award"/>
                                            </logic:equal>
                                            <logic:notEqual name="frmAddCOIDisclosure" scope="session" property="disclosureTypeCode" value="1">
                                                &nbsp;&nbsp;<font color="red">*</font><bean:message bundle="coi" key="label.proposalTitle"/> 
                                            </logic:notEqual>
                                        </logic:present>&nbsp;:&nbsp;
                                    </td>
                                    <td>
                                        <logic:equal name="frmAddCOIDisclosure" scope="session" property="disclosureTypeCode" value="3">
                                            <html:textarea  cols ="80" rows="3" property="title" styleClass="copy"/>
                                        </logic:equal>
                                        <%-- Case 3513 - START --%>
                                        <logic:notEqual name="frmAddCOIDisclosure" scope="session" 
                                                        property="disclosureTypeCode" value="3">
                                            <td colspan="0" class='copy'>						
                                                <html:textarea cols ="80" rows="3" property="title" readonly = "true" styleClass="copy" onchange="limitText(this.form.title, 150)"/>						
                                            </td>
                                        </logic:notEqual>
                                        <%-- Case 3513 - END--%>
                                    </td>
                                ...
                                <logic:equal name="frmAddCOIDisclosure" scope="session" property="disclosureTypeCode" value="3">
                                    <tr>			
                                        <td valign="top" width="120" class='copybold'>
                                            &nbsp;&nbsp;<font color="red">*</font><bean:message bundle ="coi" key="label.proposalType"/>&nbsp;:&nbsp;
                                        </td>                                               
                                        <td valign="top" colspan="2">                                                
                                            <select name="proposalTypeCode" class='textbox-long'>
                                                <%
                                ...
                                <tr>			
                                    <td valign="top" class ='copybold'>
                                        &nbsp;&nbsp;<font color="red">*</font><bean:message bundle="coi" key="label.sponsor"/>&nbsp;:&nbsp;
                                    </td>
                                    <logic:equal name="frmAddCOIDisclosure" scope="session" property="disclosureTypeCode" value="3">                                       			
                                        <td  class="copy">                                                       			
                                            <html:text property="sponsorName" size="25" style="copy" styleClass="textbox-long"/>				
                                        </td>
                                    </logic:equal>
                                    <logic:notEqual name="frmAddCOIDisclosure" scope="session" property="disclosureTypeCode" value="3">
                                        <td colspan="3" class='copy'>                                                        
                                            <html:text size="45" readonly="true" property="sponsorName" style="copy" styleClass="textbox-long" />
                                        </td>
                                    </logic:notEqual>
                                </tr>
                    ...
                    <tr>
                        <td colspan="4" align="left" valign="top">
                            <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" class="tableheader">
                                <tr>
                                    <td> <bean:message bundle="coi" key="coiDisclosure.headerCert"/>  </td>
                                </tr>
                        </table></td>
                    </tr>  
                    ...
                    <tr align="center">
                        <td colspan="2"><br>
                            <%--<DIV STYLE="overflow: auto; width: 900px; height: 165; padding:0px; margin: 0px">--%>
                                <table width="99%"  border="0" cellpadding="2" callspacing="0" class="tabtable">
                                    <logic:present name="questionsData" scope="session">
                                        <tr>                                                
                                            <td width="80%" align="center" class="theader"> <bean:message bundle="coi" key="label.question"/> </td>
                                            <td width="40%" align="center" class="theader"> <bean:message bundle="coi" key="label.answer"/> </td>                                                
                                        </tr>
                                        <logic:notEqual name="questionsSize" value="0" >
                                            ...
                                            %>    
                                            <INPUT type='hidden' name='hdnQuestionId' value='<%=dynaValidatorForm.get("questionId")%>'>                                                    
                                            <INPUT type='hidden' name='hdnQuestionDesc' value='<%=dynaValidatorForm.get("description")%>'>
                                            ...
                                            <tr bgcolor="<%=strBgColor%>" class="rowLine" onmouseover="className='rowHover rowLine'" onmouseout="className='rowLine'">    
                                                <td class="copy" valign="top">
                                                    <logic:present name="certQuestionErrors">
                                                        ...
                                                        %>
                                                        <font color="red">
                                                            <bean:message key="error.addCOIDisclosure.entYesAnsNoForOne" bundle="coi"/>
                                                            <%=correspEntQuestLabel%>
                                                            <bean:message key="error.addCOIDisclosure.entYesAnsNo2ForOne" bundle="coi"/>
                                                        </font>
                                                        <%
                                                                } else{
                                                        %>
                                                        <font color="red">
                                                            <bean:message key="error.addCOIDisclosure.entYesAnsNoForTwo" bundle="coi"/>
                                                            <%=correspEntQuestLabel%>							 
                                                            <bean:message key="error.addCOIDisclosure.entYesAnsNo2ForTwo" bundle="coi"/>
                                                        </font>
                                                        <%
                                                                }
                                                        ...
                                                        %>
                                                        <a href="<bean:write name='ctxtPath'/>/editFinEnt.do?actionFrom=addDiscl&entityNumber=<%=entityNumber%>"> <%=entityName%></a>
                                                        <%
                                                        ...
                                                        <font color="red">
                                                            <bean:message key="error.addCOIDisclosure.entYesAnsNo3ForOne" bundle="coi"/>
                                                            <%=correspEntQuestLabel%>
                                                            <bean:message key="error.addCOIDisclosure.entYesAnsNo4ForOne" bundle="coi"/>							 
                                                        </font>
                                                        <%
                                                                } else{
                                                        %>
                                                        <!--<font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="red">-->
                                                        <font color="red">
                                                            <bean:message key="error.addCOIDisclosure.entYesAnsNo3ForTwo" bundle="coi"/>
                                                            <%=correspEntQuestLabel%>							 
                                                            <bean:message key="error.addCOIDisclosure.entYesAnsNo4ForTwo" bundle="coi"/>							 
                                                        </font>				
                                                        <%
                                                                }//End else
                                                        ...
                                                        %>                                                       
                                                        <font color="red">
                                                            <bean:message key="error.addCOIDisclosure.noFinEntAnsReqExplForOne" bundle="coi"/><br>
                                                            <html:link action="/getAddFinEnt.do?actionFrom=addDiscl"><bean:message bundle="coi" key="label.addFinancialEntity"/><%--Add Financial Entity--%></html:link>
                                                            <bean:message key="error.addCOIDisclosure.noFinEntAnsReqExplForTwo" bundle="coi"/>
                                                        </font>			
                                                        <%
                                                            }
                                                        ...
                                                        <font color="red">
                                                            <bean:message key="error.addCOIDisclosure.entNoAnsYes" bundle="coi"/>
                                                            <%=correspEntQuestLabel%>							 
                                                            <bean:message key="error.addCOIDisclosure.entNoAnsYes2" bundle="coi" />						
                                                            <a href="<bean:write name="ctxtPath"/>/getReviewFinEnt.do?actionFrom=addDiscl">
                                                                <bean:message key="error.addCOIDisclosure.entNoAnsYes3" bundle="coi"/>
                                                            </a>
                                                        </font>							
                                                        <bean:message key="error.addCOIDisclsoure.entNoAnsYes4" bundle="coi"/>
                                                        <%
                                                            }
                                                        }
                                                        %>   
                                                    ...
                                                    <div align="justify">
                                                        <b>Question <%=dynaValidatorForm.get("label")%></b> &nbsp;:&nbsp;<%=dynaValidatorForm.get("description")%> 
                                                        <a href='javascript:showQuestion("/question.do?questionNo=<%=dynaValidatorForm.get("questionId")%>",  "ae");'  method="POST">
                                                            <u>  <bean:message bundle="coi" key="financialEntity.moreAbtQuestion"/><%--More about this question--%> </u>  
                                                        </a>
                                                    </div>   
                                                </td>
                                                <td class="copy" valign="top" width="50%">
                                                <table border="0" width="100%" cellpadding="0" cellspacing="0" border="0" class="copy">
                                                <tr align="center">
                                                    <td style="border-style:solid none; border-width:0px 0;">
                                                        <bean:message bundle="coi" key="financialEntity.yes"/><br>
                                                        <input type="radio" name="<%= questionId %>"  value="Y" <%=checkedYes%> class='copy'>
                                                    </td>
                                                    <td style="border-style:solid none; border-width:0px 0;">
                                                        <bean:message bundle="coi" key="financialEntity.no"/><br>
                                                        <input type="radio" name="<%= certCode %>"  value="N"   <%=checkedNo%> class='copy'>
                                                    </td>
                                                    <% if(noOfAns!=null && Integer.parseInt(noOfAns)> 2 ){%>
                                                    <td style="border-style:solid none; border-width:0px 0;">
                                                        <bean:message bundle="coi" key="financialEntity.na"/>
                                                        <input type="radio" name="<%= certCode %>"  value="X" <%=checkedNA%> class='copy'>
                                                    </td>
                                                    <%}%>
                                                </tr>
                                                </table>
                                    ...
                                    <logic:equal name="questionsSize" value="0" >
                                        <tr>
                                            <td colspan='3' height="23" align=center>
                                                <div>
                                                    <bean:message bundle="coi" key="financialEntity.noCertQuestionFound"/><%--No Certification Questions Found--%>
                                                </div>
                                            </td>
                                        </tr>
                                    </logic:equal>
        ...
        <tr>
            <td height="119" align="left" valign="top"><br>
                <table width="99%"  border="0" align="center" cellpadding="3" cellspacing="0" class="tabtable">
                    <tr class="tableheader">
                        <!--<td align="left" valign="top">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableheader">
                                <tr>-->
                                    <td><bean:message bundle="coi" key="coiDisclosure.headerFinEntities"/>  </td>
                                <!--</tr>
                        </table>
                    </td>-->
                    </tr>
                    ...
                    <tr>
                        <td colspan="6" class='copy' style='copy'>
                            &nbsp;&nbsp;<bean:message bundle="coi" key="label.setConflictStatus"/><%--Set conflict status for all entities to:--%>
                            <select name="conflictStatus" class='textbox-long' onchange="changeAllStatus();">
                                <option selected>-<bean:message bundle="coi" key="label.pleaseSelect"/><%-- Please Select ---%></option>
                                <%
                                String description1 = "";
                                String code1 = "";
                    ...
                    <!--<DIV STYLE="overflow: auto; width: 920px; height: 165; padding:0px; margin: 0px">-->
                        <table width="99%"  border="1" cellpadding="2" cellspacing="0" class="tabtable">
                        <tr>
                            <td width="40%" class="theader">
                                <bean:message bundle="coi" key="label.entityName"/>
                            </td>
                            <td class="theader" width="20%">
                                <bean:message bundle="coi" key="label.conflictStatus"/>
                            </td>
                            <td class="theader" width="10%" nowrap>
                                <bean:message bundle="coi" key="label.reviewedBy"/>
                            </td>
                            <td class="theader" width="30%" >
                                <bean:message bundle="coi" key="label.relationshipDesc"/>
                            </td>                                    
                        </tr>
                        <logic:present name="personDescDet" scope="session"> 
                            ...
                            %>
                            <logic:iterate id="personDet" name="personDescDet" type="org.apache.commons.beanutils.DynaBean">
                                <INPUT type='hidden' name='hdnEntityNum' value='<bean:write name="personDet" property="entityNumber"/>'>
                                <INPUT type='hidden' name='hdnEntSeqNum' value='<bean:write name="personDet" property="entitySequenceNumber"/>'>
                                <INPUT type='hidden' name='hdnSeqNum' value='<bean:write name="personDet" property="sequenceNum"/>'>
                                <%                                  
                                if (disclIndex%2 == 0) {
                                strBgColor = "#D6DCE5";
                                } else {
                                ...
                                <tr bgcolor='<%=strBgColor%>' class="rowLine" onmouseover="className='rowHover rowLine'" onmouseout="className='rowLine'">                                       
                                    <td class="copy">
                                        <coeusUtils:formatOutput name="personDet" property="entityName"/> 
                                        
                                    </td>
                                    <td  class="copy">
                                        <select name="sltConflictStatus<%=disclIndex%>" class='textbox-long'>
                                            <%
                                            ...
                                            %>
                                            <option value="">-<bean:message bundle="coi" key="label.pleaseSelect"/></option>
                                            <%
                                            String description2 = "";
                                            String code2 = "";
                                            for(int i=0;i<coiStatus.size();i++){
                                    ...
                                    <td align="left" class="copy">
                                        <bean:message bundle="coi" key="label.pI"/><%--PI--%>
                                    </td>
                                    <td>
                                        <%--INPUT type='text' class='textbox-long' name='relationShipDesc' value="<%=personDet.get("relationShipDesc") %>" maxlength="1000"--%>
                                        
                                        <INPUT type='text' class='textbox-long' name='relationShipDesc<%=disclIndex%>' value="<%=personDet.get("relationShipDesc") %>" maxlength="1000">
    ...
    <tr>
        <td colspan="3" nowrap class="copy" align="left" style='padding-left:6px;' width="100%">
    ...
    <table width="100%" height="100%" align="center" border="0" cellpadding="3" cellspacing="0" class="tabtable">
        <tr>
            <td align='center' class='copyred'>
                <br> &nbsp;&nbsp;&nbsp;  <bean:message bundle="coi" key="coiMessage.pleaseWait"/>  
            </td>
        </tr>
    </table>
</div>
