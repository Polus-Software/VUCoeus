...
<table width="980" height="100%" border="0" cellpadding="0" cellspacing="0" class="table">

  <tr>
    <td height="20" align="left" valign="top" class="theader">
      <bean:message bundle="coi" key="label.certificationQuesAnnDiscl"/>  <%=person.getFullName()%>
    </td>
  </tr>
  ...
  <%--<tr>
    ...
    <tr>
        <td>&nbsp;&nbsp;<bean:message bundle="coi" key="coiAnnualDisclosure.questionHeader"/></td>
    </tr>
   <!--Certification -Start -->    
                        ...
                        <tr align="center" class='copy'>
                                <td colspan="2">--%>
                                    <!--<DIV STYLE="overflow: auto; width: 900px; height: 165; padding:0px; margin: 0px">-->
                                     ...
                                     <table width="98%" class="tabtable" border="0" cellpadding="2" cellspacing="0">
                                             <logic:present name="ynqList" scope="session">
                                                    <tr class='copy'>                                                     
                                                        <td width="70%" wrap align="center" class="theader"> <bean:message bundle="coi" key="label.question"/> </td>
                                                        <td width="15%" align="center" class="theader"> <bean:message bundle="coi" key="label.answer"/> </td>                                                
                                                    </tr>
                                                     ...
                                                     <tr  bgcolor="<%=strBgColor%>" class="rowLine" onmouseover="className='rowHover rowLine'" onmouseout="className='rowLine'">  
                                                        <td width="70%" class='copy'> 
                                                                <logic:present name="certQuestionErrors">
                                                                        ...
                                                                        %>
                                                                           <a href="<bean:write name='ctxtPath'/>/editFinEnt.do?actionFrom=annDiscCert&entityNumber=<%=entityNumber%>"> <%=entityName%></a>
                                                                          <%
                                                                        ...
                                                                        %>                                                       
                                                                            <font color="red">
                                                                             <bean:message key="error.annDiscCertification.noFinEntAnsReq" bundle="coi"/>
                                                                             <a href="<bean:write name='ctxtPath'/>/getAddFinEnt.do?actionFrom=annDiscCert">Add a new Financial Entity</a>
                                                                             <bean:message key="error.annDiscCertification.noFinEntAnsReq2" bundle="coi"/>
                                                                             </font>			
                                                                        <%
                                                                                }
                                                                    ...
                                                                    <div class='copy' align="justify" ><b><bean:message bundle="coi" key="label.question"/><%--Question--%> <%=dynaValidatorForm.get("label")%></b> 
                            ...
                            <p align="left">&nbsp;&nbsp;<html:submit property="save" value=" Save And Proceed "/></p>
                            <!--</div>-->
                              <%--</td>                            
                          </tr>
                           <tr class='table'>
