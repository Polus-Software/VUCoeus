...
<jsp:useBean id="reviewAnnualDisc" scope="session"
	class="java.util.Vector" />
<bean:size id="vectSize" name="reviewAnnualDisc" />
<jsp:useBean id="reviewAnnualDisc1" scope="session"
	class="java.util.Vector" />
<bean:size id="vectSize1" name="reviewAnnualDisc1" />
  ...
  -->
		...
		<tr>
			...
			<td valign="top"><b><bean:message bundle="coi"
						key="coiAnnualDisclosure.headerData1" /> </b>
				...
				<table width="98%" border="0" align="center" cellpadding="2"
					...
					<logic:present name="reviewAnnualDisc" scope="session">
						<%  
						...
						<logic:notEqual name='vectSize' value='0'>
							<logic:iterate id="discInfo" name="reviewAnnualDisc"
								...
								<tr bgcolor='<%=strBgColor%>' id="row<%=disclIndex%>"
									...
									<td width="10%" class="copy" valign=top wrap colspan="0">
										<a
										href="/coeus/approveDisc.do?personId=<%=personID%>&person=<%=fullName%>"
		...
		<tr>
			...
			<td valign="top"><b><bean:message bundle="coi"
						key="coiAnnualDisclosure.headerData2" /></b>
				...
				<table width="98%" border="0" cellpadding="2" cellspacing="0"
					...
					<logic:present name="reviewAnnualDisc1" scope="session">
						<% // int disclIndex = 0;
                                                     String strBgColor = "#DCE5F1";

                                                    %>
						<logic:notEqual name='vectSize1' value='0'>
							<logic:iterate id="discInfo1" name="reviewAnnualDisc1"
								type="org.apache.commons.beanutils.DynaBean">
