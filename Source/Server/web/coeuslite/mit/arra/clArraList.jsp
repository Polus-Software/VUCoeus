			...
			<tr>
				<td height="653" align="left" valign="top">
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<!-- JM 10-13-2011 changed for metrics -->
							...
							<td colspan="4" align="left" valign="top">
								<table width="100%" height="20" border="0" cellpadding="0"
									...
									<tr>
										...
										<td align="right"><a
											href="<%=request.getContextPath()%>/getClosedReports.do?"><u><bean:message
														bundle="arra" key="headerLabel.closedReports" /></u></a></td>
									</tr>
								</table>
							</td>
						</tr>
							...
							<td>
								<table width="100%" height="100%" border="0" cellpadding="2"
									...
									<tr>
										...
										<td class="theader">&nbsp;</td>
										<!-- JM 3-23-2012 commented out for metrics
