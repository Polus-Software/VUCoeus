...
<html:javascript formName="generalInfoProposal" dynamicJavascript="true"
...
<body>
		...
		<table width="100%" height="100%" border="0" cellpadding="2"
			...
			<tr class="theader">
				<td colspan="3"><jsp:include
						page="/coeuslite/mit/award/jsp/awardInfoHeader.jsp" flush="true" />
				</td>
			</tr>
			...
			<table width="100%" height="100%" class="tableheader">
				<tr>
					...
					<td>Schedules and Special Reviews</td>
					<%--  </logic:present>--%>
				</tr>
				<tr class="theader">
					<td valign="top" width="50%">

						<table width="95%" height="100%" border="0" align="left"
							cellpadding="0" cellspacing="0" class="tabtable">
							<tr>
								<td align="left" class='copybold' nowrap>&nbsp;&nbsp;Pre
									Award Effective Date :</td>
								<td>&nbsp;<%= preawardEffDate%>
								</td>
							</tr>
							<tr>
								<td align="left" class='copybold' nowrap>&nbsp;&nbsp;Award
									Effective Date :</td>
								<td>&nbsp;<%= awardEffectiveDate%>
								</td>
							</tr>
							<logic:present name="awardListtmp">
								<tr></tr>
								<tr>
									<td align="left" class='copybold' width="30%" nowrap>&nbsp;&nbsp;Investigators
										:</td>
    ...
    {%>
								...
								<tr>
									...
									<td>
										<%;}
    count++;%> &nbsp;<bean:write name="investigators"
											property="fullname" />
										<%if(unitName != null && unitName.length() > 1) {%>(<%=unitName%>)<%}%>
										</logic:iterate>
							</logic:present>
							</td>
							...
							<tr>
								<td align="left" class='copybold' width="30%" nowrap>&nbsp;&nbsp;Key
									Persons :</td>
								<td align="left" width="70%">
									<% count=0;
    ...
    {%>
							...
							<tr>
								...
								<td>
									<%;}
    count++;%> &nbsp;<bean:write name="keypersons" property="fullname" />
									<%if(kpUnitName != null && kpUnitName.length() > 1) {%>(<%=kpUnitName%>)<%}%>
                  ...
                  <td colspan="2" align="left">
					...
					<td valign="top" width="50%">
						<table width="100%" height="100%" border="0" align="left"
							cellpadding="3" cellspacing="2" class="tabtable">
							<logic:present name="awardListtmp">
								<tr></tr>
...
%>
								...
								<tr>
									<td align="left" class='copybold' width="40%" nowrap>&nbsp;&nbsp;Approved
										Equipment</td>
									<td width="6%">
										<%
                if((apprvdEq!=null) && (apprvdEq.equalsIgnoreCase("N0"))){ %>
										...
										<input type="checkbox" name="apprvdEq" disabled="true" /> <%} else {%>
										<input type="checkbox" name="apprvdEq" checked="true"
										disabled="true" /> <%}%>


									</td>
									<td align="right" class='copybold' width="38%">&nbsp;&nbsp;Cost
										Sharing</td>
									<td>
										<%
                if((cost!=null) && (cost.equalsIgnoreCase("N0"))) {

    %> <input type="checkbox" name="cost" disabled="true" /> <%} else {%>

										<input type="checkbox" name="cost" checked="true"
										disabled="true" /> <%}%>
									</td>
								</tr>
								<tr>
									<td align="left" class='copybold'>&nbsp;&nbsp;Approved
										Subcontract</td>
									<td>
										<%
                if((apprvdsub!=null) && (apprvdsub.equalsIgnoreCase("N0"))) {

    %> <input type="checkbox" name="apprvdsub" disabled="true" /> <%} else {%>

										<input type="checkbox" name="apprvdsub" checked="true"
										disabled="true" /> <%}%>
									</td>
									<td align="right" class='copybold'>&nbsp;&nbsp;Indirect
										Cost</td>
									<td>
										<%
                if((indir!=null) && (indir.equalsIgnoreCase("N0"))) {

    %> <input type="checkbox" name="indir" disabled="true" /> <%} else {%>

										<input type="checkbox" name="indir" checked="true"
										disabled="true" /> <%}%>
									</td>
								</tr>
								<tr>
    ...
    %> <input type="checkbox" name="apprvdfor" disabled="true" /> <%} else {%>

										<input type="checkbox" name="apprvdfor" checked="true"
										disabled="true" /> <%}%>
									</td>
									<td align="right" class='copybold'>&nbsp;&nbsp;Transfer
										Sponsor</td>
									<td>
										<%
                if((transfr!=null) && (transfr.equalsIgnoreCase("N0"))) {

    %> <input type="checkbox" name="transfr" disabled="true" /> <%} else {%>

										<input type="checkbox" name="transfr" checked="true"
										disabled="true" /> <%}%>
									</td>
								</tr>

								<tr>
									<td class='copybold' align="left">&nbsp;&nbsp;Payment
										Schedule</td>
									<td colspan="3" align="left">
										<%
                if((paymnt!=null) && (paymnt.equalsIgnoreCase("N0"))) {

    %> <input type="checkbox" name="paymnt" disabled="true" /> <%} else {%>
										<input type="checkbox" name="paymnt" checked="true"
										disabled="true" /> <%}%>
									</td>
								</tr>
								...
								<tr>
									<td class='copybold' align="left">&nbsp;&nbsp;Special
										Reviews:</td>
								...
								<logic:present name="specialRevList">
										...
										<logic:iterate id="splRevList" name="specialRevList">
											<tr>
												<td align="left">&nbsp;&nbsp;<bean:write
														name="splRevList" property="specialReview" />
												</td>
												<td align="left"><bean:write name="splRevList"
														property="approvalTypeCode" /></td>
												<td align="center"><bean:write name="splRevList"
														property="protocolNumber" /></td>
												<td align="center" nowrap><bean:write name="splRevList"
									...
									<logic:empty name="specialRevList">
										<tr>
											<td colspan="4">&nbsp; &nbsp; No Special Reviews present
											</td>
										</tr>
									</logic:empty>
								</logic:present>
								...
								<logic:notPresent name="specialRevList">
									<tr>
										<td colspan="4">&nbsp; &nbsp;No Special Reviews present</td>
									</tr>
								</logic:notPresent>
			...
			<tr class="theader">
				<td colspan="2"><jsp:include
						page="/coeuslite/mit/award/jsp/ParentChild.jsp" flush="true" /></td>
			</tr>
	...
	<logic:notPresent name="awardListtmp">
		<table>
			<tr class="theader">
				<td width="5%" colspan="10" height="23" align=center>Award
					Details not present</td>
			</tr>
		</table>
	</logic:notPresent>
		...
		<logic:present name="awardDisclDetails">
			<table width="450px" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td colspan="4" align="left" valign="top">
						...
						<table width="100%" height="7" border="0" cellpadding="1"
							...
							<tr>
								<td height="10%" width="20%" align="left">Project # :</td>
								<td width="80%" align="left"><%=awardNumber%></td>
							</tr>
							<tr>
				...
				<tr height="22">
					...
					<td valign="top" class="theader" align="left">Disclosure
						Status</td>
				</tr>
				<% int index = 0;%>
				<logic:iterate id="awardDisclDetailsList" name="awardDisclDetails">
					<tr bgcolor="<%=strBgColor%>" valign="top"
						...
						<td class="copy" align="left"><logic:notEmpty
								name="awardDisclDetailsList" property="personName">
						...
						<td class="copy" align="left"><logic:notEmpty
								name="awardDisclDetailsList" property="role">
								<bean:write name="awardDisclDetailsList" property="role" />
							</logic:notEmpty></td>
						<td class="copy" align="left"><logic:notEmpty
								name="awardDisclDetailsList" property="disclosureStatus">
								<bean:write name="awardDisclDetailsList"
									property="disclosureStatus" />
							</logic:notEmpty> <logic:empty name="awardDisclDetailsList"
								property="disclosureStatus">
                                Not Disclosed
                            </logic:empty></td>
					</tr>
