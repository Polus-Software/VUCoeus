<%@ page contentType="text/html;charset=UTF-8" language="java"
	import="java.util.Hashtable,java.util.Vector,edu.mit.coeuslite.irb.action.TreeView;"%>
...
<body bgcolor="#000000">
	<%
   String srchStr="/areaSearch.do?type=area&form= "+ strForm;
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="10">
						<td class="copybold"><bean:message
							...
							<%--COEUS - Area Of Research Listing--%> <span class="copysmall">(<bean:message
									key="areaDialog.areaByClickingName" />
			...
			<tr>
				<td colspan="2">
					<table width="100%" border="0" cellspacing="0" cellpadding="10">
						<td class="copybold">
							<%if(expand){%> <html:link
								action="/areaSearch.do?type=area&form=areaForm&expand=false">
								<u><bean:message key="areaDialog.collapseAll" /></u>
							</html:link> <%} else {%> <html:link
								action="/areaSearch.do?type=area&form=areaForm&expand=true">
