...
<body text="#000000" link="#023264" alink="#023264" vlink="#023264"
	...
	<table border="0" height="100%" cellspacing="0" cellpadding="0"
		align="center">
		<tr>
			<td height='104' valign="top"><tiles:insert attribute="header" />
			</td>
		</tr>
		...
		<tr height="30px">
			<td valign="top"><tiles:insert attribute='body1'></tiles:insert>
			</td>
		</tr>
		<tr style="height: 3px;">
			<td></td>
		...
		<tr>
			<td valign="top" align="left"><tiles:insert attribute='body'></tiles:insert>
			</td>
		</tr>
