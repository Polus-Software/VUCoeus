...
<table id="bodyTable" class="table" style="width: 100%;height: 100%;" border="0" >
    ...
    <html:form action="/getProjectDetailsAndFinEntityDetailsAnnualCoiv2.do" method="post">
        ...
        <%if(pjtPresent){%>
                            <tr>
                                <td colspan="8">The following projects will be added to your disclosure. A check mark indicates the project financial entity relationship has been reviewed. All projects must be reviewed prior to submitting the disclosure. Click Continue to cycle through the listed projects or navigate to individual projects by clicking on the project number</td>
        ...
        <logic:notEmpty name="coiDevProposal">
            ...
            <logic:iterate id="allProposals" name="coiDevProposal">
                ...
                <tr bgcolor="<%=rowColor%>" class="rowLine" onmouseover="className='rowHover rowLine'" onmouseout="className='rowLine'" style="width: 765px;">
                    <td><%if(dataSaved){ %>
                        <img src="<%=request.getContextPath()%>/coeusliteimages/complete.gif" width="19" height="19"/>
                        <%}%>
                       </td>
                    <td colspan="2"><input type="checkbox" checked  style="visibility: hidden" name="checkedPropsalProjects" value="<bean:write name="allProposals" property="coiProjectId"/>;<bean:write name="allProposals" property="coiProjectTitle"/>;<bean:write name="allProposals" property="coiProjectStartDate"/>;<bean:write name="allProposals" property="coiProjectEndDate"/>"/>
                        <html:link action="<%=link%>"><bean:write name="allProposals" property="coiProjectId"/></html:link></td>
                    <td><bean:write name="allProposals" property="coiProjectTitle"/></td>
                    <td  colspan="2"><bean:write name="allProposals" property="coiProjectSponser"/></td>                   
            ...
            <logic:iterate id="allProposals1" name="coiInstProposals">
                <%
                         ...
                         if (i1 == 0) {
                            ...
                            instindex++;
                %>            
            <tr bgcolor="<%=rowColor1%>" class="rowLine" onmouseover="className='rowHover rowLine'" onmouseout="className='rowLine'" style="width: 765px;">
               <td><%if(dataSaved){ %>
                        <img src="<%=request.getContextPath()%>/coeusliteimages/complete.gif" width="19" height="19"/>
                        <%}%>
                       </td>
                <td colspan="2"><input type="checkbox" checked  style="visibility: hidden" name="checkedInstPropsalProjects" value="<bean:write name="allProposals1" property="coiProjectId"/>;<bean:write name="allProposals1" property="coiProjectTitle"/>;<bean:write name="allProposals1" property="coiProjectStartDate"/>;<bean:write name="allProposals1" property="coiProjectEndDate"/>;<bean:write name="allProposals1" property="personName"/>;<bean:write name="allProposals1" property="coiProjectId"/>"/>
                <html:link action="<%=link%>"><bean:write name="allProposals1" property="coiProjectId"/></html:link></td>
                </td>
           <td><bean:write name="allProposals1" property="coiProjectTitle"/></td>           
           <td colspan="2"><bean:write name="allProposals1" property="coiProjectSponser"/></td>           
                </tr>
                </logic:iterate>
  </logic:notEmpty>
                ...
                <logic:iterate id="allProtocols" name="coiIRBprotocol">
                    <%
                               ...
                               String link = "/coiSaveSelectedProject.do?selectedProject="+coiProtocolInfoBeanproto.getModuleItemKey();
                                protoIndex++;
                    %>
                <tr bgcolor="<%=rowColorProto%>" class="rowLine" onmouseover="className='rowHover rowLine'" onmouseout="className='rowLine'" style="width: 765px;">
                    <td><%if(dataSaved){ %>
                        <img src="<%=request.getContextPath()%>/coeusliteimages/complete.gif" width="19" height="19"/>
                        <%}%>
                       </td>
                    <td colspan="2">
                       <input type="checkbox" checked style="visibility: hidden" name="checkedProtocolBasedProjects" value="<bean:write name="allProtocols" property="coiProjectId"/>;<bean:write name="allProtocols" property="coiProjectTitle"/>;<bean:write name="allProtocols" property="coiProjectStartDate"/>;<bean:write name="allProtocols" property="coiProjectEndDate"/>"/>
                      <html:link action="<%=link%>"><bean:write name="allProtocols" property="coiProjectId"/></html:link> 
                    </td>
                    <td><bean:write name="allProtocols" property="coiProjectTitle"/></td>
                    <td colspan="2"><bean:write name="allProtocols" property="coiProjectStartDate" format="yyyy-MM-dd"/></td>                    
                </tr>
                    </logic:iterate>
                   </logic:notEmpty>
                </logic:present>
        <logic:present name="coiIACUCProtocol">
            ...
            <tr style="background-color:#6E97CF;">
               ...
               <tr bgcolor="<%=rowColorProto1%>" class="rowLine" onmouseover="className='rowHover rowLine'" onmouseout="className='rowLine'" style="width: 765px;">
                   <td><%if(dataSaved){ %>
                        <img src="<%=request.getContextPath()%>/coeusliteimages/complete.gif" width="19" height="19"/>
                        <%}%>
                       </td>
                   <td colspan="2"><input type="checkbox" checked style="visibility: hidden" name="checkedIacucProtocolBasedProject" value="<bean:write name="alliacucProtocols" property="coiProjectId"/>;<bean:write name="alliacucProtocols" property="coiProjectTitle"/>;<bean:write name="alliacucProtocols" property="coiProjectStartDate"/>;<bean:write name="alliacucProtocols" property="coiProjectEndDate"/>"/>
                       <html:link action="<%=link%>"><bean:write name="alliacucProtocols" property="coiProjectId"/></html:link> </td>
                   <td> <bean:write name="alliacucProtocols" property="coiProjectTitle"/></td>
               <td colspan="2"><bean:write name="alliacucProtocols" property="coiProjectStartDate" format="yyyy-MM-dd"/></td>               
               </tr> 
                    </logic:iterate>
                 </logic:notEmpty>
                </logic:present>
        ...
        <logic:present name="coiAward">
            ...
            <tr style="background-color:#6E97CF;">
                 <td><strong></strong></td>
                    <td width="15%"style="padding-left: 20px"><strong>Award #</strong></td>
            ...
            <logic:iterate id="allAwards" name="coiAward">
                <%
                            ...
                            awardIndex++;
                %>
                <tr bgcolor="<%=rowColorAward%>" class="rowLine" onmouseover="className='rowHover rowLine'" onmouseout="className='rowLine'" style="width: 765px;">
                   <td><%if(dataSaved){ %>
                        <img src="<%=request.getContextPath()%>/coeusliteimages/complete.gif" width="19" height="19"/>
                        <%}%>
                       </td>
                    <td><input type="checkbox" checked style="visibility: hidden" name="checkedAwardBasedProjects" value="<bean:write name="allAwards" property="coiProjectId"/>;<bean:write name="allAwards" property="awardTitle"/>;<bean:write name="allAwards" property="coiProjectStartDate"/>;<bean:write name="allAwards" property="coiProjectEndDate"/>"/>
                        <html:link action="<%=link%>"><bean:write name="allAwards" property="coiProjectId"/></html:link></td>
                    <td align="center"><bean:write name="allAwards" property="accountNumber"/></td>
                       <td><bean:write name="allAwards" property="coiProjectTitle"/></td>
                       <td><bean:write name="allAwards" property="coiProjectSponser"/></td>
                       <td><bean:write name="allAwards" property="coiProjectStartDate" format="yyyy-MM-dd"/></td>
                ...
                <logic:empty name="coiIACUCProtocol">
                    <logic:empty name="coiAward">
                        <logic:empty name="coiInstProposals">                         
                               <tr>
                                  <td>
                                     <font color="red">You do not have any Projects</font>                       
                                  </td>
                               </tr>
                               <tr>
                                 <td align="left" colspan="4">
                                    <% String link2 = "javaScript:noProjects()";
                                         hasEntered =true;%>
                                    <html:button styleClass="clsavebutton"  value="Continue" property="save"  onclick="<%=link2%>"/>
