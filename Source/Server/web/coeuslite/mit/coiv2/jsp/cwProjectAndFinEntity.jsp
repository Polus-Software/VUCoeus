            ...
            if(coiPersonProjectDetails.getCoiProjectEndDate()!=null)
            {
              endDate = (String) coiCommonService1.getFormatedDate(coiPersonProjectDetails.getCoiProjectEndDate());
               ...
               <%
                ...
                <tr><td colspan="2"><b>For your project listed below, think about your relationship with all your Financial Entities and update the Financial Interest status as appropriate:</b></td></tr>
                 <tr><td colspan="2"><b>Project #:</b><%=pjctId%></td></tr>
                ...
                <tr>
                    ...
                    <% }else if(projectType.equals("Travel")){%>
                        <tr><td colspan="2"><b>For your project listed below, think about your relationship with all your Financial Entities and update the Financial Interest status as appropriate:</b></td></tr>
                      <tr><td colspan="2"><b>Project # :</b><%=moduleItemKey%></td></tr>
                     <tr><td colspan="2"> <b>Project Title :</b><%=eventName%></td></tr>
                     <tr>
                         <td style="width: 410px;"><b>Start Date :</b><%=startDate%></td>
                         <td style="width: 410px;"><b>End Date :</b><%=endDate%></td>
                     </tr>
                    <%}%>
<tr>
 <td class="copybold"  colspan="2"><img width="100%" height="2" border="0" src="<%=request.getContextPath()%>/coeusliteimages/line4.gif"></img></td>
</tr>

                <tr>
                    <td colspan="2">
                        <b> Set Financial Interest Status for all Financial Entities to: </b>
                   
                        <html:select property="coiStatusCode" onchange="changeStatusCode();"  style="width:190px" >
                            <html:option   value="--------Please Select---------"/>
                        <html:options collection="typeList" property="code" labelProperty="description"/> 
                        </html:select>   
                 </td> 
                </tr>
<tr><td class="copybold" colspan="2"><img width="100%" height="2" border="0" src="<%=request.getContextPath()%>/coeusliteimages/line4.gif"></img></td></tr>
                ...
                <logic:iterate id="financialEntity" name="financialEntityList">
                    ...
                    <tr class="copybold" bgcolor="#9DBFE9"  class="rowLine">
                        <td colspan="2"><br/>
                            <div style="font-size: 13; float: left;"><b>Financial Entity: &emsp; &nbsp; <bean:write name="financialEntity" property="description"/></b></div>
            ...
            if(comments.trim().length()>210)
                {comments=(String)comments.substring(0,210);
                 comments+="<a href=\"javaScript:showDialog('txtAreaCommentId"+nameType+"')\">[...]</a>";
                                ...
                                <tr><td width="17%"></td><td colspan="2"><b>Description of entity's area of business focus and specifically your work with it.</b></td></tr>
                               
                                <tr><td width="17%"></td><td colspan="2"><font color="black">
                                            <i>" <%=comments%> "</i></font>
                                            <textarea id="relDesc<%=nameType%>" style="display: none" name="relDesc<%=nameType%>"  cols="77" rows="3"><%=typeBean.getRelationshipDescription()%></textarea>
                                    </td></tr>
                                    <tr><td colspan="3">

            <%--<input type="hidden" name="actionFrom" value="coiAnnFin"/>--%>
<!--            coeus -3424 starts-->
            <input id="txtAreaCommentId<%=nameType%>" name="finEntDet" type="hidden" value="<%=typeBean.getRelationshipDescription()%>" />
<!--            coeus -3424 ends-->
           &nbsp;&nbsp;
            </td></tr> <tr><td></td></tr> <tr><td></td></tr> <tr><td></td></tr> <tr><td></td>
             ...
             <tr><td></td></tr> <tr><td></td></tr> <tr><td></td></tr> 
                            ...
                            <tr><td width="17%"></td><td colspan="2"><b>Describe the relationship between this project and this entity, include any involvement of students, staff,and</b></td></tr>
                                <tr><td width="17%"></td><td colspan="2"><b> MIT resources. If there is no relationship, explain why.</b></td></tr>
                            <tr><td colspan="3" align="right"><textarea id="orgRelDesc<%=nameType%>"  name="orgRelDesc<%=nameType%>" cols="77" rows="8" ><%=typeBean.getOrgRelationDescription()%></textarea></td></tr>
          <tr><td class="copybold" colspan="3"><img width="100%" height="2" border="0" src="<%=request.getContextPath()%>/coeusliteimages/line4.gif" /></td></tr>
                        <%inx++;%> 
                ...
                <tr> 
                     <td class='savebutton' align="left" colspan="2"> 
                        <%/*if(disable==false){*/%>
                        <html:button styleClass="clsavebutton" style="width:150px;" value="Save & Continue" property="save"  onclick="javaScript:saveFinEntityConflict();"/>
                        <%/*}else{*/%>
                        <%--<html:button styleClass="clsavebutton" style="width:150px;" value="Continue" property="save"  onclick="javaScript:saveFinEntityConflict();"/>--%>
                        <%/*}*/%>

                        <html:button styleClass="clsavebutton" style="width:150px;" value="Discard Changes" property="save"  onclick="javaScript:exitToCoi();"/>
                    </td>  
                </tr>    
