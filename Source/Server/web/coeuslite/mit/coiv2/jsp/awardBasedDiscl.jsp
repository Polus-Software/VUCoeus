		...
		<logic:empty name="allAwardList">
			<tr>
				<td colspan="5"><p style="color: #ff0000; font-size: 12px;">There
						are no awards in the system that requires your COI disclosure.</p></td>
			</tr>
		</logic:empty>
		<logic:notEmpty name="allAwardList">
			<tr>
				<td colspan="5">Please select an award from the list to create
					a new COI disclosure</td>
			</tr>

			<tr style="background-color: #6E97CF;">
				<td width="15%" style="padding-left: 23px"><strong>Award
						#</strong></td>
			...
			<logic:iterate id="allAwards" name="allAwardList">
				...
				<tr bgcolor="<%=rowColor%>" class="rowLine"
					...
					<td><input type="radio" <%=disable%> <%=checked%>
						...
						value="<bean:write name="allAwards" property="mitAwardNumber"/>;<bean:write name="allAwards" property="awardTitle"/>;<bean:write name="allAwards" property="startDate"/>;<bean:write name="allAwards" property="awardExecutionDate"/>;<bean:write name="allAwards" property="projectSponsor"/>" />
					<bean:write name="allAwards" property="mitAwardNumber" /></td>
					...
					<td><bean:write name="allAwards" property="startDate"
