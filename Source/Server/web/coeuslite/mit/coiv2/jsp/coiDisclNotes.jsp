...
<%@ page import="edu.mit.coeus.bean.PersonInfoBean,edu.mit.coeuslite.coiv2.beans.Coiv2NotesBean,java.util.Vector,java.util.HashMap,edu.mit.coeuslite.coiv2.utilities.CoiConstants"%>
        ...
        <td valign="top">
            ...
            <html:form action="/saveNotesCoiv2.do">
                <div id="notesProtocol">
                    <table style="width: 765px;" height="100%"  border="0" cellpadding="0" cellspacing="0" class="table" align='center'>
                                            ...
                                            <td>
                                                <table width="100%"  border="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td >
                                                            <html:text   styleClass="copy" disabled="<%=disable%>" property="title" maxlength="500"/>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="4">
                                                            <html:textarea styleClass="copy" disabled="<%=disable%>" property="comments" cols="120" rows="5"/>
                                                        </td>
                                                    </tr>
                            ...
                            <td align="left" valign="top" class='core'>
                                <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tabtable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="theader" align='left'>
                                            <bean:message key="protocolNote.label.time"/>
                                        </td>
                                    ...
                                    <logic:present name="disclosureNotesData">
                                        <logic:iterate id="disclosureNotes"  name="disclosureNotesData" type="edu.mit.coeuslite.coiv2.beans.Coiv2NotesBean">
                                            ...
                                            <tr bgcolor="<%=strBgColor%>">
                                                ...
                                                <td class="copy" align='left'>
                                                    <bean:write name="disclosureNotes" property="updateTimestamp"/>
                                                </td>
