...
<%@ page
	import="edu.mit.coeus.bean.PersonInfoBean,edu.mit.coeuslite.coiv2.beans.Coiv2NotesBean,java.util.Vector,edu.mit.coeuslite.coiv2.beans.Coiv2AttachmentBean,edu.mit.coeuslite.coiv2.utilities.CoiConstants,edu.mit.coeuslite.coiv2.beans.CoiDisclosureBean;"%>
       ...
       <logic:equal name="userHaveRight" value="true">--%>
			...
			<logic:notPresent name="showAttachment">
				<table style="width: 100%;" height="100%" border="0" cellpadding="0"
					...
					<tr>
						<td class="theader" colspan="2">Disclosure Notes</td>
					</tr>
					<tr>
						<td class="copybold" align="left" valign="top"><bean:message
								key="protocolNote.label.addNotes" /></td>
					</tr>
					<tr>
						<td>
							...
							<table width="100%" border="0" cellpadding="0">
								<tr>
									<td align="left" class="copybold" style="width: 20%;">Note
										Topic:</td>
									...
									<td align="left" class="copybold" style="width: 50%;">
										Note Type:&nbsp; <logic:notEmpty name="notepadTypeList">
											<html:select property="coiNotepadEntryTypeCode"
												name="coiv2NotesBean" style="width:200px"
												styleClass="textbox-long">
												<html:option value="">
													<bean:message key="specialReviewLabel.pleaseSelect" />
												</html:option>
												<html:options collection="notepadTypeList" property="code"
													labelProperty="description" />>
                      </html:select>
										</logic:notEmpty> <logic:empty name="notepadTypeList">
											<html:select property="coiNotepadEntryTypeCode"
												name="coiv2NotesBean" styleClass="textbox-long"
												style="width:200px">
												<html:option value="">
													<bean:message key="specialReviewLabel.pleaseSelect" />
												</html:option>
                         ...
                         disable=false;
                     %> <html:checkbox styleClass="copy"
											disabled="<%=disable%>" name="coiv2NotesBean" value="R"
                           ...
                           <bean:message key="protocolNote.label.comment"/>:--%>
									...
									<td colspan="3"><html:textarea styleClass="copy"
											property="comments" name="coiv2NotesBean" cols="100" rows="5" />
									</td>
								</tr>
							</table>
						</td>
					...
					<tr style="width: 100px;">
						<td style="width: 50px;"><html:button property="Save"
								styleClass="clsavebutton" onclick="javaScript:saveNotes();">
			...
			<table id="noteBodyTable" class="table" style="width: 100%;"
				...
				<tr>
					...
					<td class="theader" align='left' style="width: 25%">Update
						Timestamp</td>
				...
				<logic:empty name="disclosureNotesData">
					<tr>
						<td colspan="8"><font color="red">No notes found</font></td>
					</tr>
				</logic:empty>
				...
				<logic:present name="disclosureNotesData">
					...
					<logic:iterate id="disclosureNotes" name="disclosureNotesData"
						...
						<tr bgcolor="<%=notstrBgColor%>" id="row<%=indexnote%>"
							...
							<td style="width: 20%;"><bean:write name="disclosureNotes"
									property="title" /></td>
							<%--code added to bring forward previously approved sequences notes start--%>
							<logic:equal name="fromViewCurrent" value="true">
								<td style="width: 20%;"><%=moduleItmKey%></td>
								<td align="justify"><bean:write name="disclosureNotes"
							...
							<%--code added to bring forward previously approved sequences notes ends--%>
							<td style="width: 25%;"><bean:write name="disclosureNotes"
									property="updateTimestamp" />by <bean:write
									name="disclosureNotes" property="updateUserName" /></td>
