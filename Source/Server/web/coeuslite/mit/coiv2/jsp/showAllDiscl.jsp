...
<tr style="background-color:#6E97CF;height: 22px;width: 985px;">
    <td colspan="5" style="background-color:#6E97CF;color:#FFFFFF;font-size:14px;font-weight:bold;margin: 0;padding: 2px 0 2px 10px;position: relative;text-align: left;"><strong>List Of All Open Reviews</strong></td>
</tr>    
    <tr>
        <td colspan="5" style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;">Open Reviews with No Financial Entities</td>
    </tr>
<tr>
...
<td width=""><html:link action='<%=linkPrint%>' target="_blank">Print</html:link></td>                        
 <td width="">     <%if(!isFEPresent){%>
         <%
            String linkAppr = request.getContextPath()+"/updateStatus.do?&param1=" + bean.getCoiDisclosureNumber() +"&param2=" + bean.getSequenceNumber()+"&param3="+ bean.getPersonId()+"&fromReviewList=true&isFRmListApprv=true&frmList=showAll";
         %>
...
<%request.getSession().setAttribute("lastIndex",index);%>
 ...
 <tr>
        <td colspan="5" style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;">Open Reviews with Financial Entities</td>
    </tr>
<tr>
    <td style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;" width="2%"></td>
    <td style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;" width="30%"><strong>Owned By</strong></td>
