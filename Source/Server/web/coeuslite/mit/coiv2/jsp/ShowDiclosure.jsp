...
<%@ page import="edu.mit.coeuslite.coiv2.beans.Coiv2NotesBean,java.util.Vector,edu.mit.coeuslite.coiv2.beans.Coiv2AttachmentBean,edu.mit.coeuslite.coiv2.utilities.CoiConstants,edu.mit.coeuslite.coiv2.beans.CoiDisclosureBean"%>
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <html:form action="/assignDisclToUser.do">
        <body>
            <div id="content" style="padding:4px;width:970px;background-color: #D1E5FF">
                <table style="background-color: #D1E5FF">
                    <tr>
                        <td valign="top">
                            <table class="table" align="left" width="200px" bgcolor="#9DBFE9" style="padding: 4px;">
                                <tr><td>
                                        <div id="contentleft">
                                            <table class="table" align="center" width="98%" style="padding: 4px;border: 0">
                                                ...
                                                <tr class="rowline">
                                                    ...
                                                    <td width="80%"  height='16' align="left" valign="middle" class = "coeusMenu">
                                                        <html:link page="/screeningquestions.do">Screening Questions</html:link>
                                                    </td>
                                                ...
                                                <tr class="rowLine">
                                                    ...
                                                    <td width='80%'  align="left" valign="middle" class = "coeusMenu" >
                                                        <html:link page="/financialentities.do"> Financial Entity</html:link>
                                                    </td>
                                                    <td width='4%' align=right  class ="selectedMenuIndicator" ></td>
                                                </tr>
                                                    <tr class="rowLine">
                                                    <td width="16%"  height='16' align="left" valign="top" class = "coeusMenu"></td>
                                                    <td width="80%"  align="left" valign="middle" class = "coeusMenu" >
                                                        <html:link page="/attachments.do">Attachments</html:link>
                                                    </td>
                                                    <td width='4%' align=right  class ="selectedMenuIndicator" ></td>
                                                </tr>
                                                <tr class="rowLine">
                                                    ...
                                                    <td align="left" valign="middle" class = "coeusMenu" >
                                                        <html:link page="/notes.do">Notes</html:link>
                                                    </td>
                                                    <td width='4%' align=right  class ="selectedMenuIndicator" ></td>
                                                </tr>
                                                ...
                                                <tr class="rowLine">
                                                    <td width="16%"  height='16' align="left" valign="top" class = "coeusMenu"></td>
                                                    <td width="80%"  align="left" valign="middle" class = "coeusMenu" >
                                                        <html:link page="/certifications.do">Certification</html:link>
                                                    </td>
                                                    <td width='4%' align=right  class ="selectedMenuIndicator" ></td>
                                                </tr>
                                                <%-- <tr class="rowLine">
                                                ...
                                                <logic:present name="<%=CoiConstants.IS_ADMIN%>">
                                                    <logic:equal value="true" name="<%=CoiConstants.IS_ADMIN%>">
                                                        <tr class="rowLine">
                                                            <td width="16%"  height='16' align="left" valign="top" class = "coeusMenu"></td>
                                                            <td width="80%"  align="left" valign="middle" class = "coeusMenu" >
                                                                <html:link page="/setstatus.do">Set Status</html:link>
                                                            </td>
                                                            <td width='4%' align=right  class ="selectedMenuIndicator" ></td>
                                                        </tr>
                                                        <tr class="rowLine">
                                                            <td width="16%"  height='16' align="left" valign="top" class = "coeusMenu"></td>
                                                            <td width="80%"  align="left" valign="middle" class = "coeusMenu" >
                                                                <html:link page="/assignviewer.do">Assign Viewer</html:link>
                                                            </td>
                                                            <td width='4%' align=right  class ="selectedMenuIndicator" ></td>
                                                        </tr>
                                                    </logic:equal></logic:present>
                                                    <tr bgcolor="#9DBFE9"><td style="height: 410;" >&nbsp;</td></tr>
                                                </table>

                                            </div></td></tr>
                                </table>
                            </td><td valign="top">
                                <div id="contentright" style="padding: 0px;width: 755px;border: 0">
                                    <table id="bodyTable" class="table" style="width: 755px;" border="0">
                                ...
                                <div class="myForm" style="background-color: #9dbfe9;visibility:hidden;height:1px;width: 755px" id="certdiv">
                                    <logic:present name="certDetView">
                                        ...
                                        <logic:iterate id="certView" name="certDetView">
                                            <bean:write name="certView" property="certificationText"/><br/><br/><br/>
                                            <b>Certified By:</b>
                                            <bean:write name="certView" property="certifiedBy"/><br/><br/><br/>
                                            <b>Last Updated :</b>
                                            <bean:write name="certView" property="certificationTimestamp"/><br/><br/><br/>
                                        </logic:iterate>
                                    </logic:present>
                                </div>
                                <div class="myForm" style="background-color: #9dbfe9;visibility:hidden;height:1px;width: 755px" id="assignviewerdiv">
                                    <br/>
                                    Select A Disclosure:
                                    <br/>
                                    <br/>
                                    Assign Rights:
                                    <select styleClass="textbox-long">
                                ...
                                <div class="myForm" style="background-color: #9dbfe9;visibility:hidden;height:1px;width: 755px" id="setstatusdiv">
                                    <form action="/updateStatus.do">
                                        ...
                                        <br/>
                                        Disposition Status:
                                        <select id="dispositionStatus" name="dispDisclStatusForm" styleClass="textbox-long">
                                            <logic:present name="statusDispDetView">
                                                <logic:iterate id="statusDispView" name="statusDispDetView">
                                                    <option value="<bean:write name="statusDispView" property="disclosureDispositionCode"/>"><bean:write name="statusDispView" property="dispositionStatus"/></option>
                                                </logic:iterate>
                                            </logic:present>
                                            <option>Select</option>
                                            <logic:present name="DisposStatusListView">
                                                <logic:iterate id="dispView" name="DisposStatusListView">
                                                    <option value="<bean:write name="dispView" property="disclosureDispositionCode"/>"><bean:write name="dispView" property="dispositionStatus"/></option>
                                                </logic:iterate>
                                            </logic:present>
                                        </select><a href="<%=path%>/setstatus.do">Customize</a>
                                        <br/><br/>
                                        Disclosure Status:
                                        <select id="disclosureStatus" name="dispDisclStatusForm" styleClass="textbox-long">
                                            <logic:present name="statusDetView">
                                                <logic:iterate id="statusView" name="statusDetView">
                                                    <option value="<bean:write name="statusView" property="disclosureStatusCode"/>"><bean:write name="statusView" property="disclosureStatus"/></option>
                                                </logic:iterate>
                                            </logic:present>
                                            <option>Select</option>
                                            <logic:present name="DisclStatusListView">
                                                <logic:iterate id="discView" name="DisclStatusListView">
                                                    <option value="<bean:write name="discView" property="disclosureStatusCode"/>"><bean:write name="discView" property="disclosureStatus"/></option>
                                                </logic:iterate>
                                            </logic:present>
                                        </select><a href="<%=path%>/setstatus.do">Customize</a>
                                        <br/><br/>
                                        <html:button styleClass="clsavebutton" onclick="javaScript:update();" property="button" value="Set"></html:button>
                                        <html:button styleClass="clsavebutton" value="Close" property="button"/>
                                    </form>
                                </div>
                                <%--</html:form>--%>
                                ...
                                <div class="myForm" style="visibility:hidden;height:1px;width: 755px" id="screeningquestionsdiv">
                                    <table id="noteBodyTable" class="table" style="width: 755px;" border="0" >
                                ...
                                <div class="myForm" style="visibility:hidden;height:1px;vertical-align: top;" id="notesdiv">
                                    <table id="noteBodyTable" class="table" style="width: 500px;" border="0" >
                                        ...
                                        <logic:equal name="userHaveRight" value="true">
                                            <tr>
                                                ...
                                                <td >
                                                    <html:text   styleClass="copy"  name="coiv2NotesBean" property="title" maxlength="500"/>
                                                </td>
                                                ...
                                                <td align="left" class="copybold" style="width: 150px;">
                                                    Private Flag:
                                                    <html:checkbox styleClass="copy"  name="coiv2NotesBean" value="R" property="resttrictedView"/>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="4">
                                                    <html:textarea styleClass="copy" property="comments" name="coiv2NotesBean" cols="120" rows="5"/>
                                                </td>
                                            </tr>

                                            <tr>    <td class='savebutton'>
                                        ...
                                        <tr style="background-color:#6E97CF;height: 22px;">
                                            <td style="color:#FFFFFF;font-size:12px;font-weight:bold;width: 15%">Title</td>
                                            <logic:notEqual name="userHaveRight" value="true">
                                                <td style="color:#FFFFFF;font-size:12px;font-weight:bold;width: 65%">Comments</td>
                                            </logic:notEqual>
                                            <td style="color:#FFFFFF;font-size:12px;font-weight:bold;width: 10%">User</td>
                                            <td style="color:#FFFFFF;font-size:12px;font-weight:bold;width: 10%">Timestamp</td>
                                            <logic:present name="userHaveRight">
                                            <logic:equal name="userHaveRight" value="true">
                                                <td style="color:#FFFFFF;font-size:12px;font-weight:bold;width: 10%"></td>
                                                <td style="color:#FFFFFF;font-size:12px;font-weight:bold;width: 10%"></td>
                                            </logic:equal>
                                            </logic:present>    
                                        </tr>
                                        <logic:present name="disclosureNotesData">
                                            ...
                                            <logic:iterate id="disclosureNotes"  name="disclosureNotesData" type="edu.mit.coeuslite.coiv2.beans.Coiv2NotesBean">
                                                ...
                                                <tr bgcolor="<%=notstrBgColor%>" id="row<%=indexnote%>" class="rowLine" onmouseover="className='rowHover rowLine'" onmouseout="className='rowLine'" height="22px">
                                                    ...
                                                    <td><bean:write name="disclosureNotes" property="comments"/></td>
                                                    <td><bean:write name="disclosureNotes" property="updateUser"/></td>
                                                    <td><bean:write name="disclosureNotes" property="updateTimestamp"/></td>
                                                    <logic:present name="userHaveRight">
                                                    <logic:equal name="userHaveRight" value="true">
                                ...
                                <div class="myForm" style="visibility:hidden;height:1px;width: 755px;vertical-align: top;" id="attachementdiv">
                                    <table width="100%" border="0" cellpadding="1" cellspacing="5">
                                        <tr>
                                            ...
                                            <td width = "30%" align="left" nowrap>
                                                ...
                                                <%--Modified DocTypes displaying - End --%>
                                            </td>
                                            ...
                                            <td width='43%' align=left>&nbsp;<html:textarea property="description" name="coiv2Attachment" styleClass="copy" cols="40" rows="2"></html:textarea></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align = "left" style='copy' colspan='3'>
                                    ...
                                    <table id="attBodyTable" class="table" style="width: 755px;" border="0" >
                                        <tr style="background-color:#6E97CF;height: 22px;">
                                            <td style="color:#FFFFFF;font-size:12px;font-weight:bold;">Attachment Type</td>
                                            <td style="color:#FFFFFF;font-size:12px;font-weight:bold;">Description</td>
                                            <td style="color:#FFFFFF;font-size:12px;font-weight:bold;">User</td>
                                            <td style="color:#FFFFFF;font-size:12px;font-weight:bold;">Timestamp</td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <logic:present name="attachmentList">
                                            ...
                                            <logic:iterate id="coiv2Attachment" name="attachmentList">
                                                ...
                                                %>
                                                <tr bgcolor="<%=strBgColoratt%>" class="rowLine" onmouseover="className='rowHover rowLine'" onmouseout="className='rowLine'" height="22px">
                                                    <td><bean:write name="coiv2Attachment" property="docType"/></td>
                                                    <td><bean:write name="coiv2Attachment" property="description"/></td>
                                                    <td><bean:write name="coiv2Attachment" property="updateUser"/></td>
                                                    <td><bean:write name="coiv2Attachment" property="updateTimeStamp"/></td>
                                                    <td class="copy" align='left'>
                                ...
                                <div style="width: 755px;height: 500px;overflow-x: hidden; overflow-y: hidden;vertical-align: top;">
                                    <div class="myForm" style="visibility:hidden;height:1px;width: 755px" id="financialentitydiv">
                                        <table id="bodyTable" class="table" style="width: 755px;height: 100%;" border="0" >
                                            <tr style="background-color:#6E97CF;height: 22px;">
                                                <td>&nbsp;</td>
                                                <td style="background-color:#6E97CF;color:#FFFFFF;float:left;font-size:14px;font-weight:bold;margin: 0;padding: 2px 0 2px 10px;position: relative;text-align: left;"><strong>Entity Names</strong></td>
                                                <td><strong>&nbsp;</strong></td>
                                                <td><strong>&nbsp;</strong></td>
                                            </tr>
                                            <%--<%
                                            ...
                                            <logic:present name="entityNameList">
                                                ...
                                                <logic:iterate id="pjtTitle" name="entityNameList">
                                                    ...
                                                    <tr>
                                                        <td colspan="4">
                                                            <div id="<%=index%>" style="height: 0px;width: 755px;visibility: hidden;background-color: #9DBFE9;overflow-x: hidden; overflow-y: scroll;">
                                                                ...
                                                                <table id="bodyTable" class="table" style="width: 760px;height: 100%;" border="0" >
                                                                    <tr>
                                                                        <td style="background-color:#6E97CF;color:#FFFFFF;font-size:12px;font-weight:bold;"><strong>Project Name</strong></td>
                                                                    ...
                                                                    <logic:iterate id="pjtEntView" name="pjtEntDetView">
                                                                        ...
                                                                        <logic:equal value="<%=projectName%>" property="entityName" name="pjtEntView">
                                ...
                                <logic:present name="option">
                                    <logic:equal name="option" value="overview"><script> openDiv("overviewdiv",100)</script></logic:equal>
                                    <logic:equal name="option" value="screeningquestions"><script> openDiv("screeningquestionsdiv",100)</script></logic:equal>
                                    <logic:equal name="option" value="financialentities"><script> openDiv("financialentitydiv",100)</script></logic:equal>
                                    <logic:equal name="option" value="notes"><script> openDiv("notesdiv",300)</script></logic:equal>
                                    <logic:equal name="option" value="attachments"><script> openDiv("attachementdiv",100)</script></logic:equal>
                                    <logic:equal name="option" value="cert"><script> openDiv("certdiv",225)</script></logic:equal>
                                    <logic:equal name="option" value="disclstatus"><script> openDiv("disclstatusdiv",100)</script></logic:equal>
                                    <logic:equal name="option" value="disposistatus"><script> openDiv("disposistatusdiv",100)</script></logic:equal>
                                    <logic:equal name="option" value="setstatus"><script> openDiv("setstatusdiv",150)</script></logic:equal>
                                    <logic:equal name="option" value="assignviewer"><script> openDiv("assignviewerdiv",200)</script></logic:equal>
                                </logic:present>
