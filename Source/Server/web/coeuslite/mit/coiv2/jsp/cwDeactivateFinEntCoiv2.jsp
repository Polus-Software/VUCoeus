...
<body>
	<html:form action="/deactivateCoiAnnFinEntSubmit.do" method="post">
        ...
        %>
			<tr>
				<td height="5" align="left" valign="top" class="theader"><bean:message
						bundle="coi" key="financialEntity.headerlabel" /> <%=entityName %>
				</td>
			</tr>
					...
					<table width="99%" border="0" align="center" cellpadding="3"
						...
						<tr>
							<td class="copy"><html:textarea property="statusDesc"
									cols="80" rows="3" styleClass="copy"
									onkeyup="return ismaxlength(this)" />(not more than 1000
								characters)</td>
						</tr>
						<tr>
