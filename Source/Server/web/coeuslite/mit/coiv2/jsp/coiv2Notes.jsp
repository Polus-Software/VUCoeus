...
<%@ page
	import="edu.mit.coeus.bean.PersonInfoBean,edu.mit.coeuslite.coiv2.services.CoiCommonService,edu.mit.coeuslite.coiv2.beans.CoiPersonProjectDetails,edu.mit.coeuslite.coiv2.beans.Coiv2NotesBean,java.util.Vector,java.util.HashMap,edu.mit.coeuslite.coiv2.utilities.CoiConstants;"%>
		...
		<div id="notesProtocol" style="vertical-align: top">
			<table style="width: 100%;" border="0" cellpadding="2"
               ...
               if(code==7){
				...
				<tr>
					<td align="right" width="15%" style="float: none" nowrap><b><%=projectType%>
							# :</b></td>
				...
				<tr>
					<td align="right" width="15%" style="float: none" nowrap><b>Application
							Date :</b></td>
					<td style="float: none" align="left" width="35%"><%=startDate%></td>
					<td align="right" nowrap width="18%" style="float: none"><b>Expiration
							Date :</b></td>
					<td align="left" width="35%"><%=endDate%></td>
				</tr>
				...
				<tr>
					<td align="right" width="15%" style="float: none" nowrap><b>Proposal
							# :</b></td>
					<td style="float: none" align="left" width="35%"><%=moduleItemKey%></td>
				...
				<tr>
					<td align="right" width="15%" style="float: none" nowrap><b>Start
							Date :</b></td>
					<td style="float: none" align="left" width="35%"><%=startDate%></td>
					<td align="right" width="10%" style="float: none"><b>End
							Date :</b></td>
					<td align="left" width="38%"><%=endDate%></td>
				</tr>
				...
				<tr>
					<td align="right" width="15%" style="float: none" nowrap><b>Award
							# :</b></td>
					<td style="float: none" align="left" width="35%"><%=moduleItemKey%></td>
					<td width="15%" style="float: none"></td>
					<td style="float: none"></td>
				...
				<tr>
					<td align="right" width="15%" style="float: none" nowrap><b>Title:</b></td>
				...
				<tr>
					<td align="right" width="15%" style="float: none" nowrap><b>Start
							Date :</b></td>
					<td style="float: none" align="left" width="35%"><%=startDate%></td>
					<td align="right" width="15%" style="float: none"><b>End
							Date :</b></td>
					<td align="left" width="30%"><%=endDate%></td>
				</tr>
				...
				<tr>
					<td align="right" width="15%" style="float: none" nowrap><b>Travel
							# :</b></td>
					<td style="float: none" align="left" width="35%"><%=moduleItemKey%></td>
					<td width="15%" style="float: none"></td>
					<td style="float: none"></td>
				...
				<tr>
					<td align="right" width="15%" style="float: none" nowrap><b>Start
							Date :</b></td>
					<td style="float: none" align="left" width="35%"><%=startDate%></td>
					<td align="right" width="18%" style="float: none"><b>End
							Date :</b></td>
					<td align="left" width="30%"><%=endDate%></td>
				</tr>
				<% } %>
										...
										<table width="100%" border="0" cellpadding="0">
											<tr>
												...
												<td><html:text styleClass="copy"
														disabled="<%=disable%>" property="title" maxlength="300" />
												</td>
												...
												<td align="left" class="copybold" style="width: 150px;">
													<%if((isAdmin)||(isReviewer)){%> Private Flag: <%
                                                                           disable=false;
                                                                                                                                                                
                                                                                    %>
													<html:checkbox styleClass="copy" disabled="<%=disable%>"
														value="R" property="resttrictedView" /> <%}%>
											...
											<tr>
												<td class="copybold">Note Text:</td>
												<td colspan="5">
													<%disable=false;%> <html:textarea styleClass="copy"
														disabled="<%=disable%>" property="comments" cols="120"
														rows="5" onkeypress="return imposeMaxLength(this,1600);" />
												</td>
											</tr>
										</table>
									</td>
				...
				<tr>
					<td colspan="5" align="left" valign="top" class='core'>
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tr>
								<td class="theader" align='left' style="width: 27%;">Topic
								</td>
								<td class="theader" align='left' style="width: 38%">Note</td>
								<td class="theader" align='left' style="width: 30%">Update
									Timestamp</td>
								<td class="theader" align='left' colspan="2"></td>
							</tr>
							<%
								...
								<logic:iterate id="disclosureNotes" name="disclosureNotesData"
									...
									<tr bgcolor="<%=strBgColor%>" class="rowLine"
										...
										<td align='left' style="width: 27%;">
											<%-- <td class="copy" align='left' style="width: 25%;">--%> <bean:write
												name="disclosureNotes" property="title" />
										</td>
										<td align='left' style="width: 38%">
											<%-- <td class="copy" align='left' style="width: 25%;">--%> <bean:write
												name="disclosureNotes" property="comments" />
										</td>
										<%--<td class="copy" align='center'>
                                                    <bean:write name="disclosureNotes" property="updateUser"/>
                                                </td>--%>
										<td align='left' style="width: 30%">
											<%-- <td class="copy" style="width: 25%;">--%> <bean:write
												name="disclosureNotes" property="updateTimestamp" /> by <bean:write
												name="disclosureNotes" property="updateUserName" />
										</td>
										<td class="copy" align='center'>
											<%
							...
							<td class='savebutton' align="left" colspan="4"><html:button
