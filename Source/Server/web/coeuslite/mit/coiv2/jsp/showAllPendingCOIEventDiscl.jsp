...
<body>
   ...
   <tr style="background-color:#6E97CF;height: 22px;width: 985px;" class="theader">
    <td colspan="9" style="background-color:#6E97CF;color:#FFFFFF;font-size:14px;font-weight:bold;margin: 0;padding: 2px 0 2px 10px;position: relative;text-align: left;"><strong>List Of Pending Event Reviews</strong></td>
</tr>
<tr>
    <td colspan="9" style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;">Pending Event Reviews with No Financial Entities</td>
</tr>
   <tr>
...
<td  style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;"><strong>Review Status</strong></td>
<td  style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;"><strong>Department</strong></td>
<td  style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;"><strong>Last Update</strong></td>
...
<td  style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;"><strong>&nbsp;&nbsp;&nbsp;</strong></td>
<td  style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;"><strong>&nbsp;&nbsp;&nbsp;</strong></td>
   </tr>
<logic:present name="pendingEventDiscl" scope="request">
       <%
                    ...
                    int index = 0;
        %>
           <logic:iterate id="projectList" name="pendingEventDiscl" type="edu.mit.coeuslite.coiv2.beans.CoiDisclosureBean">
     <%
                                if (index%2 == 0) {
                                strBgColor = "#D6DCE5";
                                } else {
...
request.getSession().setAttribute("frmDiscl", true);
     ...
     <tr bgcolor="<%=strBgColor%>" id="row<%=index%>" class="rowLine" onmouseover="className='rowHover rowLine'" onmouseout="className='rowLine'" style="height: 22px;">
        ...
        <td>
            <a href='<%=link1%>'> <b><bean:write name="projectList" property="userName"/></b></a>
        </td>
    <!--    <td>
         ...
         <td>
            <a href='<%=link1%>'> <b><bean:write name="projectList" property="reviewStatus"/></b></a>
        </td>
        <td>
            <a href='<%=link1%>'> <b><bean:write name="projectList" property="department"/></b></a>
        </td>
        <td>
           <a href='<%=link1%>'> <b><bean:write name="projectList" property="updateTimestamp" format="MM/dd/yyyy H:MM"/></b></a>
         </td>
         <td>
           <a href='<%=link1%>'> <b><bean:write name="projectList" property="updateTimestamp" format="MM/dd/yyyy"/></b></a>
          </td>
        <td>
              <a href='<%=link1%>'> <b><bean:write name="projectList" property="expirationDate" format="MM/dd/yyyy"/></b></a>
          </td>
          ...
          <td width=""><u><html:link action='<%=linkPrint%>' target="_blank">Print</html:link></u></td>
    <td width="">
    ...
    <%}index++;%>
     ...
     <tr>
            <td colspan="9" style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;">Pending Event Reviews with Financial Entities</td>
        </tr>
           <tr>
        <td  style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;">&nbsp;</td>
        <td  style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;"><strong>Owned By</strong></td>
        ...
        <logic:present name="pendingEventDiscl" scope="request">
            <%
                            ...
                            int index1 = 0;
                %>
                   <logic:iterate id="projectList1" name="pendingEventDiscl" type="edu.mit.coeuslite.coiv2.beans.CoiDisclosureBean">
             <%
                                        if (index1%2 == 0) {
                                        strBgColor1 = "#D6DCE5";
                                        } else {
        ...
        request.getSession().setAttribute("frmDiscl", true);
              ...
              if(isFEPresent1) {
             %>
             <tr bgcolor="<%=strBgColor1%>" id="row<%=index1%>" class="rowLine" onmouseover="className='rowHover rowLine'" onmouseout="className='rowLine'" style="height: 22px;">
                <td>&nbsp;
                  <%
                    session.setAttribute("isEvent", true);
                ...
                <td>
                    <a href='<%=link1%>'> <b><bean:write name="projectList1" property="userName"/></b></a>
                </td>
            <!--    <td>
                 ...
                 <td>
                    <a href='<%=link1%>'> <b><bean:write name="projectList1" property="reviewStatus"/></b></a>
                </td>
                <td>
                    <a href='<%=link1%>'> <b><bean:write name="projectList1" property="department"/></b></a>
                </td>
                <td>
                   <a href='<%=link1%>'> <b><bean:write name="projectList1" property="updateTimestamp" format="MM/dd/yyyy H:MM"/></b></a>
                 </td>
                 <td>
                   <a href='<%=link1%>'> <b><bean:write name="projectList1" property="updateTimestamp" format="MM/dd/yyyy"/></b></a>
                  </td>
                <td>
                      <a href='<%=link1%>'> <b><bean:write name="projectList1" property="expirationDate" format="MM/dd/yyyy"/></b></a>
                  </td>
