...
<html:form action="/saveCertificationCoiv2.do">
	<div id="InProgress">
		<table style="width: 100%;" height="100%" border="0" cellpadding="2"
			...
			<tr>
				<td align="right" width="15%" style="float: none" nowrap><b>IRB
						protocol # :</b></td>
			...
			<tr>
				<td align="right" width="15%" style="float: none"><b>Title:</b></td>
			...
			<tr>
				<td align="right" width="15%" style="float: none" nowrap><b>Application
						Date :</b></td>
				<td align="left" width="33%" style="float: none"><%=startDate%></td>
				<td align="right" width="15%" style="float: none" nowrap><b>Expiration
						Date :</b></td>
				<td align="left" width="18%" style="float: none"><%=endDate%></td>
			</tr>
			...
			<tr>
				<td align="right" width="15%" style="float: none" nowrap>&emsp;<b>IACUC
						protocol # :</b></td>
			...
			<tr>
				<td align="right" width="15%" style="float: none">&emsp;<b>Title:</b></td>
				<td align="left" width="30%" align="left"><%=pjctTitle%></td>
				<td width="15%" style="float: none"></td>
				<td style="float: none"></td>
			</tr>
			<tr>
				<td align="right" width="15%" style="float: none" nowrap>&emsp;<b>Application
						Date :</b></td>
				<td align="left" width="33%" style="float: none"><%=startDate%></td>
				<td align="right" width="15%" style="float: none" nowrap>&emsp;&emsp;<b>Expiration
						Date :</b></td>
				<td align="left" width="18%" style="float: none"><%=endDate%></td>
			</tr>
			...
			<tr>
				<td align="right" width="15%" style="float: none">&emsp;&emsp;&emsp;<b>Proposal
						# :</b></td>
				<td align="left" width="30%" align="left"><%=moduleItemKey%></td>
				<td width="15%" style="float: none"></td>
				<td style="float: none"></td>
			...
			<tr>
				<td align="right" width="15%" style="float: none">&emsp;&emsp;&emsp;<b>Title:</b></td>
				<td align="left" width="30%" align="left"><%=pjctTitle%></td>
				<td width="15%" style="float: none"></td>
				<td style="float: none"></td>
			</tr>
			<tr>
				<td align="right" width="15%" style="float: none">&emsp;&emsp;&emsp;<b>Start
						Date :</b></td>
				<td align="left" width="33%" style="float: none"><%=startDate%></td>
				<td align="right" width="15%" style="float: none">&emsp;&emsp;<b>End
						Date :</b></td>
				<td align="left" width="18%" style="float: none"><%=endDate%></td>
			</tr>
			...
			<tr>
				<td align="right" width="15%" style="float: none">&emsp;&emsp;&emsp;<b>Award
						# :</b></td>
				<td align="left" width="30%" align="left"><%=moduleItemKey%></td>
				<td width="15%" style="float: none"></td>
				<td style="float: none"></td>
			...
			<tr>
				<td align="right" width="15%" style="float: none">&emsp;&emsp;&emsp;<b>Travel
						# :</b></td>
				<td align="left" width="30%" align="left"><%=moduleItemKey%></td>
				<td width="15%" style="float: none"></td>
				<td style="float: none"></td>
			...
			<logic:present name="eventProjectDetails">
				...
				<%                                                       
                    ...
                    %>
				<tr bgcolor="#D6DCE5" class="rowLine"
				...
				<tr>
					<td class='savebutton' align="left" colspan="4"><html:button
                        ...
                        Continue
                    </html:button> <html:button onclick="javaScript:exitToCoi();"
