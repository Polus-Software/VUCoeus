...
<script>
    ...
    function processData(operation){
     debugger;
       ...
       // if(errValue){
     //       document.dynaBeanList.action = "<%=request.getContextPath()%>/saveCoiAnnualQuestionnaireCoiv2.do?operation="+operation;
       // }else{
            document.dynaBeanList.action = "<%=request.getContextPath()%>/createAnnualDisclosureCoiv2.do?operation="+operation+"&operationType="+opType;
    //    }
    ...
    function continueProcess(){
        var opType='<%=request.getParameter("operationType")%>';
        document.dynaBeanList.action = "<%=request.getContextPath()%>/annual.do";
        <%--document.dynaBeanList.action = "<%=request.getContextPath()%>/getProjectDetailsAndFinEntityDetailsAnnualCoiv2.do?&operationType="+opType;--%>
        document.dynaBeanList.submit();
    }
   function continueWithoutQnr(){        
        document.dynaBeanList.action = "<%=request.getContextPath()%>/continueWithoutAnnQnr.do?&type=annual";
        document.dynaBeanList.submit();
    }
     function exitToCoi(){
...
<body>
    <form action="/createAnnualDisclosureCoiv2.do" name="dynaBeanList"  method="POST">
                ...
                <td align="left" valign="top">
                                ...
                                <table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" class="table">
                                    <tr height="20px">
                                        ...
                                        <td height="23" class="theader" style="font-size:14px" ><bean:message bundle="coi" key="AnnualDisclosure.Certification.Header"/></font>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <logic:present name="questionsList">   <tr><td class="copybold" height="30px"><bean:message bundle="coi" key="AnnualDisclosure.Certification.request"/></td></tr></logic:present>
                            ...
                            %>
                                        ...
                                        <font color="red"><bean:message bundle="coi" key="coiMessage.noQuestionnaire"/></font>
                                            ...
                                            <tr>
                                            <td class='savebutton' align='left'>
                                            <html:submit  value="Continue" styleClass="clsavebutton" onclick="javascript:continueWithoutQnr();"/></td>
                                            </tr>
                            ...
                            <tr>
                                <td class='savebutton' align='left'>
                                    <html:submit  value="Continue" styleClass="clsavebutton" onclick="javascript:continueProcess();"/></td>
                            </tr>
                 <%}%>
                            <!--Case#4447 - End-->
                           </table>
...
<script>
    ...
    LINK = "<%=request.getContextPath()%>/saveCoiAnnualQuestionnaire.do?operation=SAVE";
