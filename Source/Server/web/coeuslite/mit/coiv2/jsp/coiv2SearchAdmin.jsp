<%-- 
    Document   : coiv2SearchAdmin
    Created on : Oct 26, 2010, 12:40:39 PM
    Author     : indhulekha
--%>
...
<head>
<title><bean:message bundle="coi" key="searchWindow.title.admin" /></title>
<style type="text/css">
//
div {
	font-family: verdana;
...
<body onload="populateResultData()" class='tabtable'>
	<% String srch = "/searchCoiDisclosureAdmin.do?type=+strType&disclosureSearch=true"; %>
	<%if(resData == null) {%>
