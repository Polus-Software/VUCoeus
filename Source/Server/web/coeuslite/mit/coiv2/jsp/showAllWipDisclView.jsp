...
<td colspan="6" style="background-color:#6E97CF;color:#FFFFFF;font-size:14px;font-weight:bold;margin: 0;padding: 2px 0 2px 10px;position: relative;text-align: left;"><strong>List Of WIP</strong></td>
</tr>
<tr>
...
<logic:empty name="entityNameList">
    <tr>
    <td colspan="6">
    <font color="red">No Disclosure found</font>
    </td>
    </tr>
</logic:empty>
...
<a href='<%=link1%>' ><b><bean:write name="pjtEntView" property="reviewStatus"/></b></a>
    ...
    <td>
        <% String linkPrint = "/approveddisclosureprint.do?selected=current&fromReview=showAllAnnualReview&param1="+ projectName.getCoiDisclosureNumber() +"&param2=" + projectName.getSequenceNumber()+"&param7="+ projectName.getPersonId();%>
