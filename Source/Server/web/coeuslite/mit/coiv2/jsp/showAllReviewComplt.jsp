...
<tr style="background-color:#6E97CF;height: 22px;width: 985px;">
    <td colspan="9" style="background-color:#6E97CF;color:#FFFFFF;font-size:14px;font-weight:bold;margin: 0;padding: 2px 0 2px 10px;position: relative;text-align: left;"><strong>List of Assigned Reviews Completed </strong></td>
</tr>
   <tr>
...
<td style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;"><strong>Disc.Event</strong></td>
<td style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;">Event #</td>
<td style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;"><strong>Disclosure Status</strong></td>
...
<td style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;"><strong>&nbsp;&nbsp;&nbsp;</strong></td>
   ...
   <img src='<%=request.getContextPath()%>/coeusliteimages/minus.gif' style="display: none;" border='none' id="imgtoggleminus<%=index%>" name="imgtoggleminus<%=index%>" border="none" onclick="javaScript:selectProj(<%=index%>);"/>
    ...
    <td class="copy" style="color: #173B63;">
    ...
    <td>
          <a href='<%=link1%>'><b><bean:write name="projectList" property="moduleItemKey"/></b></a>
      </td>
       <td>
         <a href='<%=link1%>'>  <b><bean:write name="projectList" property="disclosureStatus"/></b></a>
      </td>
      <td>
      ...
      <% String linkPrint = "/approveddisclosureprint.do?selected=current&fromReview=showAllAnnualReview&param1="+ beanHeader.getCoiDisclosureNumber() +"&param2=" + beanHeader.getSequenceNumber()+"&param7="+ beanHeader.getPersonId();%>
...
<tr>
<td style="background-color:#6E97CF;color:#FFFFFF;font-size:12px;font-weight:bold;" width="18%">Assigned Reviewer</td>
<td style="background-color:#6E97CF;color:#FFFFFF;font-size:12px;font-weight:bold;">Recommended Action</td>
<td style="background-color:#6E97CF;color:#FFFFFF;font-size:12px;font-weight:bold;">Department</td>
...
%>
    ...
    <logic:iterate id="pjtEntView" name="entityNameList"  type="edu.mit.coeuslite.coiv2.beans.CoiDisclosureBean">
            <%
...
<td>
 <b><bean:write name="pjtEntView" property="reviewerName"/></b>
</td>
<td>
 <b><bean:write name="pjtEntView" property="recmdDescptn"/></b>
</td>
<td>
<b><bean:write name="pjtEntView" property="department"/></b>
</td>
<td colspan="5">
 <b><bean:write name="pjtEntView" property="updateTimestamp" format="MM/dd/yyyy H:MM"/></b>
</td>
                    </tr>
 <%}%>
</logic:equal>
