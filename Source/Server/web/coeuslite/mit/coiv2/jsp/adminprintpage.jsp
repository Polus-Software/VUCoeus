	...
	<table id="bodyTable" class="table" style="width: 960px;" border="0"
		...
		<tr>
			...
			<td
				...
				Status</td>
			<td
				style="background-color: #6E97CF; color: #173B63; font-size: 12px; font-weight: bold;"><strong>Update
					Timestamp</strong></td>
			<td
     ...
     %>
				...
				<tr bgcolor="<%=strBgColor%>" id="row<%=index%>" class="rowLine"
					...
					<td><html:link
							...
							action="" onclick="dothis()">Print</html:link></td>
					<td><b><bean:write name="pjtTitle"
								property="coiDisclosureNumber" /></b></td>
					<td><b><bean:write name="pjtTitle" property="userName" /></b>
					</td>
					<td><b><bean:write name="pjtTitle"
								property="disclosureStatus" /></b></td>
					<td><b><bean:write name="pjtTitle"
								property="updateTimestamp" /></b></td>
					<td><b><bean:write name="pjtTitle"
								property="expirationDate" /></b></td>
				</tr>
				<tr>
					<td colspan="7">
						<div id="<%=index%>"
							...
							<table id="bodyTable" class="table"
								...
								<tr>
									...
									<td
										style="background-color: #6E97CF; color: #FFFFFF; font-size: 12px; font-weight: bold;">Disclosure
										Event</td>
									<td
										style="background-color: #6E97CF; color: #FFFFFF; font-size: 12px; font-weight: bold;"><strong>Disclosure
											Status</strong></td>
									<td
										style="background-color: #6E97CF; color: #FFFFFF; font-size: 12px; font-weight: bold;">Disposition
										Status</td>
									<td
										style="background-color: #6E97CF; color: #FFFFFF; font-size: 12px; font-weight: bold;"><strong>Last
											Updated</strong></td>
									<td
										style="background-color: #6E97CF; color: #FFFFFF; font-size: 12px; font-weight: bold;"><strong>Update
											User</strong></td>
									<td
										style="background-color: #6E97CF; color: #FFFFFF; font-size: 12px; font-weight: bold;"><strong>Expiration
											Date</strong></td>
								</tr>
									...
									<logic:equal value="<%=name%>" property="coiDisclosureNumber"
										...
										<tr class="rowLineLight"
											...
											<td>
												...
												<html:link
													style="color: #003399;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: left;font-size:12px;"
													action="<%=link1%>">Print</html:link> &nbsp;&nbsp;
											</td>
											<td><b><bean:write name="pjtEntView"
														property="moduleName" /></b></td>
											<td><b><bean:write name="pjtEntView"
														property="disclosureStatus" /></b></td>
											<td><b><bean:write name="pjtEntView"
														property="dispositionStatus" /></b></td>
											<td><b><bean:write name="pjtEntView"
														property="updateTimestamp" /></b></td>
											<td><b><bean:write name="pjtEntView"
														property="updateUser" /></b></td>
											<td><b><bean:write name="pjtEntView"
														property="expirationDate" /></b></td>
										</tr>
									</logic:equal>
