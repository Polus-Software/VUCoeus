...
<%@ page
	import="java.util.Vector,edu.mit.coeuslite.coiv2.beans.Coiv2AttachmentBean,edu.mit.coeuslite.coiv2.services.CoiCommonService,edu.mit.coeuslite.coiv2.beans.CoiPersonProjectDetails;"%>
	...
	<div id="notesProtocol">
		<table style="width: 100%;" height="100%" border="0" cellpadding="2"
			...
			<tr>
				...
				<td align="right" width="23%" style="float: none" nowrap><b>Expiration
						Date :</b></td>
			...
			<tr>
				<td align="right" width="15%" style="float: none" nowrap><b>Start
						Date :</b></td>
				<td style="float: none" align="left" width="30%"><%=startDate%></td>
				<td align="right" width="23%" style="float: none" nowrap><b>End
						Date :</b></td>
				<td align="left"><%=endDate%></td>
			</tr>
			...
			<tr>
				<td colspan="4"><b>Certification:</b><br /> <%-- The information provided for this Financial Interest Disclosure, including responses to Yes/No questions, list of pertinent financial entities, and disclosure of possible conflict with my sponsored activity, is an accurate and current statement of my reportable outside interests and activities.--%>
					<bean:message bundle="coi"
						key="AnnualDisclosure.Certification.Text" /></td>
			</tr>
			<tr>
				<td align="center" colspan="4"><br /> <html:button
						property="Save" onclick="javaScript:onCertify();"
			...
			<tr>
				...
				<br /> Last Updated: <bean:write name="coiv2Certification"
						property="updateTimeStampNew" format="yyyy-MM-dd  hh:mm a" /></td>
			</tr>
			<tr>
				<td align="center" colspan="4"><br /> Thank you for your
					cooperation.</td>
			</tr>
			<tr>
				<td align="center" colspan="4"><br /> When you are done click
					on the 'Logout' button above right</td>
			</tr>
		</table>
