...
<%@page import="java.util.Vector,java.text.SimpleDateFormat,java.text.Format,java.util.Date,edu.mit.coeuslite.coiv2.beans.CoiDisclosureBean,edu.mit.coeuslite.coiv2.services.CoiCommonService"%>
...
<table id="bodyNoTable" class="table" style="width: 100%;" border="0">
    <tr style="background-color:#6E97CF;height: 22px;width: 100%;" valign="top">
<td colspan="7" style="background-color:#6E97CF;color:#FFFFFF;font-size:14px;font-weight:bold;margin: 0;padding: 2px 0 2px 10px;position: relative;text-align: left;"><strong>Disclosure History</strong></td>
</tr>
<tr>
<td><p style="color: #ff0000;font-size: 12px;">No Disclosure History Available</p></td>
</tr></table>
</logic:notPresent>
...
<td style="background-color:#6E97CF;color:#FFFFFF;font-size:12px;font-weight:bold;" align="left">Event</td>

<td style="background-color:#6E97CF;color:#FFFFFF;font-size:12px;font-weight:bold;" align="left">Project #</td>
<td style="background-color:#6E97CF;color:#FFFFFF;font-size:12px;font-weight:bold;" align="left">Title</td>
<td style="background-color:#6E97CF;color:#FFFFFF;font-size:12px;font-weight:bold;" align="left">Disposition Status</td>
<td style="background-color:#6E97CF;color:#FFFFFF;font-size:12px;font-weight:bold;">Last Updated</td>
<td style="background-color:#6E97CF;color:#FFFFFF;font-size:12px;font-weight:bold;">&nbsp;</td>
</tr>
...
<html:link style="color: #003399;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: left;font-size:12px;" action="<%=link1%>">View</html:link>
  ...
  <td align="left">
<bean:write name="historyTitle" property="description"/>
</td>
<td align="left">
<bean:write name="historyTitle" property="moduleItemKey"/>
</td>

<td align="left">
   <bean:write name="historyTitle" property="pjctName"/>
</td>
<td align="left">
 <bean:write name="historyTitle" property="dispositionStatus"/>
</td>
     <td>
         <bean:write name="historyTitle" property="updateTimestamp"/>
    </td>
    <td>
        <html:link action="<%=link%>">View</html:link>
    </td>
</tr>
