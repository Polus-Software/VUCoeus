<%-- 
    Document   : CoiV2SearchViewer
    Created on : Oct 26, 2010, 11:13:03 AM
    Author     : indhulekha
--%>
...
<title><bean:message bundle="coi"
		key="searchWindow.title.viewer" /></title>
<style type="text/css">
//
div {
	font-family: verdana;
...
<body onload="populateResultData()" class='tabtable'>
	<% String srch = "/searchCoiDisclosureViewer.do?type=+strType&disclosureSearch=true"; %>
	<%if(resData == null) {%>
