...
<%@ page
	import="edu.mit.coeuslite.coiv2.utilities.CoiConstants,java.util.Vector,edu.mit.coeuslite.coiv2.beans.CoiDisclosureBean,edu.mit.coeuslite.coiv2.beans.CoiInfoBean;"%>
		...
		<td>
			<table class="table" align="center" width="98%" style="padding: 4px">
				...
				<logic:present name="frmEventDiscl">
					<tr class="menuHeaderName">
						<td colspan="3">Project Event View</td>
					</tr>
				</logic:present>
				<logic:present name="historyView">
					<tr class="menuHeaderName">
						<td colspan="3">History View</td>
					</tr>
				</logic:present>
				...
				<tr class="rowline">
					<td width="16%" height='16' align="left" valign="top"
						class="coeusMenu"><logic:present name="coiMenuDatasaved">
							<logic:equal name="coiMenuDatasaved" property="travelDataSaved"
								value="true">
								<img
									src="<%=request.getContextPath()%>/coeusliteimages/img_saved.gif"
									width="19" height="19">
							</logic:equal>
						</logic:present></td>
					<logic:present name="DiscViewTravel" scope="request">
						<td width="80%" height='16' align="left" valign="middle"
							class="selectedMenuIndicator"><html:link action="<%=url%>">
								<font color="#6D0202">Travel Details</font>
							</html:link></td>
					...
					<logic:notPresent name="DiscViewTravel" scope="request">
						<td width="80%" height='16' align="left" valign="middle"
							class="coeusMenu"><html:link action="<%=url%>">Travel Details</html:link>
						</td>
				...
				<tr>
					<td width="16%" height='16' align="left" valign="top"
						class="coeusMenu"><logic:present name="coiMenuDatasaved">
							<logic:equal name="coiMenuDatasaved" property="questDataSaved"
								value="true">
								<img
									src="<%=request.getContextPath()%>/coeusliteimages/img_saved.gif"
									width="19" height="19">
					...
					<logic:present name="DiscViewQtnr" scope="request">
						<td width="80%" height='16' align="left" valign="middle"
							class="selectedMenuIndicator"><html:link
								action="/screeningquestions.do">
								<font color="#6D0202">Questionnaires</font>
							</html:link></td>
						<td width='4%' align=right class="selectedMenuIndicator"><bean:message
								key="menu.selected" /></td>
					</logic:present>
					<logic:notPresent name="DiscViewQtnr" scope="request">
						<td width="80%" height='16' align="left" valign="middle"
							class="coeusMenu"><html:link action="/screeningquestions.do">Questionnaires</html:link>
						</td>
						<td width='4%' align=right class="selectedMenuIndicator"></td>
					</logic:notPresent>
				</tr>
				...
				<tr class="rowline">
					<td width="16%" height='16' align="left" valign="top"
						class="coeusMenu"></td>
					<td width="80%" height='16' align="left" valign="middle"
						class="coeusMenu" style="text-decoration: none; color: gray">
						Questionnaires</td>
					<td width='4%' align=right class="selectedMenuIndicator"></td>
				</tr>
				<%}%>
               ...
               <logic:notPresent name="DiscViewFinEnt" scope="request">
				...
				<logic:notPresent name="frmEventDiscl">
					...
					<tr class="rowLine">
						<td width="16%" height='16' align="left" valign="top"
							class="coeusMenu"><logic:present name="coiMenuDatasaved">
								<logic:equal name="coiMenuDatasaved" property="prjDataSaved"
									value="true">
									<img width="19" height="19" border="0"
										src="<%=request.getContextPath()%>/coeusliteimages/img_saved.gif">
								</logic:equal>
							</logic:present></td>
						<logic:present name="DiscViewByPrjt" scope="request">
							<td width='80%' align="left" valign="middle" class="coeusMenu">
								<html:link action="/getProjectsByFinancialEntitiesView.do">
									<font color="#6D0202"><%=projectLabel%></font>
								</html:link>
							</td>
							<td width='4%' align=right class="selectedMenuIndicator"><bean:message
									key="menu.selected" /></td>
					...
					<tr class="rowLine">
						...
						<logic:present name="DiscViewByPrjt" scope="request">
							<td width='80%' align="left" valign="middle" class="coeusMenu">
								<html:link action="/getProjectsByFinancialEntitiesView.do">
									<font color="#6D0202">By Project</font>
								</html:link>
							</td>
							<td width='4%' align=right class="selectedMenuIndicator"><bean:message
									key="menu.selected" /></td>
				...
				<tr class="rowLine">
					<td width="16%" height='16' align="left" valign="top"
						class="coeusMenu"><logic:present name="coiMenuDatasaved">
							<logic:equal name="coiMenuDatasaved" property="attachDataSaved"
								value="true">
								<img width="19" height="19" border="0"
									src="<%=request.getContextPath()%>/coeusliteimages/img_saved.gif">
							</logic:equal>
					...
					<logic:present name="DiscViewAttchmt" scope="request">
						<td width="80%" align="left" valign="middle" class="coeusMenu">
							...
							<html:link action="/attachments.do">
								<font color="#6D0202">Attachments</font>
							</html:link>
				...
				<tr class="rowLine">
					<td width="16%" height='16' align="left" valign="top"
						class="coeusMenu"><logic:present name="coiMenuDatasaved">
							<logic:equal name="coiMenuDatasaved" property="noteDataSaved"
								value="true">
								<img width="19" height="19" border="0"
									src="<%=request.getContextPath()%>/coeusliteimages/img_saved.gif">
							</logic:equal>
					...
					<logic:notPresent name="DiscViewNotes" scope="request">
						<td align="left" valign="middle" class="coeusMenu"><html:link
								action="/notes.do">Notes</html:link></td>
						<td width='4%' align=right class="selectedMenuIndicator"></td>
					</logic:notPresent>
				</tr>
				...
				<tr class="rowline">
					<td width="16%" height='16' align="left" valign="top"
						class="coeusMenu"><logic:present name="coiMenuDatasaved">
							<logic:equal name="coiMenuDatasaved" property="certDataSaved"
								value="true">
								<img width="19" height="19" border="0"
									src="<%=request.getContextPath()%>/coeusliteimages/img_saved.gif">
							</logic:equal>
					...
					<logic:present name="DiscViewCertify" scope="request">
						<td width="80%" height='16' align="left" valign="middle"
							class="coeusMenu"><html:link action="/certify.do">
								<font color="#6D0202">Certifications</font>
							</html:link></td>
						<td width='4%' align=right class="selectedMenuIndicator"><bean:message
								key="menu.selected" /></td>
					</logic:present>
					<logic:notPresent name="DiscViewCertify" scope="request">
						<td width="80%" height='16' align="left" valign="middle"
							class="coeusMenu"><html:link action="/certify.do">Certifications</html:link>
              ...
              if((value.equalsIgnoreCase("current"))){
				...
				<tr class="rowLine">
					...
					<logic:present name="DiscViewPrint" scope="request">
						<td width="80%" align="left" valign="middle" class="coeusMenu">
							<html:link action="/approveddisclosureprint.do?" target="_blank">
								<font color="#6D0202">Print</font>
							</html:link>
						</td>
						<td width='4%' align=right class="selectedMenuIndicator"><bean:message
								key="menu.selected" /></td>
						...
						<logic:present name="otherDiscl">
							<tr class="rowLine">
								...
								<logic:present name="DiscViewSetViewers" scope="request">
									<td width="80%" align="left" valign="middle" class="coeusMenu">
										<html:link action="/setViewer.do">
											<font color="#6D0202">Viewer Actions</font>
										</html:link>
									</td>
									<td width='4%' align=right class="selectedMenuIndicator"><bean:message
											key="menu.selected" /></td>
...
<tr class="rowLine">
                ...
                %>
                  ...
                  if(fromApprovedView==null || isReviewer){ %>
					<tr class="menuHeaderName">
						<td colspan="3">Review Actions</td>
					</tr>
					<logic:present name="<%=CoiConstants.IS_ADMIN%>">
						<logic:equal value="true" name="<%=CoiConstants.IS_ADMIN%>">
     ...
     %>
							<tr class="rowLine">
								<td width="16%" height='16' align="left" valign="top"
									class="coeusMenu"></td>
								<td width="80%" align="left" valign="middle" class="coeusMenu"
									colspan="2"><font color="#BAB8B8">Set Review Status</font>
								</td>
							</tr>
							...
							<tr class="rowLine">
								...
								<logic:present name="ReviewActPending" scope="request">
									<td width="80%" align="left" valign="middle" class="coeusMenu">
										<html:link action="/setstatus.do?&param=pending">
											<font color="#6D0202">Set Review Status</font>
										</html:link>
									</td>
									<td width='4%' align=right class="selectedMenuIndicator"><bean:message
											key="menu.selected" /></td>
							...
							<tr class="rowLine">
								...
								<logic:present name="ReviewActApprove" scope="request">
									<td width="80%" align="left" valign="middle" class="coeusMenu">
										<html:link action="/setstatus.do?&param=approve">
											<font color="#6D0202">Approve</font>
										</html:link>
									</td>
									<td width='4%' align=right class="selectedMenuIndicator"><bean:message
											key="menu.selected" /></td>
							...
							<tr class="rowLine">
								...
								<logic:present name="ReviewActDisapprove" scope="request">
									<td width="80%" align="left" valign="middle" class="coeusMenu">
										<html:link action="/setstatus.do?&param=disapprove">
											<font color="#6D0202">Disapprove</font>
										</html:link>
									</td>
									<td width='4%' align=right class="selectedMenuIndicator"><bean:message
											key="menu.selected" /></td>
							...
							<tr class="rowLine">
								<td width="16%" height='16' align="left" valign="top"
									class="coeusMenu"><logic:present name="coiMenuDatasaved">
										<logic:equal name="coiMenuDatasaved"
											property="assignViewerDataSaved" value="true">
											<img width="19" height="19" border="0"
												src="<%=request.getContextPath()%>/coeusliteimages/img_saved.gif">
										</logic:equal>
									</logic:present></td>
								...
								<logic:present name="ReviewActAssignViewr" scope="request">
									<td width="80%" align="left" valign="middle" class="coeusMenu">
										<html:link action="/assignDisclToUser.do">
											<font color="#6D0202">Assign Reviewers</font>
										</html:link>
									</td>
									<td width='4%' align=right class="selectedMenuIndicator"><bean:message
											key="menu.selected" /></td>
					...
					<logic:equal value="true" name="isReviewer">
						<tr class="rowline">
							<td width="16%" height='16' align="left" valign="top"
								class="coeusMenu"></td>
							<td width="80%" height='16' align="left" valign="middle"
								class="coeusMenu"><html:link action="/reviewerAction.do">Add Review Comments</html:link>
							</td>
							<td width='4%' align=right class="selectedMenuIndicator"></td>
						</tr>
						<tr class="rowline">
							<td width="16%" height='16' align="left" valign="top"
								class="coeusMenu"><logic:present name="coiMenuDatasaved">
									<logic:equal name="coiMenuDatasaved"
										property="reviewCompleteSaved" value="true">
										<img width="19" height="19" border="0"
											src="<%=request.getContextPath()%>/coeusliteimages/img_saved.gif">
									</logic:equal>
								</logic:present></td>
							<td width="80%" height='16' align="left" valign="middle"
								class="coeusMenu"><html:link
									action="/completeReviewAction.do">Complete Review</html:link></td>
							<td width='4%' align=right class="selectedMenuIndicator"></td>
						</tr>
					</logic:equal>
				</logic:present>
				...
				<tr class="rowline">
					<td width="16%" height='16' align="left" valign="top"
						class="coeusMenu"></td>
					<td width="80%" height='16' align="left" valign="middle"
						class="coeusMenu"><html:link action="/coiHome.do?Menu_Id=004">MY COI Home</html:link>
					</td>
					<td width='4%' align=right class="selectedMenuIndicator"></td>
				</tr>
				...
				<logic:present name="historyView">
					...
					<tr class="rowline">
						...
						<td width="80%" height='16' align="left" valign="middle"
							class="coeusMenu"><html:link
								action="/showHistoryForHeader.do">Back to History</html:link></td>
						<td width='4%' align=right class="selectedMenuIndicator"></td>
					</tr>
				</logic:present>
				<%--
