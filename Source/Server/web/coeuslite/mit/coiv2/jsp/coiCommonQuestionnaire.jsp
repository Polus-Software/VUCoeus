		...
		<table width="100%" border="0" class="table">
			...
			<tr>
				<td align="right" width="15%" style="float: none" nowrap><b>Application
						Date :</b></td>
				<td align="left" width="30%" style="float: none"><%=startDate%></td>
			...
			<tr>
				<td align="right" width="15%" style="float: none" nowrap><b>Application
						Date :</b></td>
				<td align="left" width="38%" style="float: none"><%=startDate%></td>
				<td align="right" width="15%" style="float: none" nowrap><b>Expiration
						Date :</b></td>
			...
			<tr>
				<td align="right" width="15%" style="float: none" nowrap><b>Start
						Date :</b></td>
				<td align="left" width="38%" style="float: none"><%=startDate%></td>
				<td align="right" width="15%" style="float: none" nowrap>&emsp;&emsp;&emsp;&emsp;<b>End
						Date :</b></td>
				<td align="left"><%=endDate%></td>
			</tr>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<logic:present name="questionsList">
					...
					<tr align="left" class='table'>
						<td class='savebutton' nowrap align="left">&nbsp;<html:button
								property="saveAndProceed" styleClass="clsavebutton"
								style="width:150px;" value="<%=buttonName%>"
								onclick="javascript:processData('SAVE')" /> <html:button
								property="saveAndProceed" styleClass="clsavebutton"
								style="width:150px;" value="Quit"
								onclick="javascript:exitToCoi()" /> <%} else if (modeValue) {
                                 %>
					<tr>
						<td colspan='4' class='savebutton' align='left'><html:submit
								value="Continue" styleClass="clsavebutton"
