...
<%@ page
	import="edu.mit.coeuslite.coiv2.utilities.CoiConstants,edu.mit.coeuslite.coiv2.beans.CoiInfoBean;"%>
			...
			<table class="table" align="center" width="200" style="padding: 4px">
				...
				<logic:notPresent name="disableCoiMenu">
					<tr class="rowline">
						...
						<logic:present name="DiscViewTravel" scope="request">
							<td width="80%" height='16' align="left" valign="middle"
								class="selectedMenuIndicator" nowrap><html:link
									action="<%=link2%>" onclick="<%=link%>">
						...
						<logic:notPresent name="DiscViewTravel" scope="request">
							<td width="80%" height='16' align="left" valign="middle"
								class="coeusMenu" nowrap><html:link action="<%=link2%>"
									onclick="<%=link%>">Travel Details</html:link></td>
					...
					<tr class="rowline">
						...
						<logic:present name="DiscViewQtnr" scope="request">
							<td width="80%" height='16' align="left" valign="middle"
								class="selectedMenuIndicator"><html:link
									action="/coiQuestionnaire.do" onclick="<%=link%>">
						...
						<logic:notPresent name="DiscViewQtnr" scope="request">
							<td width="80%" height='16' align="left" valign="middle"
								class="coeusMenu"><html:link action="/coiQuestionnaire.do"
									onclick="<%=link%>">Questionnaires</html:link></td>
							<td width='4%' align=right class="selectedMenuIndicator"></td>
						</logic:notPresent>
					</tr>
					<% }else{%>
					...
					<tr class="rowLine">
						...
						<logic:present name="DiscViewByPrjt" scope="request">
							<td width='80%' align="left" valign="middle" class="coeusMenu">
								<html:link action="/coiCentralAction.do" onclick="<%=link%>">
					...
					<tr class="rowLine">
						...
						<logic:present name="DiscViewAttchmt" scope="request">
							<td width="80%" align="left" valign="middle" class="coeusMenu">
								...
								<html:link action="/getAttachmentsCoiv2.do?operationType=MODIFY"
									onclick="<%=link%>">
						...
						<logic:notPresent name="DiscViewAttchmt" scope="request">
							<td width="80%" align="left" valign="middle" class="coeusMenu">
								...
								<html:link action="/getAttachmentsCoiv2.do?operationType=MODIFY"
									onclick="<%=link%>">Attachments</html:link>
					...
					<tr class="rowLine">
						...
						<logic:present name="DiscViewNotes" scope="request">
							<td align="left" valign="middle" class="coeusMenu"><html:link
									action="/getNotesCoiv2.do" onclick="<%=link%>">
						...
						<logic:notPresent name="DiscViewNotes" scope="request">
							<td align="left" valign="middle" class="coeusMenu"><html:link
									action="/getNotesCoiv2.do" onclick="<%=link%>">Notes</html:link>
							</td>
							<td width='4%' align=right class="selectedMenuIndicator"></td>
						</logic:notPresent>
					</tr>
					...
					<tr class="rowline">
						...
						<logic:present name="DiscViewCertify" scope="request">
							<td width="80%" height='16' align="left" valign="middle"
								class="coeusMenu"><html:link
									action="/getCertificationCoiv2.do?operationType=MODIFY"
									onclick="<%=link%>">
						...
						<logic:notPresent name="DiscViewCertify" scope="request">
							<td width="80%" height='16' align="left" valign="middle"
								class="coeusMenu"><html:link
									action="/getCertificationCoiv2.do?operationType=MODIFY"
									onclick="<%=link%>">Certifications</html:link></td>
							<td width='4%' align=right class="selectedMenuIndicator"></td>
						</logic:notPresent>
				...
				<tr class="rowline">
					...
					<td width="16%" height='16' align="left" valign="top"
						class="coeusMenu"></td>
					<td width="80%" height='16' align="left" valign="middle"
						class="coeusMenu"><html:link action="/coiHome.do?Menu_Id=004"
							onclick="<%=link%>">MY COI Home</html:link></td>
					<td width='4%' align=right class="selectedMenuIndicator"></td>
				</tr>
			</table>
		</td>
