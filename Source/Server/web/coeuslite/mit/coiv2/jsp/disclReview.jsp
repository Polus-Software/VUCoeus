		...
		<tr style="background-color: #6E97CF; height: 22px; width: 960px;">
			<td colspan="8"
				style="background-color: #6E97CF; color: #FFFFFF; font-size: 14px; font-weight: bold; margin: 0; padding: 2px 0 2px 10px; position: relative; text-align: left;"><strong>&nbsp;&nbsp;&nbsp;List
					Of Pending Disclosures</strong></td>
		</tr>
		<tr>
			<td
...
%>
				<tr bgcolor="<%=strBgColor%>" id="row<%=index%>" class="rowLine"
					...
					<td><a href='<%=link1%>'><b><bean:write
									name="pjtTitle" property="userName" /></b></a></td>
					<td><a href='<%=link1%>'><b><bean:write
									name="pjtTitle" property="coiDisclosureNumber" /></b></a></td>
					<td><a href='<%=link1%>'> <b><bean:write
									name="pjtTitle" property="disclosureStatus" /></b></a></td>
					<td><a href='<%=link1%>'> <b><bean:write
									name="pjtTitle" property="dispositionStatus" /></b></a></td>
					<td><a href='<%=link1%>'> <b><%=updateHeader%></b></a></td>
					<td><a href='<%=link1%>'> <b><%=updateHeader%></b></a></td>
					<td><a href='<%=link1%>'> <b><%=expireHeader%></b></a></td>
				</tr>
				<%index++;%>
			</logic:iterate>
		</logic:present>
