...
<%@ page import="edu.mit.coeus.bean.PersonInfoBean,edu.mit.coeuslite.coiv2.beans.Coiv2NotesBean,java.util.HashMap,java.util.Vector,edu.mit.coeuslite.coiv2.beans.Coiv2AttachmentBean,edu.mit.coeuslite.coiv2.utilities.CoiConstants,edu.mit.coeuslite.coiv2.beans.CoiDisclosureBean"%>
...
<html>
    ...
    <!-- Add Documents: - Start  -->
    <tr><td colspan="2"  align="left" valign="top" class="copybold">
    ...
    <tr><td colspan="2">
         ...
         <tr><td  width="12%" align="left" class="copybold" nowrap>
             ...
             <td width='43%' align=left>
                    &nbsp;<html:text property="description" maxlength="150" name="coiv2Attachment" size="40" styleClass="textbox-long"></html:text>
             </td>
        </tr>
        <tr>
            ...
            <td align = "left" class='copy' colspan='3'>
                      <html:file property="document" onchange="javaScript:selectFile()" maxlength="300" size = "50"/>
            </td> 
       </tr>
        <tr>
                 ...
                 <td style="font-size: 13px" colspan="3">
                    <logic:present name="projectList">
                        <logic:notEmpty name="projectList">
                            <html:select property="pjtName" styleClass="textbox-long" style="width:650;">
                                <html:option value=""><bean:message key="specialReviewLabel.pleaseSelect"/></html:option>
     ...
     <input type="hidden" name="pjtName" id="pjtName" value="<%=session.getAttribute("selectedPjct")%>" />
                 </td>
       </tr>
       <tr>
...
<input type="hidden" name="entity" id="entity" value="<%=request.getAttribute("entity")%>" disabled="true"/>
                 </td>
            <%}%>
       </tr>
    ...
    <tr class='table'><td class='savebutton' colspan="2">
      ...
      <table id="attBodyTable" class="table" style="width: 100%;" border="0" >
           <tr style="background-color:#6E97CF;height: 22px;">
                <td style="color:#FFFFFF;font-size:12px;font-weight:bold;padding: 2px 0 2px 10px;" colspan="8">
                List of Attachments
                </td>
           </tr>
           <tr style="background-color:#6E97CF;height: 22px;">
                    <td style="font-size:12px;font-weight:bold;" width="15%">Attachment Type</td>
                    <td style="font-size:12px;font-weight:bold;" width="16%">File Name</td>
                    <td style="font-size:12px;font-weight:bold;"  width="16%">Description</td>
                    <td style="font-size:12px;font-weight:bold;" width="12%">Project #</td>
                     <%  if(projectType.equalsIgnoreCase("Travel")){ %>
                     <td style="font-size:12px;font-weight:bold;" width="12%" colspan="2">Update Timestamp</td>
                     <%} else {%>
                        <td style="font-size:12px;font-weight:bold;" width="12%">Entity </td>
                        <td style="font-size:12px;font-weight:bold;" width="12%">Update Timestamp</td>
                     <%}%>
                ...
                <logic:notEmpty name="attachmentList">
                    ...
                    <logic:iterate id="coiv2Attachment" name="attachmentList">
                        ...
                        %>
                            <tr bgcolor="<%=strBgColoratt%>" class="rowLine" onmouseover="className='rowHover rowLine'" onmouseout="className='rowLine'" >
                                 <td><bean:write name="coiv2Attachment" property="docdescription"/></td>
                                 <td><bean:write name="coiv2Attachment" property="fileName"/></td>
                                 <td><bean:write name="coiv2Attachment" property="description"/></td>
                                 <td><bean:write name="coiv2Attachment" property="moduleItemKey"/></td>   
                                 <%  if(projectType.equalsIgnoreCase("Travel")){ %>
                                 <td colspan="2"><bean:write name="coiv2Attachment" property="updateTimeStamp"/>by
                                     <bean:write name="coiv2Attachment" property="userName"/>
                                 </td>
                                 <%} else {%>
                                     <td><bean:write name="coiv2Attachment" property="entName"/></td>

                                     <td><bean:write name="coiv2Attachment" property="updateTimeStamp"/>by
                                         <bean:write name="coiv2Attachment" property="userName"/>
                                     </td>
                                <%}%>
                                 <td class="copy" >
