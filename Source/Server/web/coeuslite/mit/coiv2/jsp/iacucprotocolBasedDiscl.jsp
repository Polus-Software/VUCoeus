<%--
    Document   : iacucprotocolBasedDiscl
    Created on : Sep 19, 2011, 5:36:37 PM
    Author     : twinkle
--%>



<%@page contentType="text/html" pageEncoding="UTF-8" import="edu.mit.coeuslite.coiv2.beans.CoiDisclosureBean,java.util.HashMap,edu.mit.coeuslite.coiv2.utilities.CoiConstants,java.util.Vector,edu.mit.coeuslite.coiv2.beans.CoiProtocolInfoBean,edu.mit.coeuslite.coiv2.services.CoiCommonService"%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <%String path = request.getContextPath();                    
                   ...
                   // if (disclosureBean == null || disclosureBean.getCoiDisclosureNumber() == null) {
                    //    target = path + "/getCompleteDisclCoiv2.do?projectType=IacucProtocol";
                   // } else {
    ...
    <script type="text/javascript">
        ...
        if(cc>0){
          for(i=0;i<=cc;i++ ){
            if(document.forms[0].checkedIacucProtocolBasedProject[i] == undefined) {
               if(document.forms[0].checkedIacucProtocolBasedProject.checked==true){
                    canContinue=true;
                }
            }
            else if(document.forms[0].checkedIacucProtocolBasedProject[i].checked==true)
             {
                canContinue=true;
                break;
             }
        ...
        <table id="bodyTable" class="table" style="width: 100%;" border="0">
            <html:form action="/createDisclosureCoiv2.do">
                <logic:notPresent name="protocolList">
                    <tr>
                        <td><p style="color: #ff0000;font-size: 12px;">There are no IACUC protocols in the system that requires your COI disclosure.</p></td>
                    </tr>
                </logic:notPresent>
                <logic:present name="protocolList">
                    ...
                    <tr>
                        <td colspan="6">Please select an IACUC protocol from the list to create a new COI disclosure</td>
                    </tr>
                    ...
                    <tr style="background-color:#6E97CF;">
                      <td width="14%"><strong> Protocol #</strong></td>
                       ...
                       <tr bgcolor="<%=rowColor%>" class="rowLine" onmouseover="className='rowHover rowLine'" onmouseout="className='rowLine'" style="width: 765px;">
                            ...
                            <td><input type="radio" <%=disable%> <%=checked%> name="checkedIacucProtocolBasedProject" value="<bean:write name="allProtocols" property="protocolNumber"/>;<bean:write name="allProtocols" property="title"/>;<bean:write name="allProtocols" property="applicationDate"/>;<bean:write name="allProtocols" property="expirationDate"/>"/><bean:write name="allProtocols" property="protocolNumber"/></td>
                            <td width="35%"><bean:write name="allProtocols" property="title"/></td>
                ...
                <tr bgcolor="#D1E5FF"><td colspan="6">
                        <div class="myForm" id="pjtDet" style="visibility: hidden; overflow: hidden;height: 1px">
                            <div class="Formline0">
                                <br/>
                                <div class="FormLeft">
                                    Project Title
