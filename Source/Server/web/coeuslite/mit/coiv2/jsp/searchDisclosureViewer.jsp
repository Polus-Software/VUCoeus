		...
		<logic:notPresent name="searchDetView">
			<logic:notPresent name="message">
				...
				<table id="bodyTable" style="width: 960px; height: 100%"
					...
					<tr>
						<td width="15%" align="right">&nbsp;&nbsp;&nbsp;&nbsp;<b>Disclosure
								Number:</b>
						</td>
						<td width="25%"><html:text property="discl"
								style="height: 14px;width: 195px;" styleClass="copy"></html:text>
						</td>
						<td width="20%" align="right">&nbsp;&nbsp;&nbsp;&nbsp;<b>Select
								Reporter:</b></td>
						<td width="40%"><html:select property="user"
					...
					<tr>
						...
						<td><html:text property="subDate" styleClass="copy"
							...
							id="hlIRBDate" style="vertical-align: bottom"
					...
					<tr>
						<logic:equal value="false" name="dateMessage">
							<td colspan="2">
								<li>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<font color="red">Please enter a valid start date
