<%--
    Document   : showAssignedDiscl
    Created on : May 6, 2010, 10:21:28 AM
    Author     : Mr Roshin Roy
--%>
...
<td colspan="6" style="background-color:#6E97CF;color:#FFFFFF;font-size:14px;font-weight:bold;margin: 0;padding: 2px 0 2px 10px;position: relative;text-align: left;"><strong>List Of Assigned Reviews</strong></td>
</tr>
<tr>
...
<td style="background-color:#6E97CF;color:#173B63;font-size:12px;font-weight:bold;">Department</td>
...
<td style="background-color:#6E97CF;color:#FFFFFF;font-size:12px;font-weight:bold;"><strong>Disc.Event</strong></td>
<td style="background-color:#6E97CF;color:#FFFFFF;font-size:12px;font-weight:bold;"><strong>Event #</strong></td>
...
<td style="background-color:#6E97CF;color:#FFFFFF;font-size:12px;font-weight:bold;"><strong>Last Update By</strong></td>
...
<!--    <td>
<%String link1 = request.getContextPath()+"/getannualdisclosure.do?&param1=" + bean.getCoiDisclosureNumber() +"&param2=" + bean.getSequenceNumber()+"&param7="+ bean.getPersonId()+"&param5="+ModuleName+"&param6="+"othersDiscl"+"&selectedPjct="+moduleKey;
    if(ModuleName!= null && ModuleName.equals("Travel")){
        link1= request.getContextPath()+"/travelDetails.do?&param1=" + bean.getCoiDisclosureNumber()+"&param7="+ bean.getPersonId()+"&edit=true&view=true&selectedPjct="+moduleKey+"&sequenceNumber="+bean.getSequenceNumber()+"&param6="+"othersDiscl";
    }
%>
...
<td>
    <a href='<%=link1%>' > <b><%--<bean:write name="pjtEntView" property="moduleName"/>--%><%=ModuleName%></b></a>
    </td>
<td>
...
<a href='<%=link1%>' ><b><bean:write name="pjtEntView" property="reviewStatus"/></b></a>
    ...
    <td>
        <a href='<%=link1%>' ><b><bean:write name="pjtEntView" property="updateUser"/></b></a>
    </td>
    <td>
