...
<font color="red">No disclosures assigned by admin</font>
		...
		<logic:empty name="entityNameList">
			<tr>
				<td colspan="6"><font color="red">No disclosures
						assigned by admin</font></td>
			</tr>
		</logic:empty>
...
&nbsp;&nbsp;
											...
											<td><a href='<%=link1%>'><b><bean:write
															name="pjtEntView" property="disclosureStatus" /></b></a></td>
											<td><a href='<%=link1%>'><b><bean:write
											...
											<td><b><html:link action="<%=linkPrint%>"
														target="_blank">Print&nbsp;&nbsp;&nbsp;</html:link></b></td>
										</tr>
									</logic:equal>
									<%i++;%>
								</logic:iterate>
