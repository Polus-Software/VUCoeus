        ...
        <table id="bodyTable" class="table" style="width: 100%;" border="0">
            <html:form action="/createDisclosureCoiv2.do">             
                <logic:notPresent name="protocolList">
                    <tr>
                        <td><p style="color: #ff0000;font-size: 12px;">There are no IRB protocols in the system that requires your COI disclosure.</p></td>
                    </tr>
                </logic:notPresent>
                <logic:present name="protocolList">
                    ...
                    <tr>
                        <td colspan="6">Please select an IRB protocol from the list to create a new COI disclosure</td>
                    </tr>
