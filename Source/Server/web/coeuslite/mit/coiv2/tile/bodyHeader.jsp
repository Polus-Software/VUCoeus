    ...
    <body>
        <table id="bodyTable1"  class="table"  border="0" width="100%">
            <tr style="background-color:#6E97CF;" >
                <td colspan="4">
                    <h1 style="background-color:#6E97CF;color:#FFFFFF;float:left;font-size:14px;font-weight:bold;margin: 0;padding: 2px 0 2px 1px;position: relative;text-align: left;">Financial Disclosure by <%=peronFullName%><%--<bean:write name="person" property="fullName"/>--%></h1>
                </td>
            </tr>
            <logic:present name="PersonDetails">
                     <logic:iterate id="person" name="PersonDetails">
            <tr>
                <td  style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none;" width="15%" align="right">
                            &emsp;&emsp;&emsp; Name  :
                </td>
                <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none;" width="35%" align="left">
                &nbsp;<span style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-weight:normal;font-size:12px;"><bean:write name="person" property="fullName"/></span>
                </td>
                <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none" width="18%" align="right">
                User Name :
                </td>
                <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none" align="left">
                &nbsp;<span style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-weight:normal;font-size:12px;"><bean:write name="person" property="userName"/></span>
                </td>
            </tr>
            <tr>
                <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none" align="right">
                               &nbsp; Department :
                </td>
                <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none" align="left">
                               &nbsp;<span style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-weight:normal;font-size:12px;"><%=Desc%><%--<bean:write name="person" property="homeUnit"/>--%></span>
                </td>
                ...
                <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none" align="left">
                      &nbsp;<span style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-weight:normal;font-size:12px;"><bean:write name="person" property="offPhone"/></span>
                </td>
            ...
            <tr>
                ...
                <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none" align="left">
                  &nbsp;<span style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-weight:normal;font-size:12px;"><%=faculty%></span>
                </td>
                ...
                <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none" align="left">
                     &nbsp;<span style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-weight:normal;font-size:12px;"><html:link href="mailto:"><bean:write name="person" property="email"/></html:link></span>
                </td>
            </tr>
            <tr>
               <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none" align="right">
                ...
                <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none" colspan="3" align="left">
                  &nbsp;<span style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-weight:normal;font-size:12px;"><%=Campus%><bean:write name="person" property="school"/></span>
                </td>
            </tr>
...
<%--        </table>
        ...
        <table class="table" style="width: 100%;" border="0">--%>
               ...
               <logic:present name="ApprovedDisclDetView" >
                <tr>
                    <td class="copybold"  nowrap="" colspan="4"><img width="100%" height="2" border="0" src="<%=request.getContextPath()%>/coeusliteimages/line4.gif"></td>
                </tr>
                   <logic:iterate id="disclDetails" name="ApprovedDisclDetView">
                       <tr>
                           <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none;" align="right">
                               <logic:notPresent name="ToShowMY">My</logic:notPresent> Discl. No :
                           </td>
                           <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none;" align="left">
                               <span style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-weight:normal;font-size:12px;"><bean:write name="disclDetails" property="coiDisclosureNumber"/>(<bean:write name="disclDetails" property="sequenceNumber"/>)</span>
                           </td>
                           <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none;" align="right">
                                Expiration Date :
                           </td>
                           <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none;" align="left">
                                <span style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-weight:normal;font-size:12px;">
                                    <logic:notEqual name="disclDetails" property="dispositionStatus" value="Pending">
                                    <coeusUtils:formatDate name="disclDetails" property="expirationDate" />
                                    </logic:notEqual>
                                </span>
                           </td>
                       </tr>
                       <tr>
                           <td nowrap style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none;" align="right">
                                Disposition Status :
                           </td>
                           <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none;" align="left">
                                <span style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-weight:normal;font-size:12px;"><bean:write name="disclDetails" property="dispositionStatus"/></span>
                           </td>
                           <td nowrap style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none;" align="right">
                                <logic:notPresent name="ToShowMY">My</logic:notPresent> Disclosure Status :
                           </td>
                           <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none;" align="left">
                                <span style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-weight:normal;font-size:12px;"><bean:write name="disclDetails" property="disclosureStatus"/></span>
                           </td>
                       </tr>
                       <tr>
                           <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none;" align="right">
                           ...
                           <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none;" align="left">
                               <span style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-weight:normal;font-size:12px;"><bean:write name="disclDetails" property="updateTimestamp"/><b> by </b><bean:write name="disclDetails" property="updateUser"/></span>
                           </td>
                           <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none;" align="right">
                           Review Status :
                           </td>
                           <td style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;float: none;" align="left">
                           <span style="color: #333333;font-family:Arial,Helvetica,sans-serif;font-weight:normal;font-size:12px;"><bean:write name="disclDetails" property="reviewStatus"/></span>
                           </td>
                       </tr>
                   </logic:iterate>
               </logic:present>
          ...
          <%
           ...
           <table id="bodyTable" class="table" style="width: 100%;" border="0" >
                <tr style="background-color:#6E97CF;height: 22px;">
                    <td style="width: 10%;background-color:#6E97CF;color:#FFFFFF;float:none;font-size:14px;font-weight:bold;margin: 0;padding: 2px 0 2px 10px;text-align: left; "><strong>Discl.Event</strong></td>
                    <td style="width: 10%;background-color:#6E97CF;color:#FFFFFF;float:none;font-size:14px;font-weight:bold;margin: 0;padding: 2px 0 2px 10px;text-align: left;"><strong>Project #</strong></td>
                    <td style="width: 47%;background-color:#6E97CF;color:#FFFFFF;float:none;font-size:14px;font-weight:bold;margin: 0;padding: 2px 0 2px 10px;text-align: left;"><strong>Project Name</strong></td>
                    <td style="width: 13%;background-color:#6E97CF;color:#FFFFFF;float:none;font-size:14px;font-weight:bold;margin: 0;padding: 2px 0 2px 10px;text-align: left;"><strong>Discl.Status</strong></td>
...
<logic:iterate id="pjtTitle" name="eventPjtNameList">
         <%
              ...
              <tr bgcolor="<%=strBgColor%>" id="row<%=index%>" class="rowLine" onmouseover="className='rowHover rowLine'" onmouseout="className='rowLine'" height="22px">
                ...
                <td width="6%" style="padding: 2px 0 2px 10px;text-align: left;"><bean:write name="pjtTitle" property="coiProjectId"/></td>
          ...
          <%}%>
            ...
            <html:form action="/showQuestionnaire.do">
             <table class="table" style="width: 100%;height: 40px;" border="0" >
                 <tr>
                     <td height="15%" align="center"><font color="#800517" size="2px" face="verdana" ><b><bean:message bundle="coi" key="Annualreview.due.Message" /></b></font>&nbsp;&nbsp;<html:button property="discSubmit" styleClass="clsavebutton" value="Prepare and Submit Annual Disclosure" style="width:270px;" onclick="javascript:cal();"/></td>
                 </tr>
             </table>
            </html:form>
           <%}%>
    ...
    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="table"  >
            <tr style="background-color:#6E97CF;font-size:12px;margin: 0;">
                <td style="padding: 2px 0px 5px 0px"> <font color="#FFFFFF" size="2px"><b>Project Title</b></font></td>
            </tr>
