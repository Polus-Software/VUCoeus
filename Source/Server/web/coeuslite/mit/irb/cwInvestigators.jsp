...
<%@page
	import="java.util.Vector,
                ...
                edu.mit.coeus.irb.bean.ProtocolInvestigatorUnitsBean,
                edu.mit.coeuslite.irb.bean.IRBInvestigatorBean,
...
//start--3      
    ...
    String protocolNo = (String)session.getAttribute(CoeusLiteConstants.PROTOCOL_NUMBER);
    if(protocolNo!= null){ 
