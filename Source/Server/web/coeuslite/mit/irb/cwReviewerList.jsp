...
<%
    Vector vecCompletedColumns =(Vector)session.getAttribute("REVIEWER_REVIEW_COMPLETED_PROTOCOL_SEARCH_COLUMNS");
    Vector vecPendingColumns =(Vector)session.getAttribute("REVIEWER_REVIEW_INCOMPLETED_PROTOCOL_SEARCH_COLUMNS");
													...
													<td>
														<div id='pendingPanel'>
															<table width="933" align=center border="0"
																...
																<logic:present
																	name="REVIEWER_REVIEW_INCOMPLETED_PROTOCOL_SEARCH">
																	<tr>
																	...
																	<logic:iterate id="pendingReviewProtocol"
																		...
																		<tr bgcolor="<%=strBgColor%>" valign="top"
																			...
																			<td align="left" nowrap class="copy"><a
																				href="<%=request.getContextPath()%>/getProtocolData.do?SEARCH_ACTION=SEARCH_ACTION&protocolNumber=<%=protocolNumber.trim()%>&PAGE=<%=destPage.trim()%>&sequenceNumber=<%=sequenceNumber%>&submissionNumber=<%=submissionNumber%>&fromIsReviewer=true">
																					<u> <%=value%>
																				</u>
																			</a></td>
																			<%}%>
																...
																<td>
																	<div id='completedPanel'>
																		<table width="933" align=center border="0"
																			...
																			class="sortable">
																			<logic:present
																				name="REVIEWER_REVIEW_COMPLETED_PROTOCOL_SEARCH">
																				<tr>
