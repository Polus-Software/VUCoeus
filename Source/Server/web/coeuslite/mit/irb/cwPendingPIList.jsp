										...
										<td colspan='4'>
											<table width="933" align=center border="0" cellpadding="0"
                                                ...
                                                To avoid the double quotes when setting the attributes to img tag-->
															...
															&nbsp;
															<bean:message key="pendingPI.SMRprotocolSearch" />
														</div>
														...
														<div id='smrPanel'>
                                                         ...
                                                         for(int index=0;index<vecColumnData.size();index++){
                                                             ...
                                                             if(displayBean.isVisible()){
																...
																<logic:present
																	name="PENDING_PI_ACTION_SMR_RQD_PROTO_SEARCH">
																	...
																	<logic:iterate id="smrProtoSearch"
																		...
																		<tr bgcolor="<%=strBgColor%>" valign="top"
																			...
																			<td align="left" nowrap class="copy"><a
																				href="<%=request.getContextPath()%>/getProtocolData.do?SEARCH_ACTION=SEARCH_ACTION&protocolNumber=<%=protocolNumber.trim()%>&PAGE=<%=destPage.trim()%>&sequenceNumber=<%=sequenceNumber%>&notFromIsReviewer=true">
																					<u> <%=value%>
																				</u>
																			</a></td>
																			<%
										...
										<td colspan='4'>
											<table width="933" align=center border="0" cellpadding="0"
                                                ...
                                                To avoid the double quotes when setting the attributes to img tag-->
															...
															&nbsp;
															<bean:message key="pendingPI.SRProtocolSearch" />
														</div>
														...
														<div id='srPanel'>
                                                         ...
                                                         for(int index=0;index<vecColumnData.size();index++){
                                                             ...
                                                             if(displayBean.isVisible()){
																...
																<logic:present
																	name="PENDING_PI_ACTION_SR_RQD_PROTO_SEARCH">
																	<%String strBgColor = "#DCE5F1";
                                                          String protocolNumber="";
                                                          int count = 0;%>
																	<logic:iterate id="smrProtoSearch"
																		...
																		<tr bgcolor="<%=strBgColor%>" valign="top"
                                                                            ...
                                                                            %>
																			<td align="left" nowrap class="copy" width='25%'>
																				<a
																				href="<%=request.getContextPath()%>/getProtocolData.do?SEARCH_ACTION=SEARCH_ACTION&protocolNumber=<%=protocolNumber.trim()%>&PAGE=<%=destPage.trim()%>&sequenceNumber=<%=sequenceNumber%>&notFromIsReviewer=true">
																					<u> <%=value%>
																				</u>
														...
														<div id='expPanel'>
                                                         ...
                                                         for(int index=0;index<vecColumnData.size();index++){
                                                             ...
                                                             if(displayBean.isVisible()){
																...
																<logic:present
																	name="PENDING_PI_ACTION_EXPIRE_PROTO_SEARCH">
																	<%String strBgColor = "#DCE5F1";
                                                          String protocolNumber="";
                                                          int count = 0;%>
																	<logic:iterate id="smrProtoSearch"
