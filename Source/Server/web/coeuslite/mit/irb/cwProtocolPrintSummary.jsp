...
<jsp:useBean id="printSummQuestio" scope="request"
	class="java.util.HashMap" />
<jsp:useBean id="irbPrintSummProtoAttach" scope="request"
	class="java.util.HashMap" />
<jsp:useBean id="irbPrintSummOtherAttach" scope="request"
	class="java.util.HashMap" />
...
Map hmPrintSummaryProtoAttach = (Map)request.getAttribute("irbPrintSummProtoAttach");
Map hmPrintSummaryOtherAttach = (Map)request.getAttribute("irbPrintSummOtherAttach");
...
<html:form action="/protocolPrint" method="post" target="_blank">

	<script type="text/javascript">
             document.getElementById('txt').innerHTML = '<bean:message key="helpPageTextProtocol.PrintSummary"/>';
</script>
	<body>
