...
<body>
	<!-- JM menu parameter for setting pages -->
	<% String value = "";%>
	<% 
...
%>
	...
	<table width="100%" align="center" border="0" cellpadding="0"
		...
		<tr>
			<td>
				<!-- JM 6-22-2011 changed background to VU black -->
				<table width="100%" cellpadding="0" cellspacing="0"
					STYLE="background-color: black; border: 0">
					<tr>
						<!-- JM 6-22-2011 changed gif height to 68 -->
						<td><img
					...
					<tr>
						<td height='20' colspan='3' align='right'><span
							class="copysmallwhite"> <html:link
									...
									<!-- JM 6-22-2011 change current lock link color to white --->
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td width="99%">
                            ...
                            <table bgcolor="#E1E3E8" width="100%" height="24"  
							...
							<table width="100%" height="24" border="0" cellpadding="0"
								...
								<tr>
                                    ...
                                    for (int i =0; i<headerItemsVector.size();  i++) {
                                        ...
                                        // JM allows page to display as selected
										...
										<% 
                                       	...
                                       	%> <html:link page='<%=link%>'
											...
											<img src="<bean:write name='ctxtPath'/><%=path%>"
												name="<%=menuId%>" width="130" height="24" border="0"
