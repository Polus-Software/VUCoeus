...
<body>
    ...
    String strPage =(String) session.getAttribute("newAmendRenew");
    boolean isNotAR = true;
    //Modified for displaying New Amendment/Renewal Status-Start
    isNotAR = strPage!= null && (strPage.equals("NA")|| strPage.equals("NR")|| strPage.equals("RA"))? false : true;
    //Modified for displaying New Amendment/Renewal Status-End
    ...
    if("NA".equals(strPage)){
        ...
        status = newRenewal;
    } //Added for displaying New Amendment/Renewal Status-Start
      else if("RA".equals(strPage)){
        // If a New Renewal/Amendment Window is opened for the Protocol
        status = newRenewalAmendment;
    } //Added for displaying New Amendment/Renewal Status-End
