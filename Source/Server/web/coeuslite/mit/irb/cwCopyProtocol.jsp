...
function protocolCopy(){      
  ...
  document.copyProtocolForm.action ="<%=request.getContextPath()%>/copyProtocol.do?PAGE=CP&attachment="+attachment+"&otherAttchment="+otherAttchment+"&questionnaire="+questionnaire; 
...
document.copyProtocolForm.action ="<%=request.getContextPath()%>/getProtocolData.do?protocolNumber=<%=session.getAttribute("PROTOCOL_NUMBER"+session.getId())%>&PAGE=G&sequenceNumber=<%=session.getAttribute("SEQUENCE_NUMBER"+session.getId())%>"; 
  document.copyProtocolForm.submit();
}
										...
										<tr>
											...
											<td align="left" class='copybold'><html:checkbox
												...
												<bean:message bundle="protocol"
													key="copyProtocol.attachments" /></td>
										</tr>
										<tr>
											<td align="left" class='copybold'><html:checkbox
													property='otherAttachmentFlag' value="Y"
													disabled="<%=hasOtherAttach%>" /> <bean:message
													bundle="protocol" key="copyProtocol.otherAttachments" /></td>
										</tr>
										<tr>
											<td align="left" class='copybold'><html:checkbox
													property='questionnaireFlag' value="Y"
													disabled="<%=hasQnr%>" /> <bean:message bundle="protocol"
				...
				<td class='savebutton'>
					<div id="mainbutton" style="display: block;">
						<html:button property="Ok" styleClass="clbutton" disabled=""
							...
							<bean:message bundle="protocol" key="copyProtocol.ok" />
						</html:button>
						&nbsp;&nbsp;&nbsp;
