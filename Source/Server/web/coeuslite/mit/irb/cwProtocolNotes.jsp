...
<%@ page
	import="edu.mit.coeuslite.utils.CoeusLiteConstants,edu.mit.coeuslite.irb.bean.ProtocolHeaderDetailsBean"%>
...
<script language="JavaScript">            
            ...
            function saveNotes(){
                ...
                /*
                if(document.protocolNotesForm.addRestrictedView.checked == true){
                    restricted = 'Y'
                }
                */
                //Commented for Coeus4.3 Protocol Notes enhancement - end
                document.protocolNotesForm.action = "<%=request.getContextPath()%>/saveProtocolNotes.do?&restricted="+restricted;
                document.protocolNotesForm.submit();
            ...
            function cancelNotes(){        
                    document.protocolNotesForm.action = "<%=request.getContextPath()%>/getProtocolNotes.do?page=N";
                    document.protocolNotesForm.submit();
                  }
        </script>
...
<body>
	...
	<html:form action="/getProtocolNotes.do">
		<script type="text/javascript">
                document.getElementById('txt').innerHTML = '<bean:message key="helpPageTextProtocol.Notes"/>';
            </script>
		<div id='notesProtocol'>
			<table width="100%" height="100%" border="1" cellpadding="0"
							...
							<tr>
								<td height="20" width="50%" align="left" valign="top"
									class="theader"><bean:message
										key="protocolNote.label.header" /></td>
				...
				<tr class='copybold' align='left' width='100%'>
					<td>
						<div id='open_Add' style='display: block;'>

							<html:link href="javaScript:called();">
								<u>
								<bean:message key="protocolNote.label.addNotes" /></u>
							</html:link>

							<%--<html:link action="/getProtocolNotes.do?actionType=Add">
                        <u><bean:message key="protocolNote.label.add"/></u>
                        </html:link>--%>
						</div>
					</td>
				</tr>
				...
				<tr>
                    ...
                    <td width="20%" align="left" valign="top" class="copy" nowrap>
                        <html:checkbox name="protocolNotesForm" property="addRestrictedView" value="N" onclick="dataChanged()"/>
                    </td>
                    --%>
											<!-- Commented for Coeus4.3 Protocol Notes enhancement - end -->
                                        ...
                                        --%> <bean:message
												...
												<td width="85%">
													...
													<html:textarea name="protocolNotesForm" styleClass="copy"
				...
				<tr>
					<td align="left" valign="top" class='core'>
                        ...
                        <td colspan="5" align="left" valign="top">
                            ...
                            <tr>
                                <td>
                                    <bean:message key="protocolNote.label.list"/>
                                </td>
                            </tr>
                            </table>
                        </td>
        ...
        <%}else if(show == null && "313".equals(statusCode)) {%>
                document.getElementById('open_window').style.display = 'none';
                //document.getElementById('hide_Add').style.display = 'none';
                document.getElementById('open_Add').style.display = 'none';
        <%}else {%>       
	...
	<script>
          ...
          LINK = "<%=request.getContextPath()%>/saveProtocolNotes.do?restricted="+restricted;
          FORM_LINK = document.protocolNotesForm;
